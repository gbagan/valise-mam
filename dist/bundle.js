...
(function($PS) {
  ...
  var newGame = function (dictGame) {
      return function (f) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
              var state2 = f(v);
              return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(onNewGame(dictGame)(state2)))(function (v1) {
                  return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(initialPosition(dictGame)(v1)))(function (v2) {
                      ...
                      return Pha_Update.setState((function () {
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          ...
          throw new Error("Failed pattern match at Game.Core (line 290, column 13 - line 292, column 39): " + [ bestMove.constructor.name ]);
      };
  };
  var computerPlay = function (dictGame) {
      return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
          return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(computerMove(dictGame)(v)))(function (v1) {
              ...
              if (v2 instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState(Data_Function["const"](v2.value0)))(function () {
      ...
      return function (v) {
          if (v instanceof Undo) {
              return Pha_Update.purely(function (state) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 157, column 35 - line 163, column 56): " + [ v1.constructor.name ]);
              });
          };
          if (v instanceof Redo) {
              return Pha_Update.purely(function (state) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 165, column 35 - line 171, column 52): " + [ v1.constructor.name ]);
              });
          };
          if (v instanceof Reset) {
              return Pha_Update.purely(function (state) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 173, column 36 - line 178, column 37): " + [ v1.constructor.name ]);
              });
          };
          ...
          if (v instanceof SetCustomSize) {
              return Pha_Update.purely(Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(true));
          };
  ...
  var playA = function (dictGame) {
      return function (move) {
          return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState(function (v2) {
                      ...
                      if ($170) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState(function (v3) {
                              return v2.value0;
                          }))(function () {
      ...
      return function (dictGame) {
          return function (_dragged) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 327, column 1 - line 328, column 79): " + [ _dragged.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
  ...
  var update = function (v) {
      ...
      if (v instanceof SetBeast) {
          return Game_Core.newGame(labeteGame)((function () {
              ...
              var $128 = Data_Lens_Setter.set(_beastType(Data_Profunctor_Strong.strongFn))(v.value0);
              return function ($129) {
                  return $127($128($129));
              };
          })());
      ...
      if (v instanceof FinishZone) {
          return Pha_Update.purely(function (state) {
              ...
              throw new Error("Failed pattern match at Game.Labete.Model (line 199, column 46 - line 206, column 44): " + [ v1.constructor.name ]);
          });
      };
...
(function($PS) {
  ...
  var afterPlay = Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      if (v instanceof SelectVertex) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v2) {
  ...
  var update = function (v) {
      ...
      if (v instanceof Customize) {
          return Game_Core.newGame(queensGame)((function () {
              var $105 = Data_Lens_Setter.set(_multiPieces(Data_Profunctor_Strong.strongFn))(false);
              var $106 = Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.CustomDialog.value);
              var $107 = Data_Lens_Setter.set(_allowedPieces(Data_Profunctor_Strong.strongFn))(Data_Array_NonEmpty.singleton(Custom.value));
              return function ($108) {
  ...
  var update = function (v) {
      if (v instanceof SetPage) {
          return Pha_Update.purely(function (st) {
              var $16 = Data_Lens_Getter.viewOn(st)(_locked(Data_Lens_Internal_Forget.strongForget));
              if ($16) {
                  return st;
              };
      ...
      if (v instanceof Animate) {
          return Control_Monad.unlessM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Data_Lens_Getter.view(_locked(Data_Lens_Internal_Forget.strongForget)))(Pha_Update.getState))(Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState((function () {
              var $24 = Data_Lens_Setter.set(_locked(Data_Profunctor_Strong.strongFn))(true);
              var $25 = Data_Lens_Setter.set(_anim(Data_Profunctor_Strong.strongFn))(Data_Map_Internal.empty);
              return function ($26) {
                  return $24($25($26));
              };
          })()))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Effects_Delay.delay(v1.value0))(function () {
                      return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v2) {
                          return Pha_Update.setState(Data_Lens_Setter.set((function () {
                              var $27 = _anim(Data_Profunctor_Strong.strongFn);
                              var $28 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(v1.value1)(Data_Profunctor_Strong.strongFn);
                              return function ($29) {
                                  return $27($28($29));
                              };
