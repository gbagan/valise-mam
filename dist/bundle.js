...
(function($PS) {
  ...
  var interpretRng = function (v) {
      ...
      throw new Error("Failed pattern match at Pha.Effects.Random (line 42, column 1 - line 42, column 48): " + [ v.constructor.name ]);
  };
  var functorRng = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          throw new Error("Failed pattern match at Pha.Effects.Random (line 13, column 1 - line 13, column 41): " + [ m.constructor.name ]);
      };
  });
