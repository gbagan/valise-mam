...
(function($PS) {
  ...
  var randomPick = function (v) {
      ...
      return Data_Maybe.Just.create(Data_Functor.map(Run.functorRun)(Data_Array.unsafeIndex()(v))(randomInt(Data_Array.length(v))));
  };
...
(function($PS) {
  ...
  exports["delay"] = delay;
  exports["delayInterpret"] = delayInterpret;
  exports["rngInterpret"] = rngInterpret;
  exports["GetState"] = GetState;
  exports["SetState"] = SetState;
...
(function($PS) {
  ...
  var _customSize = function (dictStrong) {
      var $169 = _core(dictStrong);
      var $170 = Data_Lens_Lens.lens(function (v) {
          return v.customSize;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _dialog = function (dictStrong) {
      var $172 = _core(dictStrong);
      var $173 = Data_Lens_Lens.lens(function (v) {
          return v.dialog;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _help = function (dictStrong) {
      var $175 = _core(dictStrong);
      var $176 = Data_Lens_Lens.lens(function (v) {
          return v.help;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _history = function (dictStrong) {
      var $178 = _core(dictStrong);
      var $179 = Data_Lens_Lens.lens(function (v) {
          return v.history;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _nbColumns = function (dictStrong) {
      var $187 = _core(dictStrong);
      var $188 = Data_Lens_Lens.lens(function (v) {
          return v.nbColumns;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _nbRows = function (dictStrong) {
      var $190 = _core(dictStrong);
      var $191 = Data_Lens_Lens.lens(function (v) {
          return v.nbRows;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _pointer = function (dictStrong) {
      var $193 = _core(dictStrong);
      var $194 = Data_Lens_Lens.lens(function (v) {
          return v.pointer;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _position = function (dictStrong) {
      var $196 = _core(dictStrong);
      var $197 = Data_Lens_Lens.lens(function (v) {
          return v.position;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _redoHistory = function (dictStrong) {
      var $199 = _core(dictStrong);
      var $200 = Data_Lens_Lens.lens(function (v) {
  ...
  var _scores = function (dictStrong) {
      var $202 = _core(dictStrong);
      var $203 = Data_Lens_Lens.lens(function (v) {
          return v.scores;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var bestScore = function (dictScoreGame) {
      return function (state) {
          return Data_Lens_Getter.viewOn(state)((function () {
              var $205 = _scores(Data_Lens_Internal_Forget.strongForget);
              var $206 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(scoreHash$prime(dictScoreGame)(state))(Data_Lens_Internal_Forget.strongForget);
              return function ($207) {
                  return $205($206($207));
              };
          })());
              ...
              return Control_Bind.bind(Run.bindRun)(onNewGame(dictGame)(state2))(function (v1) {
                  return Control_Bind.bind(Run.bindRun)(initialPosition(dictGame)(v1))(function (v2) {
                      var state4 = Data_Lens_Setter.set((function () {
                          var $208 = _scores(Data_Profunctor_Strong.strongFn);
                          var $209 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))("custom")(Data_Profunctor_Strong.strongFn);
                          return function ($210) {
                              return $208($209($210));
                          };
          ...
          return function (nbColumns) {
              return function (customSize) {
                  ...
                  return newGame(dictGame)((function () {
                      var $211 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(customSize);
                      return function ($212) {
                          return setSize$prime($211($212));
                      };
                  })());
              };
          };
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          ...
          return Control_Alt.alt(Data_Maybe.altMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Control_Applicative.pure(Run.applicativeRun))(bestMove))(Pha_Random.randomPick(moves));
      };
  };
  var computerPlay = function (dictGame) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Run.bindRun)(Data_Functor.map(Run.functorRun)(Data_Function.flip(playAux(dictGame))(v))(v1.value0))(function (v2) {
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                  };
                  if (v2 instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 188, column 48 - line 192, column 59): " + [ v2.constructor.name ]);
              });
          };
          throw new Error("Failed pattern match at Game.Core (line 185, column 5 - line 192, column 59): " + [ v1.constructor.name ]);
      });
  };
  var computerStartsA = function (dictGame) {
      return Control_Apply.applySecond(Run.applyRun)(Pha_Action.setState((function () {
          var $227 = Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(oppositeTurn);
          return function ($228) {
              return pushToHistory($227($228));
          };
          ...
          return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v2) {
                      ...
                      var $157 = isLevelFinished(dictGame)(v1.value0);
                      if ($157) {
                      ...
                      var $161 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v1.value0)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v1.value0)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                      if ($161) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 200, column 5 - line 211, column 26): " + [ v1.constructor.name ]);
          }));
      };
  };
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $165 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($165) {
...
(function($PS) {
  ...
  exports["eventInterpret"] = eventInterpret;
...
(function($PS) {
  ...
  var interpretEffects = Data_Functor_Variant.match()()()({
      delay: Pha_Action.delayInterpret,
      rng: Pha_Action.rngInterpret,
      location: function (v) {
      ...
      event: Pha_Event.eventInterpret,
      eventEff: function (v) {
