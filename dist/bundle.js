  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          ...
          if (bestMove instanceof Data_Maybe.Nothing) {
              return Pha_Effects_Random.sample(moves);
          };
...
(function($PS) {
  ...
  var interpretLocation = (function () {
      var handle = function (v) {
          return Run.liftAff(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.mapFlipped(Effect.functorEffect)($foreign.getLoc)(v.value0)));
      };
      return Run.run(Run.monadRun)(Data_Functor_Variant.on()(new Data_Symbol.IsSymbol(function () {
          return "location";
      }))(_location)(handle)(Run.send));
  })();
