...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          }), UI_Icons.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
          var board = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          }))([ Pha_Html["class'"]("ui-board dessin-board")(true) ]))([ Pha_Html.svg([ Pha_Html["class'"]("dessin-svg")(true), Pha_Html.viewBox(0)(0)(100)(100) ])(Data_Array.concat([ Data_Functor.mapFlipped(Data_Functor.functorArray)(graph.edges)(function (edge) {
              ...
              return function (v) {
                  return Pha_Html.circle(20.0 * v.x)(20.0 * v.y)(3.0)([ Pha_Html.stroke((function () {
                      var $36 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Maybe.eqMaybe(Data_Eq.eqInt)))(new Data_Maybe.Just(new Data_Maybe.Just(i)))(Data_Array.last(position));
                      if ($36) {
                          return "red";
                      };
                      return "blue";
