...
(function($PS) {
  ...
  var scoreHash$prime = function (dictScoreGame) {
      return function (state) {
          var $102 = isCustomGame(dictScoreGame)(state);
          if ($102) {
              return "custom";
          };
          ...
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      ...
                      var $119 = Data_List["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget))) || isLevelFinished(dictGame)(state);
                      if ($119) {
          ...
          return function (nbColumns) {
              return function (customSize) {
                  var setSize$prime = function (state) {
                      ...
                      var $121 = nbRows >= v.value0 && (nbRows <= v.value2 && (nbColumns >= v.value1 && nbColumns <= v.value3));
                      if ($121) {
  ...
  var updateScore$prime = function (dictScoreGame) {
      return function (strat) {
          return function (state) {
              ...
              var cmp = (function () {
                  var $126 = Data_Eq.eq(eqObjective)(objective(dictScoreGame)(state))(Minimize.value);
                  if ($126) {
  ...
  var changeTurn = function (state) {
      return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (x) {
          var $128 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
          if ($128) {
  ...
  var redoA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 142, column 28 - line 148, column 52): " + [ v.constructor.name ]);
  });
  var undoA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 133, column 28 - line 139, column 56): " + [ v.constructor.name ]);
  });
  var playAux = function (dictGame) {
      return function (move) {
          return function (state) {
              var $135 = canPlay(dictGame)(state)(move);
              if ($135) {
                  var position = Data_Lens_Getter.viewOn(state)(_position(Data_Lens_Internal_Forget.strongForget));
                  return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(oppositeTurn)(Data_Lens_Setter.set(_position(Data_Profunctor_Strong.strongFn))(play(dictGame)(state)(move))(state));
              };
              return state;
          };
      };
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $136 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($136) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $137 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($137) {
                      return Data_Maybe.Nothing.value;
                  };
      ...
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Run.bindRun)(Pha_Action["randomAction'"](function (st) {
                  return Data_Functor.mapFlipped(Lib_Random.functorRandom)(v1.value0)(Data_Function.flip(playAux(dictGame))(st));
              }))(function (v2) {
                  return Control_Applicative.when(Run.applicativeRun)(isLevelFinished(dictGame)(v2))(showVictory);
              });
          };
          throw new Error("Failed pattern match at Game.Core (line 183, column 5 - line 187, column 51): " + [ v1.constructor.name ]);
      });
  };
  var computerStartsA = function (dictGame) {
      return Control_Apply.applySecond(Run.applyRun)(Pha_Action.setState((function () {
          var $212 = Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(oppositeTurn);
          return function ($213) {
              return pushToHistory($212($213));
          };
  ...
  var playA = function (dictGame) {
      return function (move) {
          return lockAction(Control_Monad.whenM(Run.monadRun)(Data_Functor.mapFlipped(Run.functorRun)(Pha_Action.getState)(Data_Function.flip(canPlay(dictGame))(move)))(Control_Bind.bind(Run.bindRun)(Pha_Action["setState'"]((function () {
              var $214 = playAux(dictGame)(move);
              return function ($215) {
                  return $214(pushToHistory($215));
              };
          })()))(function (v) {
              var $143 = isLevelFinished(dictGame)(v);
              if ($143) {
  ...
  var resetA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 151, column 29 - line 156, column 37): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var winTitleFor2Players = function (state) {
      ...
      if ($31) {
          return "Le " + ((function () {
              var $32 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn2.value);
              if ($32) {
                  return "premier";
              };
              return "second";
      ...
      var $33 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn2.value);
      if ($33) {
  ...
  var turnMessage = function (dictGame) {
      return function (state) {
          ...
          var $35 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
          if ($35) {
...
(function($PS) {
  ...
  var nbRaises = (function () {
      var $56 = Data_Array.filter(Data_Maybe.isNothing);
      var $57 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($58) {
          return Data_Array.length($56($57($58)));
      };
  })();
  var house = {
      vertices: [ {
  ...
  var edgesOf = (function () {
      ...
      var $59 = Data_Array.mapMaybe(toEdge);
      return function ($60) {
          return $59(Lib_Util.pairwise($60));
      };
  })();
  var cross = {
      vertices: Data_Functor.mapFlipped(Data_Functor.functorArray)([ {
  ...
  var gameDessin = new Game_Core.Game(function (state) {
      return function (x) {
          ...
          throw new Error("Failed pattern match at Game.Dessin.Model (line 94, column 9 - line 98, column 26): " + [ x.constructor.name ]);
      };
  }, function (v) {
      return Data_Maybe.Nothing.value;
  }, function (v) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Template.card("Dessin")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Dessin")([ 0, 1, 2, 3, 4 ])(Data_Lens_Getter.viewOn(state)(Game_Dessin_Model["_graphIndex"](Data_Lens_Internal_Forget.strongForget)))(Game_Dessin_Model.setGraphIndexA)(function (i) {
              return function (opt) {
                  return {
...
(function($PS) {
      ...
      return function (columns) {
          return function (mode) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.Model (line 111, column 24 - line 114, column 83): " + [ mode.constructor.name ]);
              });
          };
      };
  };
  ...
  var getNewBeast = function (state) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 144, column 21 - line 149, column 42): " + [ v.constructor.name ]);
  };
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              ...
              throw new Error("Failed pattern match at Game.Labete.View (line 112, column 26 - line 114, column 83): " + [ v.constructor.name ]);
          })()) ])) ]);
          var scoreDialog = function (v) {
          ...
          var config = UI_Template.card("La b\xeate")([ UI_Icons.iconSelectGroup(Game_Labete_Model.showBt)(Game_Labete_Model.eqBt)(function (dictStrong) {
              ...
              return function (opt) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.View (line 66, column 106 - line 71, column 63): " + [ i.constructor.name ]);
              };
              ...
              return function (opt) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.View (line 73, column 96 - line 76, column 88): " + [ i.constructor.name ]);
              };
  ...
  var nimGame = new Game_Core.Game(function (state) {
      return function (v) {
          return Data_Maybe.maybe(false)(function (v1) {
              return v.value1 !== v1.value0 && (v.value1 !== v1.value1 && (function () {
                  var $33 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
                  if ($33) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
          return (v.value1 - v.value0 | 0) === 1 && v.value0 === (function () {
              var $42 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn2.value);
              if ($42) {
      ...
      return function (v) {
          return Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(function (v1) {
              var $48 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
              if ($48) {
  ...
  var view = function (lens) {
      return function (state) {
          var winTitle = "Les " + ((function () {
              var $7 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn2.value);
              if ($7) {
                  return "bleu";
              };
              return "rouge";
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(100)(100) ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
              ...
              var $15 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
              if ($15) {
  ...
  var toggleAllowedPiece = function (piece) {
      return function (v) {
          return function (pieces) {
              ...
              throw new Error("Failed pattern match at Game.Queens.Model (line 123, column 1 - line 123, column 91): " + [ piece.constructor.name, v.constructor.name, pieces.constructor.name ]);
          };
      };
  };
  var _ext = function (dictStrong) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          return Pha_Html["div'"]([ Pha_Html["class'"]("sansmot-main")(true) ])([ Pha_Html["div'"]([ Pha_Html["class'"]("sansmot-menu")(true) ])([ Pha_Html["div'"]([ Pha_Html["class'"]("sansmot-pagelink")(true), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Sansmot_Model.setPageA(Game_Sansmot_Model.PythaPage.value))) ])([ Pha.text("1") ]), Pha_Html["div'"]([ Pha_Html["class'"]("sansmot-pagelink")(true), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Sansmot_Model.setPageA(Game_Sansmot_Model.CarollPage.value))) ])([ Pha.text("2") ]) ]), main(state.page) ]);
      };
  };
  exports["view"] = view;
})(PS);
...
(function($PS) {
  ...
  var _size = function (dictStrong) {
      var $37 = _ext(dictStrong);
      var $38 = Data_Lens_Lens.lens(function (v) {
          return v.size;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var tricolorGame = new Game_Core.Game(function (v) {
      ...
      return function (i) {
          return Data_Array.mapWithIndex(function (i$prime) {
              return function (color) {
                  var $27 = inRange(state)(i)(i$prime);
                  if ($27) {
      ...
      return function (state) {
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board tricolor-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(100)(100) ])(Data_Array.mapWithIndex(function (i) {
              return function (color) {
                  ...
                  })()), Pha_Html.style(Pha_Html.unittoStr)("transform")(translateCell(i)(size)), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(Game_Core.playA(Game_Tricolor_Model.tricolorGame)(i))), Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(Game_Tricolor_Model.setHoverCellA(new Data_Maybe.Just(i)))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
...
(function($PS) {
  ...
  var cgame = new Game.CGame(Pha_Action.zoomAt(function (dictStrong) {
      ...
      return function (v) {
          return Game_Tricolor_View.view(function (dictStrong) {
              var $9 = lens(dictStrong);
              var $10 = _iso(dictStrong.Profunctor0());
              return function ($11) {
                  return $9($10($11));
...
(function($PS) {
  ...
  var hashChange = Control_Bind.bind(Run.bindRun)(Game_Effs.getLocation)(function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(100))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v1) {
                      ...
                      return Pha_Action.zoomAt(function (dictStrong) {
                          ...
                          var $119 = Game_Valise.is(dictStrong.Profunctor0());
                          return function ($120) {
                              return $118($119($120));
                          };
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.zoomAt(function (dictStrong) {
          ...
          var $122 = Game_Valise.is(dictStrong.Profunctor0());
          return function ($123) {
              return $121($122($123));
          };
  ...
  var onKeyDown = Control_Bind.bind(Run.bindRun)(Pha_Action.getEvent)(function (v) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
          ...
          throw new Error("Failed pattern match at Main (line 164, column 5 - line 166, column 59): " + [ v2.constructor.name ]);
      });
  });
