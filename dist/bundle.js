...
(function($PS) {
  ...
  var sample = function (t) {
      return Data_Functor.map(Control_Monad_Free.freeFunctor)(Data_Array.index(t))(randomInt(Data_Array.length(t)));
  };
  var shuffle = function (array) {
      return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Free.freeApplicative)(Data_Array.mapWithIndex(function (i) {
          return function (x) {
              return Data_Functor.map(Control_Monad_Free.freeFunctor)(Data_Tuple.Tuple.create(x))(randomInt(i + 1 | 0));
          };
      })(array)))(function (v) {
  ...
  var randomBool = Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(randomInt(2))(Data_Eq.eq(Data_Eq.eqInt)(0));
...
(function($PS) {
  ...
  var runRng = (function () {
      var go = function (v) {
          if (v instanceof Pha_Random.RandomInt) {
              return function __do() {
                  var v1 = $foreign.mathRandom();
                  return v.value1(Data_Int.floor(v1 * Data_Int.toNumber(v.value0)));
              };
          };
          if (v instanceof Pha_Random.RandomNumber) {
              return Data_Functor.mapFlipped(Effect.functorEffect)($foreign.mathRandom)(v.value0);
          };
          throw new Error("Failed pattern match at Pha.Effects.Random (line 33, column 5 - line 35, column 44): " + [ v.constructor.name ]);
      };
  ...
  var functorRng = new Data_Functor.Functor(function (f) {
      return runExists(function (v) {
          return mkExists(new GenWrapper(v.value0, function ($15) {
              return f(v.value1($15));
          }));
      });
  });
...
(function($PS) {
  ...
  var newGame = function (dictGame) {
      return function (f) {
          return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
              var state2 = f(v);
              return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(onNewGame(dictGame)(state2)))(function (v1) {
                  return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(initialPosition(dictGame)(v1)))(function (v2) {
  ...
  var computerPlay = function (dictGame) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(computerMove(dictGame)(v)))(function (v1) {
...
(function($PS) {
  ...
  var baseballGame = new Game_Core.Game(function (v) {
      ...
      return Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Pha_Random.randomInt(2 * Data_Lens_Getter.viewOn(state)(_nbBases(Data_Lens_Internal_Forget.strongForget)) | 0))(function (i) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Baseball.Model (line 70, column 1 - line 70, column 33): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var onpointerup$prime = (function () {
      var $36 = on$prime("pointerup");
      return function ($37) {
          return $36(Pha_Events_Decoder.always($37));
      };
  })();
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Frog.Model (line 88, column 1 - line 88, column 33): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Jetons.Model (line 70, column 1 - line 70, column 33): " + [ v.constructor.name ]);
  };
...
(function($PS) {
      ...
      return function (v) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return v.value1 !== v1.value0.value0 && (v.value1 !== v1.value0.value1 && (function () {
                  var $24 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
                  if ($24) {
  ...
  var nimGame2 = new Game_Core.TwoPlayersGame(function () {
      ...
      return Data_Array.sortWith(Data_Ord.ordInt)(function (v) {
          return Data_Maybe.maybe(0)(function (x) {
              var $32 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
              if ($32) {
  ...
  var nimGame = new Game_Core.Game(Game_Core["computerMove'"](nimGame2), function (state) {
      return Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Free.freeApplicative)(Data_Array.replicate(Data_Lens_Getter.viewOn(state)(_nbPiles(Data_Lens_Internal_Forget.strongForget)))((function () {
          var $35 = Data_Lens_Getter.viewOn(state)(_length(Data_Lens_Internal_Forget.strongForget)) === 5;
          if ($35) {
              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new Data_Tuple.Tuple(0, 4));
          };
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Pha_Random.randomInt(5))(function (v) {
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Pha_Random.randomInt(5))(function (v1) {
                  return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(new Data_Tuple.Tuple(v, v1 + 5 | 0));
              });
          });
      })()));
  }, function (state) {
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
          return (v.value1 - v.value0 | 0) === 1 && v.value0 === (function () {
              var $39 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn2.value);
              if ($39) {
      ...
      return function (v) {
          var $44 = canPlay(state)(v);
          if ($44) {
              return Data_Array.modifyAt(v.value0)(function (v1) {
                  var $46 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
                  if ($46) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Nim.Model (line 80, column 1 - line 80, column 33): " + [ v.constructor.name ]);
  };
  exports["Move"] = Move;
  exports["istate"] = istate;
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var drawSquare = function (i) {
          return function (j) {
              return Pha_Svg.rect([ Pha_Svg.x_("-2.5"), Pha_Svg.y_("-2.5"), Pha_Svg.width("5"), Pha_Svg.height("5"), Pha.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Svg.fill("gray"), Pha_Events.onclick(new Game_Nim_Model.Play(new Game_Nim_Model.Move(i, j))), Pha.style("transform")(Pha_Util.translate(Pha_Util["px'"]((function () {
                  var $2 = length === 5;
                  if ($2) {
                      return 30;
                  };
...
(function($PS) {
  ...
  var onKeyDown = function ($58) {
      return Data_Maybe.Just.create(Konami.create($58));
  };
  var istate = Game_Core.genState({
      light: [  ],
      played: [  ]
  ...
  var genRandomBoard = function (state) {
      ...
      return Control_Bind.bind(Control_Monad_Free.freeBind)(Pha_Random.randomInt(size + 1 | 0))(function (v) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Free.freeApplicative)(Data_Array.replicate(v)(Pha_Random.randomInt(size))))(function (v1) {
              return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Foldable.foldr(Data_Foldable.foldableArray)(toggleCell(state))(Data_Array.replicate(size)(true))(v1));
          });
      });
  };
  var noirblancGame = new Game_Core.Game(function (v) {
      ...
      return function (index) {
          return Data_Maybe.Just.create(Data_Lens_Setter.over((function () {
              var $74 = _played(Data_Profunctor_Strong.strongFn);
              var $75 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(index)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($76) {
                  return $74($75($76));
              };
  ...
  var afterPlay = Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
      ...
      return Control_Applicative.when(Run.applicativeRun)(Game_Core.isLevelFinished(noirblancGame)(v))((function () {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set((function () {
              var $77 = _maxLevels(Data_Profunctor_Strong.strongFn);
              var $78 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(mode)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($79) {
                  return $77($78($79));
              };
          })())(nextLevel)))(function () {
  ...
  var update = function (v) {
      ...
      if (v instanceof SelectMode) {
          return Game_Core.newGame(noirblancGame)((function () {
              var $80 = Data_Lens_Setter.set(_mode(Data_Profunctor_Strong.strongFn))(v.value0);
              var $81 = Data_Lens_Setter.set(_level(Data_Profunctor_Strong.strongFn))(0);
              return function ($82) {
                  return $80($81($82));
              };
          })());
      ...
      throw new Error("Failed pattern match at Game.Noirblanc.Model (line 119, column 1 - line 119, column 33): " + [ v.constructor.name ]);
  };
  exports["istate"] = istate;
  exports["_mode"] = _mode;
...
(function($PS) {
  ...
  var game = new Game_Core.Game(function (v) {
      ...
      return Data_Functor.map(Control_Monad_Free.freeFunctor)(Data_Function.flip(Data_Lens_Setter.set(_exit(Data_Profunctor_Strong.strongFn)))(state))((function () {
          ...
          if ($43) {
              return Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Pha_Random.randomInt(Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0))(Data_Maybe.Just.create);
          };
          return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Maybe.Nothing.value);
      })());
  }, function (state) {
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Queens.Model (line 140, column 1 - line 140, column 33): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var roueGame = new Game_Core.Game(function (v) {
      ...
      var $70 = Control_Applicative.pure(Control_Monad_Free.freeApplicative);
  ...
  var update = function (v) {
      ...
      if (v instanceof Animate) {
          return Control_Monad.unlessM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Data_Lens_Getter.view(_locked(Data_Lens_Internal_Forget.strongForget)))(Pha_Action.getState))(Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState((function () {
              var $26 = Data_Lens_Setter.set(_locked(Data_Profunctor_Strong.strongFn))(true);
              var $27 = Data_Lens_Setter.set(_anim(Data_Profunctor_Strong.strongFn))(Data_Map_Internal.empty);
              return function ($28) {
                  return $26($27($28));
              };
          })()))(function () {
...
(function($PS) {
  ...
  var solitaireGame = new Game_Core.Game(function (v) {
      ...
      var $106 = Control_Applicative.pure(Control_Monad_Free.freeApplicative);
      ...
      var v = (function () {
          ...
          if (v1 instanceof CircleBoard) {
              return {
                  ...
                  position: Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Pha_Random.randomInt(rows))(function (x) {
          ...
          if (v1 instanceof Grid3Board) {
              return {
                  ...
                  position: Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Lib_Util.tabulate(3 * Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(function (v2) {
          ...
          if (v1 instanceof RandomBoard) {
              return {
                  holes: Data_Array.replicate(3 * Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(true),
                  position: Data_Functor.mapFlipped(Control_Monad_Free.freeFunctor)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Free.freeApplicative)(Data_Array.replicate(columns)(Pha_Random.randomBool)))(function (bools) {
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Tiling.Model (line 142, column 1 - line 142, column 33): " + [ v.constructor.name ]);
  };
  exports["Type1"] = Type1;
  exports["Type2"] = Type2;
  exports["Type3"] = Type3;
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Tricolor.Model (line 64, column 1 - line 64, column 33): " + [ v.constructor.name ]);
  };
  exports["_size"] = _size;
