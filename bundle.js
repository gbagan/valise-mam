...
(function($PS) {
  ...
  var winPanel = function (state) {
      return Pha_Html["div'"]([ Pha_Html["class'"]("ui-flex-center ui-absolute component-win-container")(true) ])([ Pha_Html["div'"]([ Pha_Html["class'"]("component-win")(true), Pha_Html["class'"]("visible")(Data_Lens_Getter.viewOn(state)(Game_Core["_showWin"](Data_Lens_Internal_Forget.strongForget))) ])([ Pha.text("GAGN\xc9") ]) ]);
  };
          ...
          return function (elements) {
              return function (state) {
                  var dialog$prime = function (v) {
                      ...
                      if (v instanceof Game_Core.ConfirmNewGame) {
                          return UI_Dialog.dialog({
                              ...
                              onOk: new Data_Maybe.Just(Pha.lensAction(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Game_Core.confirmNewGameA(v.value0)))
                          })([ Pha.text("Tu es sur le point de cr\xe9er une nouvelle partie. Ta partie en cours sera perdue. Es-tu s\xfbr(e)?") ]);
                      };
                      return Pha.emptyNode;
                  };
                  return Pha_Html["div'"]([  ])([ Pha_Html["div'"]([ Pha_Html["class'"]("main-container")(true) ])([ Pha_Html["div'"]([  ])([ elements.board, winPanel(state) ]), elements.config ]), dialog$prime(Data_Lens_Getter.viewOn(state)(Game_Core["_dialog"](Data_Lens_Internal_Forget.strongForget))) ]);
              };
          };
      };
  };
  ...
  var trackPointer = function (lens) {
      ...
      return [ Pha_Html.attr("touch-action")("none"), Pha_Html["class'"]("ui-touch-action-none")(true), Pha_Html.pointermove(Pha.lensAction(function (dictStrong) {
          return lens(dictStrong);
      })(setPointerPositionA)), Pha_Html.pointerleave(Pha.lensAction(function (dictStrong) {
          return lens(dictStrong);
...
(function($PS) {
  ...
  var betweenMove = function (state) {
      return function (v) {
          ...
          var $39 = ((v1.row * v1.row | 0) + (v1.col * v1.col | 0) | 0) === 4;
          if ($39) {
          ...
          if ($55) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(betweenInCircle(v.from)(v.to)(rows))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      var $57 = rows === 4 && Data_Maybe.maybe(false)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v1));
                      if ($57) {
  ...
  var solitaireGame = new Game_Core.Game(function (state) {
      ...
      var $90 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      ...
      var v = (function () {
          ...
          throw new Error("Failed pattern match at Game.Solitaire.Model (line 89, column 13 - line 100, column 18): " + [ v1.constructor.name ]);
      })();
      ...
      var $83 = Data_Eq.eq(boardMode)(Data_Lens_Getter.viewOn(state)(_board(Data_Lens_Internal_Forget.strongForget)))(CircleBoard.value);
      if ($83) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var cursor = Data_Maybe.maybe(Pha.emptyNode)(function (pos) {
              return Pha_Html.circle(0.0)(0.0)(20.0)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.fill("url(#soli-peg)") ])(UI_Template.svgCursorStyle(pos)));
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.pointermove(Pha.lensAction(function (dictStrong) {
              return lens(dictStrong);
          })(UI_Template.setPointerPositionA)), Pha_Html["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          }))((function () {
              if (isCircleBoard) {
              ...
              return function (val) {
                  ...
                  return Pha_Html.circle(0.0)(0.0)(17.0)([ Pha_Html.key("h" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.fill("url(#soli-hole)"), Pha_Html["class'"]("solitaire-hole")(true), Pha_Html.style("transform")(itemStyle(i)) ]);
              };
              ...
              return function (val) {
                  ...
                  return Pha_Html.circle(0.0)(0.0)(20.0)([ Pha_Html.key("p" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.fill("url(#soli-peg)"), Pha_Html["class'"]("solitaire-peg")(true), Pha_Html.style("transform")(itemStyle(i)) ]);
              };
          })(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))))([ cursor ])))) ]);
