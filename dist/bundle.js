...
(function($PS) {
  ...
  var monoidAction = new Data_Monoid.Monoid(function () {
  ...
  exports["monoidAction"] = monoidAction;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
                          ...
                          return function (id) {
                              return function (state) {
                                  ...
                                  return [ Pha_Html["class'"]("dragged")(dragged), Pha_Html["class'"]("candrop")(candrop), Pha_Html.pointerdown((function () {
                                      ...
                                      return Data_Monoid.mempty(Pha_Action.monoidAction);
      ...
      return function (rows) {
          return function (columns) {
              return function (size) {
                  return [ Pha_Html.style("left")(Data_Show.show(Data_Show.showNumber)(v.left) + "px"), Pha_Html.style("top")(Data_Show.show(Data_Show.showNumber)(v.top) + "px"), Pha_Html.style("position")("fixed") ];
              };
          };
      };
  };
...
(function($PS) {
  ...
  var ihelp = function (lens) {
      return function (state) {
          ...
          })([ Pha_Html.pointerdown(Pha_Action.lensAction(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Labete_Model.setHelpA(true))), Pha_Html.pointerup(Pha_Action.lensAction(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Labete_Model.setHelpA(false))), Pha_Html.pointerleave(Pha_Action.lensAction(function (dictStrong) {
              return lens(dictStrong);
...
(function($PS) {
  ...
  }, Data_Function["const"](Data_Monoid.mempty(Pha_Action.monoidAction)), function (lens) {
      return function (v) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              ...
              return lens(dictStrong);
          })(Data_Semigroup.append(Pha_Action.semigroupAction)(Pha_Event.preventDefaultA)(Game_Tiling_Model.rotateA))) ])))([ Pha_Html.svg([ Pha_Html.width("100%"), Pha_Html.height("100%"), Pha_Html.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (index) {
              return function (pos) {
                  var v = Lib_Util.coords(columns)(index);
                  return square({
...
(function($PS) {
  ...
  var cgame = new Game.CGame(Control_Applicative.pure(Effect.applicativeEffect), Data_Function["const"](Data_Monoid.mempty(Pha_Action.monoidAction)), function (lens) {
      return function (v) {
...
(function($PS) {
          ...
          return function (v1) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(v.updateState(function (v2) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(100.0))(function () {
                      ...
                      var $93 = location === "valise" || location === "";
                      if ($93) {
                          return v.dispatch(Pha_Action.lensAction(function (dictStrong) {
                              var $114 = _valise(dictStrong);
                              var $115 = Game_Valise.is(dictStrong.Profunctor0());
                              return function ($116) {
                                  return $114($115($116));
                              };
  ...
  var main = function __do() {
      ...
      var v5 = Game.init(Game_Labete.cgame)(Game_Labete.state)();
      var v6 = Game.init(Game_Nim.cgame)(Game_Nim.state)();
      var v7 = Game.init(Game_Noirblanc.cgame)(Game_Noirblanc.state)();
      var v8 = Game.init(Game_Paths.cgame)(Game_Paths.state)();
      var v9 = Game.init(Game_Queens.cgame)(Game_Queens.state)();
      var v10 = Game.init(Game_Roue.cgame)(Game_Roue.state)();
      var v11 = Game.init(Game_Solitaire.cgame)(Game_Solitaire.state)();
      var v12 = Game.init(Game_Tiling.cgame)(Game_Tiling.state)();
      var v13 = Game.init(Game_Valise.cgame)(Game_Valise.state)();
      var state = {
          baseball: v1,
          chocolat: v2,
          frog: v3,
