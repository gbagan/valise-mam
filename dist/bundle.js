...
(function($PS) {
  // Generated by purs version 0.13.4
  "use strict";
  $PS["Pha.Class"] = $PS["Pha.Class"] || {};
  var exports = $PS["Pha.Class"];
...
(function($PS) {
  ...
  var noAction = function (setState) {
      return function (ev) {
          return function (st) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(st);
          };
      };
  };
              ...
              return function (ev) {
                  return function (st) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(v(function (st$prime) {
                          return function __do() {
                              var v1 = setState(Data_Lens_Setter.set(lens(Data_Profunctor_Strong.strongFn))(st$prime)(st))();
                              return st$prime;
                          };
  ...
  var action = function (fn) {
      return Pha_Class.Action(function (setState) {
          return function (ev) {
              return function (st) {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(fn(st)));
              };
          };
      });
  };
  exports["unwrapA"] = unwrapA;
  exports["action"] = action;
...
(function($PS) {
  ...
  var defaultCoreState = function (p) {
      return {
          ...
          locked: false,
          showWin: false,
          pointerPosition: Data_Maybe.Nothing.value
      };
  };
  ...
  var _help = function (dictStrong) {
      var $124 = _core(dictStrong);
      var $125 = Data_Lens_Lens.lens(function (v) {
          return v.help;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _history = function (dictStrong) {
      var $127 = _core(dictStrong);
      var $128 = Data_Lens_Lens.lens(function (v) {
          return v.history;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _levelFinished = function (dictStrong) {
      var $130 = _core(dictStrong);
      var $131 = Data_Lens_Lens.lens(function (v) {
          return v.levelFinished;
      })(function (v) {
          return function (v1) {
              return {
                  levelFinished: v1,
  ...
  var lockAction = function (v) {
      return function (setState) {
          return function (ev) {
              return function (state) {
                  var $95 = Data_Lens_Getter.viewOn(state)(_locked(Data_Lens_Internal_Forget.strongForget));
                  if ($95) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(state);
                  };
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(Data_Lens_Setter.set(_locked(Data_Profunctor_Strong.strongFn))(true)(state))))(function (v1) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(v(setState)(ev)(v1))(function (v2) {
                          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(Data_Lens_Setter.set(_locked(Data_Profunctor_Strong.strongFn))(false)(v2)));
                      });
                  });
              };
          };
  ...
  var _pointerPosition = function (dictStrong) {
      var $145 = _core(dictStrong);
      var $146 = Data_Lens_Lens.lens(function (v) {
          return v.pointerPosition;
      })(function (v) {
          return function (v1) {
              return {
                  pointerPosition: v1,
          ...
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      var state4 = Data_Lens_Setter.set(_redoHistory(Data_Profunctor_Strong.strongFn))([  ])(Data_Lens_Setter.set(_history(Data_Profunctor_Strong.strongFn))([  ])(Data_Lens_Setter.set(_position(Data_Profunctor_Strong.strongFn))(v1)(v)));
                      var $100 = Data_Array["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget)));
                      if ($100) {
  ...
  var init = function (dictGame) {
      return newGameAux(dictGame)(Control_Category.identity(Control_Category.categoryFn));
  };
  ...
  var setGridSizeA = function (dictGame) {
      return function (nbRows) {
          return function (nbColumns) {
              var setCustomSize$prime = function (state) {
              ...
              return newGame(dictGame)(setCustomSize$prime);
          };
      };
  };
  ...
  var showVictory = function (setState) {
      return function (state) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(Data_Lens_Setter.set(_showWin(Data_Profunctor_Strong.strongFn))(true)(state))))(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                  return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(state));
              });
          });
      };
  };
  ...
  var _play = function (dictGame) {
      return function (move) {
          return function (state) {
              var $107 = canPlay(dictGame)(state)(move);
              if ($107) {
                  var state2 = Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (v) {
                      return 1 - v | 0;
                  ...
                  return Data_Lens_Setter.set(_levelFinished(Data_Profunctor_Strong.strongFn))(isLevelFinished(dictGame)(state2))(state2);
              };
              return state;
          };
      };
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $108 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($108) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $109 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($109) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $160 = isLosingPosition(dictTwoPlayersGame);
                      var $161 = Data_Function.flip(_play(dictTwoPlayersGame.Game0()))(state);
                      return function ($162) {
                          return $160($161($162));
                      };
  ...
  var computerPlay = function (dictGame) {
      return function (setState) {
          return function (state) {
              return Data_Function.flip(Data_Maybe.maybe(Control_Applicative.pure(Effect_Aff.applicativeAff)(state)))(computerMove(dictGame)(state))(function (rndmove) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Lib_Random.runRnd(rndmove)))(function (v) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(_play(dictGame)(v)(state))))(function (v1) {
                          var $112 = isLevelFinished(dictGame)(v1);
                          if ($112) {
                              return showVictory(setState)(v1);
                          };
  ...
  var computerStartsA = function (dictGame) {
      return function (setState) {
          return function (v) {
              return function (state) {
                  return computerPlay(dictGame)(setState)(pushToHistory(state));
              };
          };
      };
  };
  var playA = function (dictGame) {
      return function (move) {
          return lockAction(function (setState) {
              return function (v) {
                  return function (state) {
                      var $113 = !canPlay(dictGame)(state)(move);
                      if ($113) {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(state);
                      };
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(_play(dictGame)(move)(pushToHistory(state)))))(function (v1) {
                          var $115 = isLevelFinished(dictGame)(v1);
                          if ($115) {
                              return showVictory(setState)(v1);
                          };
                          var $116 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                          if ($116) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                                  return computerPlay(dictGame)(setState)(v1);
                              });
                          };
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1);
                      });
          ...
          return function (dragLens) {
              return function (to) {
                  return function (setState) {
                      return function (ev) {
                          return function (state) {
                              var state2 = Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)(state);
                              var v = Data_Lens_Getter.viewOn(state)(dragLens(Data_Lens_Internal_Forget.strongForget));
                              if (v instanceof Data_Maybe.Nothing) {
                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(state);
                              };
                              if (v instanceof Data_Maybe.Just) {
                                  var $118 = Data_Eq.notEq(dictEq)(v.value0)(to);
                                  if ($118) {
                                      return Pha_Action.unwrapA(playA(dictGame)({
                                          from: v.value0,
                                          to: to
                                      }))(setState)(ev)(state2);
                                  };
                                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(state2);
                              };
                              throw new Error("Failed pattern match at Game.Core (line 274, column 5 - line 277, column 39): " + [ v.constructor.name ]);
                          };
                      };
                  };
              };
  ...
  var changeTurn = function (state) {
      var $120 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
      if ($120) {
  ...
  exports["_pointerPosition"] = _pointerPosition;
  exports["SizeLimit"] = SizeLimit;
  exports["Game"] = Game;
...
(function($PS) {
  ...
  var Lib_Core = $PS["Lib.Core"];
  var Lib_Random = $PS["Lib.Random"];
  var baseballState = Game_Core.genState([  ])(Control_Category.identity(Control_Category.categoryFn))({
      nbBases: 5
  });
  ...
  var _nbBases = function (dictStrong) {
      var $17 = _ext(dictStrong);
      var $18 = Data_Lens_Lens.lens(function (v) {
          return v.nbBases;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var baseballGame = new Game_Core.Game(function (state) {
      ...
      return Lib_Random.shuffle(Data_Array.range(0)((2 * Data_Lens_Getter.viewOn(state)(_nbBases(Data_Lens_Internal_Forget.strongForget)) | 0) - 1 | 0));
  }, function (state) {
      ...
      return function (i) {
          return Lib_Core.swap(0)(i)(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
      };
...
(function($PS) {
  ...
  var isStyle = function (v) {
      if (v instanceof Pha_Class.Style) {
          return true;
      };
      return false;
  };
...
(function($PS) {
  ...
  var svg = Pha.h("svg");
  var style = Pha_Class.Style.create;
  var span = Pha.h("span");
  ...
  var pointerup = Pha_Class.Event.create("pointerup");
  var pointermove = Pha_Class.Event.create("pointermove");
  var pointerleave = Pha_Class.Event.create("pointerleave");
  var pointerdown = Pha_Class.Event.create("pointerdown");
  var p = Pha.h("p");
  var key = Pha_Class.Key.create;
  var h2 = Pha.h("h2");
  var g = Pha.h("g");
  var div$prime = Pha.h("div");
  var click = Pha_Class.Event.create("click");
  var class$prime = Pha_Class.Class.create;
  var button = Pha.h("button");
  var br = Pha.h("br")([  ])([  ]);
  var attr = Pha_Class.Attr.create;
  ...
  var svguse = function (symbol) {
      return function (props) {
          return svg([ width("100%"), height("100%") ])([ Pha.h("use")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ attr("href")(symbol) ])(props))([  ]) ]);
      };
  };
  exports["key"] = key;
  exports["attr"] = attr;
      ...
      return function (props) {
          ...
          return Pha_Html.button(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-icon")(true), Pha_Html["class'"]("selected")(v.selected), Pha_Html["class'"]("round")(v.large), Pha_Html["class'"]("hidden")(v.hidden), Pha_Html.disabled(v.disabled) ])(props))([ (function () {
              if (v.icon instanceof IconSymbol) {
                  return Pha_Html.svguse(v.icon.value0)([ Pha_Html["class'"]("ui-icon-symbol")(true) ]);
              };
              ...
              throw new Error("Failed pattern match at UI.Icon (line 42, column 9 - line 45, column 34): " + [ v.icon.constructor.name ]);
...
(function($PS) {
  ...
  var iredo = function (lens) {
      return function (state) {
          return iconbutton(state)(function (v) {
              ...
              return lens(dictStrong);
          })(Game_Core.redoA)), Pha_Html.style("transform")("scaleX(-1)") ]);
      };
  };
          ...
          return function (state) {
              return function (sizeList) {
                  return function (customSize) {
                      ...
                      return UI_Icon.icongroup("Dimensions de la grille")(Data_Functor.mapFlipped(Data_Functor.functorArray)(sizeList)(function (v) {
                          return iconbutton(state)(function (v1) {
                              return {
                                  ...
                                  selected: v.value0 === crows && v.value1 === ccols,
                                  tooltip: v1.tooltip,
                                  round: v1.round,
                                  large: v1.large,
                                  hidden: v1.hidden,
                              ...
                              return lens(dictStrong);
                          })(Game_Core.setGridSizeA(dictGame)(v.value0)(v.value1))) ]);
                      }));
                  };
              };
          };
  ...
  var iconSelect = function (dictEq) {
      return function (lens) {
          return function (state) {
              return function (selection) {
                  return function (action) {
                      return function (value) {
                          return function (optionFn) {
                              return iconbutton(state)(function (opt) {
                                  return optionFn({
                                      icon: opt.icon,
                                      selected: Data_Eq.eq(dictEq)(value)(selection),
                                      tooltip: opt.tooltip,
                                      round: opt.round,
                                      large: opt.large,
                                      hidden: opt.hidden,
...
(function($PS) {
  ...
  var setPointerPositionA = function (setState) {
      return function (ev) {
          return function (state) {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
                  var v = relativePointerPosition(ev)();
                  return setState(Data_Lens_Setter.set(Game_Core["_pointerPosition"](Data_Profunctor_Strong.strongFn))(v)(state))();
              });
          };
      };
  };
  var trackPointer = function (lens) {
      var leave = Pha_Action.action(Data_Lens_Setter.set(Game_Core["_pointerPosition"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value));
      return [ Pha_Html.attr("touch-action")("none"), Pha_Html["class'"]("ui-touch-action-none")(true), Pha_Html.pointermove(Pha_Action.lensAction(function (dictStrong) {
          return lens(dictStrong);
      })(setPointerPositionA)), Pha_Html.pointerleave(Pha_Action.lensAction(function (dictStrong) {
          return lens(dictStrong);
      })(Pha_Action.action(Data_Lens_Setter.set(Game_Core["_pointerPosition"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))), Pha_Html.pointerdown(Pha_Action.lensAction(function (dictStrong) {
          return lens(dictStrong);
      })(setPointerPositionA)) ];
  };
                  ...
                  onResize: function (x) {
                      return function (y) {
                          return Pha_Action.lensAction(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game_Core.setGridSizeA(dictGame)(x)(y));
                      };
                  }
              });
          };
  ...
  var gridStyle = function (rows) {
      return function (columns) {
          var m = Data_Int.toNumber(Data_Ord.max(Data_Ord.ordInt)(5)(Data_Ord.max(Data_Ord.ordInt)(rows)(columns)));
      ...
      return function (dictGame) {
          return function (lens) {
              return function (dragLens) {
                  ...
                  return [ Pha_Html.attr("touch-action")("none"), Pha_Html["class'"]("ui-touch-action-none")(true), Pha_Html.pointermove(Pha_Action.lensAction(function (dictStrong) {
                      return lens(dictStrong);
                  })(setPointerPositionA)), Pha_Html.pointerup(Pha_Action.lensAction(function (dictStrong) {
                      return lens(dictStrong);
  ...
  exports["setPointerPositionA"] = setPointerPositionA;
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Baseball multicolore")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Nombres de bases")([ 4, 5, 6, 7, 8 ])(function (v) {
              return Control_Category.identity(Control_Category.categoryFn);
          })(nbBases)(Game_Baseball_Model.setNbBases), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.iundo, UI_Icons.iredo, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
          ...
          })(Data_Array.take(nbBases)(colors)))(Lib_Core.map2(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(dupColors)(function (peg) {
              return function (pos) {
                  return function (color) {
                      var $5 = peg === 0;
                      if ($5) {
...
(function($PS) {
  ...
  var frogState = Game_Core.genState(20)(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
  ...
  var markA = function (i) {
      return Pha_Action.action(Data_Lens_Setter.over((function () {
          var $30 = _marked(Data_Profunctor_Strong.strongFn);
          var $31 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(i)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($32) {
              return $30($31($32));
          };
  ...
  var reachableArray = function (state) {
      return Lib_Core.tabulate(Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) + 1 | 0)(Game_Core.canPlay(frogGame)(state));
  };
  var selectMoveA = (function () {
      ...
      return Game_Core["newGame'"](frogGame)((function () {
          var $39 = Data_Lens_Setter.over(_moves(Data_Profunctor_Strong.strongFn));
          return function ($40) {
              return $39(_selectMove($40));
          };
      })());
  })();
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board frog-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("-190 -200 400 400"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.path(spiralPath)([ Pha_Html.fill("none"), Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(153.0)(9.0)(207.0)(20.0)([ Pha_Html.stroke("black"), Pha_Html.strokeDasharray("5"), Pha_Html.strokeWidth("6") ]), Pha_Html.line(153.0)(7.0)(153.0)(39.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(207.0)(18.0)(207.0)(50.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Core.map2(spoints)(reachable)(function (i) {
              return function (v) {
                  return function (reach) {
                      return Pha_Html.g([ Pha_Html.key("lily" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.click(Pha_Action.lensAction(function (dictStrong) {
                          return lens(dictStrong);
                      })(Pha_Action.ifThenElseA(function (v1) {
                          return Pha_Event.shiftKey;
                      })(Game_Frog_Model.markA(i))(Game_Core.playA(Game_Frog_Model.frogGame)(i)))) ])([ lily(i)(v.x)(v.y)(false)(false), lily(i)(v.x)(v.y)(true)(!reach), Pha_Html["text'"](v.x)(v.y)((function () {
          ...
          }))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Core.map2(Data_Lens_Getter.viewOn(state)(Game_Frog_Model["_marked"](Data_Lens_Internal_Forget.strongForget)))(spoints)(function (i) {
              return function (mark) {
                  return function (v) {
                      var $30 = mark && i !== position;
                      if ($30) {
              ...
              var $37 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
              if ($37) {
                  return "Tour du premier joueur";
              };
              var $38 = Data_Eq.eq(Game_Core.eqMode)(Data_Lens_Getter.viewOn(state)(Game_Core["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.DuelMode.value);
              if ($38) {
                  return "Tour du second joueur";
              };
              return "Tour de l'IA";
          })()) ]) ]);
          var config = UI_Dialog.card("La grenouille")([ UI_Icons.iconSelectGroupM(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("D\xe9placements autoris\xe9s")([ 1, 2, 3, 4, 5 ])(Data_Lens_Getter.viewOn(state)(Game_Frog_Model["_moves"](Data_Lens_Internal_Forget.strongForget)))(Game_Frog_Model.selectMoveA), UI_Icons.icons2Players(Game_Frog_Model.frogGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.ihelp, UI_Icons.iundo, UI_Icons.iredo, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
...
(function($PS) {
  ...
  var Lib_Core = $PS["Lib.Core"];
  var Lib_Random = $PS["Lib.Random"];
  var jetonsState = Game_Core.genState([  ])(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
  ...
  var jetonsGame = new Game_Core.Game(function (state) {
      return function (v) {
          var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var v1 = Lib_Core.dCoords(Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(v.from)(v.to);
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (i) {
          ...
          var y = (function () {
              var $26 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i + 1 | 0)(columns) === 0;
              if ($26) {
                  return 0;
              };
          ...
          return (x * (y + z | 0) | 0) === 0;
      })(Data_Array.range(0)(Data_Array.length(position) - 1 | 0));
  }, Game_Core.defaultOnNewGame, function (state) {
      return function (v) {
          var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
  ...
  exports["jetonsState"] = jetonsState;
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Jeu des jetons")([ UI_Icons.iconSizesGroup(Game_Jetons_Model.jetonsGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state)([ new Data_Tuple.Tuple(2, 2), new Data_Tuple.Tuple(4, 4), new Data_Tuple.Tuple(5, 5), new Data_Tuple.Tuple(6, 6) ])(true), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.iundo, UI_Icons.iredo, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          var cursor = Data_Maybe.maybe(Pha.emptyNode)(function (pp) {
          ...
          })(Data_Lens_Getter.viewOn(state)(Game_Core["_pointerPosition"](Data_Lens_Internal_Forget.strongForget)));
          var piece = function (i) {
              return function (val) {
                  return function (props) {
                      var v = Lib_Core.coords(columns)(i);
          ...
          var board = UI_Template.incDecGrid(Game_Jetons_Model.jetonsGame)(function (dictStrong) {
          ...
          }))(UI_Template.gridStyle(rows)(columns))))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (i) {
              return function (val) {
                  var $14 = val === 0;
                  if ($14) {
                      return Pha.emptyNode;
              ...
              var $15 = Data_Maybe.isJust(Data_Lens_Getter.viewOn(state)(Game_Jetons_Model["_dragged"](Data_Lens_Internal_Forget.strongForget)));
              if ($15) {
                  return [ cursor ];
              };
              return [  ];
...
(function($PS) {
  ...
  var nimState = Game_Core.genState([  ])(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
  ...
  var nimGame2 = new Game_Core.TwoPlayersGame(function () {
      ...
      var $62 = Data_Eq.eq(Data_Eq.eqInt)(0);
      var $63 = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (t) {
      ...
      })(Data_Array.filter(Game_Core.canPlay(nimGame)(state))(Lib_Core.tabulate2(Data_Lens_Getter.viewOn(state)(_nbPiles(Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter.viewOn(state)(_length(Data_Lens_Internal_Forget.strongForget)))(function (v) {
  ...
  var nimGame = new Game_Core.Game(function (state) {
      ...
      return Data_Traversable.sequence(Data_Traversable.traversableArray)(Lib_Random.applicativeRandom)(Data_Array.replicate(Data_Lens_Getter.viewOn(state)(_nbPiles(Data_Lens_Internal_Forget.strongForget)))(Control_Bind.bind(Lib_Random.bindRandom)(Lib_Random.randomInt(5))(function (v) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
          return (v.value1 - v.value0 | 0) === 1 && v.value0 === (function () {
              var $45 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
              if ($45) {
      ...
      return function (v) {
          return Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(function (v1) {
              var $51 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
              if ($51) {
  ...
  var view = function (lens) {
      return function (state) {
          var winTitle = "Les " + ((function () {
              var $8 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
              if ($8) {
                  return "bleu";
              };
              return "rouge";
          ...
          var config = UI_Dialog.card("Poker Nim")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Nombre de rang\xe9es")([ 1, 2, 3, 4, 5 ])(function (v) {
              return Control_Category.identity(Control_Category.categoryFn);
          })(nbPiles)(Game_Nim_Model.setNbPilesA), UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Taille des rang\xe9es")([ 10, 5 ])(function (v) {
              return Control_Category.identity(Control_Category.categoryFn);
          })(length)(Game_Nim_Model.setLengthA), UI_Icons.icons2Players(Game_Nim_Model.nimGame)(function (dictStrong) {
              return lens(dictStrong);
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("0 0 100 100"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
              return function (pile) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.rect((function () {
                      ...
                      return Pha_Html.rect(-2.5)(-2.5)(5.0)(5.0)([ Pha_Html.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html.fill("gray"), Pha_Html.click(Pha_Action.lensAction(function (dictStrong) {
                          ...
                          var $12 = Game_Core.canPlay(Game_Nim_Model.nimGame)(state)(new Game_Nim_Model.Move(i, j));
                          if ($12) {
                              return "pointer";
                          };
                          return "not-allowed";
              ...
              var $15 = Game_Core.isLevelFinished(Game_Nim_Model.nimGame)(state);
              if ($15) {
                  return "Partie finie";
              };
...
(function($PS) {
  ...
  var noirblancState = Game_Core.genState({
      light: [  ],
      played: [  ]
  ...
  var neighbor = function (state) {
      return function (index1) {
          return function (index2) {
              ...
              var v = Lib_Core.dCoords(Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(index1)(index2);
  ...
  var noirblancGame = new Game_Core.Game(function (v) {
      ...
      return Control_Bind.bind(Lib_Random.bindRandom)((function () {
          var $34 = Data_Lens_Getter.viewOn(state)(_level(Data_Lens_Internal_Forget.strongForget)) >= 6;
          if ($34) {
  ...
  var selectModeA = Game_Core["newGame'"](noirblancGame)(function (mode) {
      var $48 = Data_Lens_Setter.set(_level(Data_Profunctor_Strong.strongFn))(0);
      var $49 = Data_Lens_Setter.set(_mode2(Data_Profunctor_Strong.strongFn))(mode);
      return function ($50) {
          return $48($49($50));
      };
  });
  exports["noirblancState"] = noirblancState;
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var rows = Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
          var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var config = UI_Dialog.card("Tout noir tout blanc")([ (function () {
              var fn = function (i) {
                  return function (v) {
                      return {
              ...
              return UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)("Mode jeu")([ 0, 1, 2, 3 ])(fn)(Data_Lens_Getter.viewOn(state)(Game_Noirblanc_Model["_mode2"](Data_Lens_Internal_Forget.strongForget)))(Game_Noirblanc_Model.selectModeA);
          })(), (function () {
              var fn = function (i) {
                  return function (opt) {
                      return levels(i)(opt);
              ...
              return UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)("Difficult\xe9")([ 0, 1, 2, 3, 4, 5, 6 ])(fn)(Data_Lens_Getter.viewOn(state)(Game_Noirblanc_Model["_mode2"](Data_Lens_Internal_Forget.strongForget)))(Game_Noirblanc_Model.selectLevelA);
          })(), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.ihelp, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])(UI_Template.gridStyle(rows)(columns)))(Lib_Core.map2(position.light)(position.played)(function (index) {
              return function (light) {
                  return function (played) {
                      var v = Lib_Core.coords(columns)(index);
                      return square(light)(Data_Lens_Getter.viewOn(state)(Game_Core["_help"](Data_Lens_Internal_Forget.strongForget)) && played)([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.style("height")(Data_Show.show(Data_Show.showNumber)(86.0 / Data_Int.toNumber(rows)) + "%"), Pha_Html.style("width")(Data_Show.show(Data_Show.showNumber)(86.0 / Data_Int.toNumber(columns)) + "%"), Pha_Html.style("left")(Data_Show.show(Data_Show.showNumber)((100.0 * Data_Int.toNumber(v.col) + 7.0) / Data_Int.toNumber(columns)) + "%"), Pha_Html.style("top")(Data_Show.show(Data_Show.showNumber)((100.0 * Data_Int.toNumber(v.row) + 7.0) / Data_Int.toNumber(rows)) + "%"), Pha_Html.click(Pha_Action.lensAction(function (dictStrong) {
                          return lens(dictStrong);
                      })(Game_Core.playA(Game_Noirblanc_Model.noirblancGame)(index))) ]);
                  };
              };
          }));
...
(function($PS) {
  ...
  var pathsState = Game_Core.genState([  ])(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
  ...
  var pathBetween = function (columns) {
      return function (u) {
          return function (v) {
              var v1 = Lib_Core.dCoords(columns)(u)(v);
              var $27 = v1.row === 0;
              if ($27) {
                  return new Data_Maybe.Just((function () {
                      var $28 = u < v;
                      if ($28) {
                          return Lib_Core.range(u + 1 | 0)(v)(1);
                      };
                      return Lib_Core.range(u - 1 | 0)(v)(-1 | 0);
                  })());
              };
              var $29 = v1.col === 0;
              if ($29) {
                  return new Data_Maybe.Just((function () {
                      var $30 = u < v;
                      if ($30) {
                          return Lib_Core.range(u + columns | 0)(v)(columns);
                      };
                      return Lib_Core.range(u - columns | 0)(v)(-columns | 0);
                  })());
              };
              return Data_Maybe.Nothing.value;
          };
  ...
  var pathGame = new Game_Core.Game(function (state) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Game.Paths.Model (line 59, column 9 - line 63, column 78): " + [ v1.constructor.name ]);
      };
  }, function (v) {
      return Data_Maybe.Nothing.value;
  }, (function () {
      var $58 = Control_Applicative.pure(Lib_Random.applicativeRandom);
...
(function($PS) {
  ...
  var UI_Icons = $PS["UI.Icons"];
  var UI_Template = $PS["UI.Template"];                
  var square = function (darken) {
      return function (trap) {
          return function (door) {
              return function (x) {
                  return function (y) {
                      return function (props) {
                          return Pha_Html.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("paths-darken")(darken) ])(props))([ Pha_Html.use(x)(y)(100.0)(100.0)("#paths-background")([  ]), (function () {
                              if (door) {
                                  return Pha_Html.use(x)(y)(100.0)(100.0)("#paths-door")([  ]);
                              };
                              return Pha.emptyNode;
                          })(), Pha_Html.use(x)(y)(100.0)(100.0)("#paths-trap")([ Pha_Html["class'"]("paths-trap")(true), Pha_Html["class'"]("visible")(trap && !door) ]) ]);
                      };
                  };
              };
          };
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Chemins")([ UI_Icon.icongroup("Mode de jeu")([ UI_Icons.iconSelect(Game_Paths_Model.eqMode)(function (dictStrong) {
              return lens(dictStrong);
          })(state)(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Paths_Model.selectModeA)(Game_Paths_Model.Mode1.value)(function (v) {
              return {
          ...
          }), UI_Icons.iconSelect(Game_Paths_Model.eqMode)(function (dictStrong) {
              return lens(dictStrong);
          })(state)(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Paths_Model.selectModeA)(Game_Paths_Model.Mode2.value)(function (v) {
              return {
              ...
              return lens(dictStrong);
          })(state)([ new Data_Tuple.Tuple(4, 6), new Data_Tuple.Tuple(5, 5), new Data_Tuple.Tuple(3, 8) ])(true), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.ihelp, UI_Icons.iundo, UI_Icons.iredo, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          var hero = Data_Maybe.maybe(Pha.emptyNode)(function (h) {
              var v = Lib_Core.coords(columns)(h);
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns))(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          })))([ Pha_Html.svg([ Pha_Html.width("100%"), Pha_Html.height("100%"), Pha_Html.viewBox("0 0 " + (Data_Show.show(Data_Show.showInt)(100 * columns | 0) + (" " + Data_Show.show(Data_Show.showInt)(100 * rows | 0)))) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Core.tabulate(rows * columns | 0)(function (index) {
              var v = Lib_Core.coords(columns)(index);
              return square(Data_Lens_Getter.viewOn(state)(Game_Core["_help"](Data_Lens_Internal_Forget.strongForget)) && Data_Int.even(v.row + v.col | 0))(Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(index)(position) && Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(index))(Data_Array.last(position)))(Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_exit"](Data_Lens_Internal_Forget.strongForget)))(new Data_Maybe.Just(index)))(Data_Int.toNumber(100 * v.col | 0))(Data_Int.toNumber(100 * v.row | 0))([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.click(Pha_Action.lensAction(function (dictStrong) {
                  return lens(dictStrong);
              })(Game_Paths_Model.selectVertexA(index))) ]);
          }))([ Pha_Html.path(pathdec)([ Pha_Html["class'"]("paths-path")(true) ]), hero, Data_Maybe.maybe(Pha.emptyNode)(function (pp) {
              var $24 = Data_Array["null"](position);
              if ($24) {
                  return heroCursor(pp);
              };
              var $25 = Data_Maybe.isNothing(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_exit"](Data_Lens_Internal_Forget.strongForget)));
              if ($25) {
...
(function($PS) {
  ...
  var roueState = Game_Core.genState([  ])(Control_Category.identity(Control_Category.categoryFn))({
      rotation: 0,
      size: 5,
      dragged: Data_Maybe.Nothing.value
  });
  ...
  var checkA = (function () {
      var aux = function (setS) {
          return function (v) {
              return function (st2) {
                  if (v === 0) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setS(Data_Lens_Setter.set(Game_Core["_showWin"](Data_Profunctor_Strong.strongFn))(true)(st2))))(function (v1) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setS(st2));
                          });
                      });
                  };
                  var $43 = !validRotation(st2);
                  if ($43) {
                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(st2);
                  };
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setS(rotate(1)(st2))))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(600.0))(function () {
                          return aux(setS)(v - 1 | 0)(v1);
                      });
                  });
              };
          };
      };
      return Game_Core.lockAction(function (setState) {
          return function (ev) {
              return function (state) {
                  return aux(setState)(Data_Lens_Getter.viewOn(state)(_size(Data_Lens_Internal_Forget.strongForget)))(state);
              };
          };
      });
  })();
      ...
      return function (move) {
          var act = (function () {
              ...
              if (move.from instanceof Wheel && move.to instanceof Wheel) {
                  return Lib_Core.swap(move.from.value0)(move.to.value0);
              };
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var outerWheel = Pha_Html["div'"]([ Pha_Html["class'"]("roue-outer")(true), Pha_Html.style("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((360.0 * Data_Int.toNumber(Data_Lens_Getter.viewOn(state)(Game_Roue_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)))) / Data_Int.toNumber(size)) + "deg)")) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.svg([ Pha_Html.key("svg"), Pha_Html.viewBox("0 0 100 100") ])(Lib_Core.map2(position)(Game_Roue_Model.aligned(state))(function (i) {
              return function (pos) {
                  return function (align) {
                      return Pha_Html.path(pizza(50.0)(50.0)(50.0)((2.0 * $$Math.pi * (Data_Int.toNumber(i) - 0.5)) / Data_Int.toNumber(size))((2.0 * $$Math.pi * (Data_Int.toNumber(i) + 0.5)) / Data_Int.toNumber(size)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("roue-wheel-part")(true), Pha_Html.fill((function () {
                          ...
                          var $15 = Game_Roue_Model["validRotation'"](state);
                          if ($15) {
                              return "lightgreen";
                          };
                          return "#F5B7B1";
              ...
              return function (c) {
                  return Data_Maybe.maybe(Pha.emptyNode)(function (color) {
          ...
          var draggedColor = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Lens_Getter.viewOn(state)(Game_Roue_Model["_dragged"](Data_Lens_Internal_Forget.strongForget)))(function (d) {
              var colorIndex = (function () {
                  ...
                  if (d instanceof Game_Roue_Model.Wheel) {
                      return Data_Maybe.fromMaybe(-1 | 0)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(position)(d.value0))(Control_Category.identity(Control_Category.categoryFn)));
                  };
                  return -1 | 0;
              })();
              return Data_Array.index(colors)(colorIndex);
          });
          var cursor = Data_Maybe.fromMaybe(Pha.emptyNode)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointerPosition"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(draggedColor)(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Pha_Html["div'"]([ Pha_Html["class'"]("ui-cursor roue-select-color roue-cursor")(true), Pha_Html.style("left")(Data_Show.show(Data_Show.showNumber)(v.left) + "px"), Pha_Html.style("top")(Data_Show.show(Data_Show.showNumber)(v.top) + "px"), Pha_Html.style("background-color")(v1) ])([  ]));
              });
          }));
          var config = UI_Dialog.card("Roue des couleurs")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Nombre de couleurs")([ 4, 5, 6, 7, 8 ])(function (v) {
              return Control_Category.identity(Control_Category.categoryFn);
          })(size)(Game_Roue_Model.setSizeA), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
          var board = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("roue-board")(true) ])(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
...
(function($PS) {
  ...
  var solitaireState = Game_Core.genState([  ])(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
      ...
      return function (columns) {
          return function (startingHole) {
              return function (holeFilter) {
                  var holes = Lib_Core.tabulate2(rows)(columns)(holeFilter);
  ...
  var betweenMove = function (state) {
      return function (v) {
          var v1 = Lib_Core.dCoords(Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(v.from)(v.to);
          var $43 = ((v1.row * v1.row | 0) + (v1.col * v1.col | 0) | 0) === 4;
          if ($43) {
  ...
  var solitaireGame = new Game_Core.Game(function (state) {
      ...
      var $98 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      var $99 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($100) {
          return $98($99($100));
      };
  })(), function (state) {
      ...
      var v = (function () {
          ...
          if (v1 instanceof EnglishBoard) {
              return generateBoard(7)(7)(24)(function (v2) {
                  return Data_Ord.min(Data_Ord.ordInt)(v2.row)(6 - v2.row | 0) >= 2 || Data_Ord.min(Data_Ord.ordInt)(v2.col)(6 - v2.col | 0) >= 2;
              });
          };
          if (v1 instanceof FrenchBoard) {
              return generateBoard(7)(7)(24)(function (v2) {
                  return (Data_Ord.min(Data_Ord.ordInt)(v2.row)(6 - v2.row | 0) + Data_Ord.min(Data_Ord.ordInt)(v2.col)(6 - v2.col | 0) | 0) >= 2;
              });
          };
          if (v1 instanceof CircleBoard) {
              return generateBoard(Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)))(1)(0)(function (v2) {
                  return true;
              });
          };
          if (v1 instanceof Grid3Board) {
              return {
                  ...
                  position: Control_Applicative.pure(Lib_Random.applicativeRandom)(Lib_Core.tabulate(3 * Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(function (v2) {
          ...
          throw new Error("Failed pattern match at Game.Solitaire.Model (line 93, column 13 - line 104, column 18): " + [ v1.constructor.name ]);
      })();
      return Data_Functor.mapFlipped(Lib_Random.functorRandom)(v.position)(function (p) {
          return Data_Lens_Setter.set(Game_Core["_position"](Data_Profunctor_Strong.strongFn))(p)(Data_Lens_Setter.set(_holes(Data_Profunctor_Strong.strongFn))(v.holes)(state));
      });
  }, function (state) {
      return function (v) {
      ...
      var $87 = Data_Eq.eq(boardMode)(Data_Lens_Getter.viewOn(state)(_board(Data_Lens_Internal_Forget.strongForget)))(CircleBoard.value);
      if ($87) {
  ...
  exports["solitaireState"] = solitaireState;
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var cursor = Data_Maybe.maybe(Pha.emptyNode)(function (pos) {
              return Pha_Html.circle(0.0)(0.0)(20.0)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.attr("pointer-events")("none"), Pha_Html.fill("url(#soli-peg)") ])(UI_Template.svgCursorStyle(pos)));
          })(Data_Lens_Getter.viewOn(state)(Game_Core["_pointerPosition"](Data_Lens_Internal_Forget.strongForget)));
          var config = (function () {
              var ic = UI_Icons.iconSelect(Game_Solitaire_Model.boardMode)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)(Data_Lens_Getter.viewOn(state)(Game_Solitaire_Model["_board"](Data_Lens_Internal_Forget.strongForget)))(Game_Solitaire_Model.setBoardA);
              return UI_Dialog.card("Jeu du solitaire")([ UI_Icon.icongroup("Plateau")([ ic(Game_Solitaire_Model.CircleBoard.value)(function (v) {
                  return {
              ...
              }), ic(Game_Solitaire_Model.Grid3Board.value)(function (v) {
                  return {
              ...
              }), ic(Game_Solitaire_Model.RandomBoard.value)(function (v) {
                  return {
              ...
              }), ic(Game_Solitaire_Model.EnglishBoard.value)(function (v) {
                  return {
              ...
              }), ic(Game_Solitaire_Model.FrenchBoard.value)(function (v) {
                  return {
              ...
              }) ]), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.iundo, UI_Icons.iredo, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
                  return x(function (dictStrong) {
                      return lens(dictStrong);
                  })(state);
              })) ]);
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.pointermove(Pha_Action.lensAction(function (dictStrong) {
              return lens(dictStrong);
          })(UI_Template.setPointerPositionA)), Pha_Html["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Data_Eq.eqInt)(Game_Solitaire_Model.solitaireGame)(function (dictStrong) {
              return lens(dictStrong);
          })(function (dictStrong) {
              ...
              return UI_Template.gridStyle(rows)(columns);
          ...
          })(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))))((function () {
              var $28 = Data_Maybe.isJust(Data_Lens_Getter.viewOn(state)(Game_Solitaire_Model["_dragged"](Data_Lens_Internal_Forget.strongForget)));
              if ($28) {
                  return [ cursor ];
              };
              return [  ];
...
(function($PS) {
  ...
  var main = function __do() {
      var v = $foreign.getLocationHref();
      var location = extractLocation(v)("valise");
      var v1 = Lib_Random.runRnd(Game_Core.init(Game_Baseball_Model.baseballGame)(Game_Baseball_Model.baseballState))();
      var v2 = Lib_Random.runRnd(Game_Core.init(Game_Nim_Model.nimGame)(Game_Nim_Model.nimState))();
      var v3 = Lib_Random.runRnd(Game_Core.init(Game_Frog_Model.frogGame)(Game_Frog_Model.frogState))();
      var v4 = Lib_Random.runRnd(Game_Core.init(Game_Jetons_Model.jetonsGame)(Game_Jetons_Model.jetonsState))();
      var v5 = Lib_Random.runRnd(Game_Core.init(Game_Noirblanc_Model.noirblancGame)(Game_Noirblanc_Model.noirblancState))();
      var v6 = Lib_Random.runRnd(Game_Core.init(Game_Paths_Model.pathGame)(Game_Paths_Model.pathsState))();
      var v7 = Lib_Random.runRnd(Game_Core.init(Game_Roue_Model.roueGame)(Game_Roue_Model.roueState))();
      var v8 = Lib_Random.runRnd(Game_Core.init(Game_Solitaire_Model.solitaireGame)(Game_Solitaire_Model.solitaireState))();
      var state = {
          baseball: v1,
          nim: v2,
          frog: v3,
