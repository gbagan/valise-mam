...
(function($PS) {
              ...
              return function (srcs) {
                  return function (dests) {
                      if (from === to || Data_Foldable.elem(Data_Foldable.foldableArray)(eqEdge)(new Edge(from, to))(edges)) {
                          ...
                          throw new Error("Failed pattern match at Game.Eternal.Model (line 165, column 9 - line 167, column 41): " + [ v.constructor.name ]);
                      };
                      if (Data_Boolean.otherwise) {
                          return dests;
                      };
  ...
  var isValidNextMove = function (st) {
      return function (dests) {
          ...
          throw new Error("Failed pattern match at Game.Eternal.Model (line 97, column 5 - line 106, column 50): " + [ v.constructor.name ]);
      };
  };
  ...
  var update = function (v) {
      ...
      if (v instanceof StartGame) {
          return Pha_Update.purely(function (st) {
              return Debug_Trace.spy()("start")(Data_Lens_Setter.set(_nextmove(Data_Profunctor_Strong.strongFn))((Data_Lens_Getter.viewOn(st)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))).guards)(Data_Lens_Setter.set(_phase(Data_Profunctor_Strong.strongFn))(GamePhase.value)(st)));
          });
      };
      ...
      if (v instanceof DropGuard) {
          return Pha_Update.purely(Debug_Trace.spy()(Data_Show.show(Data_Show.showInt)(v.value0))(dragGuard(new Data_Maybe.Just(v.value0))));
      };
      ...
      if (v instanceof Play) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (st) {
              ...
              throw new Error("Failed pattern match at Game.Eternal.Model (line 201, column 5 - line 204, column 49): " + [ v1.constructor.name ]);
          });
      };
...
(function($PS) {
  ...
  var always2 = function (msg) {
      return function (ev) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Debug_Trace.traceM()(Control_Monad_Except_Trans.monadExceptT(Data_Identity.monadIdentity))("pointerup"))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Debug_Trace.traceM()(Control_Monad_Except_Trans.monadExceptT(Data_Identity.monadIdentity))(ev))(function () {
                  return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(msg);
              });
          });
      };
  };
  var dndItemProps = function (state) {
      return function (v) {
          ...
          return [ Pha["class'"]("draggable")(v.draggable), Pha["class'"]("dragged")(dragged), Pha["class'"]("candrop")(candrop), Pha_Events.releasePointerCaptureOn("pointerdown")(always2((function () {
              if (v.draggable) {
  ...
  var view = function (state) {
      ...
      var config = UI_Template.card("Domination \xe9ternelle")([ UI_Icons.iconSelectGroup(UI_Icons.defa)(Game_Eternal_Model.eqgkind)(state)("Type de graphe")([ Game_Eternal_Model.Path.value, Game_Eternal_Model.Cycle.value ])(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_graphkind"](Data_Lens_Internal_Forget.strongForget)))(Game_Eternal_Model.SetGraphKind.create)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Eternal.View (line 87, column 100 - line 89, column 72): " + [ v.constructor.name ]);
          ...
          throw new Error("Failed pattern match at Game.Eternal.View (line 91, column 84 - line 93, column 88): " + [ v.constructor.name ]);
