...
(function($PS) {
  ...
  var randomAction = function (fn) {
      return Action(function (setState) {
          return function (ev) {
              return function (st) {
...
(function($PS) {
  ...
  var toggleHelpA = Pha.action(Data_Lens_Setter.over(_help(Data_Profunctor_Strong.strongFn))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  var _history = function (dictStrong) {
      var $116 = _core(dictStrong);
      var $117 = Data_Lens_Lens.lens(function (v) {
          return v.history;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _levelFinished = function (dictStrong) {
      var $119 = _core(dictStrong);
      var $120 = Data_Lens_Lens.lens(function (v) {
          ...
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      ...
                      var $89 = Data_Array["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget)));
                      if ($89) {
  ...
  var newGame = function (dictGame) {
      return function (f) {
          return Pha.randomAction(newGameAux(dictGame)(f));
      };
  };
  ...
  var _play = function (dictGame) {
      return function (move) {
          return function (state) {
              var $96 = canPlay(dictGame)(state)(move);
              if ($96) {
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $97 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($97) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $98 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($98) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $146 = isLosingPosition(dictTwoPlayersGame);
                      var $147 = Data_Function.flip(_play(dictTwoPlayersGame.Game0()))(state);
                      return function ($148) {
                          return $146($147($148));
                      };
              ...
              return Data_Function.flip(Data_Maybe.maybe(Control_Applicative.pure(Effect_Aff.applicativeAff)(state)))(computerMove(dictGame)(state))(function (rndmove) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Lib_Random.runRnd(rndmove)))(function (v) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(_play(dictGame)(v)(state))))(function (v1) {
                          var $101 = isLevelFinished(dictGame)(v1);
                          if ($101) {
  ...
  var playA = function (dictGame) {
      return function (move) {
          return function (setState) {
              return function (v) {
                  return function (state) {
                      var $102 = !canPlay(dictGame)(state)(move);
                      if ($102) {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(_play(dictGame)(move)(pushToHistory(state)))))(function (v1) {
                          var $104 = isLevelFinished(dictGame)(v1);
                          if ($104) {
                              return showVictory(setState)(v1);
                          };
                          var $105 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value);
                          if ($105) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                  ...
                  return function (setState) {
                      return function (ev) {
                          return function (state) {
                              ...
                              if (v instanceof Data_Maybe.Just) {
                                  var $107 = Data_Eq.notEq(dictEq)(v.value0)(to);
                                  if ($107) {
                                      return Pha.unwrapA(playA(dictGame)({
                                          from: v.value0,
                                          to: to
                                      }))(setState)(ev)(state2);
                                  };
                              ...
                              throw new Error("Failed pattern match at Game.Core (line 258, column 5 - line 261, column 39): " + [ v.constructor.name ]);
                          };
                      };
                  };
              };
  ...
  var changeTurn = function (state) {
      var $109 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
      if ($109) {
  ...
  var redoA = Pha.action(function (state) {
      return Data_Function.flip(Data_Maybe.maybe(state))(Data_Array_NonEmpty.fromArray(Data_Lens_Getter.viewOn(state)(_redoHistory(Data_Lens_Internal_Forget.strongForget))))(function (hs) {
  ...
  var undoA = Pha.action(function (state) {
      return Data_Function.flip(Data_Maybe.maybe(state))(Data_Array_NonEmpty.fromArray(Data_Lens_Getter.viewOn(state)(_history(Data_Lens_Internal_Forget.strongForget))))(function (hs) {
  ...
  var resetA = Pha.action(function (state) {
      return Data_Function.flip(Data_Maybe.maybe(state))(Data_Array_NonEmpty.fromArray(Data_Lens_Getter.viewOn(state)(_history(Data_Lens_Internal_Forget.strongForget))))(function (hs) {
  ...
  exports["setCustomSizeA"] = setCustomSizeA;
...
(function($PS) {
  ...
  var svguse = function (symbol) {
      return function (props) {
          return svg([ width("100%"), height("100%") ])([ Pha.h("use")([ attr("href")(symbol) ])([  ]) ]);
      };
  };
  exports["key"] = key;
  exports["attr"] = attr;
  ...
  var iconbutton = function (optionFn) {
      return function (props) {
          ...
          return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-icon")(true), Pha_Html["class'"]("selected")(v.selected), Pha_Html["class'"]("round")(v.large), Pha_Html["class'"]("hidden")(v.hidden), Pha_Html["class'"]("disabled")(v.disabled) ])(props))([ (function () {
              ...
              throw new Error("Failed pattern match at UI.Icon (line 41, column 9 - line 44, column 34): " + [ v.icon.constructor.name ]);
  ...
  var icons2Players = function (dictGame) {
      return function (lens) {
          return function (state) {
              ...
              })([ Pha_Html.click(Pha.lensAction(function (dictStrong) {
  ...
  var irules = function (lens) {
      return function (state) {
          ...
          return iconbutton(state)(function (v) {
              ...
              return lens(dictStrong);
          })(Pha.action(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.Rules.value)))) ]);
      };
  };
...
(function($PS) {
  ...
  var winTitleFor2Players = function (state) {
      ...
      if ($22) {
          return "Le " + ((function () {
              var $23 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
              if ($23) {
                  return "premier";
              };
              return "second";
                  ...
                  var dialog$prime = function (v1) {
                      if (v1 instanceof Game_Core.Rules) {
                          return UI_Dialog.dialog({
                              ...
                              onOk: Data_Maybe.Just.create(Pha.lensAction(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Pha.action(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.NoDialog.value))))
                          })(v.rules);
                      };
                      if (v1 instanceof Game_Core.ConfirmNewGame) {
                          return UI_Dialog.dialog({
                              title: "Nouvelle partie",
                              onCancel: Data_Maybe.Just.create(Pha.lensAction(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Pha.action(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.NoDialog.value)))),
                              onOk: new Data_Maybe.Just(Pha.lensAction(function (dictStrong) {
                                  return lens(dictStrong);
          ...
          return function (lens) {
              return function (dragLens) {
                  return function (hasDnD) {
                      var leave = Pha.action(Data_Lens_Setter.set(Game_Core["_pointerPosition"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value));
                      return [ Pha_Html.attr("touch-action")("none"), Pha_Html["class'"]("ui-touch-action-none")(true), Pha_Html.pointermove(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
                      })(setPointerPositionA)), Pha_Html.pointerup((function () {
                          if (hasDnD) {
                              return Pha.lensAction(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Pha.action(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)));
                          };
                          return Pha.noAction;
                      })()), Pha_Html.pointerleave(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
                      })(leave)), Pha_Html.pointerdown(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
                      })(setPointerPositionA)) ];
                  };
              };
              ...
              return UI_IncDecGrid.incDecGrid({
                  ...
                  onResize: function (x) {
                      return function (y) {
                          return Pha.lensAction(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game_Core.setCustomSizeA(dictGame)(x)(y));
                      };
                  }
              });
          };
                              ...
                              return function (state) {
                                  ...
                                  return [ Pha_Html["class'"]("dragged")(dragged), Pha_Html["class'"]("candrop")(candrop), Pha_Html.pointerdown((function () {
                                      if (draggable) {
                                          return Pha.lensAction(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(Pha.action(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(id))));
                                      };
                                      return Pha.noAction;
                                  })()), Pha_Html.pointerup(Pha.lensAction(function (dictStrong) {
                                      return lens(dictStrong);
                                  })((function () {
                                      if (candrop) {
                                      ...
                                      return Pha.action(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value));
                                  })())) ];
                              };
                          };
                      };
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board baseball-board")(true) ])([ Pha_Html.svg([ Pha_Html.width("100%"), Pha_Html.height("100%"), Pha_Html.viewBox("0 0 100 100") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (i) {
              ...
              return function (pos) {
                  return function (color) {
                      ...
                      return Pha_Html.g([ Pha_Html["class'"]("baseball-player")(true), Pha_Html.style("transform")(translatePeg(pos)(nbBases)), Pha_Html.key("p" + Data_Show.show(Data_Show.showInt)(peg)) ])([ Pha_Html.use(0.0)(0.0)(7.0)(7.0)("#meeple")([ Pha_Html.click(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
...
(function($PS) {
  ...
  var markA = function (i) {
      return Pha.action(Data_Lens_Setter.over((function () {
          ...
          var grid = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board frog-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("-190 -200 400 400"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.path(spiralPath)([ Pha_Html.fill("none"), Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(153.0)(9.0)(207.0)(20.0)([ Pha_Html.stroke("black"), Pha_Html.strokeDasharray("5"), Pha_Html.strokeWidth("6") ]), Pha_Html.line(153.0)(7.0)(153.0)(39.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(207.0)(18.0)(207.0)(50.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Core.map2(spoints)(reachable)(function (i) {
              return function (v) {
                  return function (reach) {
                      return Pha_Html.g([ Pha_Html.key("lily" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.click(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
                      })(Pha.ifThenElseA(function (v1) {
...
(function($PS) {
  ...
  var nimGame2 = new Game_Core.TwoPlayersGame(function () {
      ...
      return Data_Array.sortWith(Data_Ord.ordInt)(function (v) {
          return Data_Function.flip(Data_Maybe.maybe(0))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v.value0))(function (x) {
  ...
  var nimGame = new Game_Core.Game(function (state) {
      return function (v) {
          return Data_Function.flip(Data_Maybe.maybe(false))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v.value0))(function (v1) {
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("0 0 100 100"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
              return function (pile) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.rect((function () {
                      ...
                      return Pha_Html.rect(-2.5)(-2.5)(5.0)(5.0)([ Pha_Html.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html.fill("gray"), Pha_Html.click(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])(UI_Template.gridStyle(rows)(columns)))(Lib_Core.map2(position.light)(position.played)(function (index) {
              return function (light) {
                  return function (played) {
                      ...
                      return square(light)(Data_Lens_Getter.viewOn(state)(Game_Core["_help"](Data_Lens_Internal_Forget.strongForget)) && played)([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.style("height")(Data_Show.show(Data_Show.showNumber)(86.0 / Data_Int.toNumber(rows)) + "%"), Pha_Html.style("width")(Data_Show.show(Data_Show.showNumber)(86.0 / Data_Int.toNumber(columns)) + "%"), Pha_Html.style("left")(Data_Show.show(Data_Show.showNumber)((100.0 * Data_Int.toNumber(v.col) + 7.0) / Data_Int.toNumber(columns)) + "%"), Pha_Html.style("top")(Data_Show.show(Data_Show.showNumber)((100.0 * Data_Int.toNumber(v.row) + 7.0) / Data_Int.toNumber(rows)) + "%"), Pha_Html.click(Pha.lensAction(function (dictStrong) {
                          return lens(dictStrong);
...
(function($PS) {
  ...
  var solitaireGame = new Game_Core.Game(function (state) {
      ...
      var $97 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      var $98 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($99) {
          return $97($98($99));
      };
  })(), function (state) {
          ...
          if (v1 instanceof RandomBoard) {
              return {
                  ...
                  position: Data_Functor.mapFlipped(Lib_Random.functorRandom)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Lib_Random.applicativeRandom)(Data_Array.replicate(columns)(Lib_Random.randomBool)))(function (bools) {
                      return Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(bools)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.replicate(columns)(true))(bools)))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean));
                  })
              };
          };
          throw new Error("Failed pattern match at Game.Solitaire.Model (line 92, column 13 - line 103, column 18): " + [ v1.constructor.name ]);
      })();
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Jeu du solitaire")([ UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.iundo, UI_Icons.iredo, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })) ]);
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.pointermove(Pha.lensAction(function (dictStrong) {
              return lens(dictStrong);
              ...
              var $22 = Data_Maybe.isJust(Data_Lens_Getter.viewOn(state)(Game_Solitaire_Model["_dragged"](Data_Lens_Internal_Forget.strongForget)));
              if ($22) {
                  return [ cursor ];
              };
              return [  ];
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var v4 = Lib_Random.runRnd(Game_Core.init(Game_Noirblanc_Model.noirblancGame)(Game_Noirblanc_Model.noirblancState))();
      var v5 = Lib_Random.runRnd(Game_Core.init(Game_Solitaire_Model.solitaireGame)(Game_Solitaire_Model.solitaireState))();
      var state = {
          baseball: v1,
          nim: v2,
          frog: v3,
