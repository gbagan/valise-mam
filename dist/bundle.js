...
(function($PS) {
  ...
  var view = function (state) {
              ...
              return function (color) {
                  return Pha.whenN(peg !== Data_Lens_Getter.viewOn(state)(Game_Baseball_Model["_missingPeg"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
                      return Pha_Svg.g([ Pha.class_("baseball-player"), Pha.style("transform")(translatePeg(pos)(nbBases)), Pha.key("p" + Data_Show.show(Data_Show.showInt)(peg)) ])([ Pha_Svg.use("#meeple")([ Pha_Svg.width("7"), Pha_Svg.height("7"), Pha_Events.onclick(new Game_Baseball_Model.Play(peg)), Pha_Svg.fill(color), Pha.style("animation")((function () {
                          ...
                          var $2 = Game_Core.canPlay(Game_Baseball_Model.baseballGame)(state)(peg);
                          if ($2) {
                              return "pointer";
                          };
                          return "not-allowed";
      ...
      return UI_Template.template(Lib_Util.precord()())(Game_Baseball_Model.withcore)(Game_Baseball_Model.baseballGame)({
          config: config,
          board: board,
          rules: rules
      })(state);
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      return UI_Template.template(Lib_Util.precord()())(Game_Paths_Model.withcore)(Game_Paths_Model.pathGame)({
          config: config,
          board: board,
          rules: rules
      })(state);
