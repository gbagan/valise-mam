...
(function($PS) {
  ...
  var setState = function (fn) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "setState";
      }))(functorSetStateF)(Data_Symbol.SProxy.value)(new SetState(fn, Data_Unit.unit));
  };
  ...
  var rng = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "rng";
  }))(functorRandF)(Data_Symbol.SProxy.value)(new Rng(Control_Category.identity(Control_Category.categoryFn)));
  ...
  var getState = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "getState";
  }))(functorGetStateF)(Data_Symbol.SProxy.value)(new GetState(Control_Category.identity(Control_Category.categoryFn)));
      ...
      return Data_Functor_Variant.onMatch()()()({
          getState: function (v) {
              return Data_Functor_Variant.inj()(new Data_Symbol.IsSymbol(function () {
                  return "getState";
              }))(functorGetStateF)(Data_Symbol.SProxy.value)(new GetState((function () {
                  var $45 = Data_Lens_Getter.view(lens(Data_Lens_Internal_Forget.strongForget));
                  return function ($46) {
                      return v.value0($45($46));
                  };
              })()));
          },
          setState: function (v) {
              return Data_Functor_Variant.inj()(new Data_Symbol.IsSymbol(function () {
                  return "setState";
              }))(functorSetStateF)(Data_Symbol.SProxy.value)(new SetState(Data_Lens_Setter.over(lens(Data_Profunctor_Strong.strongFn))(v.value0), v.value1));
          }
  ...
  var delay = function (ms) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "delay";
      }))(functorDelayF)(Data_Symbol.SProxy.value)(new Delay(ms, Data_Unit.unit));
  };
...
(function($PS) {
  ...
  var scoreHash$prime = function (dictScoreGame) {
      return function (state) {
          var $100 = isCustomGame(dictScoreGame)(state);
          if ($100) {
              return "custom";
          };
  ...
  var _customSize = function (dictStrong) {
      var $154 = _core(dictStrong);
      var $155 = Data_Lens_Lens.lens(function (v) {
          return v.customSize;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _dialog = function (dictStrong) {
      var $157 = _core(dictStrong);
      var $158 = Data_Lens_Lens.lens(function (v) {
          return v.dialog;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _help = function (dictStrong) {
      var $160 = _core(dictStrong);
      var $161 = Data_Lens_Lens.lens(function (v) {
          return v.help;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _history = function (dictStrong) {
      var $163 = _core(dictStrong);
      var $164 = Data_Lens_Lens.lens(function (v) {
          return v.history;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _locked = function (dictStrong) {
      var $166 = _core(dictStrong);
      var $167 = Data_Lens_Lens.lens(function (v) {
          return v.locked;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var lockAction = function (act) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          var $114 = Data_Lens_Getter.viewOn(v)(_locked(Data_Lens_Internal_Forget.strongForget));
          if ($114) {
  ...
  var bestScore = function (dictScoreGame) {
      return function (state) {
          return Data_Lens_Getter.viewOn(state)((function () {
              var $190 = _scores(Data_Lens_Internal_Forget.strongForget);
              var $191 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(scoreHash$prime(dictScoreGame)(state))(Data_Lens_Internal_Forget.strongForget);
              return function ($192) {
                  return $190($191($192));
              };
          })());
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      var state4 = Data_Lens_Setter.set((function () {
                          var $193 = _scores(Data_Profunctor_Strong.strongFn);
                          var $194 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))("custom")(Data_Profunctor_Strong.strongFn);
                          return function ($195) {
                              return $193($194($195));
                          };
                      ...
                      var $117 = Data_List["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget))) || isLevelFinished(dictGame)(state);
                      if ($117) {
          ...
          return function (nbColumns) {
              return function (customSize) {
                  var setSize$prime = function (state) {
                      ...
                      var $119 = nbRows >= v.value0 && (nbRows <= v.value2 && (nbColumns >= v.value1 && nbColumns <= v.value3));
                      if ($119) {
                  ...
                  return newGame(dictGame)((function () {
                      var $196 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(customSize);
                      return function ($197) {
                          return setSize$prime($196($197));
                      };
                  })());
              };
          };
  ...
  var updateScore$prime = function (dictScoreGame) {
      return function (strat) {
          return function (state) {
              ...
              var cmp = (function () {
                  var $124 = Data_Eq.eq(eqObjective)(objective(dictScoreGame)(state))(Minimize.value);
                  if ($124) {
              ...
              var st2 = Data_Lens_Setter.over((function () {
                  var $200 = _scores(Data_Profunctor_Strong.strongFn);
                  var $201 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(hash)(Data_Profunctor_Strong.strongFn);
                  return function ($202) {
                      return $200($201($202));
                  };
              })())((function () {
  ...
  var changeTurn = function (state) {
      return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (x) {
          var $126 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
          if ($126) {
              return 1 - x | 0;
          };
          return 0;
  ...
  var redoA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 137, column 26 - line 143, column 52): " + [ v.constructor.name ]);
  });
  var undoA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 128, column 26 - line 134, column 56): " + [ v.constructor.name ]);
  });
  var playAux = function (dictGame) {
      return function (move) {
          return function (state) {
              var $133 = canPlay(dictGame)(state)(move);
              if ($133) {
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $134 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($134) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $135 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($135) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $209 = isLosingPosition(dictTwoPlayersGame);
                      var $210 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                      return function ($211) {
                          return $209($210($211));
                      };
      ...
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Data_Maybe.maybe(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(function (rndmove) {
              return Control_Bind.bind(Run.bindRun)(Pha_Action["randomAction'"](function (st) {
                  ...
                  var $138 = isLevelFinished(dictGame)(v1);
                  if ($138) {
                      return showVictory;
                  };
                  return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
  ...
  var computerStartsA = function (dictGame) {
      return Control_Apply.applySecond(Run.applyRun)(Pha_Action.action(pushToHistory))(computerPlay(dictGame));
  };
  var playA = function (dictGame) {
      return function (move) {
          return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
              var $140 = !canPlay(dictGame)(v)(move);
              if ($140) {
                  return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
              };
              return Control_Bind.bind(Run.bindRun)(Pha_Action["setState'"]((function () {
                  var $212 = playAux(dictGame)(move);
                  return function ($213) {
                      return $212(pushToHistory($213));
                  };
              })()))(function (v1) {
                  var $142 = isLevelFinished(dictGame)(v1);
                  if ($142) {
                      var v2 = updateScore(dictGame)(v1);
                  ...
                  var $147 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($147) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(1000))(function () {
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $150 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($150) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 319, column 5 - line 323, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var resetA = Pha_Action.action(function (state) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Data_Lens_Setter.set(_turn(Data_Profunctor_Strong.strongFn))(0)(Data_Lens_Setter.set(_redoHistory(Data_Profunctor_Strong.strongFn))(Data_List_Types.Nil.value)(Data_Lens_Setter.set(_history(Data_Profunctor_Strong.strongFn))(Data_List_Types.Nil.value)(Data_Lens_Setter.set(_position(Data_Profunctor_Strong.strongFn))(v.value0)(state))));
      };
      throw new Error("Failed pattern match at Game.Core (line 146, column 27 - line 151, column 33): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var unitPc2 = new EUnit(function (v) {
  ...
  var text$prime = function (x1) {
      return function (y1) {
          return function (t) {
              return function (props) {
                  return Pha.h("text")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ attr(unittoStr)("x")(Data_Show.show(Data_Show.showNumber)(x1)), attr(unittoStr)("y")(Data_Show.show(Data_Show.showNumber)(y1)) ])(props))([ Pha.text(t) ]);
              };
          };
      };
  };
      ...
      return function (lens) {
          return function (state) {
              return icongroup("Meilleur score (" + (Data_Maybe.maybe("\u2205")((function () {
                  ...
                  return lens(dictStrong);
              })(Pha_Action.action(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.ScoreDialog.value)))) ]) ]);
          };
      };
  };
  exports["iconbutton"] = iconbutton;
...
(function($PS) {
  ...
  var winTitleFor2Players = function (state) {
      ...
      if ($31) {
          return "Le " + ((function () {
              var $32 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
              if ($32) {
                  return "premier";
              };
              return "second";
      ...
      var $33 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
      if ($33) {
  ...
  var turnMessage = function (dictGame) {
      return function (state) {
          var $34 = Game_Core.isLevelFinished(dictGame)(state);
          if ($34) {
              return "Partie finie";
          };
          var $35 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
          if ($35) {
              return "Tour du premier joueur";
          };
          var $36 = Data_Eq.eq(Game_Core.eqMode)(Data_Lens_Getter.viewOn(state)(Game_Core["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.DuelMode.value);
          if ($36) {
  ...
  var svgCursorStyle = function (v) {
      return [ Pha_Html.style(Pha_Html.unittoStr)("transform")(Pha_Html.translate(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc(100.0 * v.x))(Pha_Html.pc(100.0 * v.y))) ];
  };
  ...
  var trackPointer = function (lens) {
      ...
      return [ Pha_Html.attr(Pha_Html.unittoStr)("touch-action")("none"), Pha_Html["class'"]("ui-touch-action-none")(true), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
          return lens(dictStrong);
      })(move)), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
          return lens(dictStrong);
      })(Pha_Action.action(Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))), Pha_Html.pointerdown(Pha_Action.zoomAt(function (dictStrong) {
          return lens(dictStrong);
      })(move)) ];
  };
  ...
  var gridStyle = function (rows) {
      return function (columns) {
          return function (limit) {
              ...
              return [ Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc((Data_Int.toNumber(rows) / m) * 100.0)), Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc((Data_Int.toNumber(columns) / m) * 100.0)) ];
          };
      };
  };
                          ...
                          return function (id) {
                              return function (state) {
                                  ...
                                  return [ Pha_Html["class'"]("dragged")(dragged), Pha_Html["class'"]("candrop")(candrop), Pha_Html.pointerdown((function () {
                                      if (draggable) {
                                          return Control_Apply.applySecond(Run.applyRun)(Game_Effs.releasePointerCapture)(Pha_Action.zoomAt(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(Pha_Action.action(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(id)))));
                                      };
                                      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                                  })()), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
                                      return lens(dictStrong);
                                  })((function () {
                                      if (candrop) {
          ...
          return function (lens) {
              return function (dragLens) {
                  ...
                  var leave = Pha_Action.action((function () {
                      var $62 = Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value);
                      var $63 = Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value);
                      return function ($64) {
                          return $62($63($64));
                      };
                  })());
                  return [ Pha_Html.attr(Pha_Html.unittoStr)("touch-action")("none"), Pha_Html["class'"]("ui-touch-action-none")(true), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(move)), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(Pha_Action.action(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(leave)), Pha_Html.pointerdown(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(move)) ];
              };
          };
              ...
              return function (state) {
                  ...
                  var dialog$prime = function (v1) {
                      if (v1 instanceof Game_Core.Rules) {
                          return dialog(function (dictStrong) {
                              return lens(dictStrong);
                          })("R\xe8gles du jeu")(v.rules);
                      };
      ...
      return function (rows) {
          return function (columns) {
              return function (size) {
                  return [ Pha_Html.style(Pha_Html.unitPc)("left")(Pha_Html.pc(v.x * 100.0)), Pha_Html.style(Pha_Html.unitPc)("top")(Pha_Html.pc(v.y * 100.0)), Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(size / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(size / Data_Int.toNumber(rows))) ];
              };
          };
      };
  };
...
(function($PS) {
  ...
  var translatePeg = function (position) {
      return function (nbBases) {
          ...
          return Pha_Html.translate(Pha_Html.unitNumber)(Pha_Html.unitNumber)(x)(y);
      };
  };
  var transformBase = function (i) {
      return function (nbBases) {
          ...
          return Pha_Html.translate(Pha_Html.unitNumber)(Pha_Html.unitNumber)(x)(y) + " rotate(45deg)";
      };
  };
                  ...
                  return function (color) {
                      return Pha.ifN(peg !== Data_Lens_Getter.viewOn(state)(Game_Baseball_Model["_missingPeg"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
                          return Pha_Html.g([ Pha_Html["class'"]("baseball-player")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")(translatePeg(pos)(nbBases)), Pha_Html.key("p" + Data_Show.show(Data_Show.showInt)(peg)) ])([ Pha_Html.use(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(0.0)(0.0)(7.0)(7.0)("#meeple")([ Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                              ...
                              var $7 = Game_Core.canPlay(Game_Baseball_Model.baseballGame)(state)(peg);
                              if ($7) {
                                  return "pointer";
                              };
                              return "not-allowed";
...
(function($PS) {
  ...
  var cutLine = function (state) {
      ...
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Game.Chocolat.Model (line 78, column 17 - line 82, column 56): " + [ v1.constructor.name ]);
      };
  };
  var _ext = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
  ...
  var chocolatGame = new Game_Core.Game(function (v) {
      ...
      return Control_Bind.bind(Lib_Random.bindRandom)((function () {
          var $78 = Data_Eq.eq(eqSoapMode)(Data_Lens_Getter.viewOn(state)(_soapMode(Data_Lens_Internal_Forget.strongForget)))(StandardMode.value);
          if ($78) {
          ...
          return Control_Bind.bind(Lib_Random.bindRandom)((function () {
              var $80 = Data_Eq.notEq(eqSoapMode)(Data_Lens_Getter.viewOn(state)(_soapMode(Data_Lens_Internal_Forget.strongForget)))(CornerMode.value);
              if ($80) {
      ...
      return function (v) {
          ...
          throw new Error("Failed pattern match at Game.Chocolat.Model (line 42, column 15 - line 46, column 42): " + [ v.constructor.name ]);
      };
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var cutter = function (row) {
              return function (col) {
                  return function (move) {
                      return Pha_Html.circle(50.0 * Data_Int.toNumber(col))(50.0 * Data_Int.toNumber(row))(7.0)([ Pha_Html.key("c" + Data_Show.show(Data_Show.showInt)((row * (columns + 1 | 0) | 0) + col | 0)), Pha_Html["class'"]("chocolat-cutter")(true), Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
                      })(Game_Chocolat_Model.setHoverA(new Data_Maybe.Just(move)))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
                      })(Game_Chocolat_Model.setHoverA(Data_Maybe.Nothing.value))), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
                      })(Control_Apply.applySecond(Run.applyRun)(Game_Chocolat_Model.setHoverA(Data_Maybe.Nothing.value))(Game_Core.playA(Game_Chocolat_Model.chocolatGame)(move)))) ]);
                  };
              };
          };
          ...
          var board = UI_Template.incDecGrid(Game_Chocolat_Model.chocolatGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state)([ grid, Pha_Html.span([ Pha_Html["class'"]("frog-turn-message")(true) ])([ Pha.text(UI_Template.turnMessage(Game_Chocolat_Model.chocolatGame)(state)) ]) ]);
...
(function($PS) {
  ...
  var _isoCustom = function (dictProfunctor) {
      var to = (function () {
          var $6 = Data_Array.mapWithIndex(function (i) {
              return function (b) {
                  if (b) {
                      return new Data_Maybe.Just({
          ...
          return function ($7) {
              return Data_Array.catMaybes($6($7));
          };
      })();
      var from = (function () {
          var $8 = Data_Function.flip(Data_Array.updateAtIndices(Data_Foldable.foldableArray))(Data_Array.replicate(25)(false));
          var $9 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
...
(function($PS) {
  ...
  var nbRaises = (function () {
      var $44 = Data_Array.filter(Data_Maybe.isNothing);
      var $45 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($46) {
          return Data_Array.length($44($45($46)));
      };
  })();
  var house = {
      vertices: [ {
  ...
  var edgesOf = (function () {
      ...
      var $47 = Data_Array.mapMaybe(toEdge);
      return function ($48) {
          return $47(Lib_Util.pairwise($48));
      };
  })();
  var cross = {
  ...
  var gameDessin = new Game_Core.Game(function (state) {
      return function (x) {
          ...
          throw new Error("Failed pattern match at Game.Dessin.Model (line 62, column 9 - line 66, column 26): " + [ x.constructor.name ]);
      };
  }, function (v) {
      return Data_Maybe.Nothing.value;
  }, function (v) {
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Template.card("Dessin")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Dessin")([ 0, 1 ])(Data_Lens_Getter.viewOn(state)(Game_Dessin_Model["_graphIndex"](Data_Lens_Internal_Forget.strongForget)))(Game_Dessin_Model.setGraphIndexA)(function (i) {
              return function (opt) {
                  return {
          ...
          var board = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          }))([ Pha_Html["class'"]("ui-board dessin-board")(true), Pha_Html.contextmenu(Control_Apply.applySecond(Run.applyRun)(Game_Effs.preventDefault)(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Core.playA(Game_Dessin_Model.gameDessin)(Data_Maybe.Nothing.value)))) ]))([ Pha_Html.svg([ Pha_Html["class'"]("dessin-svg")(true), Pha_Html.viewBox(0)(0)(100)(100) ])(Data_Array.concat([ Data_Functor.mapFlipped(Data_Functor.functorArray)(graph.edges)(function (edge) {
              ...
              return function (v) {
                  return Pha_Html.circle(20.0 * v.x)(20.0 * v.y)(3.0)([ Pha_Html.stroke((function () {
                      var $37 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Maybe.eqMaybe(Data_Eq.eqInt)))(new Data_Maybe.Just(new Data_Maybe.Just(i)))(Data_Array.last(position));
                      if ($37) {
                          return "red";
                      };
                      return "blue";
                  })()), Pha_Html.fill("blue"), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(Game_Core.playA(Game_Dessin_Model.gameDessin)(new Data_Maybe.Just(i)))) ]);
              };
          })(graph.vertices), [ Pha.maybeN(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(currentLine)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget))))(Data_Functor.map(Data_Maybe.functorMaybe)(getCoords(graph))(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array.last(position))))) ] ])), Pha_Html.span([ Pha_Html["class'"]("dessin-raise-info dessin-raise-info")(true) ])([ Pha.text(Data_Show.show(Data_Show.showInt)(raises) + (" lev\xe9" + (s + " de crayon"))) ]), Pha_Html.button([ Pha_Html["class'"]("ui-button ui-button-primary dessin-raise")(true), Pha_Html.disabled(!Game_Core.canPlay(Game_Dessin_Model.gameDessin)(state)(Data_Maybe.Nothing.value)), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Core.playA(Game_Dessin_Model.gameDessin)(Data_Maybe.Nothing.value))) ])([ Pha.text("Lever le crayon") ]) ]);
          return UI_Template.template(Game_Dessin_Model.gameDessin)(function (dictStrong) {
              return lens(dictStrong);
          })(function (v) {
              return {
                  board: board,
...
(function($PS) {
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.map(Effect.functorEffect)(State)(Game_Core.init(Game_Dessin_Model.gameDessin)(v));
  }, function (v) {
      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
  }, function (lens) {
      return function (v) {
          return Game_Dessin_View.view(function (dictStrong) {
              var $10 = lens(dictStrong);
              var $11 = is(dictStrong.Profunctor0());
              return function ($12) {
                  return $10($11($12));
...
(function($PS) {
  ...
  var scoregame = new Game_Core.ScoreGame(function () {
      ...
      var $36 = Data_Array.filter(function (v) {
          return v > 0;
      });
      var $37 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($38) {
          return Data_Array.length($36($37($38)));
      };
  })(), function (state) {
  ...
  var jetonsGame = new Game_Core.Game(function (state) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (i) {
          ...
          var y = (function () {
              var $24 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i + 1 | 0)(columns) === 0;
              if ($24) {
                  return 0;
              };
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          })), UI_Icons.iconBestScore(Game_Jetons_Model.scoregame)(function (dictStrong) {
              return lens(dictStrong);
          })(state) ]);
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          ...
          var piece = function (i) {
              return function (val) {
                  return function (props) {
                      ...
                      return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("jetons-peg")(true), Pha_Html["class'"]("small")(columns >= 8), Pha_Html.style(Pha_Html.unittoStr)("background-color")(Pha_Html.rgbColor(255)(Data_Int.floor(255.0 * (1.0 - $$Math.sqrt(Data_Int.toNumber(val) / Data_Int.toNumber(rows * columns | 0)))))(0)), Pha_Html.style(Pha_Html.unitPc)("left")(Pha_Html.pc((15.0 + Data_Int.toNumber(v.col) * 100.0) / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("top")(Pha_Html.pc((15.0 + Data_Int.toNumber(v.row) * 100.0) / Data_Int.toNumber(rows))), Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(70.0 / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(70.0 / Data_Int.toNumber(rows))), Pha_Html.style(Pha_Html.unittoStr)("box-shadow")(Data_Show.show(Data_Show.showInt)(val * 2 | 0) + ("px " + (Data_Show.show(Data_Show.showInt)(val * 2 | 0) + "px 5px 0px #656565"))) ])(props))([ Pha_Html.span([  ])([ Pha.text(Data_Show.show(Data_Show.showInt)(val)) ]) ]);
                  };
              };
          };
          var scoreDialog = function (v) {
              return UI_Template.bestScoreDialog(Game_Jetons_Model.scoregame)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)(function (pos) {
...
(function($PS) {
  ...
  var showBt = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 30, column 1 - line 35, column 32): " + [ v.constructor.name ]);
  });
  var setHelpA = function (a) {
      return Pha_Action.action(Data_Lens_Setter.set(Game_Core["_help"](Data_Profunctor_Strong.strongFn))(a));
  };
      ...
      return function (columns) {
          return function (mode) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.Model (line 105, column 24 - line 108, column 83): " + [ mode.constructor.name ]);
              });
          };
      };
  };
  ...
  var incSelectedColorA = function (x) {
      return Pha_Action.action(Data_Lens_Setter.over(_selectedColor(Data_Profunctor_Strong.strongFn))(function (y) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((x + y | 0) + 9 | 0)(9);
      }));
  };
  ...
  var finishZoneA = function (index1) {
      return Pha_Action.action(function (state) {
          return Data_Maybe.maybe(state)(function (index2) {
              var v = Lib_Util.coords(Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(index1);
              var v1 = Lib_Util.coords(Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(index2);
          ...
          })(Data_Lens_Getter.viewOn(state)(_startSquare(Data_Lens_Internal_Forget.strongForget)));
      });
  };
  var startZoneA = function (pos) {
      return Pha_Action.action(Data_Lens_Setter.set(_startSquare(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(pos)));
  };
  var _beastType = function (dictStrong) {
      var $107 = _ext(dictStrong);
  ...
  var getNewBeast = function (state) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 134, column 21 - line 139, column 42): " + [ v.constructor.name ]);
  };
  ...
  var setBeastA = function (ttype) {
      return Game_Core.newGame(labeteGame)((function () {
          ...
          var $123 = (function () {
              var $91 = Data_Eq.eq(eqBt)(ttype)(CustomBeast.value);
              if ($91) {
...
(function($PS) {
  ...
  var ihelp = function (lens) {
      return function (state) {
          ...
          })([ Pha_Html.pointerdown(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Labete_Model.setHelpA(true))), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Labete_Model.setHelpA(false))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Labete_Model.setHelpA(false))) ]);
      };
  };
  var colors = [ "#5aa02c", "blue", "red", "yellow", "magenta", "cyan", "orange", "darkgreen", "grey" ];
  var square = function (v) {
      return function (props) {
          return Pha_Html.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.transform(Pha_Html.translate(Pha_Html.unitInt)(Pha_Html.unitInt)(50 * v.col | 0)(50 * v.row | 0)) ])(props))([ Pha_Html.use(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(0.0)(0.0)(50.0)(50.0)("#grass")([ Pha_Html.fill(Data_Maybe.fromMaybe("#5aa02c")(Data_Array.index(colors)(v.color))) ]), Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(0.0)(0.0)(51.0)(51.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("0.5"), Pha_Html.fill("transparent") ]), Pha_Html.use(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(5.0)(5.0)(40.0)(40.0)("#paw")([ Pha_Html["class'"]("labete-beast")(true), Pha_Html["class'"]("visible")(v.hasBeast) ]), Pha.ifN(v.hasTrap)(function (v1) {
  ...
  var zone = function (color) {
      return function (v) {
          return function (v1) {
              return Pha_Html.rect(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc(100.0 * Data_Ord.min(Data_Ord.ordNumber)(v.x)(v1.x)))(Pha_Html.pc(100.0 * Data_Ord.min(Data_Ord.ordNumber)(v.y)(v1.y)))(Pha_Html.pc(100.0 * $$Math.abs(v1.x - v.x)))(Pha_Html.pc(100.0 * $$Math.abs(v1.y - v.y)))([ Pha_Html.key("zone"), Pha_Html.stroke("black"), Pha_Html.fill(Data_Maybe.fromMaybe("#5aa02c")(Data_Array.index(colors)(color))), Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none"), Pha_Html.attr(Pha_Html.unittoStr)("opacity")("0.4") ]);
          };
      };
  };
  var view = function (lens) {
      return function (state) {
          ...
          var customDialog = function (v) {
              return UI_Template.dialog(function (dictStrong) {
                  return lens(dictStrong);
              })("Personnalise ta b\xeate")([ Pha_Html["div'"]([ Pha_Html["class'"]("labete-custombeast-grid-container")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(250)(250) ])(Data_Array.mapWithIndex(function (index) {
                  return function (hasBeast) {
                      ...
                      return square({
                          ...
                          hasTrap: false,
                          color: 0
                      })([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
                      })(Game_Labete_Model.flipCustomBeastA(index))) ]);
                  };
              })(Data_Lens_Getter.viewOn(state)((function () {
                  var $66 = Game_Labete_Model["_beast"](Data_Lens_Internal_Forget.strongForget);
                  var $67 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Forget.wanderForget(Data_Monoid.monoidArray));
                  var $68 = Game_Common["_isoCustom"](Data_Lens_Internal_Forget.profunctorForget);
                  return function ($69) {
                      return $66($67($68($69)));
                  };
              })()))) ]) ]);
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          }))([ Pha_Html["class'"]("ui-board")(true), Pha_Html.pointerdown(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Control_Bind.ifM(Run.bindRun)(Data_Functor.map(Run.functorRun)(Pha_Event.shiftKey)(Pha_Action.getEvent))(Game_Labete_Model.startZone2A)(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit)))) ])))([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Util.map3(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(nonTrappedBeast)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_squareColors"](Data_Lens_Internal_Forget.strongForget)))(function (index) {
                  ...
                  return function (hasBeast) {
                      return function (color) {
                          ...
                          return square({
                              ...
                              return lens(dictStrong);
                          })(Control_Bind.ifM(Run.bindRun)(Data_Functor.map(Run.functorRun)(Pha_Event.shiftKey)(Pha_Action.getEvent))(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(Game_Core.playA(Game_Labete_Model.labeteGame)(index)))), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game_Labete_Model.finishZoneA(index))), Pha_Html.pointerdown(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
                          })(Control_Bind.ifM(Run.bindRun)(Data_Functor.map(Run.functorRun)(Pha_Event.shiftKey)(Pha_Action.getEvent))(Game_Labete_Model.startZoneA(index))(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit)))) ]);
                      };
                  };
              };
          }))([ Pha.maybeN((function () {
              ...
              throw new Error("Failed pattern match at Game.Labete.View (line 121, column 26 - line 123, column 83): " + [ v.constructor.name ]);
          })()) ])) ]);
          var scoreDialog = function (v) {
              return UI_Template.bestScoreDialog(Game_Labete_Model.scoregameLabete)(function (dictStrong) {
                  return lens(dictStrong);
          ...
          var board = UI_Template.incDecGrid(Game_Labete_Model.labeteGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state)([ grid, Pha.ifN(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_selectedColor"](Data_Lens_Internal_Forget.strongForget)) > 0)(function (v) {
              return Pha_Html["div'"]([ Pha_Html["class'"]("labete-color")(true), Pha_Html.style(Pha_Html.unittoStr)("background-color")(Data_Maybe.fromMaybe("transparent")(Data_Array.index(colors)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_selectedColor"](Data_Lens_Internal_Forget.strongForget))))) ])([  ]);
          }) ]);
          ...
          var config = UI_Template.card("La b\xeate")([ UI_Icons.iconSelectGroup(Game_Labete_Model.showBt)(Game_Labete_Model.eqBt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Forme de la b\xeate")(beastTypes)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_beastType"](Data_Lens_Internal_Forget.strongForget)))(Game_Labete_Model.setBeastA)(function (i) {
              return function (opt) {
                  if (i instanceof Game_Labete_Model.Type1) {
                      return {
                  ...
                  if (i instanceof Game_Labete_Model.Type2) {
                      return {
                  ...
                  if (i instanceof Game_Labete_Model.Type3) {
                      return {
                  ...
                  if (i instanceof Game_Labete_Model.Type4) {
                      return {
                  ...
                  if (i instanceof Game_Labete_Model.CustomBeast) {
                      return {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.View (line 75, column 106 - line 80, column 63): " + [ i.constructor.name ]);
              };
          }), UI_Icons.iconSelectGroup(Game_Labete_Model.showMode)(Game_Labete_Model.eqMode)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Type de la grille")(modes)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Labete_Model.setModeA)(function (i) {
              return function (opt) {
                  if (i instanceof Game_Labete_Model.StandardMode) {
                      return {
                  ...
                  if (i instanceof Game_Labete_Model.CylinderMode) {
                      return {
                  ...
                  if (i instanceof Game_Labete_Model.TorusMode) {
                      return {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.View (line 82, column 96 - line 85, column 88): " + [ i.constructor.name ]);
              };
          }), UI_Icons.iconSizesGroup(Game_Labete_Model.labeteGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state)([ new Data_Tuple.Tuple(3, 3), new Data_Tuple.Tuple(5, 5), new Data_Tuple.Tuple(6, 6) ])(true), UI_Icons.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ ihelp, UI_Icons.ireset, UI_Icons.irules ])(function (x) {
              return x(function (dictStrong) {
                  return lens(dictStrong);
              })(state);
          })), UI_Icons.iconBestScore(Game_Labete_Model.scoregameLabete)(function (dictStrong) {
              return lens(dictStrong);
          })(state) ]);
          return UI_Template.template(Game_Labete_Model.labeteGame)(function (dictStrong) {
              return lens(dictStrong);
          })(function (v) {
              return {
                  board: board,
...
(function($PS) {
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.map(Effect.functorEffect)(State)(Game_Core.init(Game_Labete_Model.labeteGame)(v));
  }, function (a) {
      return Pha_Action.zoomAt(function (dictStrong) {
          return is(dictStrong.Profunctor0());
      ...
      return function (v) {
          return Game_Labete_View.view(function (dictStrong) {
              var $10 = lens(dictStrong);
              var $11 = is(dictStrong.Profunctor0());
              return function ($12) {
                  return $10($11($12));
  ...
  var view = function (lens) {
      return function (state) {
          var winTitle = "Les " + ((function () {
              var $7 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
              if ($7) {
                  return "bleu";
              };
              return "rouge";
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(100)(100) ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
              return function (pile) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)((function () {
                      ...
                      return Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(-2.5)(-2.5)(5.0)(5.0)([ Pha_Html.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html.fill("gray"), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
                      })(Game_Core.playA(Game_Nim_Model.nimGame)(new Game_Nim_Model.Move(i, j)))), Pha_Html.style(Pha_Html.unittoStr)("transform")(Pha_Html.translate(Pha_Html.unitPx2)(Pha_Html.unitPx2)(Pha_Html.px((function () {
                          var $10 = length === 5;
                          if ($10) {
                              return 30;
                          };
                          ...
                          var $11 = Game_Core.canPlay(Game_Nim_Model.nimGame)(state)(new Game_Nim_Model.Move(i, j));
                          if ($11) {
                              return "pointer";
                          };
                          return "not-allowed";
              ...
              var $14 = Game_Core.isLevelFinished(Game_Nim_Model.nimGame)(state);
              if ($14) {
                  return "Partie finie";
              };
              var $15 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
              if ($15) {
...
(function($PS) {
  ...
  var afterPlay = Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
      var mode = Data_Lens_Getter.viewOn(v)(_mode2(Data_Lens_Internal_Forget.strongForget));
      var $53 = Game_Core.isLevelFinished(noirblancGame)(v);
      if ($53) {
          var nextLevel = (function () {
              var $54 = Data_Lens_Getter.viewOn(v)(_level(Data_Lens_Internal_Forget.strongForget)) >= 4;
              if ($54) {
                  return 6;
              };
              return Data_Lens_Getter.viewOn(v)(_level(Data_Lens_Internal_Forget.strongForget)) + (function () {
                  var $55 = mode === 0 || mode === 3;
                  if ($55) {
                      return 1;
                  };
                  return 2;
  ...
  var selectModeA = function (mode) {
      return Game_Core.newGame(noirblancGame)((function () {
          var $71 = Data_Lens_Setter.set(_mode2(Data_Profunctor_Strong.strongFn))(mode);
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])(UI_Template.gridStyle(rows)(columns)(4)))(Lib_Util.map2(position.light)(position.played)(function (index) {
              return function (light) {
                  return function (played) {
                      var v = Lib_Util.coords(columns)(index);
                      return square(light)(Data_Lens_Getter.viewOn(state)(Game_Core["_help"](Data_Lens_Internal_Forget.strongForget)) && played)([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(86.0 / Data_Int.toNumber(rows))), Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(86.0 / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("left")(Pha_Html.pc((100.0 * Data_Int.toNumber(v.col) + 7.0) / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("top")(Pha_Html.pc((100.0 * Data_Int.toNumber(v.row) + 7.0) / Data_Int.toNumber(rows))), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
...
(function($PS) {
  ...
  var pathGame = new Game_Core.Game(function (state) {
      ...
      var $61 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      ...
      return Data_Array.length(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))) === ((Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) | 0) + (function () {
          var $47 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Lens_Getter.viewOn(state)(_exit(Data_Lens_Internal_Forget.strongForget)))(Data_Array.head(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))));
          if ($47) {
              return 1;
          };
          return 0;
      ...
      var $48 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(Mode1.value);
      if ($48) {
  ...
  var selectVertexA = function (v) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
          var $53 = Data_Array["null"](Data_Lens_Getter.viewOn(v1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
          if ($53) {
              return Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_position"](Data_Profunctor_Strong.strongFn))([ v ]));
          };
          var $54 = Data_Maybe.isNothing(Data_Lens_Getter.viewOn(v1)(_exit(Data_Lens_Internal_Forget.strongForget)));
          if ($54) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var hero = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Array.last(position))(function (h) {
              ...
              return Pha_Html.use(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(0.0)(0.0)(80.0)(80.0)("#meeplehat")([ Pha_Html.key("hero"), Pha_Html["class'"]("paths-hero")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")(Pha_Html.translate(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc((Data_Int.toNumber(v.col) * 100.0 + 10.0) / Data_Int.toNumber(columns)))(Pha_Html.pc((Data_Int.toNumber(v.row) * 100.0 + 10.0) / Data_Int.toNumber(rows)))) ]);
          });
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          })))([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(100 * columns | 0)(100 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Util.tabulate(rows * columns | 0)(function (index) {
              var v = Lib_Util.coords(columns)(index);
              return square({
              ...
              var $33 = Data_Array["null"](position);
              if ($33) {
                  return heroCursor(pp);
              };
              var $34 = Data_Maybe.isNothing(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_exit"](Data_Lens_Internal_Forget.strongForget)));
              if ($34) {
...
(function($PS) {
  ...
  var toggleAllowedPiece = function (piece) {
      return function (v) {
          return function (pieces) {
              ...
              throw new Error("Failed pattern match at Game.Queens.Model (line 125, column 1 - line 125, column 91): " + [ piece.constructor.name, v.constructor.name, pieces.constructor.name ]);
          };
      };
  };
  var _ext = function (dictStrong) {
  ...
  var _multiPieces = function (dictStrong) {
      var $70 = _ext(dictStrong);
      var $71 = Data_Lens_Lens.lens(function (v) {
      ...
      return function (piece) {
          return function (index1) {
              return function (index2) {
                  ...
                  var $62 = Data_Eq.notEq(eqPiece)(piece)(Custom.value);
                  if ($62) {
  ...
  var capturableSquares = function (state) {
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
          var $66 = Data_Eq.eq(eqPiece)(v.value1)(Empty.value);
          if ($66) {
              return Control_Category.identity(Control_Category.categoryFn);
          };
  ...
  var queensScoreGame = new Game_Core.ScoreGame(function () {
      ...
      var $88 = Data_Array.filter(Data_Eq.notEq(eqPiece)(Empty.value));
      var $89 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($90) {
          return Data_Array.length($88($89($90)));
      };
  })(), function (state) {
  ...
  var queensGame = new Game_Core.Game(function (v) {
      ...
      return function (index) {
          ...
          return Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(index)(Data_Lens_Internal_Wander.wanderFunction))(function (t) {
              var $69 = Data_Eq.eq(eqPiece)(t)(selectedPiece);
              if ($69) {
                  return Empty.value;
              };
  ...
  var customizeA = Game_Core.newGame(queensGame)((function () {
      var $91 = Data_Lens_Setter.set(_allowedPieces(Data_Profunctor_Strong.strongFn))(Data_Array_NonEmpty.singleton(Custom.value));
      var $92 = Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.CustomDialog.value);
      var $93 = Data_Lens_Setter.set(_multiPieces(Data_Profunctor_Strong.strongFn))(false);
      return function ($94) {
          return $91($92($93($94)));
      };
  })());
  var flipDirectionA = function (direction) {
      return Game_Core.newGame(queensGame)(Data_Lens_Setter.over((function () {
          ...
          var $96 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(direction)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($97) {
              return $95($96($97));
          };
      })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  ...
  var flipLocalMoveA = function (position) {
      return Game_Core.newGame(queensGame)(Data_Lens_Setter.over((function () {
          ...
          var $99 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(position)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($100) {
              return $98($99($100));
          };
      })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("queens-square")(true), Pha_Html["class'"]("queens-square-capturable")(v.capturable), Pha_Html["class'"]("queens-square-nonavailable")(v.nonavailable), Pha_Html["class'"]("queens-square-selected")(v.selected) ])(props))((function () {
              var $30 = Data_Eq.eq(Game_Queens_Model.eqPiece)(v.piece)(Game_Queens_Model.Empty.value);
              if ($30) {
                  return [  ];
              };
              return [ Pha_Html.svg([ Pha_Html.width(Pha_Html.unittoStr)("100%"), Pha_Html.height(Pha_Html.unittoStr)("100%"), Pha_Html["class'"]("queen-piece")(true) ])([ Pha_Html.use(Pha_Html.unitPc2)(Pha_Html.unitPc2)(Pha_Html.unitPc2)(Pha_Html.unitPc2)(Pha_Html.pc(10))(Pha_Html.pc(10))(Pha_Html.pc(80))(Pha_Html.pc(80))("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(v.piece))([ Pha_Html["class'"]("queens-piece")(true) ]) ]) ];
          })());
      };
  };
  var view = function (lens) {
      return function (state) {
          ...
          var pieceSelector = Pha_Html["div'"]([ Pha_Html["class'"]("ui-flex-center gutter2 queens-pieceselector")(true) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array_NonEmpty.toArray(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_allowedPieces"](Data_Lens_Internal_Forget.strongForget))))(function (piece) {
              ...
              })([ Pha_Html.key(name), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                  return lens(dictStrong);
              })(Game_Queens_Model.selectPieceA(piece))) ]);
          }));
          var config = UI_Template.card("Les reines")([ UI_Icons.iconSizesGroup(Game_Queens_Model.queensGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state)([ new Data_Tuple.Tuple(4, 4), new Data_Tuple.Tuple(5, 5), new Data_Tuple.Tuple(7, 7), new Data_Tuple.Tuple(8, 8) ])(true), UI_Icons.iconSelectGroupM(Game_Queens_Model.showPiece)(Game_Queens_Model.eqPiece)(Data_Array_NonEmpty_Internal.foldableNonEmptyArray)(function (dictStrong) {
              return lens(dictStrong);
              ...
              return lens(dictStrong);
          })(Game_Queens_Model.customizeA)) ]), UI_Icons.iconbutton(state)(function (v) {
              return {
          ...
          }))), UI_Icons.iconBestScore(Game_Queens_Model.queensScoreGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state) ]);
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          var cursor = function (pp) {
              return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-cursor")(true) ])(UI_Template.cursorStyle(pp)(rows)(columns)(80.0)))([ Pha_Html.svg([ Pha_Html.width(Pha_Html.unittoStr)("100%"), Pha_Html.height(Pha_Html.unittoStr)("100%") ])([ Pha.h("use")([ Pha_Html.href("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_selectedPiece"](Data_Lens_Internal_Forget.strongForget)))) ])([  ]) ]) ]);
          };
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(UI_Template.trackPointer(function (dictStrong) {
              ...
              return function (piece) {
                  return function (attacked) {
                      return function (capturable) {
                          ...
                          })([ Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(100.0 / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(100.0 / Data_Int.toNumber(rows))), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game_Core.playA(Game_Queens_Model.queensGame)(index))), Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game_Queens_Model.selectSquareA(new Data_Maybe.Just(index)))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
              ...
              var $39 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($40) {
                  return $39(cursor($40));
              };
          })())(Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget)))));
          var scoreDialog = function (v) {
              return UI_Template.bestScoreDialog(Game_Queens_Model.queensScoreGame)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)(function (position1) {
                  return [ Pha_Html["div'"]([ Pha_Html["class'"]("ui-flex-center queens-bestscore-container")(true) ])([ Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))([ Pha_Html["class'"]("ui-board queens-grid")(true) ]))(Data_Functor.mapFlipped(Data_Functor.functorArray)(position1)(function (piece) {
                      return square({
                          piece: piece,
                          capturable: false,
                          selected: false,
                          nonavailable: false
                      })([ Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(100.0 / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(100.0 / Data_Int.toNumber(rows))) ]);
                  })) ]) ];
              });
          };
          var board = Pha_Html["div'"]([  ])([ pieceSelector, UI_Template.incDecGrid(Game_Queens_Model.queensGame)(function (dictStrong) {
              return lens(dictStrong);
          })(state)([ grid ]) ]);
          ...
          var customDialog = function (v) {
              return UI_Template.dialog(function (dictStrong) {
                  return lens(dictStrong);
              })("Personnalise ta pi\xe8ce")([ Pha_Html["div'"]([ Pha_Html["class'"]("flex queens-custompiece")(true) ])([ Pha_Html["div'"]([ Pha_Html["class'"]("queens-grid queens-custompiece-grid")(true) ])(Data_Array.mapWithIndex(function (index) {
                  return function (selected) {
                      return square({
                          piece: (function () {
                              var $35 = index === 12;
                          ...
                          if ($36) {
                              return Pha_Action.zoomAt(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Game_Queens_Model.flipLocalMoveA(index));
                          };
                          return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                      })()) ]);
                  };
                      ...
                      return function (angle) {
                          return UI_Icons.iconbutton(state)(function (v1) {
                              ...
                              if ($38) {
                                  return Pha_Action.zoomAt(function (dictStrong) {
                                      return lens(dictStrong);
                                  })(Game_Queens_Model.flipDirectionA(i));
                              };
                              return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                          })()) ]);
                      };
          ...
          return UI_Template.template(Game_Queens_Model.queensGame)(function (dictStrong) {
              return lens(dictStrong);
          })(function (v) {
              return {
                  board: board,
...
(function($PS) {
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.map(Effect.functorEffect)(State)(Game_Core.init(Game_Queens_Model.queensGame)(v));
  }, function (v) {
      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
  }, function (lens) {
      return function (v) {
          return Game_Queens_View.view(function (dictStrong) {
              var $10 = lens(dictStrong);
              var $11 = _iso(dictStrong.Profunctor0());
              return function ($12) {
                  return $10($11($12));
              };
          })(v);
...
(function($PS) {
  ...
  var roueGame = new Game_Core.Game(function (v) {
      ...
      var $63 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      var $64 = Data_Lens_Setter.set(_rotation(Data_Profunctor_Strong.strongFn))(0);
      return function ($65) {
          return $63($64($65));
      };
  })(), function (state) {
      ...
      return Data_Maybe.maybe(state2)(function (v) {
          if (v instanceof Wheel) {
              return Data_Lens_Setter.set((function () {
                  var $69 = Game_Core["_position"](Data_Profunctor_Strong.strongFn);
                  var $70 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction);
                  return function ($71) {
                      return $69($70($71));
                  };
...
(function($PS) {
  ...
  var cursor = function (v) {
      return function (color) {
          return Pha_Html["div'"]([ Pha_Html["class'"]("ui-cursor roue-select-color roue-cursor")(true), Pha_Html.style(Pha_Html.unitPc)("left")(Pha_Html.pc(100.0 * v.x)), Pha_Html.style(Pha_Html.unitPc)("top")(Pha_Html.pc(100.0 * v.y)), Pha_Html.style(Pha_Html.unittoStr)("background-color")(color) ])([  ]);
      };
  };
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var outerWheel = Pha_Html["div'"]([ Pha_Html["class'"]("roue-outer")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((360.0 * Data_Int.toNumber(Data_Lens_Getter.viewOn(state)(Game_Roue_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)))) / Data_Int.toNumber(size)) + "deg)")) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.svg([ Pha_Html.key("svg"), Pha_Html.viewBox(0)(0)(100)(100) ])(Lib_Util.map2(position)(Game_Roue_Model.aligned(state))(function (i) {
              return function (pos) {
                  return function (align) {
                      return Pha_Html.path(pizza(50.0)(50.0)(50.0)((2.0 * $$Math.pi * (Data_Int.toNumber(i) - 0.5)) / Data_Int.toNumber(size))((2.0 * $$Math.pi * (Data_Int.toNumber(i) + 0.5)) / Data_Int.toNumber(size)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("roue-wheel-part")(true), Pha_Html.fill((function () {
                          ...
                          var $20 = Game_Roue_Model["validRotation'"](state);
                          if ($20) {
                              return "lightgreen";
                          };
                          return "#F5B7B1";
              ...
              return function (c) {
                  return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(c)(function (color) {
                      return Pha_Html["div'"]([ Pha_Html["class'"]("roue-outer-piece")(true), Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.style(Pha_Html.unitPc)("left")(Pha_Html.pc(44.0 + 40.0 * $$Math.cos((Data_Int.toNumber(index) * 2.0 * $$Math.pi) / Data_Int.toNumber(size)))), Pha_Html.style(Pha_Html.unitPc)("top")(Pha_Html.pc(44.0 + 40.0 * $$Math.sin((Data_Int.toNumber(index) * 2.0 * $$Math.pi) / Data_Int.toNumber(size)))), Pha_Html.style(Pha_Html.unittoStr)("background-color")(Data_Maybe.fromMaybe("black")(Data_Array.index(colors)(color))) ])([  ]);
                  });
              };
          })(position))));
          ...
          var board = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Game_Roue_Model.eqBall)(Game_Roue_Model.roueGame)(function (dictStrong) {
              ...
              return function (color) {
                  return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("roue-select-color ui-flex-center")(true), Pha_Html.style(Pha_Html.unittoStr)("background-color")(color) ])(UI_Template.dndItemProps(Game_Roue_Model.eqBall)(Game_Roue_Model.roueGame)(function (dictStrong) {
                      return lens(dictStrong);
                  })(function (dictStrong) {
                      return Game_Roue_Model["_dragged"](dictStrong);
                  })(true)(false)(new Game_Roue_Model.Panel(i))(state)))((function () {
                      var $24 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(i))(position);
                      if ($24) {
          ...
          })(Data_Array.take(size)(colors)))([ Pha_Html.button([ Pha_Html["class'"]("ui-button ui-button-primary roue-button")(true), Pha_Html.disabled(Data_Lens_Getter.viewOn(state)(Game_Core["_locked"](Data_Lens_Internal_Forget.strongForget))), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
...
(function($PS) {
  ...
  var betweenMove = function (state) {
      return function (v) {
          var v1 = Lib_Util.dCoords(Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(v.from)(v.to);
          var $49 = ((v1.row * v1.row | 0) + (v1.col * v1.col | 0) | 0) === 4;
          if ($49) {
  ...
  var betweenMove2 = function (state) {
      return function (v) {
          var rows = Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
          var $65 = Data_Eq.eq(boardMode)(Data_Lens_Getter.viewOn(state)(_board(Data_Lens_Internal_Forget.strongForget)))(CircleBoard.value);
          if ($65) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(betweenInCircle(v.from)(v.to)(rows))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      var $67 = rows === 4 && Data_Maybe.maybe(false)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v1));
                      if ($67) {
  ...
  var scoregame = new Game_Core.ScoreGame(function () {
      ...
      var $102 = Data_Array.filter(Control_Category.identity(Control_Category.categoryFn));
      var $103 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($104) {
          return Data_Array.length($102($103($104)));
      };
  })(), function (state) {
  ...
  var solitaireGame = new Game_Core.Game(function (state) {
      ...
      var $105 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      var $106 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($107) {
          return $105($106($107));
      };
  })(), function (state) {
      ...
      var v = (function () {
          ...
          throw new Error("Failed pattern match at Game.Solitaire.Model (line 107, column 13 - line 125, column 18): " + [ v1.constructor.name ]);
      })();
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = (function () {
              ...
              }))), UI_Icons.iconBestScore(Game_Solitaire_Model.scoregame)(function (dictStrong) {
                  return lens(dictStrong);
              })(state) ]);
          })();
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          ...
          var scoreDialog = function (v) {
              return UI_Template.bestScoreDialog(Game_Solitaire_Model.scoregame)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)(function (position) {
...
(function($PS) {
  ...
  var putSinkA = function (i) {
      return Pha_Action.action(Data_Lens_Setter.set((function () {
          ...
          var $71 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(i)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($72) {
              return $70($71($72));
          };
      })())(-1 | 0));
  ...
  var getTile = function (state) {
      ...
      throw new Error("Failed pattern match at Game.Tiling.Model (line 67, column 17 - line 71, column 31): " + [ v.constructor.name ]);
  };
  var tilingGame = new Game_Core.Game(function (state) {
      ...
      var $88 = Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Eq.notEq(Data_Eq.eqInt)(0));
      var $89 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($90) {
          return $88($89($90));
      };
      ...
      return function (index) {
          ...
          var pos = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var $64 = canPutTile(state)(tilePos);
          if ($64) {
              var m = Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Ord.max(Data_Ord.ordInt))(0)(pos) + 1 | 0;
              return Data_Array.mapWithIndex(function (i) {
                  return function (x) {
                      var $65 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(i)(tilePos);
                      if ($65) {
                          return m;
                      };
                      return x;
          ...
          return Data_Functor.mapFlipped(Data_Functor.functorArray)(pos)(function (x) {
              var $66 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(x))(Data_Array.index(pos)(index));
              if ($66) {
                  return 0;
              };
              return x;
  ...
  var clickOnCellA = function (a) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          var $68 = Data_Array.length(sinks(v)) < Data_Lens_Getter.viewOn(v)(_nbSinks(Data_Lens_Internal_Forget.strongForget));
          if ($68) {
              return putSinkA(a);
          };
  ...
  var setTileA = function (ttype) {
      return Game_Core.newGame(tilingGame)((function () {
          ...
          var $96 = (function () {
              var $69 = Data_Eq.eq(eqTileType)(ttype)(CustomTile.value);
              if ($69) {
  ...
  var view = function (lens) {
      return function (state) {
          var tileCursor = function (pp) {
              return Pha_Html.g(UI_Template.svgCursorStyle(pp))([ Pha_Html.g([ Pha_Html["class'"]("tiling-cursor")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")("rotate(" + (Data_Show.show(Data_Show.showInt)(90 * Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)) | 0) + "deg)")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_tile"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
                  return Pha_Html.use(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(50.0 * Data_Int.toNumber(v.col) - 25.0)(50.0 * Data_Int.toNumber(v.row) - 25.0)(50.0)(50.0)("#tile2")([ Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none"), Pha_Html.attr(Pha_Html.unittoStr)("opacity")((function () {
                      var $35 = Game_Tiling_Model.inConflict(state);
                      if ($35) {
                          return "0.3";
                      };
                      return "0.8";
          ...
          var customDialog = function (v) {
              return UI_Template.dialog(function (dictStrong) {
                  return lens(dictStrong);
              })("Personnalise ta tuile")([ Pha_Html["div'"]([ Pha_Html["class'"]("tiling-customtile-grid-container")(true) ])([ Pha_Html["div'"]([ Pha_Html["class'"]("tiling-grid")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(250)(250) ])(Data_Array.mapWithIndex(function (index) {
                  return function (hasBlock) {
                      ...
                      return square({
                          ...
                          return lens(dictStrong);
                      })(Game_Tiling_Model.flipTileA(index))) ]);
                  };
              })(Data_Lens_Getter.viewOn(state)((function () {
                  var $48 = Game_Tiling_Model["_tile"](Data_Lens_Internal_Forget.strongForget);
                  var $49 = Game_Common["_isoCustom"](Data_Lens_Internal_Forget.profunctorForget);
                  return function ($50) {
                      return $48($49($50));
                  };
              })()))) ]) ]) ]);
          ...
          var config = UI_Template.card("Carrelage")([ UI_Icons.iconSizesGroup(Game_Tiling_Model.tilingGame)(function (dictStrong) {
              ...
              return lens(dictStrong);
          })(state)("Motif du pav\xe9")([ Game_Tiling_Model.Type1.value, Game_Tiling_Model.Type2.value, Game_Tiling_Model.Type3.value, Game_Tiling_Model.CustomTile.value ])(Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_tileType"](Data_Lens_Internal_Forget.strongForget)))(Game_Tiling_Model.setTileA)(function (t) {
              return function (v) {
                  return {
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              return lens(dictStrong);
          }))([ Pha_Html["class'"]("ui-board")(true), Pha_Html.contextmenu(Control_Apply.applySecond(Run.applyRun)(Game_Effs.preventDefault)(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Tiling_Model.rotateA))) ])))([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (index) {
              return function (pos) {
                  var v = Lib_Util.coords(columns)(index);
                  return square({
                      ...
                      return lens(dictStrong);
                  })(Game_Tiling_Model.clickOnCellA(index))), Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
                  })(Game_Tiling_Model.setHoverSquareA(new Data_Maybe.Just(index)))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
              ...
              var $47 = Data_Array.length(Game_Tiling_Model.sinks(state)) < Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_nbSinks"](Data_Lens_Internal_Forget.strongForget));
              if ($47) {
                  return sinkCursor;
              };
              return tileCursor;
...
(function($PS) {
      ...
      return Control_Bind.bind(Run.bindRun)(Game_Effs.getPointerPosition)(function (v1) {
          ...
          if (v2.value0 instanceof Data_Maybe.Just && v2.value1 instanceof Data_Maybe.Just) {
              return Pha_Action.setState(Data_Lens_Setter.set((function () {
                  var $38 = _positions(Data_Profunctor_Strong.strongFn);
                  var $39 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(v2.value0.value0.name)(Data_Profunctor_Strong.strongFn);
                  return function ($40) {
                      return $38($39($40));
                  };
              })())(new Data_Maybe.Just({
  ...
  var showHelpA = function (help) {
      return Pha_Action.action((function () {
          var $41 = Data_Lens_Setter.over(_help(Data_Profunctor_Strong.strongFn))((function () {
              var $37 = help === "";
              if ($37) {
                  return Control_Category.identity(Control_Category.categoryFn);
              };
          ...
          var $42 = Data_Lens_Setter.set(_helpVisible(Data_Profunctor_Strong.strongFn))(help !== "");
          return function ($43) {
              return $41($42($43));
          };
      })());
  };
  var _drag = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.drag;
      })(function (v) {
          return function (v1) {
  ...
  var setDragA = function (d) {
      return Pha_Action.setState(Data_Lens_Setter.set(_drag(Data_Profunctor_Strong.strongFn))(d));
  };
  exports["istate"] = istate;
...
(function($PS) {
  ...
  var valise = function (lens) {
      return function (state) {
                  ...
                  return function (y$prime) {
                      return function (w$prime) {
                          return function (h$prime) {
                              return function (props) {
                                  return function (children) {
                                      var defaultTranslate = Pha_Html.translate(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc(Data_Int.toNumber(x$prime) / 8.5))(Pha_Html.pc(Data_Int.toNumber(y$prime) / 6.9));
                                      return Pha_Html.g([ Pha_Html.style(Pha_Html.unittoStr)("transform")((function () {
                                          if (v.drag) {
                                              return Data_Maybe.maybe(defaultTranslate)(function (v1) {
                                                  return Pha_Html.translate(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc(100.0 * v1.x))(Pha_Html.pc(100.0 * v1.y));
                                              })(Data_Lens_Getter.viewOn(state)((function () {
                                                  var $27 = Game_Valise_Model["_positions"](Data_Lens_Internal_Forget.strongForget);
                                                  var $28 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(v.symbol)(Data_Lens_Internal_Forget.strongForget);
                                                  return function ($29) {
                                                      return $27($28($29));
                                                  };
                                              })()));
                                      ...
                                      })()) ])([ Pha_Html.g(props)([ Pha_Html.svg(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("valise-object ui-touch-action-none")(true), Pha_Html["class'"]("draggable")(v.drag), Pha_Html.width(Pha_Html.unitInt)(w$prime), Pha_Html.height(Pha_Html.unitInt)(h$prime), Pha_Html.pointerdown((function () {
                                          if (v.drag) {
                                              return Pha_Action.zoomAt(function (dictStrong) {
                                                  return lens(dictStrong);
                                              })(Game_Valise_Model.setDragA(new Data_Maybe.Just({
                                                  name: v.symbol,
                                          ...
                                          var $22 = Data_Maybe.isJust(v.link);
                                          if ($22) {
                                              return [  ];
                                          };
                                          return [ Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(Game_Valise_Model.showHelpA(v.help))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(Game_Valise_Model.showHelpA(""))) ];
                                          ...
                                          return Pha_Html.a([ Pha_Html.href("#" + l) ])([ Pha_Html.rect(Pha_Html.unittoStr)(Pha_Html.unittoStr)(Pha_Html.unittoStr)(Pha_Html.unittoStr)("0")("0")("100%")("100%")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("valise-object-link")(true), Pha_Html.fill("transparent"), Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(Game_Valise_Model.showHelpA(v.help))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(Game_Valise_Model.showHelpA(""))) ])(children)) ]);
                                      })) ]) ]) ]);
                                  };
                              };
                          };
          ...
          return Pha_Html.svg([ Pha_Html.viewBox(0)(0)(825)(690), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Valise_Model.moveObjectA)), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Valise_Model.setDragA(Data_Maybe.Nothing.value))) ])([ Pha.h("use")([ Pha_Html.href("#valise"), Pha_Html["class'"]("valise-close")(true), Pha_Html.width(Pha_Html.unittoStr)("100%"), Pha_Html.height(Pha_Html.unittoStr)("100%") ])([  ]), Pha_Html.g([ Pha_Html["class'"]("valise-open")(true) ])([ Pha.h("use")([ Pha_Html.href("#openvalise") ])([  ]), object({
              symbol: "switch",
...
(function($PS) {
  ...
  var cgame = new Game.CGame(Control_Applicative.pure(Effect.applicativeEffect), function (v) {
      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
  }, function (lens) {
      return function (v) {
          return Game_Valise_View.view(function (dictStrong) {
              var $8 = lens(dictStrong);
              var $9 = is(dictStrong.Profunctor0());
              return function ($10) {
                  return $8($9($10));
              };
          })(v);
...
(function($PS) {
  ...
  var hashChange = Control_Bind.bind(Run.bindRun)(Game_Effs.getLocation)(function (v) {
      ...
      var $101 = location === "valise" || location === "";
      if ($101) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(100))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v1) {
                      ...
                      return Pha_Action.zoomAt(function (dictStrong) {
                          var $122 = _valise(dictStrong);
                          var $123 = Game_Valise.is(dictStrong.Profunctor0());
                          return function ($124) {
                              return $122($123($124));
                          };
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.zoomAt(function (dictStrong) {
          var $125 = _valise(dictStrong);
          var $126 = Game_Valise.is(dictStrong.Profunctor0());
          return function ($127) {
              return $125($126($127));
          };
  ...
  var onKeyDown = Control_Bind.bind(Run.bindRun)(Pha_Action.getEvent)(function (v) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
          ...
          throw new Error("Failed pattern match at Main (line 135, column 5 - line 137, column 62): " + [ v2.constructor.name ]);
      });
  });
  ...
  var viewG = function (state) {
      return Pha_Html["div'"]([ Pha_Html.key(state.location), Pha_Html["class'"]("main-main-container")(true), Pha_Html["class'"]("valise")(state.location === "valise"), Pha_Html["class'"]("appear")(state.anim) ])([ Pha.ifN(state.location !== "valise")(function (v) {
          return Pha_Html.a([ Pha_Html["class'"]("main-minivalise-link")(true), Pha_Html.href("#valise") ])([ Pha_Html.svguse("#valise")([  ]) ]);
      }), viewGame(state) ]);
  };
  var main = function __do() {
      var v = Game_Effs.getLoc();
      var location = extractLocation(v.hash)("valise");
      var v1 = Game.init(Game_Baseball.cgame)(Game_Baseball.state)();
      var v2 = Game.init(Game_Chocolat.cgame)(Game_Chocolat.state)();
      var v3 = Game.init(Game_Dessin.cgame)(Game_Dessin.state)();
      var v4 = Game.init(Game_Frog.cgame)(Game_Frog.state)();
      var v5 = Game.init(Game_Jetons.cgame)(Game_Jetons.state)();
      var v6 = Game.init(Game_Labete.cgame)(Game_Labete.state)();
      var v7 = Game.init(Game_Nim.cgame)(Game_Nim.state)();
      var v8 = Game.init(Game_Noirblanc.cgame)(Game_Noirblanc.state)();
      var v9 = Game.init(Game_Paths.cgame)(Game_Paths.state)();
      var v10 = Game.init(Game_Queens.cgame)(Game_Queens.state)();
      var v11 = Game.init(Game_Roue.cgame)(Game_Roue.state)();
      var v12 = Game.init(Game_Solitaire.cgame)(Game_Solitaire.state)();
      var v13 = Game.init(Game_Tiling.cgame)(Game_Tiling.state)();
      var v14 = Game.init(Game_Valise.cgame)(Game_Valise.state)();
      var state = {
          baseball: v1,
          chocolat: v2,
          dessin: v3,
