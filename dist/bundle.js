...
(function($PS) {
  ...
  var ReleasePointerCapture = (function () {
      function ReleasePointerCapture(value0) {
          this.value0 = value0;
      };
      ReleasePointerCapture.create = function (value0) {
          return new ReleasePointerCapture(value0);
      };
      ...
      return Data_Functor_Variant.match()()()({
          ...
          rng: function (v) {
              if (v instanceof Pha_Random.RngInt) {
                  return function __do() {
                      var r = $foreign.genNumber();
                      return v.value1(Data_Int.floor(r * Data_Int.toNumber(v.value0)))();
                  };
              };
              if (v instanceof Pha_Random.RngNumber) {
                  return Control_Bind.bind(Effect.bindEffect)($foreign.genNumber)(v.value0);
              };
              throw new Error("Failed pattern match at Game.Effs (line 64, column 10 - line 66, column 49): " + [ v.constructor.name ]);
          },
          event: function (v) {
              return v.value0(ev);
          },
          ...
          eventEff: function (v) {
              if (v instanceof PreventDefault) {
                  return Control_Apply.applySecond(Effect.applyEffect)(Pha_Event.preventDefault(ev))(v.value0);
              };
              if (v instanceof ReleasePointerCapture) {
                  return Control_Apply.applySecond(Effect.applyEffect)($foreign.releasePointerCaptureAux(ev))(v.value0);
              };
              throw new Error("Failed pattern match at Game.Effs (line 70, column 15 - line 72, column 78): " + [ v.constructor.name ]);
          }
      });
  };
  ...
  var functorEvEff = new Data_Functor.Functor(function (f) {
      return function (m) {
          if (m instanceof PreventDefault) {
              return new PreventDefault(f(m.value0));
          };
          if (m instanceof ReleasePointerCapture) {
              return new ReleasePointerCapture(f(m.value0));
          };
          throw new Error("Failed pattern match at Game.Effs (line 39, column 1 - line 39, column 49): " + [ m.constructor.name ]);
      };
  });
  var preventDefault = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "eventEff";
  }))(functorEvEff)(Data_Symbol.SProxy.value)(new PreventDefault(Data_Unit.unit));
  var releasePointerCapture = Run.lift()(new Data_Symbol.IsSymbol(function () {
      return "eventEff";
  }))(functorEvEff)(Data_Symbol.SProxy.value)(new ReleasePointerCapture(Data_Unit.unit));
  ...
  var view = function (state) {
      ...
      var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(0)(0)(100)(100) ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
          return function (pile) {
              return Data_Array.concat([ [ Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)((function () {
                  var $2 = length === 5;
                  if ($2) {
                      return 25.0;
                  };
                  ...
                  return 100.0;
              })())(10.0)([ Pha_Html.key("pile" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.fill("snow") ]) ], Lib_Util.tabulate(length)(function (j) {
