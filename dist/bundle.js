...
(function($PS) {
  ...
  var shuffle = function (array) {
      return Control_Bind.bind(bindRandom)(Data_Traversable.sequence(Data_Traversable.traversableArray)(applicativeRandom)(Data_Array.mapWithIndex(function (i) {
          ...
          return Control_Applicative.pure(applicativeRandom)(Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v1) {
              return function (t) {
                  return Data_Maybe.fromMaybe(t)(Data_Array.insertAt(v1.value1)(v1.value0)(t));
              };
          })([  ])(v));
      });
  };
