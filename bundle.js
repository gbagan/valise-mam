...
(function($PS) {
  ...
  var frogGame = new Lib_Game.Game(function (state) {
      ...
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Optic_Setter.set(_winning(Data_Identity.functorIdentity))(winningPositions(Optic_Getter.weiv(state)(Lib_Game["_nbRows"](Data_Const.functorConst)) + 1 | 0)(Optic_Getter.weiv(state)(_moves(Data_Const.functorConst))))(state));
  }, function (state) {
      return function (v) {
          return v;
      };
  ...
  var selectMove = (function () {
      ...
      return Lib_Game["newGame'"](frogGame)((function () {
          var $30 = Optic_Setter.over(Data_Profunctor.profunctorFn)(_moves(Data_Identity.functorIdentity));
          return function ($31) {
              return $30(_selectMove($31));
          };
      })());
  })();
  exports["Ext"] = Ext;
...
(function($PS) {
  ...
  var icons2Players = function (lens) {
      return function (state) {
          return UI_Icon.icongroup("Mode de jeu")([ iconbutton(state)(function (v) {
              ...
              return lens(dictFunctor);
          })(Pha.action(Optic_Setter.set(Lib_Game["_mode"](Data_Identity.functorIdentity))(Lib_Game.RandomMode.value)))) ]), iconbutton(state)(function (v) {
              return {
              ...
              return lens(dictFunctor);
          })(Pha.action(Optic_Setter.set(Lib_Game["_mode"](Data_Identity.functorIdentity))(Lib_Game.ExpertMode.value)))) ]), iconbutton(state)(function (v) {
              return {
  ...
  var iconSelectGroupM = function (dictShow) {
      return function (dictEq) {
          return function (dictLensAction) {
                              ...
                              return function (selected) {
                                  return function (action) {
                                      return UI_Icon.icongroup(title)(Data_Functor.mapFlipped(Data_Functor.functorArray)(values)(function (val) {
                                          ...
                                          })([ Pha_Html.click(Lib_Game["_lensaction"](dictLensAction)(function (dictFunctor) {
                                              return lens(dictFunctor);
                                          })(action(val))) ]);
                                      }));
                                  };
      ...
      return function (lens) {
          return function (state) {
              ...
              return UI_IncDecGrid.incDecGrid({
                  ...
                  onResize: function (x) {
                      return function (y) {
                          return Lib_Game["_lensaction"](Lib_Game.lensactionrnd)(function (dictFunctor) {
                              return lens(dictFunctor);
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board frog-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("-190 -200 400 400"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.path(spiralPath)([ Pha_Html.fill("none"), Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(153.0)(9.0)(207.0)(20.0)([ Pha_Html.stroke("black"), Pha_Html.strokeDasharray("5"), Pha_Html.strokeWidth("6") ]), Pha_Html.line(153.0)(7.0)(153.0)(39.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(207.0)(18.0)(207.0)(50.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (i) {
              return function (v) {
                  return Pha_Html.g([ Pha_Html.key("lily" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.click(Pha.lensAction(function (dictFunctor) {
                      return lens(dictFunctor);
                  })(Lib_Game["_play'"](Game_Frog_Model.frogGame)(i))) ])([ lily(i)(v.x)(v.y)(false)(false), lily(i)(v.x)(v.y)(true)(Data_Maybe.maybe(true)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array.index(reachable)(i))), Pha_Html["text'"](v.x)(v.y)(Data_Show.show(Data_Show.showInt)(Optic_Getter.weiv(state)(Lib_Game["_nbRows"](Data_Const.functorConst)) - i | 0))([ Pha_Html["class'"]("frog-index")(true) ]) ]);
              };
          })(spiralPoints(Optic_Getter.weiv(state)(Lib_Game["_nbRows"](Data_Const.functorConst)))))([ (function () {
              ...
              var $31 = Optic_Getter.weiv(state)(Lib_Game["_turn"](Data_Const.functorConst)) === 0;
              if ($31) {
                  return "Tour du premier joueur";
              };
              var $32 = Data_Eq.eq(Lib_Game.eqMode)(Optic_Getter.weiv(state)(Lib_Game["_mode"](Data_Const.functorConst)))(Lib_Game.DuelMode.value);
              if ($32) {
                  return "Tour du second joueur";
              };
              return "Tour de l'IA";
          })()) ]) ]);
          var config = UI_Dialog.card("La grenouille")([ UI_Icons.iconSelectGroupM(Data_Show.showInt)(Data_Eq.eqInt)(Lib_Game.lensactionrnd)(function (dictFunctor) {
              return lens(dictFunctor);
...
(function($PS) {
  ...
  var main = function __do() {
      var v = Lib_Random.runRnd(Lib_Game.init(Game_Baseball_Model.baseballGame)(Game_Baseball_Model.baseballState))();
      var v1 = Lib_Random.runRnd(Lib_Game.init(Game_Nim_Model.nimGame)(Game_Nim_Model.nimState))();
      var v2 = Lib_Random.runRnd(Lib_Game.init(Game_Frog_Model.frogGame)(Game_Frog_Model.frogState))();
      var state = {
          baseball: Game_Baseball_Model.baseballState,
          nim: v1,
          frog: v2
      };
      return Pha.app({
