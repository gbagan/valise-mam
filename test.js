...
(function($PS) {
      ...
      return Data_Maybe.fromMaybe(new St(v.value0))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(v.value0.history))(function (v1) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new St((function () {
              ...
              for (var $23 in v.value0) {
                  if ({}.hasOwnProperty.call(v.value0, $23)) {
                      $22[$23] = v["value0"][$23];
                  };
              };
              $22.position = Data_Array_NonEmpty.last(v1);
              $22.history = Data_Array_NonEmpty.init(v1);
              $22.redoHistory = Data_Array.snoc(v.value0.redoHistory)(v.value0.position);
              return $22;
          })()));
      }));
  };
      ...
      return Data_Maybe.fromMaybe(new St(v.value0))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(v.value0.history))(function (v1) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new St((function () {
              ...
              for (var $29 in v.value0) {
                  if ({}.hasOwnProperty.call(v.value0, $29)) {
                      $28[$29] = v["value0"][$29];
                  };
              };
              $28.position = Data_Array_NonEmpty.head(v1);
              $28.history = [  ];
              $28.redoHistory = [  ];
              return $28;
          })()));
      ...
      return Data_Maybe.fromMaybe(new St(v.value0))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(v.value0.redoHistory))(function (v1) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new St((function () {
              ...
              for (var $35 in v.value0) {
                  if ({}.hasOwnProperty.call(v.value0, $35)) {
                      $34[$35] = v["value0"][$35];
                  };
              };
              $34.position = Data_Array_NonEmpty.last(v1);
              $34.redoHistory = Data_Array_NonEmpty.init(v1);
              $34.history = Data_Array.snoc(v.value0.history)(v.value0.position);
              return $34;
          })()));
      }));
  };
              ...
              return function (state) {
                  ...
                  return new St((function () {
                      ...
                      for (var $45 in v.value0) {
                          if ({}.hasOwnProperty.call(v.value0, $45)) {
                              $44[$45] = v["value0"][$45];
                          };
                      };
                      $44.position = initialPosition(dictGame)(v);
                      return $44;
                  })());
              };
          };
  ...
  var _play = function (dictGame) {
      return function (v) {
          return function (v1) {
              var $50 = canPlay(dictGame)(v1)(v.move);
              if ($50) {
                  return new St((function () {
                      var $51 = {};
                      for (var $52 in v1.value0) {
                          if ({}.hasOwnProperty.call(v1.value0, $52)) {
                              $51[$52] = v1["value0"][$52];
                          };
                      };
                      $51.position = play(dictGame)(v1)(v.move);
                      $51.history = Data_Array.snoc(v1.value0.history)(v1.value0.position);
                      $51.redoHistory = [  ];
                      return $51;
                  })());
              };
...
(function($PS) {
  ...
  var example = new Lib_Game.St({
      ...
      history: [  ],
      redoHistory: [  ],
      newState: Data_Maybe.Nothing.value
  });
  var baseballGame = new Lib_Game.Game(function (v) {
      ...
      return Data_Array.range(0)((2 * v.value0.nbBases | 0) - 1 | 0);
  }, function (v) {
      ...
      return function (i) {
          return swap(0)(i)(v.value0.position);
      };
  });
      ...
      return function (lens) {
          return function (v) {
              return iconbutton(dictGame)(new Lib_Game.St(v.value0))(function (v1) {
                  return {
                      icon: new UI_Icon.IconSymbol("#redo"),
              ...
              })([ Pha_Html.click(Optic_Setter.over(Data_Profunctor.profunctorFn)(lens(Data_Identity.functorIdentity))(Lib_Game.redo)) ]);
          };
      };
  };
  var ireset = function (dictGame) {
      return function (lens) {
          return function (v) {
              ...
              })([ Pha_Html.click(Optic_Setter.over(Data_Profunctor.profunctorFn)(lens(Data_Identity.functorIdentity))(Lib_Game.reset)) ]);
          };
      };
  };
  var iundo = function (dictGame) {
      return function (lens) {
          return function (v) {
              ...
              })([ Pha_Html.click(Optic_Setter.over(Data_Profunctor.profunctorFn)(lens(Data_Identity.functorIdentity))(Lib_Game.undo)) ]);
          };
      };
  };
  exports["iconbutton"] = iconbutton;
...
(function($PS) {
  ...
  var repeat = function (n) {
      return function (f) {
          return Data_Functor.map(Data_Functor.functorArray)(f)(Data_Array.range(0)(n - 1 | 0));
      };
  };
  ...
  var view = function (lens) {
      return function (v) {
          ...
          var config = UI_Dialog.card("Baseball multicolore")([ UI_Icon.icongroup("nombres de bases")(Data_Functor.map(Data_Functor.functorArray)(function (i) {
              ...
              })([ Pha_Html.click(Optic_Setter.over(Data_Profunctor.profunctorFn)(lens(Data_Identity.functorIdentity))(Game_Baseball_Model.setNbBases(i))) ]);
          ...
          })(v), UI_Icons.iredo(Game_Baseball_Model.baseballGame)(function (dictFunctor) {
              return lens(dictFunctor);
          })(v), UI_Icons.ireset(Game_Baseball_Model.baseballGame)(function (dictFunctor) {
              return lens(dictFunctor);
          })(v) ]) ]);
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board baseball-board")(true) ])([ Pha_Html.svg([ Pha_Html.width("100%"), Pha_Html.height("100%"), Pha_Html.viewBox("0 0 1000 1000") ])(Data_Array.concat([ repeat(v.value0.nbBases)(function (i) {
              ...
              return function (position) {
                  ...
                  return Pha_Html.g([ Pha_Html["class'"]("baseball-player")(true), Pha_Html.style("transform")(translatePlayer(position)(v.value0.nbBases)), Pha_Html.key("p" + Data_Show.show(Data_Show.showInt)(player)) ])([ Pha_Html.use([ Pha_Html.href("#meeple"), Pha_Html.click(Optic_Setter.over(Data_Profunctor.profunctorFn)(lens(Data_Identity.functorIdentity))(Lib_Game["_play'"](Game_Baseball_Model.baseballGame)(player))), Pha_Html.width("70"), Pha_Html.height("70"), Pha_Html.fill(Data_Maybe.fromMaybe("black")(Data_Array.index(colors)(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(player)(2)))), Pha_Html.style("animation")((function () {
                      ...
                      var $9 = Lib_Game.canPlay(Game_Baseball_Model.baseballGame)(v)(player);
                      if ($9) {
                          return "pointer";
                      };
                      return "not-allowed";
          ...
          return Pha_Html["div'"]([  ])([ Pha_Html["div'"]([ Pha_Html["class'"]("main-container")(true) ])([ Pha_Html["div'"]([  ])([ board ]), config ]) ]);
      };
  };
...
(function($PS) {
  ...
  var mylens = function (dictFunctor) {
      return Optic_Lens.lens(function (x) {
          return x;
      })(function (x) {
          return function (a) {
              return a;
  ...
  var main = Pha.app({
      init: function (x) {
          return Game_Baseball_Model.example;
      },
      view: Game_Baseball_View.view(function (dictFunctor) {
