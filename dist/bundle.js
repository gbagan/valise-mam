...
(function($PS) {
      ...
      if (v instanceof OnKeyDown) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (st) {
              return callByName(st.location)(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(function (game) {
                  ...
                  throw new Error("Failed pattern match at Main (line 174, column 13 - line 176, column 52): " + [ v1.constructor.name ]);
              });
          });
      };
  ...
  var main = Pha_App.attachTo("root")(Pha_App.app({
      ...
      view: view,
      update: update,
      subscriptions: Data_Function["const"]([ Pha_Subs.onKeyDown(function ($115) {
          return Data_Maybe.Just.create(OnKeyDown.create($115));
