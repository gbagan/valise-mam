...
(function($PS) {
  ...
  var toggleHelp = Data_Lens_Setter.over(_help(Data_Profunctor_Strong.strongFn))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean));
  var _history = function (dictStrong) {
      var $102 = _core(dictStrong);
          ...
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      ...
                      var $79 = Data_Array["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget)));
                      if ($79) {
      ...
      return function (nbRows) {
          return function (nbColumns) {
              var setCustomSize$prime = function (state) {
                  ...
                  var $82 = nbRows >= v.value0 && (nbRows <= v.value2 && (nbColumns >= v.value1 && nbColumns <= v.value3));
                  if ($82) {
  ...
  var showVictory = function (setState) {
      return function (state) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(Data_Lens_Setter.set(_showWin(Data_Profunctor_Strong.strongFn))(true)(state))))(function () {
  ...
  var _play = function (dictGame) {
      return function (move) {
          return function (state) {
              var $87 = canPlay(dictGame)(state)(move);
              if ($87) {
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $88 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($88) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $89 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($89) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $129 = isLosingPosition(dictTwoPlayersGame);
                      var $130 = Data_Function.flip(_play(dictTwoPlayersGame.Game0()))(state);
                      return function ($131) {
                          return $129($130($131));
                      };
  ...
  var computerPlay = function (dictGame) {
      return function (setState) {
          return function (state) {
              return Data_Function.flip(Data_Maybe.maybe(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit)))(computerMove(dictGame)(state))(function (rndmove) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Lib_Random.runRnd(rndmove)))(function (v) {
                      var st2 = _play(dictGame)(v)(state);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(st2)))(function () {
                          var $91 = isLevelFinished(dictGame)(st2);
                          if ($91) {
  ...
  var computerStarts = function (dictGame) {
      return function (setState) {
          return function (v) {
              return function (state) {
                  return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff((function () {
                      var st2 = pushToHistory(state);
                      return computerPlay(dictGame)(setState)(st2);
                  })()));
              };
          };
      };
      ...
      return function (move) {
          return function (setState) {
              return function (v) {
                  return function (state) {
                      return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff((function () {
                          var $92 = !canPlay(dictGame)(state)(move);
                          if ($92) {
                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
                          };
                          var st2 = _play(dictGame)(move)(pushToHistory(state));
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(st2)))(function () {
                              var $93 = isLevelFinished(dictGame)(st2);
                              if ($93) {
                                  return showVictory(setState)(st2);
                              };
                              var $94 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value);
                              if ($94) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                                      return computerPlay(dictGame)(setState)(st2);
                                  });
  ...
  var changeTurn = function (state) {
      var $95 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
      if ($95) {
                  ...
                  return function (ev) {
                      return function (st) {
                          return v(function (st$prime) {
                              return setState(Data_Lens_Setter.set(lens(Data_Profunctor_Strong.strongFn))(st$prime)(st));
                          })(ev)(Data_Lens_Getter.viewOn(st)(lens(Data_Lens_Internal_Forget.strongForget)));
                      };
                  };
              };
          };
...
(function($PS) {
  ...
  var icons2Players = function (dictGame) {
      return function (lens) {
          return function (state) {
              return UI_Icon.icongroup("Mode de jeu")([ iconbutton(state)(function (v) {
              ...
              })([ Pha_Html.click(Pha.lensAction(Pha.lensactionrnd)(function (dictStrong) {
                  return lens(dictStrong);
              })(Game_Core.setMode(dictGame)(Game_Core.RandomMode.value))) ]), iconbutton(state)(function (v) {
                  return {
                  ...
                  return lens(dictStrong);
              })(Game_Core.setMode(dictGame)(Game_Core.ExpertMode.value))) ]), iconbutton(state)(function (v) {
                  return {
                  ...
                  return lens(dictStrong);
              })(Game_Core.setMode(dictGame)(Game_Core.DuelMode.value))) ]), iconbutton(state)(function (v) {
                  return {
              ...
              })([ Pha_Html.click(Pha.lensAction(Pha.lensactionId)(function (dictStrong) {
                  return lens(dictStrong);
              })(Game_Core.computerStarts(dictGame))) ]) ]);
          };
      };
  };
  var ihelp = function (lens) {
      return function (state) {
          ...
          })([ Pha_Html.click(Pha.lensAction(Pha.lensactionState)(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Core.toggleHelp)) ]);
      };
  };
  var iredo = function (lens) {
      return function (state) {
          return iconbutton(state)(function (v) {
              ...
              return lens(dictStrong);
          })(Game_Core.redo)), Pha_Html.style("transform")("scaleX(-1)") ]);
      };
  };
  ...
  var irules = function (lens) {
      return function (state) {
          ...
          return iconbutton(state)(function (v) {
              ...
              return lens(dictStrong);
          })(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.Rules.value))) ]);
      };
  };
                              ...
                              return function (selected) {
                                  return function (action) {
                                      return UI_Icon.icongroup(title)(Data_Functor.mapFlipped(Data_Functor.functorArray)(values)(function (val) {
                                          ...
                                          })([ Pha_Html.click(Pha.lensAction(dictClsAction)(function (dictStrong) {
                                              return lens(dictStrong);
                                          })(action(val))) ]);
                                      }));
                                  };
                  ...
                  var dialog$prime = function (v) {
                      if (v instanceof Game_Core.Rules) {
                          return UI_Dialog.dialog({
                              ...
                              onOk: new Data_Maybe.Just(Pha.lensAction(Pha.lensactionState)(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.NoDialog.value)))
                          })(elements.rules);
                      };
                      if (v instanceof Game_Core.ConfirmNewGame) {
                          return UI_Dialog.dialog({
                              title: "Nouvelle partie",
                              onCancel: new Data_Maybe.Just(Pha.lensAction(Pha.lensactionState)(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.NoDialog.value))),
                              onOk: new Data_Maybe.Just(Pha.lensAction(Pha.lensactionState)(function (dictStrong) {
                                  return lens(dictStrong);
                              })(Game_Core.confirmNewGame(v.value0)))
      ...
      return function (lens) {
          return function (state) {
              ...
              return UI_IncDecGrid.incDecGrid({
                  ...
                  onResize: function (x) {
                      return function (y) {
                          return Pha.lensAction(Pha.lensactionrnd)(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game_Core.setCustomSize(dictGame)(x)(y));
                      };
                  }
              });
          };
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Baseball multicolore")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(Pha.lensactionrnd)(function (dictStrong) {
              return lens(dictStrong);
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board baseball-board")(true) ])([ Pha_Html.svg([ Pha_Html.width("100%"), Pha_Html.height("100%"), Pha_Html.viewBox("0 0 100 100") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (i) {
              ...
              return function (pos) {
                  return function (color) {
                      ...
                      return Pha_Html.g([ Pha_Html["class'"]("baseball-player")(true), Pha_Html.style("transform")(translatePeg(pos)(nbBases)), Pha_Html.key("p" + Data_Show.show(Data_Show.showInt)(peg)) ])([ Pha_Html.use(0.0)(0.0)(7.0)(7.0)("#meeple")([ Pha_Html.click(Pha.lensAction(Pha.lensactionId)(function (dictStrong) {
                          return lens(dictStrong);
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board frog-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("-190 -200 400 400"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.path(spiralPath)([ Pha_Html.fill("none"), Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(153.0)(9.0)(207.0)(20.0)([ Pha_Html.stroke("black"), Pha_Html.strokeDasharray("5"), Pha_Html.strokeWidth("6") ]), Pha_Html.line(153.0)(7.0)(153.0)(39.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(207.0)(18.0)(207.0)(50.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Core.map2(spoints)(reachable)(function (i) {
              return function (v) {
                  return function (reach) {
                      return Pha_Html.g([ Pha_Html.key("lily" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.click(Pha.lensAction(Pha.lensactionId)(function (dictStrong) {
                          return lens(dictStrong);
                      })(Pha.ifThenElseA(Pha.lensactionState)(Pha.lensactionId)(Pha_Event.shift)(Game_Frog_Model.mark(i))(Game_Core.playA(Game_Frog_Model.frogGame)(i)))) ])([ lily(i)(v.x)(v.y)(false)(false), lily(i)(v.x)(v.y)(true)(!reach), Pha_Html["text'"](v.x)(v.y)((function () {
          ...
          var config = UI_Dialog.card("La grenouille")([ UI_Icons.iconSelectGroupM(Data_Show.showInt)(Data_Eq.eqInt)(Pha.lensactionrnd)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("D\xe9placements autoris\xe9s")([ 1, 2, 3, 4, 5 ])(Data_Lens_Getter.viewOn(state)(Game_Frog_Model["_moves"](Data_Lens_Internal_Forget.strongForget)))(Game_Frog_Model.selectMove), UI_Icons.icons2Players(Game_Frog_Model.frogGame)(function (dictStrong) {
              return lens(dictStrong);
...
(function($PS) {
  ...
  var setLength = Game_Core["newGame'"](nimGame)(Data_Lens_Setter.set(_length(Data_Profunctor_Strong.strongFn)));
  var setNbPiles = Game_Core["newGame'"](nimGame)(Data_Lens_Setter.set(_nbPiles(Data_Profunctor_Strong.strongFn)));
  exports["Move"] = Move;
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Poker Nim")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(Pha.lensactionrnd)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Nombre de rang\xe9es")([ 1, 2, 3, 4, 5 ])(function (v) {
              return Control_Category.identity(Control_Category.categoryFn);
          })(nbPiles)(Game_Nim_Model.setNbPiles), UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(Pha.lensactionrnd)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Taille des rang\xe9es")([ 10, 5 ])(function (v) {
              return Control_Category.identity(Control_Category.categoryFn);
          })(length)(Game_Nim_Model.setLength), UI_Icons.icons2Players(Game_Nim_Model.nimGame)(function (dictStrong) {
              return lens(dictStrong);
          ...
          var board = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("0 0 100 100"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
              return function (pile) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.rect((function () {
                      ...
                      return Pha_Html.rect(-2.5)(-2.5)(5.0)(5.0)([ Pha_Html.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html.fill("gray"), Pha_Html.click(Pha.lensAction(Pha.lensactionId)(function (dictStrong) {
                          return lens(dictStrong);
...
(function($PS) {
  ...
  var selectLevel = Game_Core["newGame'"](noirblancGame)(Data_Lens_Setter.set(_level(Data_Profunctor_Strong.strongFn)));
  var selectMode = Game_Core["newGame'"](noirblancGame)(function (mode) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = UI_Dialog.card("Tout noir tout blanc")([ (function () {
              ...
              return UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(Pha.lensactionrnd)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)("Mode jeu")([ 0, 1, 2, 3 ])(fn)(Data_Lens_Getter.viewOn(state)(Game_Noirblanc_Model["_mode2"](Data_Lens_Internal_Forget.strongForget)))(Game_Noirblanc_Model.selectMode);
          })(), (function () {
              var fn = function (i) {
                  return function (opt) {
                      return levels(i)(opt);
              ...
              return UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(Pha.lensactionrnd)(function (dictStrong) {
                  return lens(dictStrong);
              })(state)("Difficult\xe9")([ 0, 1, 2, 3, 4, 5, 6 ])(fn)(Data_Lens_Getter.viewOn(state)(Game_Noirblanc_Model["_mode2"](Data_Lens_Internal_Forget.strongForget)))(Game_Noirblanc_Model.selectLevel);
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])((function () {
              if (isCircleBoard) {
