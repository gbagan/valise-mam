...
(function($PS) {
      ...
      if (v instanceof OnKeyDown) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v1) {
              return callByName(v1.location)(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(function (game) {
                  var v2 = game.core.onKeydown(v.value0);
                  if (v2 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                  };
                  if (v2 instanceof Data_Maybe.Just) {
                      return update(game.msgmap(v2.value0));
                  };
                  throw new Error("Failed pattern match at Main (line 174, column 13 - line 176, column 52): " + [ v2.constructor.name ]);
              });
          });
      };
  ...
  var init = Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Data_Foldable.for_(Run.applicativeRun)(Data_List_Types.foldableList)(Data_Map_Internal.values(games))(gameRun(function (game) {
      ...
      throw new Error("Failed pattern match at Main (line 182, column 25 - line 184, column 60): " + [ game.core.init.constructor.name ]);
  })))(function () {
      return hashChange;
  });
  ...
  var main = Pha_App.attachTo("root")(Pha_App.app({
      ...
      view: view,
      update: update,
      subscriptions: Data_Function["const"]([ Pha_Subs.onKeyDown(function ($119) {
          return Data_Maybe.Just.create(OnKeyDown.create($119));
