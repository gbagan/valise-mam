...
(function($PS) {
  ...
  var toggleGuard = function (x) {
      return function (l) {
          var $61 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(x)(l);
          if ($61) {
          ...
          return function (to) {
              return function (srcs) {
                  return function (dests) {
                      if (Data_Foldable.elem(Data_Foldable.foldableArray)(eqEdge)(new Edge(from, to))(edges)) {
                          var v = Data_Array.elemIndex(Data_Eq.eqInt)(from)(srcs);
                          if (v instanceof Data_Maybe.Nothing) {
                              return Debug_Trace.spy()("1")(dests);
                          };
                          if (v instanceof Data_Maybe.Just) {
                              return Debug_Trace.spy()("2")(Data_Lens_Setter.set(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(to)(dests));
                          };
                          throw new Error("Failed pattern match at Game.Eternal.Model (line 165, column 9 - line 167, column 51): " + [ v.constructor.name ]);
                      };
                      if (Data_Boolean.otherwise) {
                          return Debug_Trace.spy()("3")(dests);
                      };
                      throw new Error("Failed pattern match at Game.Eternal.Model (line 162, column 1 - line 162, column 75): " + [ edges.constructor.name, from.constructor.name, to.constructor.name, srcs.constructor.name, dests.constructor.name ]);
                  };
              };
          };
      };
  ...
  var _ext$prime = function (dictStrong) {
      var $116 = Game_Core["_ext"](dictStrong);
      var $117 = Data_Lens_Iso.iso(function (v) {
          return v;
      })(Ext)(dictStrong.Profunctor0());
      return function ($118) {
          return $116($117($118));
  ...
  var isValidNextMove = function (st) {
      return function (dests) {
          ...
          throw new Error("Failed pattern match at Game.Eternal.Model (line 98, column 5 - line 106, column 82): " + [ v.constructor.name ]);
      };
  };
  var _graphkind = function (dictStrong) {
      var $122 = _ext$prime(dictStrong);
  ...
  var dragGuard = function (to) {
      return function (st) {
          ...
          throw new Error("Failed pattern match at Game.Eternal.Model (line 172, column 5 - line 176, column 123): " + [ v.constructor.name ]);
      };
  };
  var game = new Game_Core.Game(function (v) {
      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Maybe.Nothing.value);
      ...
      throw new Error("Failed pattern match at Game.Eternal.Model (line 148, column 9 - line 151, column 72): " + [ v.constructor.name ]);
  }, function (state) {
      ...
      throw new Error("Failed pattern match at Game.Eternal.Model (line 140, column 9 - line 142, column 69): " + [ v.constructor.name ]);
  }, function (state) {
      return function (v) {
          if (v instanceof Defense) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  var $95 = isValidNextMove(state)(v.value0);
                  if ($95) {
                      return new Data_Maybe.Just({
                          attacked: Data_Maybe.Nothing.value,
                          guards: v.value0
          ...
          if (v instanceof Attack) {
              var $98 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(v.value0)((Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))).guards) || Data_Maybe.isJust((Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))).attacked);
              if ($98) {
                  return Data_Maybe.Nothing.value;
              };
          ...
          throw new Error("Failed pattern match at Game.Eternal.Model (line 116, column 1 - line 156, column 31): " + [ state.constructor.name, v.constructor.name ]);
      };
  ...
  var update = function (v) {
      ...
      if (v instanceof StartGame) {
          return Pha_Update.purely(function (st) {
              return Data_Lens_Setter.set(_nextmove(Data_Profunctor_Strong.strongFn))((Data_Lens_Getter.viewOn(st)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))).guards)(Data_Lens_Setter.set(_phase(Data_Profunctor_Strong.strongFn))(GamePhase.value)(st));
          });
      };
          ...
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (st) {
              ...
              if (v1.value0 instanceof PrepPhase) {
                  return Pha_Update.purely(Data_Lens_Setter.over((function () {
                      var $137 = Game_Core["_position"](Data_Profunctor_Strong.strongFn);
                      var $138 = _guards(Data_Profunctor_Strong.strongFn);
                      return function ($139) {
                          return $137($138($139));
                      };
              ...
              throw new Error("Failed pattern match at Game.Eternal.Model (line 199, column 5 - line 202, column 49): " + [ v1.constructor.name ]);
          });
      };
      throw new Error("Failed pattern match at Game.Eternal.Model (line 184, column 1 - line 184, column 33): " + [ v.constructor.name ]);
  };
  exports["Edge"] = Edge;
  exports["Path"] = Path;
  exports["Cycle"] = Cycle;
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var config = UI_Template.card("Domination \xe9ternelle")([ UI_Icons.iconSelectGroup(UI_Icons.defa)(Game_Eternal_Model.eqgkind)(state)("Type de graphe")([ Game_Eternal_Model.Path.value, Game_Eternal_Model.Cycle.value ])(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_graphkind"](Data_Lens_Internal_Forget.strongForget)))(Game_Eternal_Model.SetGraphKind.create)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Eternal.View (line 80, column 100 - line 82, column 72): " + [ v.constructor.name ]);
          ...
          throw new Error("Failed pattern match at Game.Eternal.View (line 84, column 84 - line 86, column 88): " + [ v.constructor.name ]);
