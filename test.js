  ...
  var _play = function (dictGame) {
      return function (v) {
          return function (state) {
              var $93 = canPlay(dictGame)(state)(v.move);
              if ($93) {
                  var position = Optic_Getter.weiv(state)(_position(Data_Const.functorConst));
                  var state2 = Optic_Setter.over(Data_Profunctor.profunctorFn)(_turn(Data_Identity.functorIdentity))(function (v1) {
                      return 1 - v1 | 0;
                  })(Optic_Setter.set(_redoHistory(Data_Identity.functorIdentity))([  ])(Optic_Setter.over(Data_Profunctor.profunctorFn)(_history(Data_Identity.functorIdentity))(Data_Function.flip(Data_Array.snoc)(position))(Optic_Setter.set(_position(Data_Identity.functorIdentity))(play(dictGame)(state)(v.move))(state))));
          ...
          return function (setState) {
              return function (state) {
                  return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff((function () {
                      var st2 = _play(dictGame)({
                          move: move,
                          pushToHistory: true
                      })(state);
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(st2)))(function (v) {
                          var $96 = isLevelFinished(dictGame)(st2);
                          if ($96) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(Optic_Setter.set(_showWin(Data_Identity.functorIdentity))(true)(st2))))(function (v1) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(st2)))(function (v2) {
  ...
  var redo = function (state) {
      return Data_Maybe.fromMaybe(state)((function () {
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(Optic_Getter.weiv(state)(_redoHistory(Data_Const.functorConst))))(function (v) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(changeTurn(Optic_Setter.set(_position(Data_Identity.functorIdentity))(Data_Array_NonEmpty.last(v))(Optic_Setter.set(_redoHistory(Data_Identity.functorIdentity))(Data_Array_NonEmpty.init(v))(Optic_Setter.over(Data_Profunctor.profunctorFn)(_history(Data_Identity.functorIdentity))(Data_Function.flip(Data_Array.snoc)(position))(state)))));
          });
      })());
  };
  ...
  var undo = function (state) {
      return Data_Maybe.fromMaybe(state)((function () {
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(Optic_Getter.weiv(state)(_history(Data_Const.functorConst))))(function (v) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(changeTurn(Optic_Setter.set(_position(Data_Identity.functorIdentity))(Data_Array_NonEmpty.last(v))(Optic_Setter.set(_history(Data_Identity.functorIdentity))(Data_Array_NonEmpty.init(v))(Optic_Setter.over(Data_Profunctor.profunctorFn)(_redoHistory(Data_Identity.functorIdentity))(Data_Function.flip(Data_Array.snoc)(position))(state)))));
          });
      })());
  };
      ...
      return function (f) {
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(state2))(function (v) {
                  ...
                  var $107 = Data_Array["null"](Optic_Getter.weiv(state2)(_history(Data_Const.functorConst)));
                  if ($107) {
...
(function($PS) {
  // Generated by purs version 0.13.2
  "use strict";
  $PS["Lib.TwoPlayersGame"] = $PS["Lib.TwoPlayersGame"] || {};
  var exports = $PS["Lib.TwoPlayersGame"];
  var Data_Array_NonEmpty = $PS["Data.Array.NonEmpty"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Lib_Random = $PS["Lib.Random"];                
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $1 = isLosingPosition(dictTwoPlayersGame)(state);
          if ($1) {
              return Data_Maybe.Nothing.value;
          };
          return Data_Functor.map(Data_Maybe.functorMaybe)(Lib_Random.randomPick)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)));
      };
  };
...
(function($PS) {
  ...
  var Lib_Game = $PS["Lib.Game"];
  var Lib_Random = $PS["Lib.Random"];
  var Lib_TwoPlayersGame = $PS["Lib.TwoPlayersGame"];
  var Optic_Getter = $PS["Optic.Getter"];
  var Optic_Lens = $PS["Optic.Lens"];
  var Optic_Setter = $PS["Optic.Setter"];                
  var Move = (function () {
  ...
  var nimGame2 = new Lib_TwoPlayersGame.TwoPlayersGame(function () {
      return nimGame;
  }, (function () {
      var $67 = Data_Eq.eq(Data_Eq.eqInt)(0);
      var $68 = Data_Foldable.foldr(Data_Foldable.foldableArray)(function (t) {
          return Data_Int_Bits.xor((Data_Tuple.snd(t) - Data_Tuple.fst(t) | 0) - 1 | 0);
      })(0);
      var $69 = Optic_Getter.view(Lib_Game["_position"](Data_Const.functorConst));
      return function ($70) {
          return $67($68($69($70)));
      };
  })(), function (state) {
      return Data_Array.sortWith(Data_Ord.ordInt)(function (v) {
          return Data_Maybe.fromMaybe(0)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(Optic_Getter.weiv(state)(Lib_Game["_position"](Data_Const.functorConst)))(v.value0))(function (v1) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                  var $40 = Optic_Getter.weiv(state)(Lib_Game["_turn"](Data_Const.functorConst)) === 0;
                  if ($40) {
                      return v1.value0 - v.value1 | 0;
                  };
                  return v.value1 - v1.value1 | 0;
              })());
          }));
  ...
  var nimGame = new Lib_Game.Game(function (state) {
      return function (v) {
          return Data_Maybe.fromMaybe(false)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(Optic_Getter.weiv(state)(Lib_Game["_position"](Data_Const.functorConst)))(v.value0))(function (v1) {
              return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(v.value1 !== v1.value0 && (v.value1 !== v1.value1 && (function () {
                  var $48 = Optic_Getter.weiv(state)(Lib_Game["_turn"](Data_Const.functorConst)) === 0;
                  if ($48) {
  ...
  }, Lib_TwoPlayersGame["computerMove'"](nimGame2), function (state) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
          return (v.value1 - v.value0 | 0) === 1 && (function () {
              var $56 = Optic_Getter.weiv(state)(Lib_Game["_turn"](Data_Const.functorConst)) === 1;
              if ($56) {
                  return v.value1 === (Optic_Getter.weiv(state)(_length(Data_Const.functorConst)) - 2 | 0);
              };
              return v.value0 === 0;
          })();
      })(Optic_Getter.weiv(state)(Lib_Game["_position"](Data_Const.functorConst)));
      ...
      return function (v) {
          return Data_Array.modifyAtIndices(Data_Foldable.foldableArray)([ v.value0 ])(function (v1) {
              var $62 = Optic_Getter.weiv(state)(Lib_Game["_turn"](Data_Const.functorConst)) === 0;
              if ($62) {
  ...
  var template = function (dictGame) {
      return function (lens) {
          return function (elements) {
              return function (state) {
                  return Pha_Html["div'"]([  ])([ Pha_Html["div'"]([ Pha_Html["class'"]("main-container")(true) ])([ Pha_Html["div'"]([  ])([ elements.board, UI_Icons.winPanel(state) ]), elements.config ]), elements.dialog(Optic_Getter.weiv(state)(Lib_Game["_dialog"](Data_Const.functorConst))) ]);
              };
          };
      };
  };
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var laction = (function () {
              var $18 = Pha.lensAction(function (dictFunctor) {
                  return lens(dictFunctor);
              });
              return function ($19) {
                  return $18(Pha.action($19));
              };
          })();
          ...
          var elements = {
              config: UI_Dialog.card("Poker Nim")([ UI_Icon.icongroup("Nombre de rang\xe9es")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ 1, 2, 3, 4, 5 ])(function (i) {
                  return UI_Icons.iconbutton(Game_Nim_Model.nimGame)(state)(function (v) {
                      ...
                      return lens(dictFunctor);
                  })(Pha.rndAction(Game_Nim_Model.setNbPiles(i)))) ]);
                  ...
                  return UI_Icons.iconbutton(Game_Nim_Model.nimGame)(state)(function (v) {
                      ...
                      return lens(dictFunctor);
                  })(Pha.rndAction(Game_Nim_Model.setLength(i)))) ]);
              })), UI_Icon.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.iundo(Game_Nim_Model.nimGame), UI_Icons.iredo(Game_Nim_Model.nimGame), UI_Icons.ireset(Game_Nim_Model.nimGame), UI_Icons.irules(Game_Nim_Model.nimGame) ])(function (x) {
              ...
              board: Pha_Html["div'"]([ Pha_Html["class'"]("ui-board nim-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox("0 0 100 100"), Pha_Html.height("100%"), Pha_Html.width("100%") ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
                  return function (pile) {
                      return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.rect([ Pha_Html.key("pile" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html.x((function () {
                          ...
                          return Pha_Html.rect([ Pha_Html.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html.width("5"), Pha_Html.height("5"), Pha_Html.x("-2.5"), Pha_Html.y("-2.5"), Pha_Html.fill("gray"), Pha_Html.click(Pha.lensAction(function (dictFunctor) {
                              ...
                              var $13 = Lib_Game.canPlay(Game_Nim_Model.nimGame)(state)(new Game_Nim_Model.Move(i, j));
                              if ($13) {
                                  return "pointer";
                              };
                              return "not-allowed";
                  ...
                  var $16 = Lib_Game.isLevelFinished(Game_Nim_Model.nimGame)(state);
                  if ($16) {
                      return "Partie finie";
                  };
                  var $17 = Optic_Getter.weiv(state)(Lib_Game["_turn"](Data_Const.functorConst)) === 0;
                  if ($17) {
