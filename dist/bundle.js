...
(function($PS) {
  ...
  var scoreHash$prime = function (dictScoreGame) {
      return function (state) {
          var $111 = isCustomGame(dictScoreGame)(state);
          if ($111) {
              return "custom";
          };
  ...
  var _nbRows = function (dictStrong) {
      var $207 = _core(dictStrong);
      var $208 = Data_Lens_Lens.lens(function (v) {
          return v.nbRows;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _pointer = function (dictStrong) {
      var $210 = _core(dictStrong);
      var $211 = Data_Lens_Lens.lens(function (v) {
          return v.pointer;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _position = function (dictStrong) {
      var $213 = _core(dictStrong);
      var $214 = Data_Lens_Lens.lens(function (v) {
          return v.position;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _redoHistory = function (dictStrong) {
      var $216 = _core(dictStrong);
      var $217 = Data_Lens_Lens.lens(function (v) {
  ...
  var bestScore = function (dictScoreGame) {
      return function (state) {
          return Data_Lens_Getter.viewOn(state)((function () {
              var $222 = _scores(Data_Lens_Internal_Forget.strongForget);
              var $223 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(scoreHash$prime(dictScoreGame)(state))(Data_Lens_Internal_Forget.strongForget);
              return function ($224) {
                  return $222($223($224));
              };
          })());
              ...
              return Control_Bind.bind(Run.bindRun)(onNewGame(dictGame)(state2))(function (v1) {
                  return Control_Bind.bind(Run.bindRun)(initialPosition(dictGame)(v1))(function (v2) {
                      var state4 = Data_Lens_Setter.set((function () {
                          var $225 = _scores(Data_Profunctor_Strong.strongFn);
                          var $226 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))("custom")(Data_Profunctor_Strong.strongFn);
                          return function ($227) {
                              return $225($226($227));
                          };
  ...
  var updateScore$prime = function (dictScoreGame) {
      return function (strat) {
          return function (state) {
              ...
              var cmp = (function () {
                  var $136 = Data_Eq.eq(eqObjective)(objective(dictScoreGame)(state))(Minimize.value);
                  if ($136) {
              ...
              var st2 = Data_Lens_Setter.over((function () {
                  var $230 = _scores(Data_Profunctor_Strong.strongFn);
                  var $231 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(hash)(Data_Profunctor_Strong.strongFn);
                  return function ($232) {
                      return $230($231($232));
                  };
              })())((function () {
  ...
  var _showWin = function (dictStrong) {
      var $233 = _core(dictStrong);
      var $234 = Data_Lens_Lens.lens(function (v) {
          return v.showWin;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _turn = function (dictStrong) {
      var $236 = _core(dictStrong);
      var $237 = Data_Lens_Lens.lens(function (v) {
          return v.turn;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var changeTurn = function (state) {
      return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (x) {
          var $138 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
          if ($138) {
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $139 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($139) {
          ...
          var bestMove = (function () {
              var $140 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
              if ($140) {
                  return Data_Maybe.Nothing.value;
              };
              return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                  var $239 = Data_Maybe.maybe(false)(isLosingPosition(dictTwoPlayersGame));
                  var $240 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                  return function ($241) {
                      return $239($240($241));
                  };
              })())(moves);
          ...
          throw new Error("Failed pattern match at Game.Core (line 299, column 13 - line 301, column 44): " + [ bestMove.constructor.name ]);
      };
  };
  var computerPlay = function (dictGame) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Control_Bind.bind(Run.bindRun)(computerMove(dictGame)(v))(function (v1) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 226, column 5 - line 230, column 51): " + [ v2.constructor.name ]);
          });
      });
  };
      ...
      return function (v) {
          ...
          if (v instanceof SetGridSize) {
              var setSize$prime = function (state) {
                  ...
                  var $158 = v.value0 >= v1.value0 && (v.value0 <= v1.value2 && (v.value1 >= v1.value1 && v.value1 <= v1.value3));
                  if ($158) {
              ...
              return newGame(dictGame)((function () {
                  var $242 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(v.value2);
                  return function ($243) {
                      return setSize$prime($242($243));
                  };
              })());
          };
          ...
          if (v instanceof SetScoreDialog) {
              return Pha_Action.setState(Data_Lens_Setter.set(_dialog(Data_Profunctor_Strong.strongFn))(ScoreDialog.value));
          };
          ...
          if (v instanceof ComputerStarts) {
              return Control_Apply.applySecond(Run.applyRun)(Pha_Action.setState((function () {
                  var $244 = Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(oppositeTurn);
                  return function ($245) {
                      return pushToHistory($244($245));
                  };
              })()))(computerPlay(dictGame));
          };
          if (v instanceof Init) {
              return init(dictGame);
          };
          throw new Error("Failed pattern match at Game.Core (line 158, column 1 - line 158, column 94): " + [ v.constructor.name ]);
      };
  };
          ...
          return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v2) {
                      ...
                      var $172 = isLevelFinished(dictGame)(v1.value0);
                      if ($172) {
                      ...
                      var $176 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v1.value0)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v1.value0)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                      if ($176) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 235, column 5 - line 246, column 26): " + [ v1.constructor.name ]);
          }));
      };
  };
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $180 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($180) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 347, column 5 - line 351, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
          ...
          return function (_dragged) {
              return function (v) {
                  if (v instanceof Drag) {
                      return Pha_Action.setState(Data_Lens_Setter.set(_dragged(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(v.value0)));
                  };
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 336, column 1 - line 337, column 81): " + [ _dragged.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var maybeN$prime = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Pha (line 96, column 1 - line 96, column 58): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function($PS) {
  ...
  var onclick$prime = (function () {
      var $17 = on$prime("click");
      return function ($18) {
          return $17(Pha_Events_Decoder.always($18));
      };
  })();
  var onpointerdown$prime = (function () {
      var $27 = on$prime("pointerdown");
      return function ($28) {
          return $27(Pha_Events_Decoder.always($28));
      };
  })();
  var onpointerup$prime = (function () {
      var $33 = on$prime("pointerup");
      return function ($34) {
  ...
  var onpointerdown = (function () {
      var $49 = on("pointerdown");
      return function ($50) {
          return $49(Pha_Events_Decoder.always($50));
      };
  })();
  var onpointerenter = (function () {
      var $51 = on("pointerenter");
      return function ($52) {
          return $51(Pha_Events_Decoder.always($52));
      };
  })();
  ...
  var onpointerup = (function () {
      var $55 = on("pointerup");
      return function ($56) {
          return $55(Pha_Events_Decoder.always($56));
      };
  })();
  ...
  var preventDefaultOn = function (eventname) {
      return function (decoder) {
          return custom(eventname)((function () {
              var $59 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(function (v) {
                  return {
                      message: v.value0,
  ...
  exports["onpointerup'"] = onpointerup$prime;
...
(function($PS) {
  ...
  var iconbutton = function (optionFn) {
      return function (props) {
          ...
          })(), Pha["maybeN'"](v.tooltip)(function (t) {
      ...
      return function (dictScoreGame) {
          return function (state) {
              return icongroup("Meilleur score (" + (Data_Maybe.maybe("\u2205")((function () {
                  var $41 = Data_Show.show(Data_Show.showInt);
                  return function ($42) {
                      return $41(Data_Tuple.fst($42));
                  };
...
(function($PS) {
  ...
  var _isoCustom = function (dictProfunctor) {
      var to = (function () {
          var $17 = Data_Array.mapWithIndex(function (i) {
              return function (v) {
                  if (v) {
                      return new Data_Maybe.Just({
          ...
          return function ($18) {
              return Data_Array.catMaybes($17($18));
          };
      })();
      var from = (function () {
          var $19 = Data_Function.flip(Data_Array.updateAtIndices(Data_Foldable.foldableArray))(Data_Array.replicate(25)(false));
          var $20 = Data_Functor.map(Data_Functor.functorArray)(function (v) {
...
(function($PS) {
  ...
  var incDecGrid = function (v) {
      return function (children) {
          return Pha_Elements.div([ Pha.class_("ui-incdecgrid") ])([ Pha_Elements.div([ Pha.class_("flex") ])([ Pha_Elements.div([ Pha.class_("ui-flex-center ui-incdecgrid-container") ])(children), Pha.whenN(v.showRowButtons)(function (v1) {
...
(function($PS) {
  ...
  var winTitleFor2Players = function (state) {
      var $22 = Data_Eq.eq(Game_Core.eqMode)(Data_Lens_Getter.viewOn(state)(Game_Core["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.DuelMode.value);
      if ($22) {
          return "Le " + ((function () {
              var $23 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn2.value);
              if ($23) {
                  return "premier";
              };
              return "second";
  ...
  var turnMessage = function (dictGame) {
      return function (state) {
          var $25 = Game_Core.isLevelFinished(dictGame)(state);
          if ($25) {
              return "Partie finie";
          };
          var $26 = Data_Eq.eq(Game_Core.eqTurn)(Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.Turn1.value);
          if ($26) {
          ...
          return function (dictGame) {
              return function (v) {
                  return function (state) {
                      ...
                      return [ Pha["class'"]("dragged")(dragged), Pha["class'"]("candrop")(candrop), Pha_Events["onpointerdown'"]((function () {
                          if (v.draggable) {
                              return Data_Maybe.Just.create(Game_Core.dndmsg(dictMsgWithDnd)(new Game_Core.Drag(v.id)));
                          };
                          return Data_Maybe.Nothing.value;
                      })()), Pha_Events["onpointerup'"]((function () {
                          if (candrop) {
                              return Data_Maybe.Just.create(Game_Core.dndmsg(dictMsgWithDnd)(new Game_Core.Drop(v.id)));
                          };
                          return Data_Maybe.Nothing.value;
                      })()) ];
                  };
  ...
  var dndBoardProps = function (dictMsgWithCore) {
      return function (dictMsgWithDnd) {
          ...
          return [ Pha.style("touch-action")("none"), Pha_Events.on("pointermove")(move), Pha_Events.onpointerup(Game_Core.dndmsg(dictMsgWithDnd)(Game_Core.DropOnBoard.value)), Pha_Events.onpointerleave(Game_Core.dndmsg(dictMsgWithDnd)(Game_Core.Leave.value)) ];
      };
  };
  ...
  var bestScoreDialog = function (dictMsgWithCore) {
      return function (dictScoreGame) {
          return function (state) {
              return function (children) {
                  return Pha["maybeN'"](Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.snd)(Game_Core.bestScore(dictScoreGame)(state)))(function (pos) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(3))([ Pha.class_("ui-board") ]))([ Pha_Svg.svg([ Pha_Svg.viewBox(-7 | 0)(-7 | 0)((50 * columns | 0) + 14 | 0)((50 * rows | 0) + 14 | 0) ])(Data_Array.concat([ Lib_Util.tabulate2(rows)(columns)(function (row) {
          return function (col) {
      ...
      }), [ Pha_Svg.use("#skull")([ Pha_Svg.x_(Data_Show.show(Data_Show.showInt)((50 * v.col | 0) + 12 | 0)), Pha_Svg.y_(Data_Show.show(Data_Show.showInt)((50 * v.row | 0) + 12 | 0)), Pha_Svg.width("26"), Pha_Svg.height("26"), Pha.key("skull"), Pha_Svg.fill("#20AF20") ]), Pha["maybeN'"](Data_Lens_Getter.viewOn(state)(Game_Chocolat_Model["_moveWhenHover"](Data_Lens_Internal_Forget.strongForget)))(function (m) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      }), [ Pha["maybeN'"](Data_Array.index(pointsPolar)(position))(function (v) {
...
(function($PS) {
  ...
  var scoregame = new Game_Core.ScoreGame(function () {
      ...
      var $34 = Data_Array.filter(function (v) {
          return v > 0;
      });
      var $35 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($36) {
          return Data_Array.length($34($35($36)));
      };
  })(), function (state) {
  ...
  var jetonsGame = new Game_Core.Game(function (v) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (i) {
          ...
          var y = (function () {
              var $19 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i + 1 | 0)(columns) === 0;
              if ($19) {
                  return 0;
              };
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var scoreDialog = function (v) {
          return UI_Template.bestScoreDialog(Game_Jetons_Model.withcore)(Game_Jetons_Model.scoregame)(state)(function (pos) {
              return [ Pha_Elements.div([ Pha["class'"]("ui-flex-center jetons-bestscore-grid-container")(true) ])([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(3))([ Pha["class'"]("ui-board")(true) ]))(Data_Array.mapWithIndex(function (i) {
                  return function (val) {
                      return Pha.whenN(val !== 0)(function (v1) {
      ...
      return UI_Template.template(Game_Jetons_Model.withcore)(Game_Jetons_Model.jetonsGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
  ...
  var _ext$prime = function (dictStrong) {
      var $97 = Game_Core["_ext"](dictStrong);
      var $98 = Data_Lens_Iso.iso(function (v) {
          return v;
      })(Ext)(dictStrong.Profunctor0());
      return function ($99) {
          return $97($98($99));
  ...
  var scoregameLabete = new Game_Core.ScoreGame(function () {
      ...
      var $121 = Data_Array.filter(Control_Category.identity(Control_Category.categoryFn));
      var $122 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($123) {
          return Data_Array.length($121($122($123)));
      };
  })(), function (state) {
  ...
  var labeteGame = new Game_Core.Game(function (v) {
      ...
      return Data_Array["null"](nonTrappedBeasts($124));
  }, function (st) {
  ...
  var update = function (v) {
      ...
      if (v instanceof SetHelp) {
          return Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_help"](Data_Profunctor_Strong.strongFn))(v.value0));
      };
      if (v instanceof SetBeast) {
          return Game_Core.newGame(labeteGame)((function () {
              var $125 = Data_Lens_Setter.set(_beastType(Data_Profunctor_Strong.strongFn))(v.value0);
              var $126 = (function () {
                  var $81 = Data_Eq.eq(eqBt)(v.value0)(CustomBeast.value);
                  if ($81) {
                      var $128 = Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.CustomDialog.value);
                      var $129 = Data_Lens_Setter.over(_beast(Data_Profunctor_Strong.strongFn))(Data_Array.take(1));
                      return function ($130) {
                          return $128($129($130));
                      };
                  };
      ...
      if (v instanceof IncSelectedColor) {
          return Pha_Action.setState(Data_Lens_Setter.over(_selectedColor(Data_Profunctor_Strong.strongFn))(function (x) {
              return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x + v.value0 | 0)(9);
          }));
      };
      if (v instanceof StartZone) {
          return Pha_Action.setState(Data_Lens_Setter.set(_startSquare(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(v.value0)));
      };
      if (v instanceof StartZone2) {
          return Pha_Action.setState(Data_Lens_Setter.set(_startPointer(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(v.value0)));
      };
      if (v instanceof FinishZone) {
          return Pha_Action.setState(function (state) {
              ...
              throw new Error("Failed pattern match at Game.Labete.Model (line 199, column 49 - line 206, column 44): " + [ v1.constructor.name ]);
          });
      };
      if (v instanceof FlipCustomBeast) {
          return Game_Core.newGame(labeteGame)(Data_Lens_Setter.over((function () {
              var $131 = _beast(Data_Profunctor_Strong.strongFn);
              var $132 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Wander.wanderFunction);
              var $133 = Game_Common["_isoCustom"](Data_Profunctor.profunctorFn);
              var $134 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($135) {
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])(props))([ Pha_Svg.use("#grass")([ Pha_Svg.width("50"), Pha_Svg.height("50"), Pha_Svg.fill(Data_Maybe.fromMaybe("")(Data_Array.index(colors)(v.color))) ]), Pha_Svg.rect([ Pha_Svg.width("51"), Pha_Svg.height("51"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("0.5"), Pha_Svg.fill("transparent") ]), Pha_Svg.use("#paw")([ Pha_Svg.x_("5"), Pha_Svg.y_("5"), Pha_Svg.width("40"), Pha_Svg.height("40"), Pha.class_("labete-beast"), Pha["class'"]("visible")(v.hasBeast) ]), Pha.whenN(v.hasTrap)(function (v1) {
  ...
  var view = function (state) {
      ...
      var customDialog = function (v) {
          return UI_Template.dialog(Game_Labete_Model.withcore)("Personnalise ta b\xeate")([ Pha_Elements.div([ Pha.class_("labete-custombeast-grid-container") ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(250)(250) ])(Data_Array.mapWithIndex(function (index) {
              ...
              var $56 = Game_Labete_Model["_beast"](Data_Lens_Internal_Forget.strongForget);
              var $57 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(0)(Data_Lens_Internal_Forget.wanderForget(Data_Monoid.monoidArray));
              var $58 = Game_Common["_isoCustom"](Data_Lens_Internal_Forget.profunctorForget);
              return function ($59) {
                  return $56($57($58($59)));
              };
          })()))) ]) ]);
      ...
      var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(Game_Labete_Model.withcore))([ Pha.class_("ui-board"), Pha_Events["on'"]("onpointerdown")(function (ev) {
              ...
              return function (hasBeast) {
                  return function (color) {
                      ...
                      return square({
                          ...
                          var $62 = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(function (v1) {
                              if (v1) {
                          ...
                          return function ($63) {
                              return $62(Pha_Events_Decoder.shiftKey($63));
                          };
                      })()) ]);
                  };
              };
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 122, column 26 - line 124, column 81): " + [ v.constructor.name ]);
      })()) ])) ]);
      var scoreDialog = function (v) {
      ...
      var board = UI_Template.incDecGrid(Game_Labete_Model.withcore)(Game_Labete_Model.labeteGame)(state)([ grid, Pha.whenN(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_selectedColor"](Data_Lens_Internal_Forget.strongForget)) > 0)(function (v) {
      ...
      var config = UI_Template.card("La b\xeate")([ UI_Icons.iconSelectGroup(Game_Labete_Model.showBt)(Game_Labete_Model.eqBt)(state)("Forme de la b\xeate")(beastTypes)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_beastType"](Data_Lens_Internal_Forget.strongForget)))(Game_Labete_Model.SetBeast.create)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 68, column 90 - line 73, column 61): " + [ v.constructor.name ]);
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 75, column 80 - line 78, column 86): " + [ v.constructor.name ]);
      ...
      return UI_Template.template(Game_Labete_Model.withcore)(Game_Labete_Model.labeteGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
  ...
  var pathGame = new Game_Core.Game(function (v) {
      ...
      return Control_Applicative.pure(Run.applicativeRun)((function () {
          ...
          throw new Error("Failed pattern match at Game.Paths.Model (line 74, column 36 - line 76, column 28): " + [ v.constructor.name ]);
      })());
  }, function (state) {
      ...
      return function (v) {
          ...
          throw new Error("Failed pattern match at Game.Paths.Model (line 62, column 9 - line 69, column 28): " + [ v1.constructor.name ]);
      };
  }, function (v) {
      return new Game_Core.SizeLimit(2, 2, 9, 9);
  }, function (st) {
  ...
  var update = function (v) {
      if (v instanceof Core) {
          return Game_Core.coreUpdate(pathGame)(v.value0);
      };
      ...
      throw new Error("Failed pattern match at Game.Paths.Model (line 91, column 1 - line 91, column 35): " + [ v.constructor.name ]);
  };
  exports["Mode1"] = Mode1;
  exports["Mode2"] = Mode2;
  exports["istate"] = istate;
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          ...
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("paths-darken")(v.darken) ])(props))([ Pha_Svg.use("#paths-background")(pos), Pha.whenN(v.door)(function (v1) {
  ...
  var view = function (state) {
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(UI_Template.trackPointer(Game_Paths_Model.withcore)))([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100 * columns | 0)(100 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Util.tabulate(rows * columns | 0)(function (index) {
          var v = Lib_Util.coords(columns)(index);
          return square({
      ...
      }))([ Pha_Svg.path(pathdec)([ Pha.class_("paths-path") ]), Pha["maybeN'"](Data_Array.last(position))(hero), Pha["maybeN'"](Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget)))(function (pp) {
      ...
      var board = UI_Template.incDecGrid(Game_Paths_Model.withcore)(Game_Paths_Model.pathGame)(state)([ grid ]);
      return UI_Template.template(Game_Paths_Model.withcore)(Game_Paths_Model.pathGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
      ...
      return function (piece) {
          return function (index1) {
              return function (index2) {
                  ...
                  var $57 = Data_Eq.notEq(eqPiece)(piece)(Custom.value);
                  if ($57) {
  ...
  var capturableSquares = function (state) {
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
          var $63 = Data_Eq.eq(eqPiece)(v.value1)(Empty.value);
          if ($63) {
              return Control_Category.identity(Control_Category.categoryFn);
          };
  ...
  var queensScoreGame = new Game_Core.ScoreGame(function () {
      ...
      var $96 = Data_Array.filter(function (v) {
  ...
  var queensGame = new Game_Core.Game(function (v) {
      ...
      return function (index) {
          ...
          return Data_Array.modifyAt(index)(function (t) {
              var $66 = Data_Eq.eq(eqPiece)(t)(selectedPiece);
              if ($66) {
                  return Empty.value;
              };
  ...
  var update = function (v) {
      ...
      if (v instanceof SelectPiece) {
          return Pha_Action.setState(Data_Lens_Setter.set(_selectedPiece(Data_Profunctor_Strong.strongFn))(v.value0));
      };
      if (v instanceof SelectSquare) {
          return Pha_Action.setState(Data_Lens_Setter.set(_selectedSquare(Data_Profunctor_Strong.strongFn))(v.value0));
      };
      ...
      if (v instanceof ToggleMultiPieces) {
          return Pha_Action.setState(Data_Lens_Setter.over(_multiPieces(Data_Profunctor_Strong.strongFn))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
      };
      if (v instanceof FlipDirection) {
          return Game_Core.newGame(queensGame)(Data_Lens_Setter.over((function () {
              var $99 = _customDirections(Data_Profunctor_Strong.strongFn);
              var $100 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($101) {
                  return $99($100($101));
              };
          })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
      ...
      if (v instanceof FlipLocalMove) {
          return Game_Core.newGame(queensGame)(Data_Lens_Setter.over((function () {
              var $102 = _customLocalMoves(Data_Profunctor_Strong.strongFn);
              var $103 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($104) {
                  return $102($103($104));
              };
          })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
      ...
      if (v instanceof Customize) {
          return Game_Core.newGame(queensGame)((function () {
              var $105 = Data_Lens_Setter.set(_allowedPieces(Data_Profunctor_Strong.strongFn))(Data_Array_NonEmpty.singleton(Custom.value));
              var $106 = Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.CustomDialog.value);
              var $107 = Data_Lens_Setter.set(_multiPieces(Data_Profunctor_Strong.strongFn))(false);
              return function ($108) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      })([ Pha_Events.onclick(Game_Queens_Model.Customize.value) ]), UI_Icons.iconbutton(state)(function (v) {
          return {
      ...
      }), [ Pha["maybeN'"](Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget)))(cursor) ] ]));
      var scoreDialog = function (v) {
      ...
      return UI_Template.template(Game_Queens_Model.withcore)(Game_Queens_Model.queensGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
  ...
  var _ext$prime = function (dictStrong) {
      var $61 = Game_Core["_ext"](dictStrong);
      var $62 = Data_Lens_Iso.iso(function (v) {
          return v;
      })(Ext)(dictStrong.Profunctor0());
      return function ($63) {
          return $61($62($63));
  ...
  var aligned = function (state) {
      ...
      return Data_Array.mapWithIndex(function (index) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Game.Roue.Model (line 45, column 47 - line 47, column 43): " + [ v.constructor.name ]);
          };
      })(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
  };
  ...
  var roueGame = new Game_Core.Game(function (v) {
      ...
      var $70 = Control_Applicative.pure(Run.applicativeRun);
      var $71 = Data_Lens_Setter.set(_rotation(Data_Profunctor_Strong.strongFn))(0);
      return function ($72) {
          return $70($71($72));
      };
  })(), function (state) {
  ...
  var update = function (v) {
          ...
          return Pha_Action.setState(function (state) {
              ...
              if (v1 instanceof Data_Maybe.Just && v1.value0 instanceof Wheel) {
                  return Data_Lens_Setter.set((function () {
                      var $76 = Game_Core["_position"](Data_Profunctor_Strong.strongFn);
                      var $77 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v1.value0.value0)(Data_Lens_Internal_Wander.wanderFunction);
                      return function ($78) {
                          return $76($77($78));
                      };
      ...
      if (v instanceof Rotate) {
          return Pha_Action.setState(rotate(v.value0));
      };
      ...
      throw new Error("Failed pattern match at Game.Roue.Model (line 87, column 1 - line 87, column 35): " + [ v.constructor.name ]);
  };
  exports["Panel"] = Panel;
  exports["Wheel"] = Wheel;
  exports["istate"] = istate;
  ...
  var view = function (state) {
          ...
          return function (pos) {
              return function (align) {
                  return Pha_Svg.path(pizza(50.0)(50.0)(50.0)((2.0 * $$Math.pi * (Data_Int.toNumber(i) - 0.5)) / Data_Int.toNumber(size))((2.0 * $$Math.pi * (Data_Int.toNumber(i) + 0.5)) / Data_Int.toNumber(size)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("roue-wheel-part")(true), Pha_Svg.fill((function () {
                      ...
                      var $8 = Game_Roue_Model["validRotation'"](state);
                      if ($8) {
                          return "lightgreen";
                      };
                      return "#F5B7B1";
                  })()) ])(UI_Template.dndItemProps(Game_Roue_Model.eqLoc)(Game_Roue_Model.withdnd)(Game_Roue_Model.roueGame)({
      ...
      var board = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Game_Roue_Model.withcore)(Game_Roue_Model.withdnd))([ Pha.class_("roue-board") ]))([ Pha_Elements.div([ Pha.class_("roue-buttons") ])(Data_Array.concat([ [ Pha_Elements.button([ Pha.class_("ui-button ui-button-primary roue-button"), Pha_Attributes.disabled(Data_Lens_Getter.viewOn(state)(Game_Core["_locked"](Data_Lens_Internal_Forget.strongForget))), Pha_Events.onclick(new Game_Roue_Model.Rotate(-1 | 0)) ])([ Pha.text("\u21b6") ]) ], Data_Array.mapWithIndex(function (i) {
          return function (color) {
              ...
              })(state)))([ Pha.whenN(Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(i))(position))(function (v) {
      ...
      return UI_Template.template(Game_Roue_Model.withcore)(Game_Roue_Model.roueGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
  ...
  var update = function (v) {
      if (v instanceof SetPage) {
          return Control_Monad.unlessM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Data_Lens_Getter.view(_locked(Data_Lens_Internal_Forget.strongForget)))(Pha_Action.getState))(Pha_Action.setState((function () {
              var $23 = Data_Lens_Setter.set(_page(Data_Profunctor_Strong.strongFn))(v.value0);
              var $24 = Data_Lens_Setter.set(_anim(Data_Profunctor_Strong.strongFn))(Data_Map_Internal.empty);
              return function ($25) {
                  return $23($24($25));
              };
          })()));
      ...
      if (v instanceof Animate) {
          return Control_Monad.unlessM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Data_Lens_Getter.view(_locked(Data_Lens_Internal_Forget.strongForget)))(Pha_Action.getState))(Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState((function () {
              ...
              var $27 = Data_Lens_Setter.set(_locked(Data_Profunctor_Strong.strongFn))(true);
              return function ($28) {
                  return $26($27($28));
              };
          })()))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Data_Foldable.for_(Run.applicativeRun)(Data_Foldable.foldableArray)(v.value0)(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Effects_Delay.delay(v1.value0))(function () {
                      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v2) {
                          return Pha_Action.setState(Data_Lens_Setter.set((function () {
                              var $29 = _anim(Data_Profunctor_Strong.strongFn);
                              var $30 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(v1.value1)(Data_Profunctor_Strong.strongFn);
                              return function ($31) {
                                  return $29($30($31));
                              };
...
(function($PS) {
  ...
  var _ext$prime = function (dictStrong) {
      var $88 = Game_Core["_ext"](dictStrong);
      var $89 = Data_Lens_Iso.iso(function (v) {
          return v;
      })(Ext)(dictStrong.Profunctor0());
      return function ($90) {
          return $88($89($90));
  ...
  var betweenMove2 = function (state) {
      return function (v) {
          var rows = Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
          var $61 = Data_Eq.eq(boardMode)(Data_Lens_Getter.viewOn(state)(_board(Data_Lens_Internal_Forget.strongForget)))(CircleBoard.value);
          if ($61) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(betweenInCircle(v.from)(v.to)(rows))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      var $63 = rows === 4 && Data_Maybe.maybe(false)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v1));
                      if ($63) {
  ...
  var solitaireGame = new Game_Core.Game(function (v) {
      ...
      var $106 = Control_Applicative.pure(Run.applicativeRun);
  ...
  var update = function (v) {
      if (v instanceof Core && v.value0 instanceof Game_Core.ToggleHelp) {
          return Pha_Action.setState(Data_Lens_Setter.over(_help(Data_Profunctor_Strong.strongFn))(function (x) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Game_Solitaire_Model.withcore)(Game_Solitaire_Model.withdnd))((function () {
      ...
      })() ])(Data_Array.concat([ [ Pha.whenN(isCircleBoard)(function (v) {
          ...
          return function (v) {
              return Pha.whenN(v)(function (v1) {
      ...
      var scoreDialog = function (v) {
          return UI_Template.bestScoreDialog(Game_Solitaire_Model.withcore)(Game_Solitaire_Model.scoregame)(state)(function (position) {
              return [ Pha_Elements.div([ Pha["class'"]("ui-flex-center solitaire-scoredialog")(true) ])([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])((function () {
                  ...
                  return Pha_Svg.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0);
              })() ])(Data_Array.concat([ [ Pha.whenN(isCircleBoard)(function (v1) {
                  return Pha_Svg.circle([ Pha_Svg.cx("125"), Pha_Svg.cy("125"), Pha_Svg.r("90"), Pha_Svg.stroke("grey"), Pha_Svg.fill("transparent"), Pha_Svg.strokeWidth("5") ]);
              }) ], Data_Array.mapWithIndex(function (i) {
                  return function (v1) {
                      return Pha.whenN(v1)(function (v2) {
      ...
      return UI_Template.template(Game_Solitaire_Model.withcore)(Game_Solitaire_Model.solitaireGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
  ...
  var _ext$prime = function (dictStrong) {
      var $73 = Game_Core["_ext"](dictStrong);
      var $74 = Data_Lens_Iso.iso(function (v) {
          return v;
      })(Ext)(dictStrong.Profunctor0());
      return function ($75) {
          return $73($74($75));
  ...
  var tilingGame = new Game_Core.Game(function (v) {
      ...
      var $91 = Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
          return v !== 0;
      });
      ...
      return function (index) {
          ...
          var pos = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var $59 = canPutTile(state)(tilePos);
          if ($59) {
          ...
          var $60 = Data_Ord.greaterThan(Data_Maybe.ordMaybe(Data_Ord.ordInt))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(index))(new Data_Maybe.Just(0));
          if ($60) {
  ...
  var update = function (v) {
      ...
      if (v instanceof PutSink) {
          return Pha_Action.setState(Data_Lens_Setter.set((function () {
              var $94 = Game_Core["_position"](Data_Profunctor_Strong.strongFn);
              var $95 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($96) {
                  return $94($95($96));
              };
          })())(-1 | 0));
      ...
      if (v instanceof SetTile) {
          return Game_Core.newGame(tilingGame)((function () {
              var $97 = (function () {
                  var $69 = Data_Eq.eq(eqTileType)(v.value0)(CustomTile.value);
                  if ($69) {
                      return Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.CustomDialog.value);
                  };
                  return Control_Category.identity(Control_Category.categoryFn);
              })();
              var $98 = Data_Lens_Setter.set(_tileType(Data_Profunctor_Strong.strongFn))(v.value0);
              return function ($99) {
                  return $97($98($99));
              };
          })());
      ...
      if (v instanceof Rotate) {
          return Pha_Action.setState(Data_Lens_Setter.over(_rotation(Data_Profunctor_Strong.strongFn))(function (v1) {
              return v1 + 1 | 0;
          }));
      };
      if (v instanceof SetHoverSquare) {
          return Pha_Action.setState(Data_Lens_Setter.set(_hoverSquare(Data_Profunctor_Strong.strongFn))(v.value0));
      };
      if (v instanceof FlipTile) {
          return Game_Core.newGame(tilingGame)(Data_Lens_Setter.over((function () {
              var $100 = _tile(Data_Profunctor_Strong.strongFn);
              var $101 = Game_Common["_isoCustom"](Data_Profunctor.profunctorFn);
              var $102 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction);
              return function ($103) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      var customDialog = function (v) {
          return UI_Template.dialog(Game_Tiling_Model.withcore)("Personnalise ta tuile")([ Pha_Elements.div([ Pha["class'"]("tiling-customtile-grid-container")(true) ])([ Pha_Elements.div([ Pha["class'"]("tiling-grid")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(250)(250) ])(Data_Array.mapWithIndex(function (index) {
              ...
              var $36 = Game_Tiling_Model["_tile"](Data_Lens_Internal_Forget.strongForget);
              var $37 = Game_Common["_isoCustom"](Data_Lens_Internal_Forget.profunctorForget);
              return function ($38) {
                  return $36($37($38));
              };
          })()))) ]) ]) ]);
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(Game_Tiling_Model.withcore))([ Pha["class'"]("ui-board")(true), Pha_Events.oncontextmenu(Game_Tiling_Model.Rotate.value) ])))([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (index) {
          return function (pos) {
              ...
              return square({
                  ...
                  var $29 = Game_Tiling_Model.needSinks(state);
                  if ($29) {
          ...
          return function (pos) {
              var v = Lib_Util.coords(columns)(index);
              return Pha_Svg.g([ Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])([ Pha.whenN(pos > 0 && border(index)(-1 | 0))(function (v1) {
      ...
      })(position))([ Pha["maybeN'"](Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget)))((function () {
          var $35 = Data_Array.length(Game_Tiling_Model.sinks(state)) < Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_nbSinks"](Data_Lens_Internal_Forget.strongForget));
          if ($35) {
              return sinkCursor;
          };
          return tileCursor;
      ...
      return UI_Template.template(Game_Tiling_Model.withcore)(Game_Tiling_Model.tilingGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Tricolor.Model (line 59, column 1 - line 59, column 35): " + [ v.constructor.name ]);
  };
  exports["_size"] = _size;
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      return UI_Template.template(Game_Tricolor_Model.withcore)(Game_Tricolor_Model.tricolorGame)(function (v) {
          return {
              board: board,
              config: config,
              rules: rules,
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      if (v instanceof ToggleSwitch) {
          return Pha_Action.setState(Data_Lens_Setter.over(_isSwitchOn(Data_Profunctor_Strong.strongFn))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
      };
                      ...
                      return function (h$prime) {
                          return function (props) {
                              return function (children) {
                                  ...
                                  })()) ])([ Pha_Svg.g(props)([ Pha_Svg.svg(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.class_("valise-object"), Pha.style("touch-action")("none"), Pha["class'"]("draggable")(v.drag), Pha_Svg.width(Data_Show.show(Data_Show.showInt)(w$prime)), Pha_Svg.height(Data_Show.show(Data_Show.showInt)(h$prime)), Pha_Events["onpointerdown'"]((function () {
                                      if (v.drag) {
                                  ...
                                  })()))([ Pha.h("use")([ Pha_Attributes.href("#" + v.symbol), Pha.class_("valise-symbol") ])([  ]), Pha["maybeN'"](v.link)(function (l) {
...
(function($PS) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Main (line 135, column 1 - line 135, column 39): " + [ v.constructor.name ]);
  };
  var state = {
  ...
  var games = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("baseball", gameWrap(Game_Baseball.game)(function (v) {
      ...
      return v.dessin;
  })(DessinMsg.create)), new Data_Tuple.Tuple("frog", gameWrap(Game_Frog.game)(function (v) {
      return v.frog;
  ...
  var hashChange = function (v) {
      return Control_Bind.bind(Run.bindRun)(Game_Effs.getLocation)(function (v1) {
          ...
          var $118 = location === "valise" || location === "";
          if ($118) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v2) {
                  return {
                      location: location,
  ...
  var init = Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Data_Foldable.for_(Run.applicativeRun)(Data_List_Types.foldableList)(Data_Map_Internal.values(games))(gameRun(function (game) {
      ...
      throw new Error("Failed pattern match at Main (line 156, column 26 - line 158, column 65): " + [ game.core.init.constructor.name ]);
  })))(function () {
  ...
  var callByName = function (name) {
      return function ($$default) {
          return function (f) {
              ...
              throw new Error("Failed pattern match at Main (line 115, column 29 - line 117, column 62): " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var view = function (st) {
      return {
          title: "Valise MaM",
          body: Pha_Elements.div([ Pha.key(st.location), Pha.class_("main-main-container"), Pha["class'"]("valise")(st.location === "valise"), Pha["class'"]("appear")(st.anim) ])([ Pha.whenN(st.location !== "valise")(function (v) {
