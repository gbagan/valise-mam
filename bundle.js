              ...
              return function (v) {
                  return function (state) {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(setState(_play(dictGame)(move)(pushToHistory(state)))))(function (v1) {
                          ...
                          var $105 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                          if ($105) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
                  ...
                  return function (setState) {
                      return function (ev) {
                          return function (state) {
                              ...
                              throw new Error("Failed pattern match at Game.Core (line 259, column 5 - line 262, column 39): " + [ v.constructor.name ]);
                          };
                      };
                  };
              };
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var v6 = Lib_Random.runRnd(Game_Core.init(Game_Solitaire_Model.solitaireGame)(Game_Solitaire_Model.solitaireState))();
      var state = {
          baseball: v1,
          nim: v2,
          frog: v3,
