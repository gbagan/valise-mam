...
(function($PS) {
  ...
  var functorRng = new Data_Functor.Functor(function (f) {
      return runExists(function (v) {
          return mkExists(new GenWrapper(v.value0, function ($20) {
              return f(v.value1($20));
          }));
      });
  });
  ...
  var randomly = function (f) {
      return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
          return Control_Bind.bind(Run.bindRun)(randomGenerate(f(v)))(function (v1) {
              return Pha_Update.setState(function (v2) {
                  return v1;
              });
          });
      });
...
(function($PS) {
  ...
  var bestScore = function (dictScoreGame) {
      return function (state) {
          return Data_Lens_Getter.viewOn(state)((function () {
              var $219 = _scores(Data_Lens_Internal_Forget.strongForget);
              var $220 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(scoreHash$prime(dictScoreGame)(state))(Data_Lens_Internal_Forget.strongForget);
              return function ($221) {
                  return $219($220($221));
              };
          })());
  ...
  var newGameAux = function (dictGame) {
      return function (f) {
          return function (state) {
              var state2 = f(state);
              return Control_Bind.bind(Control_Monad_Free.freeBind)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Control_Monad_Free.freeBind)(initialPosition(dictGame)(v))(function (v1) {
                      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)(Data_Lens_Setter.set((function () {
                          var $222 = _scores(Data_Profunctor_Strong.strongFn);
                          var $223 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))("custom")(Data_Profunctor_Strong.strongFn);
                          return function ($224) {
                              return $222($223($224));
                          };
  ...
  var newGame = function (dictGame) {
      return function (f) {
          return Pha_Effects_Random.randomly(function (state) {
              ...
              var $132 = Data_List["null"](Data_Lens_Getter.viewOn(state)(_history(Data_Lens_Internal_Forget.strongForget))) || isLevelFinished(dictGame)(state);
              if ($132) {
                  return rstate;
              };
  ...
  var updateScore$prime = function (dictScoreGame) {
      return function (strat) {
          return function (state) {
              ...
              var cmp = (function () {
                  var $133 = Data_Eq.eq(eqObjective)(objective(dictScoreGame)(state))(Minimize.value);
                  if ($133) {
              ...
              var st2 = Data_Lens_Setter.over((function () {
                  ...
                  var $228 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(hash)(Data_Profunctor_Strong.strongFn);
                  return function ($229) {
                      return $227($228($229));
                  };
              })())((function () {
  ...
  var _showWin = function (dictStrong) {
      var $230 = _core(dictStrong);
      var $231 = Data_Lens_Lens.lens(function (v) {
          return v.showWin;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var changeTurn = function (state) {
      return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (x) {
          var $135 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
          if ($135) {
      ...
      return function (state) {
          ...
          var bestMove = (function () {
              ...
              return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                  var $236 = Data_Maybe.maybe(false)(isLosingPosition(dictTwoPlayersGame));
                  var $237 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                  return function ($238) {
                      return $236($237($238));
                  };
              })())(moves);
          ...
          throw new Error("Failed pattern match at Game.Core (line 292, column 13 - line 294, column 39): " + [ bestMove.constructor.name ]);
      };
  };
      ...
      return function (v) {
          ...
          if (v instanceof SetGridSize) {
              var setSize$prime = function (state) {
                  ...
                  var $155 = v.value0 >= v1.value0 && (v.value0 <= v1.value2 && (v.value1 >= v1.value1 && v.value1 <= v1.value3));
                  if ($155) {
              ...
              return newGame(dictGame)((function () {
                  var $239 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(v.value2);
                  return function ($240) {
                      return setSize$prime($239($240));
                  };
              })());
          };
          ...
          if (v instanceof ComputerStarts) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState((function () {
                  var $241 = Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(oppositeTurn);
                  return function ($242) {
                      return $241(pushToHistory($242));
                  };
              })()))(function () {
          ...
          return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
              ...
              if (v1 instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState(function (v2) {
                      ...
                      var $169 = isLevelFinished(dictGame)(v1.value0);
                      if ($169) {
                      ...
                      var $173 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v1.value0)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v1.value0)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                      if ($173) {
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Update.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $177 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($177) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 340, column 5 - line 344, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
      ...
      return function (dictGame) {
          return function (_dragged) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 329, column 1 - line 330, column 79): " + [ _dragged.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
