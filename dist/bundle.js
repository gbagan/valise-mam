...
(function($PS) {
  ...
  var scoreHash$prime = function (dictScoreGame) {
      return function (state) {
          var $98 = isCustomGame(dictScoreGame)(state);
          if ($98) {
              return "custom";
          };
  ...
  var _customSize = function (dictStrong) {
      var $148 = _core(dictStrong);
      var $149 = Data_Lens_Lens.lens(function (v) {
          return v.customSize;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _dialog = function (dictStrong) {
      var $151 = _core(dictStrong);
      var $152 = Data_Lens_Lens.lens(function (v) {
          return v.dialog;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var bestScore = function (dictScoreGame) {
      return function (state) {
          return Data_Lens_Getter.viewOn(state)((function () {
              var $184 = _scores(Data_Lens_Internal_Forget.strongForget);
              var $185 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(scoreHash$prime(dictScoreGame)(state))(Data_Lens_Internal_Forget.strongForget);
              return function ($186) {
                  return $184($185($186));
              };
          })());
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      var state4 = Data_Lens_Setter.set((function () {
                          var $187 = _scores(Data_Profunctor_Strong.strongFn);
                          var $188 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))("custom")(Data_Profunctor_Strong.strongFn);
                          return function ($189) {
                              return $187($188($189));
                          };
                      ...
                      var $113 = Data_List["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget))) || isLevelFinished(dictGame)(state);
                      if ($113) {
          ...
          return function (nbColumns) {
              return function (customSize) {
                  var setSize$prime = function (state) {
                      ...
                      var $115 = nbRows >= v.value0 && (nbRows <= v.value2 && (nbColumns >= v.value1 && nbColumns <= v.value3));
                      if ($115) {
                  ...
                  return newGame(dictGame)((function () {
                      var $190 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(customSize);
                      return function ($191) {
                          return setSize$prime($190($191));
                      };
                  })());
              };
          };
  ...
  var updateScore$prime = function (dictScoreGame) {
      return function (strat) {
          return function (state) {
              ...
              var cmp = (function () {
                  var $120 = Data_Eq.eq(eqObjective)(objective(dictScoreGame)(state))(Minimize.value);
                  if ($120) {
              ...
              var st2 = Data_Lens_Setter.over((function () {
                  var $194 = _scores(Data_Profunctor_Strong.strongFn);
                  var $195 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(hash)(Data_Profunctor_Strong.strongFn);
                  return function ($196) {
                      return $194($195($196));
                  };
              })())((function () {
  ...
  var changeTurn = function (state) {
      return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (x) {
          var $122 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
          if ($122) {
              return 1 - x | 0;
          };
          return 0;
  ...
  var redoA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 136, column 28 - line 142, column 52): " + [ v.constructor.name ]);
  });
  var undoA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 127, column 28 - line 133, column 56): " + [ v.constructor.name ]);
  });
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $130 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($130) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $131 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($131) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $203 = isLosingPosition(dictTwoPlayersGame);
                      var $204 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                      return function ($205) {
                          return $203($204($205));
                      };
      ...
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Data_Maybe.maybe(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(function (rndmove) {
              return Control_Bind.bind(Run.bindRun)(Pha_Action["randomAction'"](function (st) {
                  ...
                  var $134 = isLevelFinished(dictGame)(v1);
                  if ($134) {
                      return showVictory;
                  };
  ...
  var computerStartsA = function (dictGame) {
      return Control_Apply.applySecond(Run.applyRun)(Pha_Action.setState(pushToHistory))(computerPlay(dictGame));
  };
  var playA = function (dictGame) {
      return function (move) {
          return lockAction(Control_Monad.whenM(Run.monadRun)(Data_Functor.mapFlipped(Run.functorRun)(Pha_Action.getState)(Data_Function.flip(canPlay(dictGame))(move)))(Control_Bind.bind(Run.bindRun)(Pha_Action["setState'"]((function () {
              var $206 = playAux(dictGame)(move);
              return function ($207) {
                  return $206(pushToHistory($207));
              };
          })()))(function (v) {
              var $136 = isLevelFinished(dictGame)(v);
              if ($136) {
                  var v1 = updateScore(dictGame)(v);
              ...
              var $141 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
              if ($141) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(1000))(function () {
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $144 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($144) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 311, column 5 - line 315, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var resetA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 145, column 29 - line 150, column 33): " + [ v.constructor.name ]);
  });
  ...
  var irules = function (lens) {
      return function (state) {
          ...
          return iconbutton(state)(function (v) {
              ...
              return lens(dictStrong);
          })(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.Rules.value)))) ]);
      };
  };
                      ...
                      return icongroup("Dimensions de la grille")(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.mapFlipped(Data_Functor.functorArray)(sizeList)(function (v) {
                          ...
                          if (customSize) {
                              return [ iconbutton(state)(function (v) {
                                  ...
                                  return lens(dictStrong);
                              })(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_customSize"](Data_Profunctor_Strong.strongFn))(true)))) ]) ];
                          };
                          return [  ];
                      })()));
                  };
      ...
      return function (lens) {
          return function (state) {
              return icongroup("Meilleur score (" + (Data_Maybe.maybe("\u2205")((function () {
                  ...
                  return lens(dictStrong);
              })(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.ScoreDialog.value)))) ]) ]);
          };
      };
  };
  exports["iconbutton"] = iconbutton;
...
(function($PS) {
  ...
  var trackPointer = function (lens) {
      ...
      var leave = Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value));
      return [ Pha_Html.style(Pha_Html.unittoStr)("touch-action")("none"), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
          ...
          return lens(dictStrong);
      })(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))), Pha_Html.pointerdown(Pha_Action.zoomAt(function (dictStrong) {
          return lens(dictStrong);
      })(move)) ];
  };
                      ...
                      return function (droppable) {
                          return function (id) {
                              return function (state) {
                                  ...
                                  return [ Pha_Html["class'"]("dragged")(dragged), Pha_Html["class'"]("candrop")(candrop), Pha_Html.pointerdown(Control_Applicative.when(Run.applicativeRun)(draggable)(Control_Apply.applySecond(Run.applyRun)(Game_Effs.releasePointerCapture)(Pha_Action.zoomAt(function (dictStrong) {
                                      return lens(dictStrong);
                                  })(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(id))))))), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
                                      return lens(dictStrong);
                                  })((function () {
                                      if (candrop) {
          ...
          return function (lens) {
              return function (dragLens) {
                  ...
                  var leave = Pha_Action.setState((function () {
                      var $61 = Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value);
                      var $62 = Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value);
                      return function ($63) {
                          return $61($62($63));
                      };
                  })());
                  return [ Pha_Html.style(Pha_Html.unittoStr)("touch-action")("none"), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
                      ...
                      return lens(dictStrong);
                  })(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))), Pha_Html.pointerleave(Pha_Action.zoomAt(function (dictStrong) {
                      return lens(dictStrong);
      ...
      return function (title) {
          return UI_Dialog.dialog({
              ...
              onOk: Data_Maybe.Just.create(Pha_Action.zoomAt(function (dictStrong) {
                  return lens(dictStrong);
              })(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.NoDialog.value))))
          });
      };
  };
  var defaultElements = {
                  ...
                  return function (hasBeast) {
                      return function (color) {
                          ...
                          return square({
                              ...
                              return lens(dictStrong);
                          })(Control_Monad.unlessM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Pha_Event.shiftKey)(Pha_Action.getEvent))(Game_Core.playA(Game_Labete_Model.labeteGame)(index)))), Pha_Html.pointerup(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
