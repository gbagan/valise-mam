...
(function($PS) {
  ...
  var span = Pha.h("span");
  var px = Pixel;
  var pointerup$prime = Pha.Event.create("pointerup");
  var pointerup = function ($9) {
      return pointerup$prime(Data_Function["const"]($9));
  };
  var pointermove$prime = Pha.Event.create("pointermove");
  var pointerleave$prime = Pha.Event.create("pointerleave");
  var pointerleave = function ($10) {
      return pointerleave$prime(Data_Function["const"]($10));
  };
  var pointerenter$prime = Pha.Event.create("pointerenter");
  var pointerenter = function ($11) {
      return pointerenter$prime(Data_Function["const"]($11));
  };
  var pointerdown$prime = Pha.Event.create("pointerdown");
  var pointerdown = function ($12) {
      return pointerdown$prime(Data_Function["const"]($12));
  };
  var pc = Percent;
  var p = Pha.h("p");
  ...
  var contextmenu$prime = Pha.Event.create("contextmenu");
  ...
  exports["style"] = style;
  exports["click'"] = click$prime;
  exports["click"] = click;
  exports["contextmenu'"] = contextmenu$prime;
  exports["pointermove'"] = pointermove$prime;
  exports["pointerup"] = pointerup;
  exports["pointerdown'"] = pointerdown$prime;
...
(function($PS) {
  ...
  var interpretEffects = Data_Functor_Variant.match()()()({
      ...
      eventEff: function (v) {
          if (v instanceof PreventDefault) {
              return Control_Apply.applySecond(Effect.applyEffect)(Pha_Event.preventDefault(v.value0))(v.value1);
          };
          if (v instanceof ReleasePointerCapture) {
              return Control_Apply.applySecond(Effect.applyEffect)($foreign.releasePointerCaptureAux(v.value0))(v.value1);
          };
          throw new Error("Failed pattern match at Game.Effs (line 66, column 15 - line 68, column 81): " + [ v.constructor.name ]);
      }
  });
  ...
  var functorEvEff = new Data_Functor.Functor(function (f) {
      return function (m) {
          ...
          if (m instanceof ReleasePointerCapture) {
              return new ReleasePointerCapture(m.value0, f(m.value1));
          };
          throw new Error("Failed pattern match at Game.Effs (line 38, column 1 - line 38, column 49): " + [ m.constructor.name ]);
      };
  });
  var preventDefault = function (ev) {
      return Run.lift()(new Data_Symbol.IsSymbol(function () {
          return "eventEff";
      }))(functorEvEff)(Data_Symbol.SProxy.value)(new PreventDefault(ev, Data_Unit.unit));
  };
                  ...
                  return function (droppable) {
                      return function (id) {
                          return function (state) {
                              ...
                              return [ Pha_Html["class'"]("dragged")(dragged), Pha_Html["class'"]("candrop")(candrop), Pha_Html["pointerdown'"](function (ev) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var cutter = function (row) {
          return function (col) {
              return function (move) {
                  return Pha_Svg.circle(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(50.0 * Data_Int.toNumber(col))(50.0 * Data_Int.toNumber(row))(7.0)([ Pha_Html.key("c" + Data_Show.show(Data_Show.showInt)((row * (columns + 1 | 0) | 0) + col | 0)), Pha_Html["class'"]("chocolat-cutter")(true), Pha_Html.pointerenter(Game_Chocolat_Model.setHoverA(new Data_Maybe.Just(move))), Pha_Html.pointerleave(Game_Chocolat_Model.setHoverA(Data_Maybe.Nothing.value)), Pha_Html.click(Control_Apply.applySecond(Run.applyRun)(Game_Chocolat_Model.setHoverA(Data_Maybe.Nothing.value))(Game_Core.playA(Game_Chocolat_Model.gameChocolat)(move))) ]);
              };
          };
      };
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var board = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer)([ Pha_Html["class'"]("ui-board dessin-board")(true), Pha_Html["contextmenu'"](function (ev) {
          return Control_Apply.applySecond(Run.applyRun)(Game_Effs.preventDefault(ev))(Game_Core.playA(Game_Dessin_Model.gameDessin)(Data_Maybe.Nothing.value));
          ...
          return function (v) {
              return Pha_Svg.circle(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(20.0 * v.x)(20.0 * v.y)(3.0)([ Pha_Svg.stroke((function () {
                  ...
                  return "blue";
              })()), Pha_Svg.fill("blue"), Pha_Html.click(Game_Core.playA(Game_Dessin_Model.gameDessin)(new Data_Maybe.Just(i))) ]);
          };
      ...
      var grid = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board frog-board")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(-190 | 0)(-200 | 0)(400)(400) ])(Data_Array.concat([ [ Pha_Svg.path(spiralPath)([ Pha_Svg.fill("none"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]), Pha_Svg.line(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(153.0)(9.0)(207.0)(20.0)([ Pha_Svg.stroke("black"), Pha_Svg.strokeDasharray("5"), Pha_Svg.strokeWidth("6") ]), Pha_Svg.line(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(153.0)(7.0)(153.0)(39.0)([ Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]), Pha_Svg.line(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(207.0)(18.0)(207.0)(50.0)([ Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]) ], Lib_Util.map2(spoints)(reachable)(function (i) {
          return function (v) {
              return function (reach) {
                  return Pha_Svg.g([ Pha_Html.key("lily" + Data_Show.show(Data_Show.showInt)(i)), Pha_Html["click'"](function (ev) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer)([ Pha_Html["class'"]("ui-board")(true), Pha_Html["pointerdown'"](function (ev) {
          ...
          return function (hasTrap) {
              return function (hasBeast) {
                  return function (color) {
                      ...
                      })([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html["click'"](function (ev) {
                      ...
                      }), Pha_Html.pointerup(Game_Labete_Model.finishZoneA(index)), Pha_Html["pointerdown'"](function (ev) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer)([ Pha_Html["class'"]("ui-board")(true), Pha_Html["contextmenu'"](function (ev) {
          return Control_Apply.applySecond(Run.applyRun)(Game_Effs.preventDefault(ev))(Game_Tiling_Model.rotateA);
                      ...
                      return function (h$prime) {
                          return function (props) {
                              return function (children) {
                                  ...
                                  })()) ])([ Pha_Svg.g(props)([ Pha_Svg.svg(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("valise-object")(true), Pha_Html.style(Pha_Html.unittoStr)("touch-action")("none"), Pha_Html["class'"]("draggable")(v.drag), Pha_Svg.width(Pha_Html.unitInt)(w$prime), Pha_Svg.height(Pha_Html.unitInt)(h$prime), Pha_Html.pointerdown((function () {
                                      if (v.drag) {
