  ...
  var functorRng = new Data_Functor.Functor(function (f) {
      return function (v) {
          return Rng(Data_Exists.runExists(function (v1) {
              return Data_Exists.mkExists(new GenWrapper(v1.value0, function ($19) {
                  return f(v1.value1($19));
              }));
          })(v));
      };
  });
...
(function($PS) {
  ...
  var scoreHash$prime = function (dictScoreGame) {
      return function (state) {
          ...
          throw new Error("Failed pattern match at Game.Core (line 338, column 1 - line 338, column 75): " + [ state.constructor.name ]);
      };
  };
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          ...
          if (Data_Boolean.otherwise) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 314, column 13 - line 316, column 43): " + [ bestMove.constructor.name ]);
          };
          throw new Error("Failed pattern match at Game.Core (line 303, column 1 - line 303, column 95): " + [ state.constructor.name ]);
      };
  };
  var computerPlay = function (dictGame) {
      return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (state) {
          return Control_Bind.bind(Run.bindRun)(Pha_Effects_Random.randomGenerate(computerMove(dictGame)(state)))(function (move) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 233, column 5 - line 237, column 51): " + [ v.constructor.name ]);
          });
      });
  };
      ...
      return function (v) {
          if (v instanceof Undo) {
              return Pha_Update.purely(function (state) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 162, column 35 - line 169, column 33): " + [ v1.constructor.name ]);
              });
          };
          if (v instanceof Redo) {
              return Pha_Update.purely(function (state) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 171, column 35 - line 178, column 33): " + [ v1.constructor.name ]);
              });
          };
          if (v instanceof Reset) {
              return Pha_Update.purely(function (state) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 180, column 36 - line 186, column 39): " + [ v1.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Game.Core (line 161, column 1 - line 161, column 85): " + [ v.constructor.name ]);
      };
  };
  var playA = function (dictGame) {
      return function (move) {
          return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (state) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 242, column 5 - line 253, column 26): " + [ v.constructor.name ]);
          }));
      };
  };
          ...
          return function (dragLens) {
              return function (to) {
                  return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (state) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 380, column 5 - line 384, column 71): " + [ v.constructor.name ]);
                  });
              };
          };
      };
      ...
      return function (dictGame) {
          return function (_dragged) {
              return function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Core (line 369, column 1 - line 370, column 79): " + [ _dragged.constructor.name, v.constructor.name ]);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var maybe = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Pha (line 76, column 1 - line 76, column 52): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
...
(function($PS) {
              ...
              if (v instanceof Data_Either.Right) {
                  return {
                      effect: function __do() {
                          Control_Applicative.when(Effect.applicativeEffect)(v.value0.stopPropagation)(Web_Event_Event.stopPropagation(ev))();
                          return Control_Applicative.when(Effect.applicativeEffect)(v.value0.preventDefault)(Web_Event_Event.preventDefault(ev))();
                      },
  ...
  exports["on"] = on;
  exports["on'"] = on$prime;
  exports["preventDefaultOn"] = preventDefaultOn;
  ...
  var iconbutton = function (dictPartialRecord) {
      return function (opts) {
          return function (props) {
              ...
              return Pha_Elements.button(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.class_("ui-icon"), Pha["class'"]("selected")(v.selected), Pha["class'"]("round")(v.large), Pha["class'"]("hidden")(v.hidden), Pha_Attributes.disabled(v.disabled), Pha_Events.preventDefaultOn("contextmenu")(Pha_Events_Decoder.always(new Data_Tuple.Tuple(Data_Maybe.Nothing.value, true))) ])(props))([ (function () {
                  if (v.icon instanceof IconSymbol) {
                      return Pha_Svg.svg(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.uncurry(Pha.style))(v.style))([ Pha_Svg.width("100%"), Pha_Svg.height("100%") ]))([ Pha_Svg.use([ Pha_Attributes.href(v.icon.value0), Pha.class_("ui-icon-symbol") ]) ]);
                  };
                  ...
                  throw new Error("Failed pattern match at UI.Icon (line 49, column 9 - line 54, column 33): " + [ v.icon.constructor.name ]);
...
(function($PS) {
  ...
  var iclear = function (dictMsgWithCore) {
      return function (state) {
          return iconbutton(Lib_Util.precord()())(state)({
              icon: new UI_Icon.IconSymbol("#clear"),
              tooltip: new Data_Maybe.Just("R\xe9initialise le jeu")
          })([ Pha_Events.onclick(Game_Core.core(dictMsgWithCore)(Game_Core.Clear.value)) ]);
      };
  };
          ...
          return function (pos) {
              return function (color) {
                  return Pha.when(peg !== Data_Lens_Getter.viewOn(state)(Game_Baseball_Model["_missingPeg"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
                      return Pha_Svg.g([ Pha.class_("baseball-player"), Pha.style("transform")(translatePeg(pos)(nbBases)), Pha.key("p" + Data_Show.show(Data_Show.showInt)(peg)) ])([ Pha_Svg.use([ Pha_Attributes.href("#meeple"), Pha_Svg.width("7"), Pha_Svg.height("7"), Pha_Events.onclick(new Game_Baseball_Model.Play(peg)), Pha_Svg.fill(color), Pha.style("animation")((function () {
                          if (levelFinished) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var cutter = function (row) {
          return function (col) {
              return function (move) {
                  return Pha_Svg.circle([ Pha_Svg.cx(Data_Show.show(Data_Show.showNumber)(50.0 * Data_Int.toNumber(col))), Pha_Svg.cy(Data_Show.show(Data_Show.showNumber)(50.0 * Data_Int.toNumber(row))), Pha_Svg.r_("7"), Pha.key("c" + Data_Show.show(Data_Show.showInt)((row * (columns + 1 | 0) | 0) + col | 0)), Pha.class_("chocolat-cutter"), Pha_Events.onpointerenter(new Game_Chocolat_Model.SetHover(new Data_Maybe.Just(move))), Pha_Events.onpointerleave(new Game_Chocolat_Model.SetHover(Data_Maybe.Nothing.value)), Pha_Events.onclick(new Game_Chocolat_Model.Play(move)) ]);
              };
          };
      };
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(3))([ Pha.class_("ui-board") ]))([ Pha_Svg.svg([ Pha_Svg.viewBox(-7 | 0)(-7 | 0)((50 * columns | 0) + 14 | 0)((50 * rows | 0) + 14 | 0) ])(Data_Array.concat([ Lib_Util.repeat2(rows)(columns)(function (row) {
          ...
          throw new Error("Failed pattern match at Game.Chocolat.View (line 63, column 41 - line 67, column 105): " + [ v1.constructor.name ]);
      }), [ Pha_Svg.use([ Pha_Attributes.href("#skull"), Pha_Svg.x_(Data_Show.show(Data_Show.showInt)((50 * v.col | 0) + 12 | 0)), Pha_Svg.y_(Data_Show.show(Data_Show.showInt)((50 * v.row | 0) + 12 | 0)), Pha_Svg.width("26"), Pha_Svg.height("26"), Pha.key("skull"), Pha.class_("chocolat-skull") ]), Pha.maybe(Data_Lens_Getter.viewOn(state)(Game_Chocolat_Model["_moveWhenHover"](Data_Lens_Internal_Forget.strongForget)))(function (m) {
          var v1 = Game_Chocolat_Model.cutLine(state)(m);
          return Pha_Svg.line([ Pha_Svg.x1_(Data_Show.show(Data_Show.showInt)(50 * v1.x1 | 0)), Pha_Svg.y1_(Data_Show.show(Data_Show.showInt)(50 * v1.y1 | 0)), Pha_Svg.x2_(Data_Show.show(Data_Show.showInt)(50 * v1.x2 | 0)), Pha_Svg.y2_(Data_Show.show(Data_Show.showInt)(50 * v1.y2 | 0)), Pha.key("line"), Pha.class_("chocolat-cut-line") ]);
      }) ] ])) ]);
      var config = UI_Template.card("Barre de chocolat")([ UI_Icons.iconSizesGroup(Game_Chocolat_Model.withcore)(state)([ new Data_Tuple.Tuple(6, 7) ])(true), UI_Icons.iconSelectGroup(UI_Icons.defa)(Game_Chocolat_Model.eqSoapMode)(state)("Emplacement du savon")([ Game_Chocolat_Model.CornerMode.value, Game_Chocolat_Model.BorderMode.value, Game_Chocolat_Model.StandardMode.value ])(Data_Lens_Getter.viewOn(state)(Game_Chocolat_Model["_soapMode"](Data_Lens_Internal_Forget.strongForget)))(Game_Chocolat_Model.SetSoapMode.create)(function (mode) {
          return function (opt) {
              ...
              throw new Error("Failed pattern match at Game.Chocolat.View (line 32, column 60 - line 35, column 103): " + [ mode.constructor.name ]);
          };
...
(function($PS) {
  ...
  var currentLine = function (p1) {
      return function (p2) {
          return Pha_Svg.line([ Pha_Svg.x1_(Data_Show.show(Data_Show.showNumber)(100.0 * p1.x)), Pha_Svg.y1_(Data_Show.show(Data_Show.showNumber)(100.0 * p1.y)), Pha_Svg.x2_(Data_Show.show(Data_Show.showNumber)(20.0 * p2.x)), Pha_Svg.y2_(Data_Show.show(Data_Show.showNumber)(20.0 * p2.y)), Pha.class_("dessin-line-to-pointer") ]);
      };
  };
  var view = function (state) {
      ...
      var board = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(Game_Dessin_Model.withcore))([ Pha.class_("ui-board dessin-board"), Pha_Events.oncontextmenu(new Game_Dessin_Model.Play(Data_Maybe.Nothing.value)) ]))([ Pha_Svg.svg([ Pha.class_("dessin-svg"), Pha_Svg.viewBox(0)(0)(100)(100) ])(Data_Array.concat([ Data_Functor.mapFlipped(Data_Functor.functorArray)(graph.edges)(function (edge) {
          return Pha.maybe(getCoordsOfEdge(graph)(edge))(function (v) {
              return Pha_Svg.line([ Pha_Svg.x1_(Data_Show.show(Data_Show.showNumber)(20.0 * v.px1)), Pha_Svg.y1_(Data_Show.show(Data_Show.showNumber)(20.0 * v.py1)), Pha_Svg.x2_(Data_Show.show(Data_Show.showNumber)(20.0 * v.px2)), Pha_Svg.y2_(Data_Show.show(Data_Show.showNumber)(20.0 * v.py2)), Pha.class_("dessin-line1") ]);
          });
          ...
          return Pha.maybe(getCoordsOfEdge(graph)(edge))(function (v) {
              return Pha_Svg.line([ Pha_Svg.x1_(Data_Show.show(Data_Show.showNumber)(20.0 * v.px1)), Pha_Svg.y1_(Data_Show.show(Data_Show.showNumber)(20.0 * v.py1)), Pha_Svg.x2_(Data_Show.show(Data_Show.showNumber)(20.0 * v.px2)), Pha_Svg.y2_(Data_Show.show(Data_Show.showNumber)(20.0 * v.py2)), Pha.class_("dessin-line2") ]);
          });
      }), Data_Array.mapWithIndex(function (i) {
          return function (v) {
              return Pha_Svg.circle([ Pha_Svg.cx(Data_Show.show(Data_Show.showNumber)(20.0 * v.x)), Pha_Svg.cy(Data_Show.show(Data_Show.showNumber)(20.0 * v.y)), Pha_Svg.r_("3"), Pha_Svg.stroke((function () {
              ...
              return function (srcs) {
                  return function (dests) {
                      if (from === to || Data_Foldable.elem(Data_Foldable.foldableArray)(eqEdge)(new Edge(from, to))(edges)) {
                          ...
                          throw new Error("Failed pattern match at Game.Eternal.Model (line 299, column 9 - line 301, column 40): " + [ v.constructor.name ]);
                      };
                      if (Data_Boolean.otherwise) {
                          return dests;
                      };
  ...
  var update = function (v) {
      ...
      if (v instanceof Play) {
          return Control_Bind.bind(Run.bindRun)(Pha_Update.getState)(function (st) {
              ...
              throw new Error("Failed pattern match at Game.Eternal.Model (line 341, column 5 - line 344, column 47): " + [ v1.constructor.name ]);
          });
      };
...
(function($PS) {
      ...
      return function (x2) {
          return function (y1) {
              return function (y2) {
                  ...
                  var x3 = x2 + 6.0 * $$Math.sin(angle - $$Math.pi / 3.0);
                  var x4 = x2 + 6.0 * $$Math.sin(angle - (2.0 * $$Math.pi) / 3.0);
                  var y3 = y2 + 6.0 * $$Math.cos(angle - $$Math.pi / 3.0);
                  var y4 = y2 + 6.0 * $$Math.cos(angle - (2.0 * $$Math.pi) / 3.0);
                  var arrowPath = "M" + (Data_Show.show(Data_Show.showNumber)(x2) + ("," + (Data_Show.show(Data_Show.showNumber)(y2) + ("L" + (Data_Show.show(Data_Show.showNumber)(x3) + ("," + (Data_Show.show(Data_Show.showNumber)(y3) + ("L" + (Data_Show.show(Data_Show.showNumber)(x4) + ("," + (Data_Show.show(Data_Show.showNumber)(y4) + "z")))))))))));
                  return Pha_Svg.g([  ])([ Pha_Svg.line([ Pha_Svg.x1_(Data_Show.show(Data_Show.showNumber)(x1)), Pha_Svg.y1_(Data_Show.show(Data_Show.showNumber)(y1)), Pha_Svg.x2_(Data_Show.show(Data_Show.showNumber)(x2)), Pha_Svg.y2_(Data_Show.show(Data_Show.showNumber)(y2)), Pha.class_("dessin-line2") ]), Pha_Svg.path([ Pha_Svg.d_(arrowPath), Pha_Svg.fill("red") ]) ]);
              };
          };
      };
  };
  ...
  var cursor = function (pp) {
      return function (v) {
          return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.key("cursor"), Pha_Attributes.href("#roman"), Pha_Svg.width("6"), Pha_Svg.height("12"), Pha_Svg.x_("-3"), Pha_Svg.y_("-6"), Pha.style("pointer-events")("none") ])(UI_Template.svgCursorStyle(pp)));
      };
  };
  var view = function (state) {
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(dndBoardProps)([ Pha.class_("ui-board eternal-board"), Pha.style("width")("100%"), Pha.style("height")("100%") ]))([ Pha_Svg.svg([ Pha.class_("eternal-svg"), Pha_Svg.viewBox(0)(0)(100)(100) ])([ Pha_Svg.g([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(graph.edges)(function (edge) {
          return Pha.maybe(getCoordsOfEdge(graph)(edge))(function (v) {
              return Pha_Svg.line([ Pha_Svg.x1_(Data_Show.show(Data_Show.showNumber)(100.0 * v.x1)), Pha_Svg.y1_(Data_Show.show(Data_Show.showNumber)(100.0 * v.y1)), Pha_Svg.x2_(Data_Show.show(Data_Show.showNumber)(100.0 * v.x2)), Pha_Svg.y2_(Data_Show.show(Data_Show.showNumber)(100.0 * v.y2)), Pha.class_("dessin-line1") ]);
          });
          ...
          return Pha_Svg.g([  ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array.zip(guards)(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_nextmove"](Data_Lens_Internal_Forget.strongForget))))(function (v1) {
              return Pha.when(v1.value0 !== v1.value1)(function (v2) {
                  return Pha.maybe(getCoordsOfEdge(graph)(new Game_Eternal_Model.Edge(v1.value0, v1.value1)))(function (v3) {
                      return drawArrow(v3.x1 * 100.0)(v3.x2 * 100.0)(v3.y1 * 100.0)(v3.y2 * 100.0);
                  });
              });
          }));
      }), Pha_Svg.g([  ])(Data_Array.mapWithIndex(function (i) {
          return function (v) {
              return Pha_Svg.circle([ Pha.key(Data_Show.show(Data_Show.showInt)(i)), Pha_Svg.cx(Data_Show.show(Data_Show.showNumber)(100.0 * v.x)), Pha_Svg.cy(Data_Show.show(Data_Show.showNumber)(100.0 * v.y)), Pha_Svg.r_("3"), Pha_Svg.fill("blue") ]);
          };
      })(graph.vertices)), Pha_Svg.g([  ])(Data_Array.mapWithIndex(function (i) {
          return function (index) {
              return Pha_Svg.use([ Pha.key(Data_Show.show(Data_Show.showInt)(i)), Pha_Attributes.href("#roman"), Pha_Svg.width("6"), Pha_Svg.height("12"), Pha_Svg.x_("-3"), Pha_Svg.y_("-6"), Pha.class_("eternal-guard"), Pha["class'"]("no-move")(Data_Eq.eq(Game_Eternal_Model.eqPhase)(phase)(Game_Eternal_Model.PrepPhase.value)), Pha.style("transform")(Data_Maybe.fromMaybe("none")(Data_Functor.map(Data_Maybe.functorMaybe)(translateGuard)(getCoords(graph)(index)))) ]);
          };
      })(guards)), Pha.maybeN(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(position.attacked)(function (attack) {
          return Pha_Svg.use([ Pha.key("attack"), Pha_Attributes.href("#eternal-attack"), Pha_Svg.width("8"), Pha_Svg.height("8"), Pha_Svg.x_("-4"), Pha_Svg.y_("-4"), Pha.style("transform")(Data_Maybe.fromMaybe("none")(Data_Functor.map(Data_Maybe.functorMaybe)(translateGuard)(getCoords(graph)(attack)))), Pha.style("pointer-events")("none") ]);
      ...
      })()) ]), Pha_Elements.button([ Pha.class_("ui-button ui-button-primary dessin-raise"), Pha_Attributes.disabled(Data_Array["null"](position.guards) || Data_Eq.eq(Game_Eternal_Model.eqPhase)(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_phase"](Data_Lens_Internal_Forget.strongForget)))(Game_Eternal_Model.GamePhase.value) && (Data_Eq.eq(Game_Eternal_Model.eqrules)(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_rules"](Data_Lens_Internal_Forget.strongForget)))(Game_Eternal_Model.OneGuard.value) || (Data_Maybe.isNothing(position.attacked) || !Game_Eternal_Model.isValidNextMove(state)(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_nextmove"](Data_Lens_Internal_Forget.strongForget)))))), Pha_Events.onclick((function () {
      ...
      var config = UI_Template.card("Domination \xe9ternelle")([ UI_Icons.iconSelectGroup(UI_Icons.defa)(Game_Eternal_Model.eqgkind)(state)("Type de graphe")([ Game_Eternal_Model.Path.value, Game_Eternal_Model.Cycle.value, Game_Eternal_Model.Biclique.value, Game_Eternal_Model.Sun.value, Game_Eternal_Model.Grid.value ])(Data_Lens_Getter.viewOn(state)(Game_Eternal_Model["_graphkind"](Data_Lens_Internal_Forget.strongForget)))(Game_Eternal_Model.SetGraphKind.create)(function (v) {
          if (v instanceof Game_Eternal_Model.Path) {
              return function (v1) {
                  return {
                      icon: new UI_Icon.IconSymbol("#graph-path"),
          ...
          if (v instanceof Game_Eternal_Model.Cycle) {
              return function (v1) {
                  return {
                      icon: new UI_Icon.IconSymbol("#graph-cycle"),
                      selected: v1.selected,
          ...
          if (v instanceof Game_Eternal_Model.Biclique) {
              return function (v1) {
                  return {
                      icon: new UI_Icon.IconSymbol("#graph-biclique"),
                      selected: v1.selected,
          ...
          if (v instanceof Game_Eternal_Model.Grid) {
              return function (v1) {
                  return {
                      icon: new UI_Icon.IconSymbol("#graph-grid"),
                      selected: v1.selected,
          ...
          if (v instanceof Game_Eternal_Model.Sun) {
              return function (v1) {
                  return {
                      icon: new UI_Icon.IconSymbol("#graph-sun"),
                      selected: v1.selected,
          ...
          throw new Error("Failed pattern match at Game.Eternal.View (line 114, column 121 - line 119, column 82): " + [ v.constructor.name ]);
          ...
          throw new Error("Failed pattern match at Game.Eternal.View (line 121, column 84 - line 123, column 88): " + [ v.constructor.name ]);
      }), UI_Icons.icons2Players(Game_Eternal_Model.withcore)(Game_Eternal_Model.game)(state), UI_Icons.icongroup("Options")(Data_Functor.mapFlipped(Data_Functor.functorArray)([ UI_Icons.iundo(Game_Eternal_Model.withcore), UI_Icons.iredo(Game_Eternal_Model.withcore), UI_Icons.ireset(Game_Eternal_Model.withcore), UI_Icons.iclear(Game_Eternal_Model.withcore), UI_Icons.irules(Game_Eternal_Model.withcore) ])(function (x) {
          return x(state);
      })) ]);
          ...
          return function (y) {
              return function (reachable) {
                  return function (hidden) {
                      ...
                      return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)(pos)([ Pha_Attributes.href("#lily"), Pha.class_("frog-lily"), Pha["class'"]("reachable")(reachable), Pha["class'"]("hidden")(hidden) ]));
                  };
              };
          };
      };
  };
  var drawSpiral = [ Pha_Svg.path([ Pha_Svg.d_(spiralPath), Pha_Svg.fill("none"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]), Pha_Svg.line([ Pha_Svg.x1_("153"), Pha_Svg.y1_("9"), Pha_Svg.x2_("207"), Pha_Svg.y2_("20"), Pha_Svg.stroke("black"), Pha_Svg.strokeDasharray("5"), Pha_Svg.strokeWidth("6") ]), Pha_Svg.line([ Pha_Svg.x1_("153"), Pha_Svg.y1_("7"), Pha_Svg.x2_("153"), Pha_Svg.y2_("39"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]), Pha_Svg.line([ Pha_Svg.x1_("207"), Pha_Svg.y1_("18"), Pha_Svg.x2_("207"), Pha_Svg.y2_("50"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]) ];
  var view = function (state) {
      var winTitle = UI_Template.winTitleFor2Players(state);
          ...
          return function (mark) {
              return function (v) {
                  return Pha.when(mark && i !== position)(function (v1) {
                      return Pha_Svg.use([ Pha_Attributes.href("#frog2"), Pha_Svg.x_(Data_Show.show(Data_Show.showNumber)(v.x - 20.0)), Pha_Svg.y_(Data_Show.show(Data_Show.showNumber)(v.y - 20.0)), Pha_Svg.width("32"), Pha_Svg.height("32"), Pha.key("reach" + Data_Show.show(Data_Show.showInt)(i)), Pha.class_("frog-frog marked") ]);
                  });
              };
          };
      });
      ...
      var drawFrog = Pha.maybe(Data_Array.index(pointsPolar)(position))(function (v) {
          return Pha_Svg.g([ Pha.key("frog"), Pha.class_("frog-frog-container"), Pha.style("transform")(Pha_Util.translate(Pha_Util.px(v.radius))("0") + (" rotate(" + (Data_Show.show(Data_Show.showNumber)((v.theta * 180.0) / $$Math.pi) + "deg)"))), Pha.style("transform-origin")(Pha_Util.px(-v.radius) + " 0") ])([ Pha_Svg.g([ Pha.class_("frog-frog-container"), Pha.style("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((-v.theta * 180.0) / $$Math.pi) + "deg)")) ])([ Pha_Svg.use([ Pha_Attributes.href("#frog2"), Pha_Svg.x_("-20"), Pha_Svg.y_("-20"), Pha_Svg.width("40"), Pha_Svg.height("40"), Pha.class_("frog-frog"), Pha["class'"]("goal")(position === 0) ]) ]) ]);
      });
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])(props))([ Pha_Svg.use([ Pha_Attributes.href("#grass"), Pha_Svg.width("50"), Pha_Svg.height("50"), Pha_Svg.fill(Data_Maybe.fromMaybe("")(Data_Array.index(colors)(v.color))) ]), Pha_Svg.rect([ Pha_Svg.width("51"), Pha_Svg.height("51"), Pha.class_("labete-square-borders") ]), Pha_Svg.use([ Pha_Attributes.href("#paw"), Pha_Svg.x_("5"), Pha_Svg.y_("5"), Pha_Svg.width("40"), Pha_Svg.height("40"), Pha.class_("labete-beast"), Pha["class'"]("visible")(v.hasBeast) ]), Pha.when(v.hasTrap)(function (v1) {
              return Pha_Svg.use([ Pha_Attributes.href("#trap"), Pha_Svg.x_("5"), Pha_Svg.y_("5"), Pha_Svg.width("40"), Pha_Svg.height("40") ]);
          }) ]);
      };
  };
  ...
  var view = function (state) {
      ...
      var cursor = function (pp) {
          return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.svgCursorStyle(pp))([ Pha.key("cursor"), Pha_Attributes.href("#trap"), Pha_Svg.x_("-20"), Pha_Svg.y_("-20"), Pha_Svg.width("40"), Pha_Svg.height("40"), Pha.attr("opacity")("0.7"), Pha.attr("pointer-events")("none") ]));
      };
      var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(Game_Labete_Model.withcore))([ Pha.class_("ui-board"), Pha_Events["on'"]("pointerdown")(function (ev) {
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 112, column 26 - line 114, column 80): " + [ v.constructor.name ]);
      })()) ])) ]);
      var scoreDialog = function (v) {
      ...
      var config = UI_Template.card("La b\xeate")([ UI_Icons.iconSelectGroup(UI_Icons.defa)(Game_Labete_Model.eqBt)(state)("Forme de la b\xeate")(beastTypes)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_beastType"](Data_Lens_Internal_Forget.strongForget)))(Game_Labete_Model.SetBeast.create)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 66, column 94 - line 71, column 64): " + [ v.constructor.name ]);
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 72, column 84 - line 75, column 89): " + [ v.constructor.name ]);
  ...
  var view = function (state) {
      ...
      var drawPeg = function (i) {
          return function (player) {
              return function (j) {
                  return Pha_Svg.use([ Pha_Attributes.href("#meeple"), Pha.key("p-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(player)))), Pha_Svg.width("8"), Pha_Svg.height("8"), Pha.class_("nim-player"), Pha_Svg.fill((function () {
                      var $5 = player === 0;
                      if ($5) {
                          return "blue";
                      };
      ...
      return function (cross) {
          return function (props) {
              return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.class_("noirblanc-square") ])(props))([ Pha_Elements.div([ Pha.class_("noirblanc-square-inner"), Pha["class'"]("blanc")(light) ])([ Pha_Elements.div([ Pha.class_("noirblanc-square-blanc") ])((function () {
                  if (cross) {
                      return [ Pha_Svg.svg([ Pha.class_("ui-absolute noirblanc-cross") ])([ Pha_Svg.use([ Pha_Svg.d_("#cross") ]) ]) ];
                  };
                  return [  ];
...
(function($PS) {
  ...
  var game = new Game_Core.Game(function (v) {
      ...
      return Control_Applicative.pure(Control_Monad_Free.freeApplicative)((function () {
          ...
          throw new Error("Failed pattern match at Game.Paths.Model (line 76, column 36 - line 78, column 27): " + [ v.constructor.name ]);
      })());
  }, function (state) {
      ...
      return function (v) {
          ...
          throw new Error("Failed pattern match at Game.Paths.Model (line 64, column 9 - line 71, column 28): " + [ v1.constructor.name ]);
      };
  }, function (v) {
      return new Game_Core.SizeLimit(2, 2, 9, 9);
  }, function (st) {
  ...
  var update = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Paths.Model (line 94, column 1 - line 94, column 33): " + [ v.constructor.name ]);
  };
  exports["Mode1"] = Mode1;
  exports["Mode2"] = Mode2;
  exports["istate"] = istate;
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          ...
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("paths-darken")(v.darken) ])(props))([ Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Attributes.href("#paths-background") ])(pos)), Pha.when(v.door)(function (v1) {
              return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Attributes.href("#paths-door") ])(pos));
          }), Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)(pos)([ Pha_Attributes.href("#paths-trap"), Pha.class_("paths-trap"), Pha["class'"]("visible")(v.trap && !v.door) ])) ]);
      };
  };
  var heroCursor = function (pp) {
      return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Attributes.href("#meeplehat"), Pha.key("chero"), Pha.class_("paths-cursor"), Pha_Svg.x_("-40"), Pha_Svg.y_("-40"), Pha_Svg.width("80"), Pha_Svg.height("80") ])(UI_Template.svgCursorStyle(pp)));
  };
  var doorCursor = function (pp) {
      return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Attributes.href("#paths-door"), Pha.key("cdoor"), Pha.class_("paths-cursor"), Pha_Svg.x_("-50"), Pha_Svg.y_("-50"), Pha_Svg.width("100"), Pha_Svg.height("100") ])(UI_Template.svgCursorStyle(pp)));
  };
  var view = function (state) {
      ...
      var config = UI_Template.card("Chemins")([ UI_Icons.iconSelectGroup(UI_Icons.defa)(Game_Paths_Model.eqMode)(state)("Mode de jeu")([ Game_Paths_Model.Mode1.value, Game_Paths_Model.Mode2.value ])(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Paths_Model.SelectMode.create)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Paths.View (line 63, column 90 - line 65, column 85): " + [ v.constructor.name ]);
      ...
      var hero = function (h) {
          ...
          return Pha_Svg.use([ Pha_Attributes.href("#meeplehat"), Pha.key("hero"), Pha_Svg.width("80"), Pha_Svg.height("80"), Pha.class_("paths-hero"), Pha.style("transform")(Pha_Util.translate(Pha_Util.pc((Data_Int.toNumber(v.col) + 0.1) / Data_Int.toNumber(columns)))(Pha_Util.pc((Data_Int.toNumber(v.row) + 0.1) / Data_Int.toNumber(rows)))) ]);
      };
      ...
      }))([ Pha_Svg.path([ Pha_Svg.d_(pathdec), Pha.class_("paths-path") ]), Pha.maybe(Data_Array.last(position))(hero), Pha.maybe(Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget)))(function (pp) {
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(props)([ Pha.class_("queens-square"), Pha["class'"]("queens-square-capturable")(v.capturable), Pha["class'"]("queens-square-nonavailable")(v.nonavailable), Pha["class'"]("queens-square-selected")(v.selected) ]))((function () {
              ...
              return [ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%"), Pha.class_("queens-piece") ])([ Pha_Svg.use([ Pha_Attributes.href("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(v.piece)), Pha_Svg.x_("10%"), Pha_Svg.y_("10%"), Pha_Svg.width("80%"), Pha_Svg.height("80%") ]) ]) ];
          })());
      };
  };
  var view = function (state) {
      ...
      var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var cursor = function (pp) {
          return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.class_("ui-cursor") ])(UI_Template.cursorStyle(pp)(rows)(columns)(0.8)))([ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%") ])([ Pha_Svg.use([ Pha_Attributes.href("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_selectedPiece"](Data_Lens_Internal_Forget.strongForget)))) ]) ]) ]);
      };
...
(function($PS) {
  ...
  var innerWheel = function (size) {
      return Pha_Elements.div([ Pha.class_("roue-inner") ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100)(100) ])(Data_Array.mapWithIndex(function (i) {
          return function (color) {
              return Pha_Svg.path([ Pha_Svg.d_(pizza(50.0)(50.0)(50.0)((2.0 * $$Math.pi * (Data_Int.toNumber(i) - 0.5)) / Data_Int.toNumber(size))((2.0 * $$Math.pi * (Data_Int.toNumber(i) + 0.5)) / Data_Int.toNumber(size))), Pha_Svg.fill(color), Pha_Svg.stroke("black") ]);
          };
      ...
      var outerWheel = Pha_Elements.div([ Pha.class_("roue-outer"), Pha.style("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((360.0 * Data_Int.toNumber(Data_Lens_Getter.viewOn(state)(Game_Roue_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)))) / Data_Int.toNumber(size)) + "deg)")) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.svg([ Pha.key("svg"), Pha_Svg.viewBox(0)(0)(100)(100) ])(Lib_Util.map2(position)(Game_Roue_Model.aligned(state))(function (i) {
          return function (pos) {
              return function (align) {
                  return Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_(pizza(50.0)(50.0)(50.0)((2.0 * $$Math.pi * (Data_Int.toNumber(i) - 0.5)) / Data_Int.toNumber(size))((2.0 * $$Math.pi * (Data_Int.toNumber(i) + 0.5)) / Data_Int.toNumber(size))), Pha.class_("roue-wheel-part"), Pha_Svg.fill((function () {
                      var $6 = !align;
                      if ($6) {
                          return "#F0B27A";
                      };
...
(function($PS) {
  ...
  var animPytha = function (v) {
      ...
      return Pha_Svg.svg([ Pha.class_("sansmot-svg"), Pha_Svg.viewBox(0)(0)(700)(300), Pha.style("width")("84vmin"), Pha.style("height")("36vmin") ])([ Pha_Svg.path([ Pha_Svg.d_("M 0 300 h 300 v -300 h -300 Z L 100 100 M 0 100 h 300 l -200 -100 v 300"), Pha_Svg.fill("transparent"), Pha_Svg.stroke("#000") ]), Pha_Svg.path([ Pha_Svg.d_("M 400 300 h 300 v -300 h -300 Z M 400 200 l 200 100 l 100 -200 l -200 -100 l -100 200"), Pha_Svg.fill("transparent"), Pha_Svg.stroke("#000") ]), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 0 300 v -200 h 100 Z"), Pha_Svg.fill("blue"), Pha_Svg.stroke("#000") ])(f("a"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 0 300 h 100 v -200 Z"), Pha_Svg.fill("yellow"), Pha_Svg.stroke("#000") ])(f("b"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 100 0 h 200 v 100 Z"), Pha_Svg.fill("#00FF00"), Pha_Svg.stroke("#000") ])(f("c"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 100 0 v 100 h 200 Z"), Pha_Svg.fill("red"), Pha_Svg.stroke("#000") ])(f("d"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 0 300 v -200 h 100 Z"), Pha_Svg.fill("blue"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 0 300 h 100 v -200 Z"), Pha_Svg.fill("yellow"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 100 0 h 200 v 100 Z"), Pha_Svg.fill("#00FF00"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 100 0 v 100 h 200 0 Z"), Pha_Svg.fill("red"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg["text'"]("a")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("5"), Pha_Svg.y_("55"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("a")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("46"), Pha_Svg.y_("12"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("b")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("105"), Pha_Svg.y_("210"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("b")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("198"), Pha_Svg.y_("120"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("c")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("450"), Pha_Svg.y_("98"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("c")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("595"), Pha_Svg.y_("80"), Pha.style("font-size")("20") ])(f("e"))) ]);
  };
  var animCaroll = function (v) {
      ...
      return Pha_Svg.svg([ Pha.class_("sansmot-svg"), Pha_Svg.viewBox(-10 | 0)(-10 | 0)(1370)(270), Pha_Svg.width("90vw"), Pha_Svg.height("19vw") ])(Data_Array.concat([ [ Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 400 100 h 250 v -100 Z"), Pha_Svg.fill("orange") ])(f("a"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 400 200 h 150 v -50 h 100 v -50 h -250 Z"), Pha_Svg.fill("red") ])(f("b"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 400 250 h 250 v -100 h -100 v 50 h -150 Z"), Pha_Svg.fill("blue") ])(f("c"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 0 250 h 400 v -150 Z"), Pha_Svg.fill("green") ])(f("d"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 400 100 h 250 v -100 Z"), Pha_Svg.fill("orange") ])(f("e"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 400 200 h 150 v -50 h 100 v -50 h -250 Z"), Pha_Svg.fill("red") ])(f("e"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 400 250 h 250 v -100 h -100 v 50 h -150 Z"), Pha_Svg.fill("blue") ])(f("e"))), Pha_Svg.path(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.d_("M 0 250 h 400 v -150 Z"), Pha_Svg.fill("green") ])(f("e"))) ], Lib_Util.repeat(28)(function (i) {
  ...
  var view = function (state) {
      var main = function (v) {
          ...
          throw new Error("Failed pattern match at Game.Sansmot.View (line 105, column 5 - line 122, column 10): " + [ v.constructor.name ]);
      };
...
(function($PS) {
  ...
  var cursor = function (pp) {
      return function (v) {
          return Pha_Svg.circle(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.r_("20"), Pha.class_("solitaire-cursor") ])(UI_Template.svgCursorStyle(pp)));
      };
  };
  var view = function (state) {
      ...
      var drawHole = function (i) {
          ...
          }), Pha_Svg.circle(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.key("h" + Data_Show.show(Data_Show.showInt)(i)), Pha_Svg.r_("17"), Pha.class_("solitaire-hole"), Pha.style("transform")(itemStyle(i)) ])(UI_Template.dndItemProps(Data_Eq.eqInt)(Game_Solitaire_Model.withdnd)(Game_Solitaire_Model.solitaireGame)(state)({
      ...
      var drawPeg = function (i) {
          return Pha_Svg.circle(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.r_("20"), Pha.key("p" + Data_Show.show(Data_Show.showInt)(i)), Pha.class_("solitaire-peg"), Pha.style("transform")(itemStyle(i)) ])(UI_Template.dndItemProps(Data_Eq.eqInt)(Game_Solitaire_Model.withdnd)(Game_Solitaire_Model.solitaireGame)(state)({
              draggable: true,
              droppable: false,
              currentDragged: Data_Lens_Getter.viewOn(state)(Game_Solitaire_Model["_dragged"](Data_Lens_Internal_Forget.strongForget)),
              id: i
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.class_("ui-board") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Game_Solitaire_Model.withcore)(Game_Solitaire_Model.withdnd))((function () {
          ...
          return Pha_Svg.circle([ Pha_Svg.cx("125"), Pha_Svg.cy("125"), Pha_Svg.r_("90"), Pha.class_("solitaire-circle") ]);
              ...
              return [ Pha_Elements.div([ Pha.class_("ui-flex-center solitaire-scoredialog") ])([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.class_("ui-board") ])((function () {
                  ...
                  return function (v1) {
                      return Pha.when(v1)(function (v2) {
                          return Pha_Svg.circle([ Pha.key("h" + Data_Show.show(Data_Show.showInt)(i)), Pha_Svg.r_("17"), Pha.class_("solitaire-hole"), Pha.style("transform")(itemStyle(i)) ]);
                      });
                  };
              })(Data_Lens_Getter.viewOn(state)(Game_Solitaire_Model["_holes"](Data_Lens_Internal_Forget.strongForget))), Data_Array.mapWithIndex(function (i) {
                  return function (v1) {
                      return Pha.when(v1)(function (v2) {
                          return Pha_Svg.circle([ Pha.key("p" + Data_Show.show(Data_Show.showInt)(i)), Pha_Svg.r_("20"), Pha.class_("solitaire-peg"), Pha.style("transform")(itemStyle(i)) ]);
                      });
                  };
              })(position) ])) ]) ]) ];
          });
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("tiling-darken")(v.isDark), Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])(props))([ Pha_Svg.rect([ Pha_Svg.width("50"), Pha_Svg.height("50"), Pha.key("conc"), Pha_Svg.fill("url(#concrete)") ]), Pha.when(v.hasBlock)(function (v1) {
              return Pha_Svg.use([ Pha_Attributes.href("#tile2"), Pha_Svg.width("50"), Pha_Svg.height("50"), Pha.key("tile") ]);
          }), Pha.when(v.hasSink)(function (v1) {
              return Pha_Svg.use([ Pha_Attributes.href("#sink"), Pha_Svg.width("50"), Pha_Svg.height("50"), Pha.key("sink") ]);
          }) ]);
      };
  };
  var view = function (state) {
      var tileCursor = function (pp) {
          return Pha_Svg.g(UI_Template.svgCursorStyle(pp))([ Pha_Svg.g([ Pha.class_("tiling-cursor"), Pha.style("transform")("rotate(" + (Data_Show.show(Data_Show.showInt)(90 * Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)) | 0) + "deg)")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_tile"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
              return Pha_Svg.use([ Pha_Attributes.href("#tile2"), Pha_Svg.x_(Data_Show.show(Data_Show.showNumber)(50.0 * Data_Int.toNumber(v.col) - 25.0)), Pha_Svg.y_(Data_Show.show(Data_Show.showNumber)(50.0 * Data_Int.toNumber(v.row) - 25.0)), Pha_Svg.width("50"), Pha_Svg.height("50"), Pha.attr("pointer-events")("none"), Pha.attr("opacity")((function () {
      ...
      var sinkCursor = function (pp) {
          return Pha_Svg.use(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Attributes.href("#sink"), Pha_Svg.x_("-25"), Pha_Svg.y_("-25"), Pha_Svg.width("50"), Pha_Svg.height("50"), Pha.attr("pointer-events")("none") ])(UI_Template.svgCursorStyle(pp)));
      };
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(Game_Tiling_Model.withcore))([ Pha.class_("ui-board"), Pha_Events.oncontextmenu(Game_Tiling_Model.Rotate.value) ])))([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0) ])(Data_Array.concat([ Data_Array.mapWithIndex(function (index) {
          ...
          return function (pos) {
              ...
              return Pha_Svg.g([ Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])([ Pha.when(pos > 0 && border(index)(-1 | 0))(function (v1) {
                  return Pha_Svg.line([ Pha_Svg.x1_("0"), Pha_Svg.y1_("0"), Pha_Svg.x2_("0"), Pha_Svg.y2_("50"), Pha_Svg.stroke("#000"), Pha_Svg.strokeWidth("2") ]);
              }), Pha.when(pos > 0 && border(index)(1))(function (v1) {
                  return Pha_Svg.line([ Pha_Svg.x1_("50"), Pha_Svg.y1_("0"), Pha_Svg.x2_("50"), Pha_Svg.y2_("50"), Pha_Svg.stroke("#000"), Pha_Svg.strokeWidth("2") ]);
              }), Pha.when(pos > 0 && border(index)(-columns | 0))(function (v1) {
                  return Pha_Svg.line([ Pha_Svg.x1_("0"), Pha_Svg.y1_("0"), Pha_Svg.x2_("50"), Pha_Svg.y2_("0"), Pha_Svg.stroke("#000"), Pha_Svg.strokeWidth("2") ]);
              }), Pha.when(pos > 0 && border(index)(columns))(function (v1) {
                  return Pha_Svg.line([ Pha_Svg.x1_("0"), Pha_Svg.y1_("50"), Pha_Svg.x2_("50"), Pha_Svg.y2_("50"), Pha_Svg.stroke("#000"), Pha_Svg.strokeWidth("2") ]);
              }) ]);
          };
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var drawColorCycle = Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_FoldableWithIndex.foldMapWithIndex(Data_FoldableWithIndex.foldableWithIndexArray)(Data_Monoid.monoidArray)(function (i) {
          return function (color) {
              return [ Pha_Svg.circle([ Pha_Svg.cx(Data_Show.show(Data_Show.showInt)(95 + (15 * (i - nbColors | 0) | 0) | 0)), Pha_Svg.cy("95"), Pha_Svg.r_("3"), Pha.key("c" + Data_Show.show(Data_Show.showInt)(i)), Pha_Svg.fill(color) ]), Pha_Svg["text'"]("\u2b95")([ Pha_Svg.x_(Data_Show.show(Data_Show.showInt)(99 + (15 * (i - nbColors | 0) | 0) | 0)), Pha_Svg.y_("97"), Pha.key("t" + Data_Show.show(Data_Show.showInt)(i)), Pha.attr("font-size")("7") ]) ];
          };
      })(Data_Array.take(nbColors)(colors)))([ Pha_Svg.circle([ Pha_Svg.cx("95"), Pha_Svg.cy("95"), Pha_Svg.r_("3"), Pha.key("fc"), Pha_Svg.fill("green") ]) ]);
      var drawCell = function (i) {
          return function (color) {
              return Pha_Svg.circle([ Pha_Svg.r_("7.5"), Pha.class_("tricolor-cell"), Pha["class'"]("finished")(levelFinished), Pha_Svg.stroke((function () {
...
(function($PS) {
  ...
  var view = function (state) {
      return Pha_Elements.div([ Pha.class_("ui-flex-center valise-main-container"), Pha["class'"]("open")(state.isOpen) ])([ Pha_Elements.div([  ])([ Pha_Elements.div([ Pha.class_("valise-logo") ])([ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%") ])([ Pha_Svg.use([ Pha_Attributes.href("#logo") ]) ]) ]), Pha_Elements.div([ Pha.class_("valise-container") ])([ valise(state), Pha_Elements.div([ Pha.class_("valise-help"), Pha["class'"]("visible")(state.helpVisible && state.help !== "") ])([ Pha.text(state.help) ]) ]) ]) ]);
  };
  exports["view"] = view;
})(PS);
(function($PS) {
      ...
      return function (setS) {
          return function (update) {
              return function (interpreter) {
                  ...
                  var dispatch = function ($13) {
                      return runAction(update($13));
                  };
  ...
  var view = function (st) {
      return {
          ...
          body: Pha_Elements.div([ Pha.key(st.location), Pha.class_("main-main-container"), Pha.class_((function () {
              ...
              return Pha_Elements.a([ Pha.class_("main-minivalise-link"), Pha_Attributes.href("#valise") ])([ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%") ])([ Pha_Svg.use([ Pha_Attributes.href("#valise") ]) ]) ]);
          }), viewGame(st) ])
      };
  };
