...
(function($PS) {
  ...
  var _customSize = function (dictStrong) {
      var $133 = _core(dictStrong);
      var $134 = Data_Lens_Lens.lens(function (v) {
          return v.customSize;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _dialog = function (dictStrong) {
      var $136 = _core(dictStrong);
      var $137 = Data_Lens_Lens.lens(function (v) {
          return v.dialog;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _help = function (dictStrong) {
      var $139 = _core(dictStrong);
      var $140 = Data_Lens_Lens.lens(function (v) {
          return v.help;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _history = function (dictStrong) {
      var $142 = _core(dictStrong);
      var $143 = Data_Lens_Lens.lens(function (v) {
          return v.history;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _locked = function (dictStrong) {
      var $145 = _core(dictStrong);
      var $146 = Data_Lens_Lens.lens(function (v) {
          return v.locked;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var lockAction = function (act) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          var $97 = Data_Lens_Getter.viewOn(v)(_locked(Data_Lens_Internal_Forget.strongForget));
          if ($97) {
          ...
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      ...
                      var $100 = Data_List["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget))) || isLevelFinished(dictGame)(state);
                      if ($100) {
          ...
          return function (nbColumns) {
              return function (customSize) {
                  var setSize$prime = function (state) {
                      ...
                      var $102 = nbRows >= v.value0 && (nbRows <= v.value2 && (nbColumns >= v.value1 && nbColumns <= v.value3));
                      if ($102) {
                  ...
                  return newGame(dictGame)((function () {
                      var $166 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(customSize);
                      return function ($167) {
                          return setSize$prime($166($167));
                      };
                  })());
              };
          };
  ...
  var changeTurn = function (state) {
      return Data_Lens_Setter.over(_turn(Data_Profunctor_Strong.strongFn))(function (x) {
          var $107 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
          if ($107) {
              return 1 - x | 0;
          };
          return 0;
  ...
  var redoA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 130, column 26 - line 136, column 52): " + [ v.constructor.name ]);
  });
  var undoA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 121, column 26 - line 127, column 56): " + [ v.constructor.name ]);
  });
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          var $115 = isLevelFinished(dictTwoPlayersGame.Game0())(state);
          if ($115) {
              return Data_Maybe.Nothing.value;
          };
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $116 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($116) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $174 = isLosingPosition(dictTwoPlayersGame);
                      var $175 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                      return function ($176) {
                          return $174($175($176));
                      };
      ...
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Data_Maybe.maybe(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(function (rndmove) {
              return Control_Bind.bind(Run.bindRun)(Pha_Action["randomAction'"](function (st) {
                  ...
                  var $119 = isLevelFinished(dictGame)(v1);
                  if ($119) {
                      return showVictory;
                  };
                  return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
      ...
      return function (optionFn) {
          return function (move) {
              return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                  ...
                  var $122 = !canPlay(dictGame)(v)(move);
                  if ($122) {
                      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                  };
                  return Control_Bind.bind(Run.bindRun)(Pha_Action["setState'"]((function () {
                      var $177 = playAux(dictGame)(move);
                      return function ($178) {
                          return $177(pushToHistory($178));
                      };
                  })()))(function (v2) {
                      var $124 = v1.showWin && isLevelFinished(dictGame)(v2);
                      if ($124) {
                          return showVictory;
                      };
                      var $125 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                      if ($125) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(1000))(function () {
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $129 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($129) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 286, column 5 - line 290, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var resetA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 139, column 27 - line 144, column 33): " + [ v.constructor.name ]);
  });
...
(function($PS) {
      ...
      return function (columns) {
          return function (mode) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.Model (line 97, column 24 - line 100, column 83): " + [ mode.constructor.name ]);
              });
          };
      };
  };
  ...
  var getNewBeast = function (state) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 126, column 21 - line 131, column 42): " + [ v.constructor.name ]);
  };
