...
iconBestScore state =
    icongroup ("Meilleur score (" <> maybe "∅" (show <<< fst) (bestScore state) <> ")") [
        iconbutton
            ...
            [click $ setState (_dialog .~ ScoreDialog)]
    ]