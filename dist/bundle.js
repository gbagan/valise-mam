...
(function($PS) {
  ...
  var redoA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 136, column 26 - line 142, column 52): " + [ v.constructor.name ]);
  });
  var undoA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 127, column 26 - line 133, column 56): " + [ v.constructor.name ]);
  });
          ...
          return function (dragLens) {
              return function (to) {
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 318, column 5 - line 322, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var resetA = Pha_Action.action(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 145, column 27 - line 150, column 33): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var trackPointer = function (lens) {
      ...
      return [ Pha_Html.style(Pha_Html.unittoStr)("touch-action")("none"), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
          return lens(dictStrong);
                  ...
                  return function (hasBeast) {
                      return function (color) {
                          ...
                          return square({
                              ...
                              return lens(dictStrong);
                          })(Control_Monad.whenM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Pha_Event.shiftKey)(Pha_Action.getEvent))(Game_Labete_Model.startZoneA(index)))) ]);
                      };
                  };
              };
          }))([ Pha.maybeN((function () {
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])(UI_Template.gridStyle(rows)(columns)(4)))(Lib_Util.map2(position.light)(position.played)(function (index) {
              return function (light) {
                  return function (played) {
                      var v = Lib_Util.coords(columns)(index);
                      return square(light)(Data_Lens_Getter.viewOn(state)(Game_Core["_help"](Data_Lens_Internal_Forget.strongForget)) && played)([ Pha_Html.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(0.86 / Data_Int.toNumber(rows))), Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(0.86 / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("left")(Pha_Html.pc((Data_Int.toNumber(v.col) + 7.0e-2) / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("top")(Pha_Html.pc((Data_Int.toNumber(v.row) + 7.0e-2) / Data_Int.toNumber(rows))), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("queens-square")(true), Pha_Html["class'"]("queens-square-capturable")(v.capturable), Pha_Html["class'"]("queens-square-nonavailable")(v.nonavailable), Pha_Html["class'"]("queens-square-selected")(v.selected) ])(props))((function () {
              ...
              return [ Pha_Html.svg([ Pha_Html.width(Pha_Html.unittoStr)("100%"), Pha_Html.height(Pha_Html.unittoStr)("100%"), Pha_Html["class'"]("queen-piece")(true) ])([ Pha_Html.use(Pha_Html.unittoStr)(Pha_Html.unittoStr)(Pha_Html.unittoStr)(Pha_Html.unittoStr)("10%")("10%")("80%")("80%")("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(v.piece))([ Pha_Html["class'"]("queens-piece")(true) ]) ]) ];
          })());
      };
  };
  var view = function (lens) {
      return function (state) {
          ...
          var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          var cursor = function (pp) {
              return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-cursor")(true) ])(UI_Template.cursorStyle(pp)(rows)(columns)(0.8)))([ Pha_Html.svg([ Pha_Html.width(Pha_Html.unittoStr)("100%"), Pha_Html.height(Pha_Html.unittoStr)("100%") ])([ Pha.h("use")([ Pha_Html.href("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_selectedPiece"](Data_Lens_Internal_Forget.strongForget)))) ])([  ]) ]) ]);
          };
              ...
              return function (piece) {
                  return function (attacked) {
                      return function (capturable) {
                          ...
                          })([ Pha_Html.style(Pha_Html.unitPc)("width")(Pha_Html.pc(1.0 / Data_Int.toNumber(columns))), Pha_Html.style(Pha_Html.unitPc)("height")(Pha_Html.pc(1.0 / Data_Int.toNumber(rows))), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
...
(function($PS) {
  ...
  var animateA = function (animation) {
      return Control_Monad.whenM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Data_Functor.map(Data_Functor.functorFn)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Lens_Getter.view(_locked(Data_Lens_Internal_Forget.strongForget))))(Pha_Action.getState))(Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState((function () {
          var $15 = Data_Lens_Setter.set(_anim(Data_Profunctor_Strong.strongFn))(Data_Map_Internal.empty);
          var $16 = Data_Lens_Setter.set(_locked(Data_Profunctor_Strong.strongFn))(true);
          return function ($17) {
              return $15($16($17));
          };
      })()))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(v.value0))(function () {
                      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
                          return Pha_Action.setState(Data_Lens_Setter.set((function () {
                              var $18 = _anim(Data_Profunctor_Strong.strongFn);
                              var $19 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(v.value1)(Data_Profunctor_Strong.strongFn);
                              return function ($20) {
                                  return $18($19($20));
                              };
...
(function($PS) {
  ...
  var Pha_Action = $PS["Pha.Action"];
  var Pha_Html = $PS["Pha.Html"];                
  var compStyle = function (v) {
      return [ Pha_Html.style(Pha_Html.unittoStr)("transform")("rotate(" + (Data_Show.show(Data_Show.showInt)(v.rotation) + ("deg) " + Pha_Html.translate(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc(Data_Int.toNumber(v.translation.value0) / 700.0))(Pha_Html.pc(Data_Int.toNumber(v.translation.value1) / 300.0))))), Pha_Html.style(Pha_Html.unittoStr)("transition")("all linear " + (Data_Show.show(Data_Show.showInt)(v.duration) + "ms")) ];
  };
  var pythaStyles = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("a", [ [ Pha_Html.opacity("0") ], [ Pha_Html.opacity("1") ], compStyle({
      translation: new Data_Tuple.Tuple(400, -100 | 0),
      rotation: 0,
      duration: 600
  }) ]), new Data_Tuple.Tuple("b", [ [ Pha_Html.opacity("0") ], [ Pha_Html.opacity("1") ], compStyle({
      translation: new Data_Tuple.Tuple(600, 0),
      rotation: 0,
      duration: 600
  }) ]), new Data_Tuple.Tuple("c", [ [ Pha_Html.opacity("0") ], [ Pha_Html.opacity("1") ], compStyle({
      translation: new Data_Tuple.Tuple(400, 0),
      rotation: 0,
      duration: 600
  }) ]), new Data_Tuple.Tuple("d", [ [ Pha_Html.opacity("0") ], [ Pha_Html.opacity("1") ], compStyle({
  ...
  var animPytha = function (v) {
      return function (styles) {
          var f = function (key) {
              return Data_Maybe.fromMaybe([  ])((function () {
                  ...
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Lens_Getter.viewOn(pythaStyles)(Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(key)(Data_Lens_Internal_Forget.strongForget)))(function (v1) {
                      return Data_Array.index(v1)(phase);
                  });
              })());
          };
  ...
  var view = function (lens) {
      return function (state) {
          var main = Pha_Html["div'"]([  ])([ Pha_Html.h1([ Pha_Html["class'"]("sansmot-title")(true) ])("Preuve sans mot"), Pha_Html.h2([ Pha_Html["class'"]("sansmot-h2")(true) ])("Que raconte le th\xe9or\xe8me de Pythagore ?"), Pha_Html.p([ Pha_Html["class'"]("sansmot-center")(true) ])([ Pha_Html.svg([ Pha_Html["class'"]("sansmot-svg")(true), Pha_Html.viewBox(0)(-100 | 0)(200)(250), Pha_Html.style(Pha_Html.unittoStr)("width")("20vmin"), Pha_Html.height(Pha_Html.unittoStr)("25vmin") ])([ Pha_Html.path("M 50 50 h 100 v 100 h -100 Z")([ Pha_Html.fill("yellow"), Pha_Html.stroke("black") ]), Pha_Html.path("M 0 0 h 50 v 50 h -50 Z")([ Pha_Html.fill("yellow"), Pha_Html.stroke("black") ]), Pha_Html.path("M 50 0 l 100 50 l 50 -100 l -100 -50 Z")([ Pha_Html.fill("#00ff00"), Pha_Html.stroke("black") ]), Pha_Html["text'"](Pha_Html.unitInt)(90)(105)("a\xb2")([ Pha_Html.attr(Pha_Html.unitInt)("font-size")(35) ]), Pha_Html["text'"](Pha_Html.unitInt)(18)(35)("b\xb2")([ Pha_Html.attr(Pha_Html.unitInt)("font-size")(35) ]), Pha_Html["text'"](Pha_Html.unitInt)(110)(-10 | 0)("c\xb2")([ Pha_Html.attr(Pha_Html.unitInt)("font-size")(35) ]) ]) ]), Pha_Html.h2([ Pha_Html["class'"]("sansmot-h2")(true) ])("Preuve sans mot due \xe0 un auteur chinois inconnu qui vivait vers 200 avant J.-C."), Pha_Html.p([ Pha_Html["class'"]("sansmot-center")(true) ])([ animPytha(state)(pythaStyles) ]), Pha_Html.p([ Pha_Html["class'"]("sansmot-center")(true), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Sansmot_Model.animateA(Game_Sansmot_Model.pythaAnimation))) ])([ Pha.text("Explications") ]) ]);
          return main;
      };
  };
  exports["view"] = view;
...
(function($PS) {
  ...
  var cgame = new Game.CGame(Control_Applicative.pure(Effect.applicativeEffect), function (v) {
      ...
      return function (v) {
          return Game_Sansmot_View.view(function (dictStrong) {
...
(function($PS) {
  ...
  var toggleSwitchA = Pha_Action.action(Data_Lens_Setter.over(_isSwitchOn(Data_Profunctor_Strong.strongFn))(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  ...
  var valise = function (lens) {
      return function (state) {
                                      ...
                                      return Pha_Html.g([ Pha_Html.style(Pha_Html.unittoStr)("transform")((function () {
                                          if (v.drag) {
                                              return Data_Maybe.maybe(defaultTranslate)(function (v1) {
                                                  return Pha_Html.translate(Pha_Html.unitPc)(Pha_Html.unitPc)(Pha_Html.pc(v1.x))(Pha_Html.pc(v1.y));
                                              })(Data_Lens_Getter.viewOn(state)((function () {
                                                  var $31 = Game_Valise_Model["_positions"](Data_Lens_Internal_Forget.strongForget);
                                                  var $32 = Data_Lens_At.at(Data_Lens_At.atMap(Data_Ord.ordString))(v.symbol)(Data_Lens_Internal_Forget.strongForget);
                                                  return function ($33) {
                                                      return $31($32($33));
                                                  };
                                              })()));
                                          ...
                                          var $23 = Data_Maybe.isJust(v.link);
                                          if ($23) {
                                              return [  ];
                                          };
          ...
          return Pha_Html.svg([ Pha_Html.viewBox(0)(0)(825)(690), Pha_Html.pointermove(Pha_Action.zoomAt(function (dictStrong) {
              ...
              help: "",
              drag: false
          })(300)(460)(42)(60)([ Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
              return lens(dictStrong);
          })(Game_Valise_Model.toggleSwitchA)), Pha_Html.style(Pha_Html.unittoStr)("transform")((function () {
              if (state.isSwitchOn) {
...
(function($PS) {
  ...
  var hashChange = Control_Bind.bind(Run.bindRun)(Game_Effs.getLocation)(function (v) {
      ...
      var $107 = location === "valise" || location === "";
      if ($107) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(100))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(function (v1) {
                      ...
                      return Pha_Action.zoomAt(function (dictStrong) {
                          var $129 = _valise(dictStrong);
                          var $130 = Game_Valise.is(dictStrong.Profunctor0());
                          return function ($131) {
                              return $129($130($131));
                          };
      ...
      return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.zoomAt(function (dictStrong) {
          var $132 = _valise(dictStrong);
          var $133 = Game_Valise.is(dictStrong.Profunctor0());
          return function ($134) {
              return $132($133($134));
          };
  ...
  var onKeyDown = Control_Bind.bind(Run.bindRun)(Pha_Action.getEvent)(function (v) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
          ...
          throw new Error("Failed pattern match at Main (line 141, column 5 - line 143, column 62): " + [ v2.constructor.name ]);
      });
  });
  ...
  var main = function __do() {
      ...
      var v12 = Game.init(Game_Sansmot.cgame)(Game_Sansmot.state)();
      var v13 = Game.init(Game_Solitaire.cgame)(Game_Solitaire.state)();
      var v14 = Game.init(Game_Tiling.cgame)(Game_Tiling.state)();
      var v15 = Game.init(Game_Valise.cgame)(Game_Valise.state)();
      var state = {
          baseball: v1,
          chocolat: v2,
          dessin: v3,
