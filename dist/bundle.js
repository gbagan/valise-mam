...
(function($PS) {
  ...
  var _customSize = function (dictStrong) {
      var $122 = _core(dictStrong);
      var $123 = Data_Lens_Lens.lens(function (v) {
          return v.customSize;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _dialog = function (dictStrong) {
      var $125 = _core(dictStrong);
      var $126 = Data_Lens_Lens.lens(function (v) {
          return v.dialog;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _help = function (dictStrong) {
      var $128 = _core(dictStrong);
      var $129 = Data_Lens_Lens.lens(function (v) {
          return v.help;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _history = function (dictStrong) {
      var $131 = _core(dictStrong);
      var $132 = Data_Lens_Lens.lens(function (v) {
          return v.history;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _locked = function (dictStrong) {
      var $134 = _core(dictStrong);
      var $135 = Data_Lens_Lens.lens(function (v) {
          return v.locked;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var lockAction = function (act) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          var $94 = Data_Lens_Getter.viewOn(v)(_locked(Data_Lens_Internal_Forget.strongForget));
          if ($94) {
  ...
  var _mode = function (dictStrong) {
      var $137 = _core(dictStrong);
      var $138 = Data_Lens_Lens.lens(function (v) {
          return v.mode;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _nbColumns = function (dictStrong) {
      var $140 = _core(dictStrong);
      var $141 = Data_Lens_Lens.lens(function (v) {
          return v.nbColumns;
      })(function (v) {
          return function (v1) {
              return {
  ...
  var _nbRows = function (dictStrong) {
      var $143 = _core(dictStrong);
      var $144 = Data_Lens_Lens.lens(function (v) {
          return v.nbRows;
      })(function (v) {
          return function (v1) {
              return {
          ...
          return function (state) {
              ...
              return Control_Bind.bind(Lib_Random.bindRandom)(onNewGame(dictGame)(state2))(function (v) {
                  return Control_Bind.bind(Lib_Random.bindRandom)(initialPosition(dictGame)(v))(function (v1) {
                      ...
                      var $97 = Data_Array["null"](Data_Lens_Getter.viewOn(state2)(_history(Data_Lens_Internal_Forget.strongForget))) || isLevelFinished(dictGame)(state);
                      if ($97) {
          ...
          return function (nbColumns) {
              return function (customSize) {
                  var setSize$prime = function (state) {
                      ...
                      var $99 = nbRows >= v.value0 && (nbRows <= v.value2 && (nbColumns >= v.value1 && nbColumns <= v.value3));
                      if ($99) {
                  ...
                  return newGame(dictGame)((function () {
                      var $155 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(customSize);
                      return function ($156) {
                          return setSize$prime($155($156));
                      };
                  })());
              };
          };
  ...
  var changeTurn = function (state) {
      var $104 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(DuelMode.value);
      if ($104) {
      ...
      return function (state) {
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  var $107 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                  if ($107) {
                      return Data_Maybe.Nothing.value;
                  };
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $163 = isLosingPosition(dictTwoPlayersGame);
                      var $164 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                      return function ($165) {
                          return $163($164($165));
                      };
      ...
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Data_Maybe.maybe(Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit))(function (rndmove) {
              return Control_Bind.bind(Run.bindRun)(Pha_Action["randomAction'"](function (st) {
                  ...
                  var $110 = isLevelFinished(dictGame)(v1);
                  if ($110) {
                      return showVictory;
                  };
                  return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
      ...
      return function (optionFn) {
          return function (move) {
              return lockAction(Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                  ...
                  var $113 = !canPlay(dictGame)(v)(move);
                  if ($113) {
                      return Control_Applicative.pure(Run.applicativeRun)(Data_Unit.unit);
                  };
                  return Control_Bind.bind(Run.bindRun)(Pha_Action["setState'"]((function () {
                      var $166 = playAux(dictGame)(move);
                      return function ($167) {
                          return $166(pushToHistory($167));
                      };
                  })()))(function (v2) {
                      var $115 = v1.showWin && isLevelFinished(dictGame)(v2);
                      if ($115) {
                          return showVictory;
                      };
                      var $116 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(ExpertMode.value) || Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(v)(_mode(Data_Lens_Internal_Forget.strongForget)))(RandomMode.value);
                      if ($116) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.delay(1000))(function () {
                  ...
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)))(function () {
                              var $120 = Data_Eq.notEq(dictEq)(v1.value0)(to);
                              if ($120) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 282, column 5 - line 286, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var line = function (x1) {
      return function (y1) {
          return function (x2) {
              return function (y2) {
                  return function (props) {
                      return Pha.h("line")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ attr(unittoStr)("x1")(Data_Show.show(Data_Show.showNumber)(x1)), attr(unittoStr)("y1")(Data_Show.show(Data_Show.showNumber)(y1)), attr(unittoStr)("x2")(Data_Show.show(Data_Show.showNumber)(x2)), attr(unittoStr)("y2")(Data_Show.show(Data_Show.showNumber)(y2)) ])(props))([  ]);
                  };
              };
          };
      };
          ...
          return function (w) {
              return function (h$prime) {
                  return function (href$prime) {
                      return function (props) {
                          return Pha.h("use")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ attr(unittoStr)("x")(Data_Show.show(Data_Show.showNumber)(x1)), attr(unittoStr)("y")(Data_Show.show(Data_Show.showNumber)(y1)), attr(unittoStr)("width")(Data_Show.show(Data_Show.showNumber)(w)), attr(unittoStr)("height")(Data_Show.show(Data_Show.showNumber)(h$prime)), attr(unittoStr)("href")(href$prime) ])(props))([  ]);
                      };
                  };
              };
          };
...
(function($PS) {
  ...
  var winTitleFor2Players = function (state) {
      var $27 = Data_Eq.eq(Game_Core.eqMode)(Data_Lens_Getter.viewOn(state)(Game_Core["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.DuelMode.value);
      if ($27) {
          return "Le " + ((function () {
  ...
  var turnMessage = function (dictGame) {
      return function (state) {
          var $30 = Game_Core.isLevelFinished(dictGame)(state);
          if ($30) {
              return "Partie finie";
          };
          var $31 = Data_Lens_Getter.viewOn(state)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
          if ($31) {
              return "Tour du premier joueur";
          };
          var $32 = Data_Eq.eq(Game_Core.eqMode)(Data_Lens_Getter.viewOn(state)(Game_Core["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Core.DuelMode.value);
          if ($32) {
          ...
          return function (lens) {
              return function (dragLens) {
                  ...
                  var leave = Pha_Action.action((function () {
                      var $58 = Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value);
                      var $59 = Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value);
                      return function ($60) {
                          return $58($59($60));
                      };
                  })());
              ...
              return function (pos) {
                  return function (color) {
                      return Pha.ifN(peg !== Data_Lens_Getter.viewOn(state)(Game_Baseball_Model["_missingPeg"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
                          return Pha_Html.g([ Pha_Html["class'"]("baseball-player")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")(translatePeg(pos)(nbBases)), Pha_Html.key("p" + Data_Show.show(Data_Show.showInt)(peg)) ])([ Pha_Html.use(0.0)(0.0)(7.0)(7.0)("#meeple")([ Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
...
(function($PS) {
  ...
  var currentLine = function (p1) {
      return function (p2) {
          return Pha_Html.line(100.0 * p1.x)(100.0 * p1.y)(20.0 * p2.x)(20.0 * p2.y)([ Pha_Html["class'"]("dessin-line-to-pointer")(true) ]);
      };
  };
  var view = function (lens) {
      return function (state) {
          ...
          var board = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              ...
              return Pha_Html.line(20.0 * v.x1)(20.0 * v.y1)(20.0 * v.x2)(20.0 * v.y2)([ Pha_Html.stroke("grey"), Pha_Html.attr(Pha_Html.unittoStr)("stroke-dasharray")("3,1") ]);
              ...
              var v = getCoordsOfEdge(graph)(edge);
              return Pha_Html.line(20.0 * v.x1)(20.0 * v.y1)(20.0 * v.x2)(20.0 * v.y2)([ Pha_Html.stroke("red"), Pha_Html.strokeWidth("1.5") ]);
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"]([ Pha_Html["class'"]("ui-board frog-board")(true) ])([ Pha_Html.svg([ Pha_Html.viewBox(-190 | 0)(-200 | 0)(400)(400) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.path(spiralPath)([ Pha_Html.fill("none"), Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(153.0)(9.0)(207.0)(20.0)([ Pha_Html.stroke("black"), Pha_Html.strokeDasharray("5"), Pha_Html.strokeWidth("6") ]), Pha_Html.line(153.0)(7.0)(153.0)(39.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]), Pha_Html.line(207.0)(18.0)(207.0)(50.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("3") ]) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Util.map2(spoints)(reachable)(function (i) {
              ...
              return Pha_Html.g([ Pha_Html.key("frog"), Pha_Html["class'"]("frog-frog-container")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")(Pha_Html.translate(Pha_Html.unitNumber)(Pha_Html.unitNumber)(v.radius)(0.0) + (" rotate(" + (Data_Show.show(Data_Show.showNumber)((v.theta * 180.0) / $$Math.pi) + "deg)"))), Pha_Html.style(Pha_Html.unittoStr)("transform-origin")(Data_Show.show(Data_Show.showNumber)(-v.radius) + "px 0") ])([ Pha_Html.g([ Pha_Html["class'"]("frog-frog-container")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((-v.theta * 180.0) / $$Math.pi) + "deg)")) ])([ Pha_Html.use(-20.0)(-20.0)(40.0)(40.0)("#frog2")([ Pha_Html["class'"]("frog-frog")(true), Pha_Html["class'"]("goal")(position === 0) ]) ]) ]);
...
(function($PS) {
  ...
  var beastTypes = [ [ type1 ], [ type2 ], [ type3 ], [ type2, type3 ] ];
      ...
      return function (columns) {
          return function (mode) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.Model (line 91, column 24 - line 94, column 83): " + [ mode.constructor.name ]);
              });
          };
      };
  };
  ...
  var _beastIndex = function (dictStrong) {
  ...
  var labeteGame = new Game_Core.Game(function (v) {
      ...
      return Data_Array["null"](nonTrappedBeasts($102));
  }, function (st) {
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Setter.set(_squareColors(Data_Profunctor_Strong.strongFn))(Data_Array.replicate(Data_Lens_Getter.viewOn(st)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(st)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(0))(Data_Lens_Setter.set(_beast(Data_Profunctor_Strong.strongFn))(Data_Maybe.fromMaybe([ type1 ])(Data_Array.index(beastTypes)(Data_Lens_Getter.viewOn(st)(_beastIndex(Data_Lens_Internal_Forget.strongForget)))))(st)));
  }, function (state) {
  ...
  var setBeastA = Game_Core["newGame'"](labeteGame)(Data_Lens_Setter.set(_beastIndex(Data_Profunctor_Strong.strongFn)));
  ...
  exports["_beastIndex"] = _beastIndex;
  exports["_mode"] = _mode;
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Html.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.transform(Pha_Html.translate(Pha_Html.unitInt)(Pha_Html.unitInt)(50 * v.col | 0)(50 * v.row | 0)) ])(props))([ Pha_Html.use(0.0)(0.0)(50.0)(50.0)("#grass")([ Pha_Html.fill(Data_Maybe.fromMaybe("#5aa02c")(Data_Array.index(colors)(v.color))) ]), Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(0.0)(0.0)(51.0)(51.0)([ Pha_Html.stroke("black"), Pha_Html.strokeWidth("0.5"), Pha_Html.fill("transparent") ]), Pha_Html.use(5.0)(5.0)(40.0)(40.0)("#paw")([ Pha_Html["class'"]("labete-beast")(true), Pha_Html["class'"]("visible")(v.hasBeast) ]), Pha.ifN(v.hasTrap)(function (v1) {
              return Pha_Html.use(5.0)(5.0)(40.0)(40.0)("#trap")([  ]);
          }) ]);
      };
  };
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var cursor = function (pp) {
              return Pha_Html.use(-20.0)(-20.0)(40.0)(40.0)("#trap")(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.svgCursorStyle(pp))([ Pha_Html.key("cursor"), Pha_Html.attr(Pha_Html.unittoStr)("opacity")("0.7"), Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none") ]));
          };
          var config = UI_Template.card("La b\xeate")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              return lens(dictStrong);
          })(state)("Forme de la b\xeate")([ 0, 1, 2, 3 ])(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_beastIndex"](Data_Lens_Internal_Forget.strongForget)))(Game_Labete_Model.setBeastA)(function (i) {
              return function (opt) {
                  if (i === 0) {
                      return {
              ...
              return function (opt) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.View (line 76, column 96 - line 79, column 88): " + [ i.constructor.name ]);
              };
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer(function (dictStrong) {
              ...
              throw new Error("Failed pattern match at Game.Labete.View (line 117, column 26 - line 119, column 83): " + [ v.constructor.name ]);
          })()) ])) ]);
              ...
              return function (pile) {
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)((function () {
                      ...
                      return Pha_Html.rect(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Pha_Html.unitNumber)(-2.5)(-2.5)(5.0)(5.0)([ Pha_Html.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html.fill("gray"), Pha_Html.click(Pha_Action.zoomAt(function (dictStrong) {
                          return lens(dictStrong);
                      })(Game_Core.playA(Game_Nim_Model.nimGame)(new Game_Nim_Model.Move(i, j)))), Pha_Html.style(Pha_Html.unittoStr)("transform")(Pha_Html.translate(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Data_Int.toNumber((function () {
                          var $10 = length === 5;
                          if ($10) {
                              return 30;
                          };
                          return 5;
                      })() + (10 * j | 0) | 0))(Data_Int.toNumber(15 + (19 * i | 0) | 0)) + " rotate(45deg)"), Pha_Html.style(Pha_Html.unittoStr)("cursor")((function () {
                      ...
                      return function (peg) {
                          return Pha_Html.use(0.0)(0.0)(8.0)(8.0)("#meeple")([ Pha_Html.key("p-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Html["class'"]("nim-player")(true), Pha_Html.fill((function () {
                              ...
                              return "red";
                          })()), Pha_Html.style(Pha_Html.unittoStr)("transform")(Pha_Html.translate(Pha_Html.unitNumber)(Pha_Html.unitNumber)(Data_Int.toNumber((function () {
                              var $13 = length === 5;
                              if ($13) {
                                  return 26;
                              };
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Html.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("paths-darken")(v.darken) ])(props))([ Pha_Html.use(v.x)(v.y)(100.0)(100.0)("#paths-background")([  ]), Pha.ifN(v.door)(function (v1) {
  ...
  var heroCursor = function (pp) {
      return Pha_Html.use(-40.0)(-40.0)(80.0)(80.0)(" #meeplehat")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.key("chero"), Pha_Html.attr(Pha_Html.unittoStr)("opacity")("0.6"), Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none") ])(UI_Template.svgCursorStyle(pp)));
  };
  var doorCursor = function (pp) {
      return Pha_Html.use(-50.0)(-50.0)(100.0)(100.0)(" #paths-door")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.key("cdoor"), Pha_Html.attr(Pha_Html.unittoStr)("opacity")("0.6"), Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none") ])(UI_Template.svgCursorStyle(pp)));
  };
  var view = function (lens) {
      return function (state) {
...
(function($PS) {
  ...
  var toggleAllowedPiece = function (piece) {
      return function (v) {
          return function (pieces) {
              ...
              throw new Error("Failed pattern match at Game.Queens.Model (line 154, column 1 - line 154, column 90): " + [ piece.constructor.name, v.constructor.name, pieces.constructor.name ]);
          };
      };
  };
  var _ext = function (dictStrong) {
  ...
  var customizeA = Game_Core.newGame(pathGame)((function () {
      var $88 = Data_Lens_Setter.set(_allowedPieces(Data_Profunctor_Strong.strongFn))(Data_Array_NonEmpty.singleton(Custom.value));
      var $89 = Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.CustomDialog.value);
      var $90 = Data_Lens_Setter.set(_multiPieces(Data_Profunctor_Strong.strongFn))(false);
      return function ($91) {
          return $88($89($90($91)));
      };
  })());
  var flipDirectionA = function (direction) {
      return Game_Core.newGame(pathGame)(Data_Lens_Setter.over((function () {
          var $92 = _customDirections(Data_Profunctor_Strong.strongFn);
          var $93 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(direction)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($94) {
              return $92($93($94));
          };
      })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  ...
  var flipLocalMoveA = function (position) {
      return Game_Core.newGame(pathGame)(Data_Lens_Setter.over((function () {
          var $95 = _customLocalMoves(Data_Profunctor_Strong.strongFn);
          var $96 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(position)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($97) {
              return $95($96($97));
          };
      })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("queens-square")(true), Pha_Html["class'"]("queens-square-capturable")(v.capturable), Pha_Html["class'"]("queens-square-nonavailable")(v.nonavailable), Pha_Html["class'"]("queens-square-selected")(v.selected) ])(props))((function () {
              var $26 = Data_Eq.eq(Game_Queens_Model.eqPiece)(v.piece)(Game_Queens_Model.Empty.value);
              if ($26) {
                  return [  ];
              };
              return [ Pha_Html.svg([ Pha_Html.width(Pha_Html.unittoStr)("100%"), Pha_Html.height(Pha_Html.unittoStr)("100%"), Pha_Html["class'"]("queen-piece")(true) ])([ Pha.h("use")([ Pha_Html.href("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(v.piece)), Pha_Html.attr(Pha_Html.unittoStr)("x")("10%"), Pha_Html.attr(Pha_Html.unittoStr)("y")("10%"), Pha_Html.width(Pha_Html.unittoStr)("80%"), Pha_Html.height(Pha_Html.unittoStr)("80%"), Pha_Html["class'"]("queens-piece")(true) ])([  ]) ]) ];
          })());
      };
  };
  var view = function (lens) {
      return function (state) {
          ...
          var grid = Pha_Html["div'"](Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(UI_Template.trackPointer(function (dictStrong) {
                  ...
                  return function (attacked) {
                      return function (capturable) {
                          return square({
                              ...
                              return lens(dictStrong);
                          })(Game_Queens_Model.playA(index))), Pha_Html.pointerenter(Pha_Action.zoomAt(function (dictStrong) {
                              return lens(dictStrong);
              ...
              var $35 = Control_Applicative.pure(Control_Applicative.applicativeArray);
              return function ($36) {
                  return $35(cursor($36));
              };
...
(function($PS) {
  ...
  var solitaireGame = new Game_Core.Game(function (state) {
      ...
      var v = (function () {
          ...
          throw new Error("Failed pattern match at Game.Solitaire.Model (line 99, column 13 - line 117, column 18): " + [ v1.constructor.name ]);
      })();
...
(function($PS) {
  ...
  var putSinkA = function (i) {
      return Pha_Action.action(Data_Lens_Setter.set((function () {
          var $75 = Game_Core["_position"](Data_Profunctor_Strong.strongFn);
          var $76 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(i)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($77) {
              return $75($76($77));
          };
      })())(-1 | 0));
  ...
  var istate = Game_Core.genState([  ])(function (v) {
      ...
      tile: [  ],
      nbSinks: 0,
      customTile: Data_Lens_Setter.set(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(12)(Data_Lens_Internal_Wander.wanderFunction))(true)(Data_Array.replicate(25)(false)),
  ...
  var _customTile = function (dictStrong) {
      var $93 = _ext(dictStrong);
      var $94 = Data_Lens_Lens.lens(function (v) {
          return v.customTile;
      })(function (v) {
  ...
  var getTile = function (state) {
      ...
      if (v instanceof CustomTile) {
          ...
          })(Data_Lens_Getter.viewOn(state)(_customTile(Data_Lens_Internal_Forget.strongForget))));
      };
      throw new Error("Failed pattern match at Game.Tiling.Model (line 64, column 17 - line 68, column 139): " + [ v.constructor.name ]);
  };
  var tilingGame = new Game_Core.Game(function (state) {
      ...
      var $96 = Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Eq.notEq(Data_Eq.eqInt)(0));
      ...
      return function (index) {
          ...
          var pos = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var $69 = canPutTile(state)(tilePos);
          if ($69) {
              var m = Data_Foldable.foldl(Data_Foldable.foldableArray)(Data_Ord.max(Data_Ord.ordInt))(0)(pos) + 1 | 0;
              return Data_Array.mapWithIndex(function (i) {
                  return function (x) {
                      var $70 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqInt)(i)(tilePos);
                      if ($70) {
                          return m;
                      };
                      return x;
          ...
          return Data_Functor.mapFlipped(Data_Functor.functorArray)(pos)(function (x) {
              var $71 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(new Data_Maybe.Just(x))(Data_Array.index(pos)(index));
              if ($71) {
                  return 0;
              };
              return x;
  ...
  var clickOnCellA = function (a) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          var $73 = Data_Array.length(sinks(v)) < Data_Lens_Getter.viewOn(v)(_nbSinks(Data_Lens_Internal_Forget.strongForget));
          if ($73) {
              return putSinkA(a);
          };
  ...
  var flipTileA = function (index) {
      return Game_Core.newGame(tilingGame)(Data_Lens_Setter.over((function () {
          var $99 = _customTile(Data_Profunctor_Strong.strongFn);
          var $100 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(index)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($101) {
              return $99($100($101));
          };
      })())(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean)));
  ...
  var setTileA = function (ttype) {
      return Game_Core.newGame(tilingGame)((function () {
          var $102 = Data_Lens_Setter.set(_tileType(Data_Profunctor_Strong.strongFn))(ttype);
          var $103 = (function () {
              var $74 = Data_Eq.eq(eqTileType)(ttype)(CustomTile.value);
              if ($74) {
  ...
  exports["_customTile"] = _customTile;
      ...
      return function (state) {
          var tileCursor = function (pp) {
              return Pha_Html.g(UI_Template.svgCursorStyle(pp))([ Pha_Html.g([ Pha_Html["class'"]("tiling-cursor")(true), Pha_Html.style(Pha_Html.unittoStr)("transform")("rotate(" + (Data_Show.show(Data_Show.showInt)(90 * Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)) | 0) + "deg)")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_tile"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
                  return Pha_Html.use(50.0 * Data_Int.toNumber(v.col) - 25.0)(50.0 * Data_Int.toNumber(v.row) - 25.0)(50.0)(50.0)("#tile2")([ Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none"), Pha_Html.attr(Pha_Html.unittoStr)("opacity")((function () {
          ...
          var sinkCursor = function (pp) {
              return Pha_Html.use(-25.0)(-25.0)(50.0)(50.0)("#sink")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Html.attr(Pha_Html.unittoStr)("pointer-events")("none") ])(UI_Template.svgCursorStyle(pp)));
          };
          var rules = [ Pha.text("blah blah") ];
          var rows = Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
          var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          ...
          })(Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_customTile"](Data_Lens_Internal_Forget.strongForget)))) ]) ]) ]);
