...
(function($PS) {
  ...
  var noAction = function (dispatch) {
      return function (ev) {
          ...
          return function (nbColumns) {
              return function (customSize) {
                  ...
                  return newGame(dictGame)((function () {
                      var $177 = Data_Lens_Setter.set(_customSize(Data_Profunctor_Strong.strongFn))(customSize);
                      return function ($178) {
                          return setSize$prime($177($178));
                      };
                  })());
              };
          };
          ...
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.fromArray(possibleMoves(dictTwoPlayersGame)(state)))(function (moves) {
              var bestMove = (function () {
                  ...
                  return Data_Foldable.find(Data_Foldable.foldableArray)((function () {
                      var $185 = isLosingPosition(dictTwoPlayersGame);
                      var $186 = Data_Function.flip(playAux(dictTwoPlayersGame.Game0()))(state);
                      return function ($187) {
                          return $185($186($187));
                      };
              ...
              return lockAction(Pha_Action.asyncAction(function (v) {
                  return function (state) {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(v.updateState((function () {
                          var $188 = playAux(dictGame)(move);
                          return function ($189) {
                              return $188(pushToHistory($189));
                          };
                      })()))(function (v2) {
              ...
              return function (to) {
                  return Pha_Action.asyncAction(function (v) {
                      return function (state) {
                          ...
                          throw new Error("Failed pattern match at Game.Core (line 279, column 5 - line 283, column 83): " + [ v1.constructor.name ]);
                      };
                  });
              };
          };
...
(function($PS) {
  ...
  var Lib_Random = $PS["Lib.Random"];
  var Lib_Util = $PS["Lib.Util"];
  var state = Game_Core.genState([  ])(Control_Category.identity(Control_Category.categoryFn))({
      nbBases: 5,
      missingPeg: 0
  });
  ...
  var baseballGame = new Game_Core.Game(function (state1) {
      return function (i) {
          return Data_Maybe.fromMaybe(false)((function () {
              var position = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
              var nbBases = Data_Lens_Getter.viewOn(state1)(_nbBases(Data_Lens_Internal_Forget.strongForget));
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(position)(Data_Lens_Getter.viewOn(state1)(_missingPeg(Data_Lens_Internal_Forget.strongForget))))(function (v) {
  ...
  }, Data_Function["const"](Data_Maybe.Nothing.value), function (state1) {
      return Lib_Random.shuffle(Data_Array.range(0)((2 * Data_Lens_Getter.viewOn(state1)(_nbBases(Data_Lens_Internal_Forget.strongForget)) | 0) - 1 | 0));
  }, function (state1) {
      ...
      })(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))));
  }, function (state1) {
      return Data_Functor.mapFlipped(Lib_Random.functorRandom)(Lib_Random.randomInt(2 * Data_Lens_Getter.viewOn(state1)(_nbBases(Data_Lens_Internal_Forget.strongForget)) | 0))(function (i) {
          return Data_Lens_Setter.set(_missingPeg(Data_Profunctor_Strong.strongFn))(i)(state1);
      });
  }, function (state1) {
      return function (i) {
          return Lib_Util.swap(Data_Lens_Getter.viewOn(state1)(_missingPeg(Data_Lens_Internal_Forget.strongForget)))(i)(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
      };
...
(function($PS) {
  ...
  var setPointerPositionA = function (a) {
      return Pha_Action.action(Data_Lens_Setter.set(Game_Core["_pointerPosition"](Data_Profunctor_Strong.strongFn))(a));
  };
...
(function($PS) {
  ...
  var state = Game_Baseball_Model.state;
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Baseball_Model.baseballGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var chocolatGame = new Game_Core.Game(function (v) {
      ...
      var $67 = Data_Lens_Getter.view(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      return function ($68) {
          return (function (v) {
      ...
      return function (move) {
          ...
          throw new Error("Failed pattern match at Game.Chocolat.Model (line 41, column 9 - line 45, column 42): " + [ move.constructor.name ]);
      };
      ...
      return function (state) {
          ...
          var config = UI_Template.card("Barre de chocolat")([ UI_Icons.iconSizesGroup(Game_Chocolat_Model.chocolatGame)(function (dictStrong) {
              ...
              return function (opt) {
                  ...
                  throw new Error("Failed pattern match at Game.Chocolat.View (line 31, column 58 - line 34, column 100): " + [ mode.constructor.name ]);
              };
...
(function($PS) {
  ...
  var state = Game_Chocolat_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Chocolat_Model.chocolatGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var state = Game_Core.genState(20)(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
  ...
  var frogGame2 = new Game_Core.TwoPlayersGame(function () {
      ...
      return Data_Maybe.fromMaybe(true)(Data_Array.index(Data_Lens_Getter.viewOn(state1)(_winning(Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))));
  }, function (state1) {
      return Data_Array.filter(Game_Core.canPlay(frogGame)(state1))(Data_Array.range(0)(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget))));
  });
  var frogGame = new Game_Core.Game(function (state1) {
      return function (v) {
          var position = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var moves = Data_Lens_Getter.viewOn(state1)(_moves(Data_Lens_Internal_Forget.strongForget));
  ...
  }, Game_Core["computerMove'"](frogGame2), function (state1) {
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)));
  }, function (state1) {
      return Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)) === 0;
  }, function (state1) {
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Setter.set(_marked(Data_Profunctor_Strong.strongFn))(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) + 1 | 0)(false))(Data_Lens_Setter.set(_winning(Data_Profunctor_Strong.strongFn))(winningPositions(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) + 1 | 0)(Data_Lens_Getter.viewOn(state1)(_moves(Data_Lens_Internal_Forget.strongForget))))(state1)));
  }, function (state1) {
      return function (v) {
          return v;
      };
  ...
  var reachableArray = function (state1) {
      return Lib_Util.tabulate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) + 1 | 0)(Game_Core.canPlay(frogGame)(state1));
  };
...
(function($PS) {
  ...
  var preventDefaultA = function (dispatch) {
      return function (e) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)($foreign.preventDefault(e)))(function () {
              return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(dispatch(Control_Category.identity(Control_Category.categoryFn)));
          });
      };
  };
...
(function($PS) {
  ...
  var state = Game_Frog_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Frog_Model.frogGame)(v)))(State);
  }, function (a) {
      return Pha_Action.lensAction(function (dictStrong) {
...
(function($PS) {
  ...
  var Lib_Random = $PS["Lib.Random"];
  var Lib_Util = $PS["Lib.Util"];
  var state = Game_Core.genState([  ])(function (v) {
      return {
          position: v.position,
          history: v.history,
          redoHistory: v.redoHistory,
  ...
  var jetonsGame = new Game_Core.Game(function (state1) {
      return function (v) {
          var position = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var v1 = Lib_Util.dCoords(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(v.from)(v.to);
      ...
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(1));
  }, function (state1) {
      var position = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      var columns = Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
  ...
  }, Game_Core.defaultOnNewGame, function (state1) {
      return function (v) {
          var position = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          })(position))([ Pha.maybeN(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(cursor)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointerPosition"](Data_Lens_Internal_Forget.strongForget))))(Data_Lens_Getter.viewOn(state)(Game_Jetons_Model["_dragged"](Data_Lens_Internal_Forget.strongForget)))) ])) ]);
...
(function($PS) {
  ...
  var state = Game_Jetons_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Jetons_Model.jetonsGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var nimGame2 = new Game_Core.TwoPlayersGame(function () {
      ...
      return Data_Array.sortWith(Data_Ord.ordInt)(function (v) {
          return Data_Maybe.maybe(0)(function (x) {
              var $27 = Data_Lens_Getter.viewOn(state1)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
              if ($27) {
                  return Data_Tuple.fst(x) - v.value1 | 0;
              };
              return v.value1 - Data_Tuple.snd(x) | 0;
          })(Data_Array.index(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v.value0));
      })(Data_Array.filter(Game_Core.canPlay(nimGame)(state1))(Lib_Util.tabulate2(Data_Lens_Getter.viewOn(state1)(_nbPiles(Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter.viewOn(state1)(_length(Data_Lens_Internal_Forget.strongForget)))(Move.create)));
  });
  var nimGame = new Game_Core.Game(function (state1) {
      return function (v) {
          return Data_Maybe.maybe(false)(function (v1) {
              return v.value1 !== v1.value0 && (v.value1 !== v1.value1 && (function () {
                  var $33 = Data_Lens_Getter.viewOn(state1)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
                  if ($33) {
  ...
  }, Game_Core["computerMove'"](nimGame2), function (state1) {
      return Data_Traversable.sequence(Data_Traversable.traversableArray)(Lib_Random.applicativeRandom)(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(_nbPiles(Data_Lens_Internal_Forget.strongForget)))((function () {
          var $38 = Data_Lens_Getter.viewOn(state1)(_length(Data_Lens_Internal_Forget.strongForget)) === 5;
          if ($38) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
          return (v.value1 - v.value0 | 0) === 1 && v.value0 === (function () {
              var $42 = Data_Lens_Getter.viewOn(state1)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 1;
              if ($42) {
                  return Data_Lens_Getter.viewOn(state1)(_length(Data_Lens_Internal_Forget.strongForget)) - 2 | 0;
              };
              return 0;
          })();
      })(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
      ...
      return function (v) {
          return Data_Lens_Setter.over(Data_Lens_Index.ix(Data_Lens_Index.indexArray)(v.value0)(Data_Lens_Internal_Wander.wanderFunction))(function (v1) {
              var $48 = Data_Lens_Getter.viewOn(state1)(Game_Core["_turn"](Data_Lens_Internal_Forget.strongForget)) === 0;
              if ($48) {
...
(function($PS) {
  ...
  var state = Game_Nim_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Nim_Model.nimGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var neighbor = function (state1) {
      return function (index1) {
          return function (index2) {
              var mode = Data_Lens_Getter.viewOn(state1)(_mode2(Data_Lens_Internal_Forget.strongForget));
              var v = Lib_Util.dCoords(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(index1)(index2);
  ...
  var toggleCell = function (state1) {
      return function (index) {
          return Data_Array.mapWithIndex(function (i) {
              return function (color) {
                  return color !== neighbor(state1)(index)(i);
              };
          });
      };
  };
  var genRandomBoard = function (state1) {
      var size = Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0;
      return Control_Bind.bind(Lib_Random.bindRandom)(Lib_Random.randomInt(size + 1 | 0))(function (v) {
          return Control_Bind.bind(Lib_Random.bindRandom)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Lib_Random.applicativeRandom)(Data_Array.replicate(v)(Lib_Random.randomInt(size))))(function (v1) {
              return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Foldable.foldr(Data_Foldable.foldableArray)(toggleCell(state1))(Data_Array.replicate(size)(true))(v1));
          });
      });
  };
  var noirblancGame = new Game_Core.Game(function (v) {
      ...
      return Control_Bind.bind(Lib_Random.bindRandom)((function () {
          var $45 = Data_Lens_Getter.viewOn(state1)(_level(Data_Lens_Internal_Forget.strongForget)) >= 6;
          if ($45) {
              return genRandomBoard(state1);
          };
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))((Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))).light);
  }, function (state1) {
      var v = Data_Maybe.fromMaybe(new Data_Tuple.Tuple(8, 8))(Data_Array.index(sizes)(Data_Lens_Getter.viewOn(state1)(_level(Data_Lens_Internal_Forget.strongForget))));
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Setter.set(Game_Core["_nbColumns"](Data_Profunctor_Strong.strongFn))(v.value1)(Data_Lens_Setter.set(Game_Core["_nbRows"](Data_Profunctor_Strong.strongFn))(v.value0)(state1)));
  }, function (state1) {
      return function (index) {
          var v = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          return {
              light: toggleCell(state1)(index)(v.light),
  ...
  var afterPlay = Pha_Action.asyncAction(function (v) {
      return function (state1) {
          var mode = Data_Lens_Getter.viewOn(state1)(_mode2(Data_Lens_Internal_Forget.strongForget));
          var $54 = Game_Core.isLevelFinished(noirblancGame)(state1);
          if ($54) {
              var nextLevel = (function () {
                  var $55 = Data_Lens_Getter.viewOn(state1)(_level(Data_Lens_Internal_Forget.strongForget)) >= 4;
                  if ($55) {
                      return 6;
                  };
                  return Data_Lens_Getter.viewOn(state1)(_level(Data_Lens_Internal_Forget.strongForget)) + (function () {
          ...
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(state1);
      };
  });
          ...
          var config = UI_Template.card("Tout noir tout blanc")([ UI_Icons.iconSelectGroup(Data_Show.showInt)(Data_Eq.eqInt)(function (dictStrong) {
              ...
              return function (opt) {
                  ...
                  return {
                      ...
                      large: v.large,
                      hidden: v.hidden,
                      disabled: Data_Ord.greaterThan(Data_Maybe.ordMaybe(Data_Ord.ordInt))(new Data_Maybe.Just(i))(Data_Array.index(Data_Lens_Getter.viewOn(state)(Game_Noirblanc_Model["_maxLevels"](Data_Lens_Internal_Forget.strongForget)))(Data_Lens_Getter.viewOn(state)(Game_Noirblanc_Model["_mode2"](Data_Lens_Internal_Forget.strongForget)))),
                      style: v.style
                  };
              };
...
(function($PS) {
  ...
  var state = Game_Noirblanc_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Noirblanc_Model.noirblancGame)(v)))(State);
  }, function (a) {
      return Pha_Action.lensAction(function (dictStrong) {
          return is(dictStrong.Profunctor0());
...
(function($PS) {
  ...
  var isValidPath = function (state1) {
      return function (path) {
          return Data_Maybe.fromMaybe(true)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Lens_Getter.viewOn(state1)(_exit(Data_Lens_Internal_Forget.strongForget)))(function (v) {
  ...
  var pathGame = new Game_Core.Game(function (state1) {
      return function (v) {
          var v1 = Data_Array_NonEmpty.fromArray(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
          if (v1 instanceof Data_Maybe.Nothing) {
              return Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state1)(_mode(Data_Lens_Internal_Forget.strongForget)))(Mode2.value);
          };
          if (v1 instanceof Data_Maybe.Just) {
              return Data_Maybe.maybe(false)(function (p) {
                  return !Data_Array["null"](p) && isValidPath(state1)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(p));
              })(pathBetween(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(Data_Array_NonEmpty.last(v1.value0))(v));
          };
      ...
      return Data_Array.length(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))) === ((Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) | 0) + (function () {
          var $47 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Lens_Getter.viewOn(state1)(_exit(Data_Lens_Internal_Forget.strongForget)))(Data_Array.head(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))));
          if ($47) {
              return 1;
          };
          return 0;
      ...
      var $48 = Data_Eq.eq(eqMode)(Data_Lens_Getter.viewOn(state1)(_mode(Data_Lens_Internal_Forget.strongForget)))(Mode1.value);
      if ($48) {
          return Data_Functor.mapFlipped(Lib_Random.functorRandom)(Lib_Random.randomInt(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0))(function (begin) {
              return Data_Lens_Setter.set(_exit(Data_Profunctor_Strong.strongFn))(new Data_Maybe.Just(begin))(Data_Lens_Setter.set(Game_Core["_position"](Data_Profunctor_Strong.strongFn))([ begin ])(state1));
          });
      };
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Setter.set(_exit(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)(Data_Lens_Setter.set(Game_Core["_position"](Data_Profunctor_Strong.strongFn))([  ])(state1)));
  }, function (state1) {
      return function (v) {
          var path = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          ...
          return Data_Maybe.fromMaybe([  ])(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.last(path))(function (v1) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(pathBetween(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(v1)(v))(function (v2) {
  ...
  var selectVertexA = function (v) {
      return Pha_Action.ifThenElseA(function (state1) {
          return function (v1) {
              return Data_Array["null"](Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
          };
      })(Pha_Action.action(Data_Lens_Setter.set(Game_Core["_position"](Data_Profunctor_Strong.strongFn))([ v ])))(Pha_Action.ifThenElseA(function (state1) {
          return function (v1) {
              return Data_Maybe.isNothing(Data_Lens_Getter.viewOn(state1)(_exit(Data_Lens_Internal_Forget.strongForget)));
          };
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var rows = Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
          var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var config = UI_Template.card("Chemins")([ UI_Icons.icongroup("Mode de jeu")([ UI_Icons.iconSelect(Game_Paths_Model.eqMode)(function (dictStrong) {
              return lens(dictStrong);
          ...
          }))([ Pha_Html.path(pathdec)([ Pha_Html["class'"]("paths-path")(true) ]), Pha.maybeN(hero), Pha.maybeN(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointerPosition"](Data_Lens_Internal_Forget.strongForget)))(function (pp) {
...
(function($PS) {
  ...
  var state = Game_Paths_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Paths_Model.pathGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var toggleAllowedPiece = function (piece) {
      return function (v) {
          return function (pieces) {
              ...
              throw new Error("Failed pattern match at Game.Queens.Model (line 161, column 1 - line 161, column 70): " + [ piece.constructor.name, v.constructor.name, pieces.constructor.name ]);
          };
      };
  };
  var canCapture = function (state1) {
  ...
  var attackedBy = function (state1) {
      return function (piece) {
          return function (index) {
              return Lib_Util.tabulate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(canCapture(state1)(piece)(index));
          };
      };
  };
  var capturableSquares = function (state1) {
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (v) {
          ...
          return Data_Array.zipWith(Data_HeytingAlgebra.disj(Data_HeytingAlgebra.heytingAlgebraBoolean))(attackedBy(state1)(v.value1)(v.value0));
      })(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(false))(Data_Array.mapWithIndex(Data_Tuple.Tuple.create)(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))));
  };
  var _ext = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.value1;
  ...
  var attackedBySelected = function (state1) {
      return Data_Maybe.maybe(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(false))(attackedBy(state1)(Data_Lens_Getter.viewOn(state1)(_selectedPiece(Data_Lens_Internal_Forget.strongForget))))(Data_Lens_Getter.viewOn(state1)(_selectedSquare(Data_Lens_Internal_Forget.strongForget)));
  };
  ...
  var pathGame = new Game_Core.Game(function (v) {
      ...
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(Empty.value));
  }, function (state1) {
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Control_Category.identity(Control_Category.categoryFn))(Lib_Util.map2(capturableSquares(state1))(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(function (index) {
      ...
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Setter.set(_selectedPiece(Data_Profunctor_Strong.strongFn))(Data_Maybe.fromMaybe(Queen.value)(Data_Array.head(Data_Lens_Getter.viewOn(state1)(_allowedPieces(Data_Lens_Internal_Forget.strongForget)))))(state1));
  }, function (state1) {
      return function (index) {
          var selectedPiece = Data_Lens_Getter.viewOn(state1)(_selectedPiece(Data_Lens_Internal_Forget.strongForget));
  ...
  var selectAllowedPieceA = function (piece) {
      return Game_Core.newGame(pathGame)(function (state1) {
          return Data_Lens_Setter.over(_allowedPieces(Data_Profunctor_Strong.strongFn))(toggleAllowedPiece(piece)(Data_Lens_Getter.viewOn(state1)(_multiPieces(Data_Lens_Internal_Forget.strongForget))))(state1);
      });
  };
...
(function($PS) {
  ...
  var state = Game_Queens_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Queens_Model.pathGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var aligned = function (state1) {
      var rot = Data_Lens_Getter.viewOn(state1)(_rotation(Data_Lens_Internal_Forget.strongForget));
      var n = Data_Array.length(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
  ...
  var validRotation$prime = function (state1) {
      return Data_Array.length(Data_Array.filter(Control_Category.identity(Control_Category.categoryFn))(aligned(state1))) === 1;
  };
  var validRotation = function (state1) {
      return validRotation$prime(state1) && Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Maybe.isJust)(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
  };
  ...
  var checkA = (function () {
      ...
      return Game_Core.lockAction(Pha_Action.asyncAction(function (h) {
          return function (state1) {
              return aux(h)(Data_Lens_Getter.viewOn(state1)(_size(Data_Lens_Internal_Forget.strongForget)));
          };
      }));
  })();
  var roueGame = new Game_Core.Game(function (v) {
      ...
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(_size(Data_Lens_Internal_Forget.strongForget)))(Data_Maybe.Nothing.value));
  }, function (v) {
      return false;
  }, (function () {
      var $65 = Control_Applicative.pure(Lib_Random.applicativeRandom);
      var $66 = Data_Lens_Setter.set(_rotation(Data_Profunctor_Strong.strongFn))(0);
      return function ($67) {
          return $65($66($67));
      };
  })(), function (state1) {
      return function (move) {
          ...
          return act(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
      };
  }, Game_Core.defaultSizeLimit);
  var setSizeA = Game_Core["newGame'"](roueGame)(Data_Lens_Setter.set(_size(Data_Profunctor_Strong.strongFn)));
  var _dragged = function (dictStrong) {
      var $68 = _ext(dictStrong);
  ...
  var deleteDraggedA = Pha_Action.action(function (state1) {
      var state2 = Data_Lens_Setter.set(_dragged(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value)(state1);
      return Data_Maybe.maybe(state2)(function (dragged) {
          if (dragged instanceof Wheel) {
              return Data_Lens_Setter.set((function () {
                  var $71 = Game_Core["_position"](Data_Profunctor_Strong.strongFn);
                  var $72 = Data_Lens_Index.ix(Data_Lens_Index.indexArray)(dragged.value0)(Data_Lens_Internal_Wander.wanderFunction);
                  return function ($73) {
                      return $71($72($73));
                  };
          ...
          return state2;
      })(Data_Lens_Getter.viewOn(state1)(_dragged(Data_Lens_Internal_Forget.strongForget)));
  });
  exports["Panel"] = Panel;
  exports["Wheel"] = Wheel;
  exports["state"] = state;
...
(function($PS) {
  ...
  var view = function (lens) {
      return function (state) {
          ...
          })() ]) ]), Pha.maybeN(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(cursor)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointerPosition"](Data_Lens_Internal_Forget.strongForget))))(draggedColor)) ]);
...
(function($PS) {
  ...
  var state = Game_Roue_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Roue_Model.roueGame)(v)))(State);
  }, function (v) {
      return Pha_Action.noAction;
  }, function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var betweenMove = function (state1) {
      return function (v) {
          var v1 = Lib_Util.dCoords(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)))(v.from)(v.to);
          var $46 = ((v1.row * v1.row | 0) + (v1.col * v1.col | 0) | 0) === 4;
          if ($46) {
  ...
  var betweenMove2 = function (state1) {
      return function (v) {
          var rows = Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
          var $62 = Data_Eq.eq(boardMode)(Data_Lens_Getter.viewOn(state1)(_board(Data_Lens_Internal_Forget.strongForget)))(CircleBoard.value);
          if ($62) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(betweenInCircle(v.from)(v.to)(rows))(function (v1) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      var $64 = rows === 4 && Data_Maybe.maybe(false)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Array.index(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(v1));
                      if ($64) {
          ...
          return betweenMove(state1)(v);
      };
  };
  var solitaireGame = new Game_Core.Game(function (state1) {
      return function (v) {
          return Data_Maybe.fromMaybe(false)((function () {
              var position = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
              return Control_Bind.bind(Data_Maybe.bindMaybe)(betweenMove2(state1)(v))(function (v1) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(position)(v.from))(function (v2) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(position)(v1))(function (v3) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(position)(v.to))(function (v4) {
                              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(Data_Lens_Getter.viewOn(state1)(_holes(Data_Lens_Internal_Forget.strongForget)))(v.to))(function (v5) {
      ...
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Control_Category.identity(Control_Category.categoryFn))(Data_Array.mapWithIndex(function (i) {
          return function (val) {
              return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (d) {
                  return Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean)))(Game_Core.canPlay(solitaireGame))(state1)({
                      from: i,
                      to: i + d | 0
                  });
              })([ 2, -2 | 0, 2 * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0, (-2 | 0) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0, Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) - 2 | 0 ]);
          };
      })(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget))));
  }, function (state1) {
      var rows = Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
      var columns = Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var v = (function () {
          var v1 = Data_Lens_Getter.viewOn(state1)(_board(Data_Lens_Internal_Forget.strongForget));
          ...
          if (v1 instanceof Grid3Board) {
              return {
                  holes: Data_Array.replicate(3 * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(true),
                  position: Control_Applicative.pure(Lib_Random.applicativeRandom)(Lib_Util.tabulate(3 * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(function (v2) {
          ...
          throw new Error("Failed pattern match at Game.Solitaire.Model (line 102, column 13 - line 120, column 18): " + [ v1.constructor.name ]);
      })();
      return Data_Functor.mapFlipped(Lib_Random.functorRandom)(v.position)(function (p) {
          return Data_Lens_Setter.set(Game_Core["_customSize"](Data_Profunctor_Strong.strongFn))(v.customSize)(Data_Lens_Setter.set(Game_Core["_position"](Data_Profunctor_Strong.strongFn))(p)(Data_Lens_Setter.set(_holes(Data_Profunctor_Strong.strongFn))(v.holes)(state1)));
      });
  }, function (state1) {
      return function (v) {
          return Data_Maybe.maybe(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(function (between) {
              return Data_Array.updateAtIndices(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple(v.from, false), new Data_Tuple.Tuple(between, false), new Data_Tuple.Tuple(v.to, true) ])(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
          })(betweenMove2(state1)(v));
      };
  }, function (state1) {
      var v = Data_Lens_Getter.viewOn(state1)(_board(Data_Lens_Internal_Forget.strongForget));
  ...
  var setBoardA = function (board) {
      return Game_Core.newGame(solitaireGame)(function (state1) {
          var st2 = Data_Lens_Setter.set(_board(Data_Profunctor_Strong.strongFn))(board)(state1);
  ...
  var view = function (lens) {
      return function (state) {
          ...
          var config = (function () {
              ...
              return UI_Template.card("Jeu du solitaire")([ UI_Icons.icongroup("Plateau")([ ic(Game_Solitaire_Model.CircleBoard.value)(function (v) {
                  return {
...
(function($PS) {
  ...
  var state = Game_Solitaire_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Solitaire_Model.solitaireGame)(v)))(State);
  }, Data_Function["const"](Pha_Action.noAction), function (lens) {
      return function (v) {
...
(function($PS) {
  ...
  var showTileType = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game.Tiling.Model (line 18, column 1 - line 21, column 26): " + [ v.constructor.name ]);
  });
  ...
  var getTile = function (v) {
      ...
      throw new Error("Failed pattern match at Game.Tiling.Model (line 23, column 1 - line 23, column 28): " + [ v.constructor.name ]);
  };
  ...
  var canPutTile = function (state1) {
      return Data_Foldable.all(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (index) {
          return Data_Maybe.maybe(false)(Data_Eq.eq(Data_Eq.eqInt)(0))(Data_Array.index(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(index));
      });
  };
  var _ext = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
  ...
  var placeTile = function (state1) {
      return function (index) {
          var columns = Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
          return Data_Functor.mapFlipped(Data_Functor.functorArray)(translate(Lib_Util.coords(columns)(index))(rotate(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(Data_Lens_Getter.viewOn(state1)(_rotation(Data_Lens_Internal_Forget.strongForget)))(4))(Data_Lens_Getter.viewOn(state1)(_tile(Data_Lens_Internal_Forget.strongForget)))))(function (v) {
  ...
  var tilingGame = new Game_Core.Game(function (state1) {
      return function (index) {
          return canPutTile(state1)(placeTile(state1)(index)) || Data_Maybe.maybe(false)(function (v) {
              return v > 0;
          })(Data_Array.index(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(index));
      };
  }, function (v) {
      return Data_Maybe.Nothing.value;
  }, function (state1) {
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Array.replicate(Data_Lens_Getter.viewOn(state1)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget)) * Data_Lens_Getter.viewOn(state1)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(0));
  }, (function () {
      ...
      return Control_Applicative.pure(Lib_Random.applicativeRandom)(Data_Lens_Setter.set(_rotation(Data_Profunctor_Strong.strongFn))(0)(Data_Lens_Setter.set(_tile(Data_Profunctor_Strong.strongFn))(getTile(Data_Lens_Getter.viewOn(state1)(_tileType(Data_Lens_Internal_Forget.strongForget))))(state1)));
  }, function (state1) {
      return function (index) {
          var tilePos = placeTile(state1)(index);
          var pos = Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
          var $63 = canPutTile(state1)(tilePos);
          if ($63) {
  ...
  var inConflict = function (state1) {
      return Data_Maybe.maybe(false)(function (sqr) {
          return Data_Eq.notEq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_Array.index(Data_Lens_Getter.viewOn(state1)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)))(sqr))(new Data_Maybe.Just(0)) || Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean)))(Game_Core.canPlay(tilingGame))(state1)(sqr);
      })(Data_Lens_Getter.viewOn(state1)(_hoverSquare(Data_Lens_Internal_Forget.strongForget)));
  };
...
(function($PS) {
  ...
  var state = Game_Tiling_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  ...
  var cgame = new Game.CGame(function (v) {
      return Data_Functor.mapFlipped(Effect.functorEffect)(Lib_Random.runRnd(Game_Core.init(Game_Tiling_Model.tilingGame)(v)))(State);
  }, function (a) {
      return Pha_Action.lensAction(function (dictStrong) {
          return is(dictStrong.Profunctor0());
...
(function($PS) {
  ...
  var state = Game_Valise_Model.state;
  var is = function (dictProfunctor) {
      return Data_Lens_Iso.iso(function (v) {
          return v;
      })(State)(dictProfunctor);
  };
  var cgame = new Game.CGame(function (st) {
      return Control_Applicative.pure(Effect.applicativeEffect)(st);
  }, Data_Function["const"](Pha_Action.noAction), function (lens) {
      return function (v) {
...
(function($PS) {
                  ...
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(100.0))(function () {
                      ...
                      if ($87) {
                          return v.dispatch(Pha_Action.lensAction(function (dictStrong) {
                              var $109 = _valise(dictStrong);
                              var $110 = Game_Valise.is(dictStrong.Profunctor0());
                              return function ($111) {
                                  return $109($110($111));
                              };
  ...
  var onKeyDown = function (maybek) {
      return Pha_Action.asyncAction(function (v) {
          return function (state) {
              if (maybek instanceof Data_Maybe.Nothing) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(state);
              };
              if (maybek instanceof Data_Maybe.Just) {
                  return v.dispatch(sliceFn(state)(function (dictCGame) {
                      return function (lens) {
                          return Pha_Action.lensAction(function (dictStrong) {
                              return lens(dictStrong);
                          })(Game.onKeyDown(dictCGame)(maybek.value0));
                      };
                  }));
              };
              throw new Error("Failed pattern match at Main (line 134, column 5 - line 136, column 73): " + [ maybek.constructor.name ]);
          };
      });
  };
