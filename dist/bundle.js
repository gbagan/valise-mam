...
(function($PS) {
  ...
  var redoA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 149, column 28 - line 155, column 52): " + [ v.constructor.name ]);
  });
  var undoA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 140, column 28 - line 146, column 56): " + [ v.constructor.name ]);
  });
  ...
  var computerMove$prime = function (dictTwoPlayersGame) {
      return function (state) {
          ...
          throw new Error("Failed pattern match at Game.Core (line 280, column 13 - line 282, column 44): " + [ bestMove.constructor.name ]);
      };
  };
  var computerPlay = function (dictGame) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          return Control_Bind.bind(Run.bindRun)(computerMove(dictGame)(v))(function (v1) {
              ...
              throw new Error("Failed pattern match at Game.Core (line 188, column 5 - line 192, column 51): " + [ v2.constructor.name ]);
          });
      });
  };
          ...
          return function (dragLens) {
              return function (to) {
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
                      ...
                      throw new Error("Failed pattern match at Game.Core (line 316, column 5 - line 320, column 71): " + [ v1.constructor.name ]);
                  });
              };
          };
      };
  ...
  var resetA = Pha_Action.setState(function (state) {
      ...
      throw new Error("Failed pattern match at Game.Core (line 158, column 29 - line 163, column 37): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var Data_Function = $PS["Data.Function"];
  var Pha = $PS["Pha"];     
  var onpointerup$prime = Pha.on("pointerup");
  var onpointerup = function ($2) {
      return onpointerup$prime(Data_Function["const"]($2));
  };
  var onpointermove$prime = Pha.on("pointermove");
  var onpointerleave$prime = Pha.on("pointerleave");
  var onpointerleave = function ($3) {
      return onpointerleave$prime(Data_Function["const"]($3));
  };
  var onpointerenter$prime = Pha.on("pointerenter");
  var onpointerenter = function ($4) {
      return onpointerenter$prime(Data_Function["const"]($4));
  };
  var onpointerdown$prime = Pha.on("pointerdown");
  var onpointerdown = function ($5) {
      return onpointerdown$prime(Data_Function["const"]($5));
  };
  var oncontextmenu$prime = Pha.on("contextmenu");
...
(function($PS) {
  ...
  var icons2Players = function (dictGame) {
      return function (state) {
          ...
          })([ Pha_Attributes.onclick(Game_Core.setModeA(dictGame)(Game_Core.RandomMode.value)) ]), iconbutton(state)(function (v) {
              return {
          ...
          })([ Pha_Attributes.onclick(Game_Core.setModeA(dictGame)(Game_Core.ExpertMode.value)) ]), iconbutton(state)(function (v) {
              return {
          ...
          })([ Pha_Attributes.onclick(Game_Core.setModeA(dictGame)(Game_Core.DuelMode.value)) ]), iconbutton(state)(function (v) {
              return {
          ...
          })([ Pha_Attributes.onclick(Game_Core.computerStartsA(dictGame)) ]) ]);
      };
  };
  var ihelp = function (state) {
      ...
      })([ Pha_Attributes.onclick(Game_Core.toggleHelpA) ]);
  };
  var iredo = function (state) {
      ...
      })([ Pha_Attributes.onclick(Game_Core.redoA) ]);
  };
  var ireset = function (state) {
      ...
      })([ Pha_Attributes.onclick(Game_Core.resetA) ]);
  };
  var irules = function (state) {
      ...
      })([ Pha_Attributes.onclick(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.Rules.value))) ]);
  };
  var iundo = function (state) {
      ...
      })([ Pha_Attributes.onclick(Game_Core.undoA) ]);
  };
          ...
          return function (sizeList) {
              return function (customSize) {
                  ...
                  return icongroup("Dimensions de la grille")(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.mapFlipped(Data_Functor.functorArray)(sizeList)(function (v) {
                      ...
                      })([ Pha_Attributes.onclick(Game_Core.setGridSizeA(dictGame)(v.value0)(v.value1)(false)) ]);
                  }))((function () {
                      if (customSize) {
                          return [ iconbutton(state)(function (v) {
                              return {
                          ...
                          })([ Pha_Attributes.onclick(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_customSize"](Data_Profunctor_Strong.strongFn))(true))) ]) ];
                      };
                      return [  ];
                  })()));
              };
  ...
  var iconBestScore = function (dictScoreGame) {
      return function (state) {
          ...
          })([ Pha_Attributes.onclick(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_dialog"](Data_Profunctor_Strong.strongFn))(Game_Core.ScoreDialog.value))) ]) ]);
      };
  };
  exports["iconbutton"] = iconbutton;
  ...
  var incDecGrid = function (v) {
      return function (children) {
          return Pha_Elements.div([ Pha.class_("ui-incdecgrid") ])([ Pha_Elements.div([ Pha.class_("flex") ])([ Pha_Elements.div([ Pha.class_("ui-flex-center ui-incdecgrid-container") ])(children), Pha.ifN(v.showRowButtons)(function (v1) {
              ...
              })([ Pha_Attributes.onclick(v.onResize(v.nbRows + 1 | 0)(v.nbColumns)) ]), Pha_Elements.div([ Pha.class_("ui-incdecgrid-text") ])([ Pha_Elements.span([  ])([ Pha.text(Data_Show.show(Data_Show.showInt)(v.nbRows)) ]) ]), UI_Icon.iconbutton(function (v2) {
                  return {
              ...
              })([ Pha_Attributes.onclick(v.onResize(v.nbRows - 1 | 0)(v.nbColumns)) ]) ]);
              ...
              })([ Pha_Attributes.onclick(v.onResize(v.nbRows)(v.nbColumns - 1 | 0)) ]), Pha_Elements.div([ Pha.class_("ui-incdecgrid-text") ])([ Pha_Elements.span([  ])([ Pha.text(Data_Show.show(Data_Show.showInt)(v.nbColumns)) ]) ]), UI_Icon.iconbutton(function (v2) {
                  return {
                      icon: new UI_Icon.IconSymbol("#plus"),
                      selected: v2.selected,
                      tooltip: v2.tooltip,
              ...
              })([ Pha_Attributes.onclick(v.onResize(v.nbRows)(v.nbColumns + 1 | 0)) ]) ]);
          }) ]);
      };
  };
...
(function($PS) {
  ...
  var trackPointer = (function () {
      ...
      return [ Pha.style("touch-action")("none"), Pha_Attributes["onpointermove'"](move), Pha_Attributes.onpointerleave(Pha_Action.setState(Data_Lens_Setter.set(Game_Core["_pointer"](Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value))), Pha_Attributes["onpointerdown'"](move) ];
  })();
                  ...
                  return function (droppable) {
                      return function (id) {
                          return function (state) {
                              ...
                              return [ Pha["class'"]("dragged")(dragged), Pha["class'"]("candrop")(candrop), Pha_Attributes["onpointerdown'"](function (ev) {
                              ...
                              }), Pha_Attributes.onpointerup((function () {
                                  if (candrop) {
  ...
  var dndBoardProps = function (dictEq) {
      return function (dictGame) {
          return function (dragLens) {
              ...
              return [ Pha.style("touch-action")("none"), Pha_Attributes["onpointermove'"](move), Pha_Attributes.onpointerup(Pha_Action.setState(Data_Lens_Setter.set(dragLens(Data_Profunctor_Strong.strongFn))(Data_Maybe.Nothing.value))), Pha_Attributes.onpointerleave(leave), Pha_Attributes["onpointerdown'"](move) ];
          };
      };
  };
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var cutter = function (row) {
          return function (col) {
              return function (move) {
                  return Pha_Svg.circle([ Pha_Svg.cx(Data_Show.show(Data_Show.showNumber)(50.0 * Data_Int.toNumber(col))), Pha_Svg.cy(Data_Show.show(Data_Show.showNumber)(50.0 * Data_Int.toNumber(row))), Pha_Svg.r("7"), Pha.key("c" + Data_Show.show(Data_Show.showInt)((row * (columns + 1 | 0) | 0) + col | 0)), Pha["class'"]("chocolat-cutter")(true), Pha_Attributes.onpointerenter(Game_Chocolat_Model.setHoverA(new Data_Maybe.Just(move))), Pha_Attributes.onpointerleave(Game_Chocolat_Model.setHoverA(Data_Maybe.Nothing.value)), Pha_Attributes.onclick(Control_Apply.applySecond(Run.applyRun)(Game_Chocolat_Model.setHoverA(Data_Maybe.Nothing.value))(Game_Core.playA(Game_Chocolat_Model.gameChocolat)(move))) ]);
              };
          };
      };
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(3))([ Pha["class'"]("ui-board")(true) ]))([ Pha_Svg.svg([ Pha_Svg.viewBox(-7 | 0)(-7 | 0)((50 * columns | 0) + 14 | 0)((50 * rows | 0) + 14 | 0) ])(Data_Array.concat([ Lib_Util.tabulate2(rows)(columns)(function (row) {
          ...
          throw new Error("Failed pattern match at Game.Chocolat.View (line 63, column 41 - line 67, column 106): " + [ v1.constructor.name ]);
      ...
      var config = UI_Template.card("Barre de chocolat")([ UI_Icons.iconSizesGroup(Game_Chocolat_Model.gameChocolat)(state)([ new Data_Tuple.Tuple(6, 7) ])(true), UI_Icons.iconSelectGroup(Game_Chocolat_Model.showSoapMode)(Game_Chocolat_Model.eqSoapMode)(state)("Emplacement du savon")([ Game_Chocolat_Model.CornerMode.value, Game_Chocolat_Model.BorderMode.value, Game_Chocolat_Model.StandardMode.value ])(Data_Lens_Getter.viewOn(state)(Game_Chocolat_Model["_soapMode"](Data_Lens_Internal_Forget.strongForget)))(Game_Chocolat_Model.setSoapModeA)(function (mode) {
          return function (opt) {
              ...
              throw new Error("Failed pattern match at Game.Chocolat.View (line 30, column 58 - line 33, column 100): " + [ mode.constructor.name ]);
          };
      ...
      var board = UI_Template.incDecGrid(Game_Chocolat_Model.gameChocolat)(state)([ grid, Pha_Elements.span([ Pha["class'"]("frog-turn-message")(true) ])([ Pha.text(UI_Template.turnMessage(Game_Chocolat_Model.gameChocolat)(state)) ]) ]);
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var board = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer)([ Pha.class_("ui-board dessin-board"), Pha_Attributes["oncontextmenu'"](function (ev) {
          ...
          return function (v) {
              return Pha_Svg.circle([ Pha_Svg.cx(Data_Show.show(Data_Show.showNumber)(20.0 * v.x)), Pha_Svg.cy(Data_Show.show(Data_Show.showNumber)(20.0 * v.y)), Pha_Svg.r("3"), Pha_Svg.stroke((function () {
                  ...
                  return "blue";
              })()), Pha_Svg.fill("blue"), Pha_Attributes.onclick(Game_Core.playA(Game_Dessin_Model.gameDessin)(new Data_Maybe.Just(i))) ]);
          };
      })(graph.vertices), [ Pha.maybeN(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(currentLine)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget))))(Data_Functor.map(Data_Maybe.functorMaybe)(getCoords(graph))(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array.last(position))))) ] ])), Pha_Elements.span([ Pha["class'"]("dessin-raise-info dessin-raise-info")(true) ])([ Pha.text(Data_Show.show(Data_Show.showInt)(raises) + (" lev\xe9" + (s + " de crayon"))) ]), Pha_Elements.button([ Pha["class'"]("ui-button ui-button-primary dessin-raise")(true), Pha_Attributes.disabled(!Game_Core.canPlay(Game_Dessin_Model.gameDessin)(state)(Data_Maybe.Nothing.value)), Pha_Attributes.onclick(Game_Core.playA(Game_Dessin_Model.gameDessin)(Data_Maybe.Nothing.value)) ])([ Pha.text("Lever le crayon") ]) ]);
      ...
      var grid = Pha_Elements.div([ Pha["class'"]("ui-board frog-board")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(-190 | 0)(-200 | 0)(400)(400) ])(Data_Array.concat([ [ Pha_Svg.path(spiralPath)([ Pha_Svg.fill("none"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]), Pha_Svg.line([ Pha_Svg.x_("153"), Pha_Svg.y_("9"), Pha_Svg.width("207"), Pha_Svg.height("20"), Pha_Svg.stroke("black"), Pha_Svg.strokeDasharray("5"), Pha_Svg.strokeWidth("6") ]), Pha_Svg.line([ Pha_Svg.x_("153"), Pha_Svg.y_("7"), Pha_Svg.width("153"), Pha_Svg.height("39"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]), Pha_Svg.line([ Pha_Svg.x_("207"), Pha_Svg.y_("18"), Pha_Svg.width("207"), Pha_Svg.height("50"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("3") ]) ], Lib_Util.map2(spoints)(reachable)(function (i) {
          return function (v) {
              return function (reach) {
                  return Pha_Svg.g([ Pha.key("lily" + Data_Show.show(Data_Show.showInt)(i)), Pha_Attributes["onclick'"](function (ev) {
          ...
          return Pha_Svg.g([ Pha.key("frog"), Pha["class'"]("frog-frog-container")(true), Pha.style("transform")(Pha_Util.translate(Data_Show.show(Data_Show.showString)(Pha_Util.px(v.radius)))("0") + (" rotate(" + (Data_Show.show(Data_Show.showNumber)((v.theta * 180.0) / $$Math.pi) + "deg)"))), Pha.style("transform-origin")(Data_Show.show(Data_Show.showNumber)(-v.radius) + "px 0") ])([ Pha_Svg.g([ Pha["class'"]("frog-frog-container")(true), Pha.style("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((-v.theta * 180.0) / $$Math.pi) + "deg)")) ])([ Pha_Svg.use("#frog2")([ Pha_Svg.x_("-20"), Pha_Svg.y_("-20"), Pha_Svg.width("40"), Pha_Svg.height("40"), Pha.class_("frog-frog"), Pha["class'"]("goal")(position === 0) ]) ]) ]);
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var cursor = function (pp) {
          return function (v) {
              return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-cursor jetons-cursor")(true) ])(UI_Template.cursorStyle(pp)(rows)(columns)(0.6)))([  ]);
          };
      };
      ...
      var board = UI_Template.incDecGrid(Game_Jetons_Model.jetonsGame)(state)([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Data_Eq.eqInt)(Game_Jetons_Model.jetonsGame)(function (dictStrong) {
          ...
          return function (val) {
              return Pha.ifN(val !== 0)(function (v) {
                  return piece(i)(val)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.key(Data_Show.show(Data_Show.showInt)(i)) ])(UI_Template.dndItemProps(Data_Eq.eqInt)(Game_Jetons_Model.jetonsGame)(function (dictStrong) {
                      return Game_Jetons_Model["_dragged"](dictStrong);
                  })(true)(true)(i)(state)));
              });
          };
...
(function($PS) {
  ...
  var showMode = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 14, column 1 - line 17, column 32): " + [ v.constructor.name ]);
  });
  var showBt = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 34, column 1 - line 39, column 32): " + [ v.constructor.name ]);
  });
      ...
      return function (columns) {
          return function (mode) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  ...
                  throw new Error("Failed pattern match at Game.Labete.Model (line 108, column 24 - line 111, column 83): " + [ mode.constructor.name ]);
              });
          };
      };
  };
  ...
  var getNewBeast = function (state) {
      ...
      throw new Error("Failed pattern match at Game.Labete.Model (line 141, column 21 - line 146, column 42): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var ihelp = function (state) {
      ...
      })([ Pha_Attributes.onpointerdown(Game_Labete_Model.setHelpA(true)), Pha_Attributes.onpointerup(Game_Labete_Model.setHelpA(false)), Pha_Attributes.onpointerleave(Game_Labete_Model.setHelpA(false)) ]);
  };
  var colors = [ "#5aa02c", "blue", "red", "yellow", "magenta", "cyan", "orange", "darkgreen", "grey" ];
  var square = function (v) {
      return function (props) {
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])(props))([ Pha_Svg.use("#grass")([ Pha_Svg.width("50"), Pha_Svg.height("50"), Pha_Svg.fill(Data_Maybe.fromMaybe("")(Data_Array.index(colors)(v.color))) ]), Pha_Svg.rect([ Pha_Svg.width("51"), Pha_Svg.height("51"), Pha_Svg.stroke("black"), Pha_Svg.strokeWidth("0.5"), Pha_Svg.fill("transparent") ]), Pha_Svg.use("#paw")([ Pha_Svg.x_("5"), Pha_Svg.y_("5"), Pha_Svg.width("40"), Pha_Svg.height("40"), Pha.class_("labete-beast"), Pha["class'"]("visible")(v.hasBeast) ]), Pha.ifN(v.hasTrap)(function (v1) {
  ...
  var view = function (state) {
      ...
      var customDialog = function (v) {
          return UI_Template.dialog("Personnalise ta b\xeate")([ Pha_Elements.div([ Pha["class'"]("labete-custombeast-grid-container")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(250)(250) ])(Data_Array.mapWithIndex(function (index) {
              return function (hasBeast) {
                  ...
                  return square({
                      ...
                      hasTrap: false,
                      color: 0
                  })([ Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Attributes.onclick(Game_Labete_Model.flipCustomBeastA(index)) ]);
              };
      ...
      var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer)([ Pha["class'"]("ui-board")(true), Pha_Attributes["onpointerdown'"](function (ev) {
          ...
          return function (hasTrap) {
              return function (hasBeast) {
                  return function (color) {
                      ...
                      })([ Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Attributes["onclick'"](function (ev) {
                      ...
                      }), Pha_Attributes.onpointerup(Game_Labete_Model.finishZoneA(index)), Pha_Attributes["onpointerdown'"](function (ev) {
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 120, column 26 - line 122, column 81): " + [ v.constructor.name ]);
      })()) ])) ]);
      var scoreDialog = function (v) {
          return UI_Template.bestScoreDialog(Game_Labete_Model.scoregameLabete)(state)(function (position) {
              return [ Pha_Elements.div([ Pha["class'"]("ui-flex-center labete-bestscore-grid-container")(true) ])([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))([ Pha["class'"]("ui-board")(true) ]))([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(50 * columns | 0)(50 * rows | 0) ])(Data_Array.mapWithIndex(function (index) {
                  return function (hasTrap) {
      ...
      var board = UI_Template.incDecGrid(Game_Labete_Model.labeteGame)(state)([ grid, Pha.ifN(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_selectedColor"](Data_Lens_Internal_Forget.strongForget)) > 0)(function (v) {
          return Pha_Elements.div([ Pha["class'"]("labete-color")(true), Pha.style("background-color")(Data_Maybe.fromMaybe("")(Data_Array.index(colors)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_selectedColor"](Data_Lens_Internal_Forget.strongForget))))) ])([  ]);
      }) ]);
      ...
      var config = UI_Template.card("La b\xeate")([ UI_Icons.iconSelectGroup(Game_Labete_Model.showBt)(Game_Labete_Model.eqBt)(state)("Forme de la b\xeate")(beastTypes)(Data_Lens_Getter.viewOn(state)(Game_Labete_Model["_beastType"](Data_Lens_Internal_Forget.strongForget)))(Game_Labete_Model.setBeastA)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 70, column 91 - line 75, column 61): " + [ v.constructor.name ]);
          ...
          throw new Error("Failed pattern match at Game.Labete.View (line 77, column 81 - line 80, column 86): " + [ v.constructor.name ]);
      ...
      var board = Pha_Elements.div([ Pha["class'"]("ui-board nim-board")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100)(100) ])(Data_Array.concat(Data_Array.mapWithIndex(function (i) {
          return function (pile) {
              return Data_Array.concat([ [ Pha_Svg.rect([ Pha_Svg.x_((function () {
                  ...
                  return Pha_Svg.rect([ Pha_Svg.x_("-2.5"), Pha_Svg.y_("-2.5"), Pha_Svg.width("5"), Pha_Svg.height("5"), Pha.key("base-" + (Data_Show.show(Data_Show.showInt)(i) + ("-" + Data_Show.show(Data_Show.showInt)(j)))), Pha_Svg.fill("gray"), Pha_Attributes.onclick(Game_Core.playA(Game_Nim_Model.nimGame)(new Game_Nim_Model.Move(i, j))), Pha.style("transform")(Pha_Util.translate(px$prime((function () {
                      var $4 = length === 5;
                      if ($4) {
                          return 30;
                      };
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])(UI_Template.gridStyle(rows)(columns)(4)))(Lib_Util.map2(position.light)(position.played)(function (index) {
          return function (light) {
              return function (played) {
                  var v = Lib_Util.coords(columns)(index);
                  return square(light)(Data_Lens_Getter.viewOn(state)(Game_Core["_help"](Data_Lens_Internal_Forget.strongForget)) && played)([ Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha.style("height")(Pha_Util.pc(0.86 / Data_Int.toNumber(rows))), Pha.style("width")(Pha_Util.pc(0.86 / Data_Int.toNumber(columns))), Pha.style("left")(Pha_Util.pc((Data_Int.toNumber(v.col) + 7.0e-2) / Data_Int.toNumber(columns))), Pha.style("top")(Pha_Util.pc((Data_Int.toNumber(v.row) + 7.0e-2) / Data_Int.toNumber(rows))), Pha_Attributes.onclick(Game_Noirblanc_Model.play2A(index)) ]);
              };
          };
      }));
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          ...
          return Pha_Svg.g(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("paths-darken")(v.darken) ])(props))([ Pha_Svg.use("#paths-background")(pos), Pha.ifN(v.door)(function (v1) {
  ...
  var heroCursor = function (pp) {
      return Pha_Svg.use(" #meeplehat")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha.key("chero"), Pha_Svg.x_("-40"), Pha_Svg.y_("-40"), Pha_Svg.width("80"), Pha_Svg.height("80"), Pha.attr("opacity")("0.6"), Pha.attr("pointer-events")("none") ])(UI_Template.svgCursorStyle(pp)));
  };
  ...
  var view = function (state) {
      ...
      var config = UI_Template.card("Chemins")([ UI_Icons.iconSelectGroup(Game_Paths_Model.showMode)(Game_Paths_Model.eqMode)(state)("Mode de jeu")([ Game_Paths_Model.Mode1.value, Game_Paths_Model.Mode2.value ])(Data_Lens_Getter.viewOn(state)(Game_Paths_Model["_mode"](Data_Lens_Internal_Forget.strongForget)))(Game_Paths_Model.selectModeA)(function (v) {
          ...
          throw new Error("Failed pattern match at Game.Paths.View (line 54, column 87 - line 56, column 82): " + [ v.constructor.name ]);
      ...
      var hero = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Array.last(position))(function (h) {
          ...
          return Pha_Svg.use("#meeplehat")([ Pha.key("hero"), Pha_Svg.width("80"), Pha_Svg.height("80"), Pha["class'"]("paths-hero")(true), Pha.style("transform")(Pha_Util.translate(Pha_Util.pc((Data_Int.toNumber(v.col) + 0.1) / Data_Int.toNumber(columns)))(Pha_Util.pc((Data_Int.toNumber(v.row) + 0.1) / Data_Int.toNumber(rows)))) ]);
      });
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(UI_Template.trackPointer))([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100 * columns | 0)(100 * rows | 0) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Lib_Util.tabulate(rows * columns | 0)(function (index) {
          var v = Lib_Util.coords(columns)(index);
          return square({
          ...
          })([ Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Attributes.onclick(Game_Paths_Model.selectVertexA(index)) ]);
      }))([ Pha_Svg.path(pathdec)([ Pha["class'"]("paths-path")(true) ]), Pha.maybeN(hero), Pha.maybeN(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Lens_Getter.viewOn(state)(Game_Core["_pointer"](Data_Lens_Internal_Forget.strongForget)))(function (pp) {
...
(function($PS) {
  ...
  var attackedBySelected = function (state) {
      ...
      throw new Error("Failed pattern match at Game.Queens.Model (line 97, column 28 - line 99, column 65): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var square = function (v) {
      return function (props) {
          return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(props)([ Pha["class'"]("queens-square")(true), Pha["class'"]("queens-square-capturable")(v.capturable), Pha["class'"]("queens-square-nonavailable")(v.nonavailable), Pha["class'"]("queens-square-selected")(v.selected) ]))((function () {
              var $13 = Data_Eq.eq(Game_Queens_Model.eqPiece)(v.piece)(Game_Queens_Model.Empty.value);
              if ($13) {
                  return [  ];
              };
              return [ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%"), Pha["class'"]("queens-piece")(true) ])([ Pha_Svg.use("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(v.piece))([ Pha_Svg.x_("10%"), Pha_Svg.y_("10%"), Pha_Svg.width("80%"), Pha_Svg.height("80%") ]) ]) ];
          })());
      };
  };
  var view = function (state) {
      ...
      var rows = Data_Lens_Getter.viewOn(state)(Game_Core["_nbRows"](Data_Lens_Internal_Forget.strongForget));
      var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      var pieceSelector = Pha_Elements.div([ Pha["class'"]("ui-flex-center gutter2 queens-pieceselector")(true) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Array_NonEmpty.toArray(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_allowedPieces"](Data_Lens_Internal_Forget.strongForget))))(function (piece) {
          ...
          })([ Pha.key(name), Pha_Attributes.onclick(Game_Queens_Model.selectPieceA(piece)) ]);
      }));
      ...
      })([ Pha_Attributes.onclick(Game_Queens_Model.customizeA) ]), UI_Icons.iconbutton(state)(function (v) {
          return {
      ...
      })([ Pha_Attributes.onclick(Game_Queens_Model.toggleMultiPiecesA) ]) ])([ UI_Icons.ihelp(state), UI_Icons.ireset(state), UI_Icons.irules(state) ])), UI_Icons.iconBestScore(Game_Queens_Model.queensScoreGame)(state) ]);
      var columns = Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget));
      var cursor = function (pp) {
          return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-cursor")(true) ])(UI_Template.cursorStyle(pp)(rows)(columns)(0.8)))([ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%") ])([ Pha_Svg.use("#piece-" + Data_Show.show(Game_Queens_Model.showPiece)(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_selectedPiece"](Data_Lens_Internal_Forget.strongForget))))([  ]) ]) ]);
      };
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(UI_Template.trackPointer)))(Data_Array.concat([ Lib_Util.map3(position)(Game_Queens_Model.attackedBySelected(state))(Game_Queens_Model.capturableSquares(state))(function (index) {
          return function (piece) {
              return function (attacked) {
                  return function (capturable) {
                      ...
                      })([ Pha.style("width")(Pha_Util.pc(1.0 / Data_Int.toNumber(columns))), Pha.style("height")(Pha_Util.pc(1.0 / Data_Int.toNumber(rows))), Pha_Attributes.onclick(Game_Core.playA(Game_Queens_Model.queensGame)(index)), Pha_Attributes.onpointerenter(Game_Queens_Model.selectSquareA(new Data_Maybe.Just(index))), Pha_Attributes.onpointerleave(Game_Queens_Model.selectSquareA(Data_Maybe.Nothing.value)) ]);
                  };
              };
          };
      ...
      var scoreDialog = function (v) {
          return UI_Template.bestScoreDialog(Game_Queens_Model.queensScoreGame)(state)(function (pos) {
              return [ Pha_Elements.div([ Pha["class'"]("ui-flex-center queens-bestscore-container")(true) ])([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))([ Pha["class'"]("ui-board queens-grid")(true) ]))(Data_Functor.mapFlipped(Data_Functor.functorArray)(pos)(function (piece) {
                  return square({
                      piece: piece,
                      capturable: false,
                      selected: false,
      ...
      var board = Pha_Elements.div([  ])([ pieceSelector, UI_Template.incDecGrid(Game_Queens_Model.queensGame)(state)([ grid ]) ]);
      var angles = [ 45, 90, 135, 0, 0, 180, -45 | 0, -90 | 0, -135 | 0 ];
      var customDialog = function (v) {
          return UI_Template.dialog("Personnalise ta pi\xe8ce")([ Pha_Elements.div([ Pha["class'"]("flex queens-custompiece")(true) ])([ Pha_Elements.div([ Pha["class'"]("queens-grid queens-custompiece-grid")(true) ])(Data_Array.mapWithIndex(function (index) {
              return function (selected) {
                  return square({
                      piece: (function () {
                          var $18 = index === 12;
                      ...
                      capturable: false,
                      nonavailable: false
                  })([ Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha.style("width")("20%"), Pha.style("height")("20%"), Pha_Attributes.onclick((function () {
                      var $19 = index !== 12;
                      if ($19) {
          ...
          })(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_customLocalMoves"](Data_Lens_Internal_Forget.strongForget)))), Pha_Elements.div([ Pha["class'"]("flex queens-custompiece-directions")(true) ])(Lib_Util.map2(Data_Lens_Getter.viewOn(state)(Game_Queens_Model["_customDirections"](Data_Lens_Internal_Forget.strongForget)))(angles)(function (i) {
              return function (selected) {
                  return function (angle) {
                      ...
                      })([ Pha.key(Data_Show.show(Data_Show.showInt)(i)), Pha_Attributes.onclick((function () {
                          var $21 = i !== 4;
                          if ($21) {
  ...
  var aligned = function (state) {
      ...
      return Data_Array.mapWithIndex(function (index) {
          return function (v) {
              ...
              throw new Error("Failed pattern match at Game.Roue.Model (line 41, column 47 - line 43, column 43): " + [ v.constructor.name ]);
          };
      })(Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget)));
  };
...
(function($PS) {
  ...
  var cursor = function (v) {
      return function (color) {
          return Pha_Elements.div([ Pha["class'"]("ui-cursor roue-select-color roue-cursor")(true), Pha.style("left")(Pha_Util.pc(v.x)), Pha.style("top")(Pha_Util.pc(v.y)), Pha.style("background-color")(color) ])([  ]);
      };
  };
  var colors = [ "blue", "red", "magenta", "orange", "brown", "cyan", "gray", "black" ];
  var innerWheel = function (size) {
      return Pha_Elements.div([ Pha["class'"]("roue-inner")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100)(100) ])(Data_Array.mapWithIndex(function (i) {
          return function (color) {
  ...
  var view = function (state) {
      ...
      var outerWheel = Pha_Elements.div([ Pha["class'"]("roue-outer")(true), Pha.style("transform")("rotate(" + (Data_Show.show(Data_Show.showNumber)((360.0 * Data_Int.toNumber(Data_Lens_Getter.viewOn(state)(Game_Roue_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)))) / Data_Int.toNumber(size)) + "deg)")) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.svg([ Pha.key("svg"), Pha_Svg.viewBox(0)(0)(100)(100) ])(Lib_Util.map2(position)(Game_Roue_Model.aligned(state))(function (i) {
          ...
          return function (c) {
              return Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(c)(function (color) {
                  return Pha_Elements.div([ Pha["class'"]("roue-outer-piece")(true), Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha.style("left")(Pha_Util.pc(0.44 + 0.4 * $$Math.cos((Data_Int.toNumber(index) * 2.0 * $$Math.pi) / Data_Int.toNumber(size)))), Pha.style("top")(Pha_Util.pc(0.44 + 0.4 * $$Math.sin((Data_Int.toNumber(index) * 2.0 * $$Math.pi) / Data_Int.toNumber(size)))), Pha.style("background-color")(Data_Maybe.fromMaybe("")(Data_Array.index(colors)(color))) ])([  ]);
              });
          };
      })(position))));
      ...
      var board = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Game_Roue_Model.eqLoc)(Game_Roue_Model.roueGame)(function (dictStrong) {
          return Game_Roue_Model["_dragged"](dictStrong);
      }))([ Pha["class'"]("roue-board")(true), Pha_Attributes.onpointerup(Game_Roue_Model.deleteDraggedA) ]))([ Pha_Elements.div([ Pha["class'"]("roue-buttons")(true) ])(Data_Array.concat([ [ Pha_Elements.button([ Pha["class'"]("ui-button ui-button-primary roue-button")(true), Pha_Attributes.disabled(Data_Lens_Getter.viewOn(state)(Game_Core["_locked"](Data_Lens_Internal_Forget.strongForget))), Pha_Attributes.onclick(Game_Roue_Model.rotateA(-1 | 0)) ])([ Pha.text("\u21b6") ]) ], Data_Array.mapWithIndex(function (i) {
          return function (color) {
              return Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("roue-select-color ui-flex-center")(true), Pha.style("background-color")(color) ])(UI_Template.dndItemProps(Game_Roue_Model.eqLoc)(Game_Roue_Model.roueGame)(function (dictStrong) {
                  return Game_Roue_Model["_dragged"](dictStrong);
      ...
      })(Data_Array.take(size)(colors)), [ Pha_Elements.button([ Pha["class'"]("ui-button ui-button-primary roue-button")(true), Pha_Attributes.disabled(Data_Lens_Getter.viewOn(state)(Game_Core["_locked"](Data_Lens_Internal_Forget.strongForget))), Pha_Attributes.onclick(Game_Roue_Model.rotateA(1)) ])([ Pha.text("\u21b7") ]) ] ])), Pha_Elements.div([ Pha["class'"]("roue-roue")(true) ])([ outerWheel, innerWheel(size), Pha_Elements.button([ Pha["class'"]("ui-button ui-button-primary roue-validate")(true), Pha_Attributes.disabled(!valid || Data_Lens_Getter.viewOn(state)(Game_Core["_locked"](Data_Lens_Internal_Forget.strongForget))), Pha_Attributes.onclick(Game_Roue_Model.checkA) ])([ Pha.text("Valider") ]), Pha_Elements.div([ Pha["class'"]("roue-valid-rotation")(true) ])([ (function () {
          if (valid) {
              return Pha_Elements.span([ Pha["class'"]("valid")(true) ])([ Pha.text("\u2713") ]);
          };
          return Pha_Elements.span([ Pha["class'"]("invalid")(true) ])([ Pha.text("\u2717") ]);
  ...
  var animateA = function (animation) {
      return Control_Monad.unlessM(Run.monadRun)(Data_Functor.map(Run.functorRun)(Data_Lens_Getter.view(_locked(Data_Lens_Internal_Forget.strongForget)))(Pha_Action.getState))(Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Action.setState((function () {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Data_Foldable.for_(Run.applicativeRun)(Data_Foldable.foldableArray)(animation)(function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Run.bindRun)(Pha_Effects_Delay.delay(v.value0))(function () {
                  return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v1) {
...
(function($PS) {
  ...
  var animPytha = function (v) {
      ...
      return Pha_Svg.svg([ Pha["class'"]("sansmot-svg")(true), Pha_Svg.viewBox(0)(0)(700)(300), Pha.style("width")("84vmin"), Pha.style("height")("36vmin") ])([ Pha_Svg.path("M 0 300 h 300 v -300 h -300 Z L 100 100 M 0 100 h 300 l -200 -100 v 300")([ Pha_Svg.fill("transparent"), Pha_Svg.stroke("#000") ]), Pha_Svg.path("M 400 300 h 300 v -300 h -300 Z M 400 200 l 200 100 l 100 -200 l -200 -100 l -100 200")([ Pha_Svg.fill("transparent"), Pha_Svg.stroke("#000") ]), Pha_Svg.path("M 0 300 v -200 h 100 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("blue"), Pha_Svg.stroke("#000") ])(f("a"))), Pha_Svg.path("M 0 300 h 100 v -200 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("yellow"), Pha_Svg.stroke("#000") ])(f("b"))), Pha_Svg.path("M 100 0 h 200 v 100 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("#00FF00"), Pha_Svg.stroke("#000") ])(f("c"))), Pha_Svg.path("M 100 0 v 100 h 200 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("red"), Pha_Svg.stroke("#000") ])(f("d"))), Pha_Svg.path("M 0 300 v -200 h 100 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("blue"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg.path("M 0 300 h 100 v -200 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("yellow"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg.path("M 100 0 h 200 v 100 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("#00FF00"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg.path("M 100 0 v 100 h 200 0 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("red"), Pha_Svg.stroke("#000") ])(f("e"))), Pha_Svg["text'"]("a")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("5"), Pha_Svg.y_("55"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("a")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("46"), Pha_Svg.y_("12"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("b")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("105"), Pha_Svg.y_("210"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("b")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("198"), Pha_Svg.y_("210"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("c")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("450"), Pha_Svg.y_("98"), Pha.style("font-size")("20") ])(f("e"))), Pha_Svg["text'"]("c")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.x_("595"), Pha_Svg.y_("80"), Pha.style("font-size")("20") ])(f("e"))) ]);
  };
  var animCaroll = function (v) {
      ...
      return Pha_Svg.svg([ Pha["class'"]("sansmot-svg")(true), Pha_Svg.viewBox(-10 | 0)(-10 | 0)(1370)(270), Pha_Svg.width("90vw"), Pha_Svg.height("19vw") ])(Data_Array.concat([ [ Pha_Svg.path("M 400 100 h 250 v -100 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("orange") ])(f("a"))), Pha_Svg.path("M 400 200 h 150 v -50 h 100 v -50 h -250 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("red") ])(f("b"))), Pha_Svg.path("M 400 250 h 250 v -100 h -100 v 50 h -150 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("blue") ])(f("c"))), Pha_Svg.path("M 0 250 h 400 v -150 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("green") ])(f("d"))), Pha_Svg.path("M 400 100 h 250 v -100 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("orange") ])(f("e"))), Pha_Svg.path("M 400 200 h 150 v -50 h 100 v -50 h -250 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("red") ])(f("e"))), Pha_Svg.path("M 400 250 h 250 v -100 h -100 v 50 h -150 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("blue") ])(f("e"))), Pha_Svg.path("M 0 250 h 400 v -150 Z")(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.fill("green") ])(f("e"))) ], Lib_Util.tabulate(28)(function (i) {
          return line$prime(50 * i | 0)(-10 | 0)(50 * i | 0)(260)([ Pha["class'"]("sansmot-grid")(true) ]);
      }), Lib_Util.tabulate(6)(function (i) {
          return line$prime(-10 | 0)(50 * i | 0)(1360)(50 * i | 0)([ Pha["class'"]("sansmot-grid")(true) ]);
      }) ]));
  };
  var view = function (state) {
      var main = function (v) {
          if (v instanceof Game_Sansmot_Model.PythaPage) {
              return Pha_Elements.div([ Pha.key("pytha") ])([ Pha_Elements.h1([ Pha["class'"]("sansmot-title")(true) ])([ Pha.text("Preuve sans mot") ]), Pha_Elements.h2([ Pha["class'"]("sansmot-h2")(true) ])([ Pha.text("Que raconte le th\xe9or\xe8me de Pythagore ?") ]), Pha_Elements.p([ Pha["class'"]("sansmot-center")(true) ])([ Pha_Svg.svg([ Pha["class'"]("sansmot-svg")(true), Pha_Svg.viewBox(0)(-100 | 0)(200)(250), Pha_Svg.width("20vmin"), Pha_Svg.height("25vmin") ])([ Pha_Svg.path("M 50 50 h 100 v 100 h -100 Z")([ Pha_Svg.fill("yellow"), Pha_Svg.stroke("black") ]), Pha_Svg.path("M 0 0 h 50 v 50 h -50 Z")([ Pha_Svg.fill("yellow"), Pha_Svg.stroke("black") ]), Pha_Svg.path("M 50 0 l 100 50 l 50 -100 l -100 -50 Z")([ Pha_Svg.fill("#00ff00"), Pha_Svg.stroke("black") ]), Pha_Svg["text'"]("a\xb2")([ Pha_Svg.x_("90"), Pha_Svg.y_("105"), Pha.attr("font-size")("35") ]), Pha_Svg["text'"]("b\xb2")([ Pha_Svg.x_("18"), Pha_Svg.y_("35"), Pha.attr("font-size")("35") ]), Pha_Svg["text'"]("c\xb2")([ Pha_Svg.x_("110"), Pha_Svg.y_("-10"), Pha.attr("font-size")("35") ]) ]) ]), Pha_Elements.h2([ Pha["class'"]("sansmot-h2")(true) ])([ Pha.text("Preuve sans mot due \xe0 un auteur chinois inconnu qui vivait vers 200 avant J.-C.") ]), Pha_Elements.p([ Pha["class'"]("sansmot-center")(true) ])([ animPytha(state) ]), Pha_Elements.p([ Pha["class'"]("sansmot-center sansmot-link")(true), Pha_Attributes.onclick(Game_Sansmot_Model.animateA(Game_Sansmot_Model.pythaAnimation)) ])([ Pha.text("Lancer l'animation") ]) ]);
          };
          if (v instanceof Game_Sansmot_Model.CarollPage) {
              return Pha_Elements.div([ Pha.key("caroll") ])([ Pha_Elements.h1([ Pha["class'"]("sansmot-title")(true) ])([ Pha.text("Preuve sans mot") ]), Pha_Elements.h2([ Pha["class'"]("sansmot-h2")(true) ])([ Pha.text("O\xf9 est pass\xe9 le carr\xe9 manquant ?") ]), Pha_Elements.p([ Pha["class'"]("sansmot-center")(true) ])([ animCaroll(state) ]), Pha_Elements.p([ Pha["class'"]("sansmot-center sansmot-link")(true), Pha_Attributes.onclick(Game_Sansmot_Model.animateA(Game_Sansmot_Model.carollAnimation)) ])([ Pha.text("Lancer l'animation") ]) ]);
          };
          throw new Error("Failed pattern match at Game.Sansmot.View (line 106, column 5 - line 127, column 6): " + [ v.constructor.name ]);
      };
      return Pha_Elements.div([ Pha["class'"]("sansmot-main")(true) ])([ Pha_Elements.div([ Pha["class'"]("sansmot-menu")(true) ])([ Pha_Elements.div([ Pha["class'"]("sansmot-pagelink")(true), Pha_Attributes.onclick(Game_Sansmot_Model.setPageA(Game_Sansmot_Model.PythaPage.value)) ])([ Pha.text("1") ]), Pha_Elements.div([ Pha["class'"]("sansmot-pagelink")(true), Pha_Attributes.onclick(Game_Sansmot_Model.setPageA(Game_Sansmot_Model.CarollPage.value)) ])([ Pha.text("2") ]) ]), main(state.page) ]);
  };
  exports["view"] = view;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  var showMode = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Game.Solitaire.Model (line 16, column 1 - line 21, column 32): " + [ v.constructor.name ]);
  });
  var istate = Game_Core.genState([  ])(function (v) {
      return {
          position: v.position,
      ...
      var v = (function () {
          ...
          if (v1 instanceof CircleBoard) {
              return {
                  ...
                  position: Data_Functor.mapFlipped(Run.functorRun)(Pha_Effects_Random.randomInt(rows))(function (x) {
          ...
          if (v1 instanceof RandomBoard) {
              return {
                  holes: Data_Array.replicate(3 * Data_Lens_Getter.viewOn(state)(Game_Core["_nbColumns"](Data_Lens_Internal_Forget.strongForget)) | 0)(true),
                  position: Data_Functor.mapFlipped(Run.functorRun)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Run.applicativeRun)(Data_Array.replicate(columns)(Pha_Effects_Random.randomBool)))(function (bools) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var config = (function () {
          ...
          })([ Pha_Attributes.onclick(Game_Solitaire_Model.toggleHelpA) ]);
          ...
          return UI_Template.card("Jeu du solitaire")([ UI_Icons.iconSelectGroup(Game_Solitaire_Model.showMode)(Game_Solitaire_Model.boardMode)(state)("Plateau")(boards)(Data_Lens_Getter.viewOn(state)(Game_Solitaire_Model["_board"](Data_Lens_Internal_Forget.strongForget)))(Game_Solitaire_Model.setBoardA)(function (i) {
              return function (opt) {
                  ...
                  throw new Error("Failed pattern match at Game.Solitaire.View (line 48, column 88 - line 53, column 91): " + [ i.constructor.name ]);
              };
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.dndBoardProps(Data_Eq.eqInt)(Game_Solitaire_Model.solitaireGame)(function (dictStrong) {
      ...
      var scoreDialog = function (v) {
          return UI_Template.bestScoreDialog(Game_Solitaire_Model.scoregame)(state)(function (position) {
              return [ Pha_Elements.div([ Pha["class'"]("ui-flex-center solitaire-scoredialog")(true) ])([ Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("ui-board")(true) ])((function () {
                  if (isCircleBoard) {
                      return [ Pha.style("width")("100%"), Pha.style("height")("100%") ];
                  };
                  return UI_Template.gridStyle(rows)(columns)(5);
...
(function($PS) {
  ...
  var view = function (state) {
      var tileCursor = function (pp) {
          return Pha_Svg.g(UI_Template.svgCursorStyle(pp))([ Pha_Svg.g([ Pha["class'"]("tiling-cursor")(true), Pha.style("transform")("rotate(" + (Data_Show.show(Data_Show.showInt)(90 * Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_rotation"](Data_Lens_Internal_Forget.strongForget)) | 0) + "deg)")) ])(Data_Functor.mapFlipped(Data_Functor.functorArray)(Data_Lens_Getter.viewOn(state)(Game_Tiling_Model["_tile"](Data_Lens_Internal_Forget.strongForget)))(function (v) {
      ...
      var position = Data_Lens_Getter.viewOn(state)(Game_Core["_position"](Data_Lens_Internal_Forget.strongForget));
      var customDialog = function (v) {
          return UI_Template.dialog("Personnalise ta tuile")([ Pha_Elements.div([ Pha["class'"]("tiling-customtile-grid-container")(true) ])([ Pha_Elements.div([ Pha["class'"]("tiling-grid")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(250)(250) ])(Data_Array.mapWithIndex(function (index) {
              return function (hasBlock) {
                  ...
                  return square({
                      ...
                      hasSink: false,
                      isDark: false
                  })([ Pha.key(Data_Show.show(Data_Show.showInt)(index)), Pha_Attributes.onclick(Game_Tiling_Model.flipTileA(index)) ]);
              };
          })(Data_Lens_Getter.viewOn(state)((function () {
      ...
      var grid = Pha_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.gridStyle(rows)(columns)(5))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(UI_Template.trackPointer)([ Pha["class'"]("ui-board")(true), Pha_Attributes["oncontextmenu'"](function (ev) {
          ...
          return function (pos) {
              ...
              return square({
                  ...
                  row: v.row,
                  col: v.col
              })([ Pha_Attributes.onclick(Game_Tiling_Model.clickOnCellA(index)), Pha_Attributes.onpointerenter(Game_Tiling_Model.setHoverSquareA(new Data_Maybe.Just(index))), Pha_Attributes.onpointerleave(Game_Tiling_Model.setHoverSquareA(Data_Maybe.Nothing.value)) ]);
          };
      })(position))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Array.mapWithIndex(function (index) {
          return function (pos) {
              var v = Lib_Util.coords(columns)(index);
              return Pha_Svg.g([ Pha_Svg.transform(Pha_Util.translate(Data_Show.show(Data_Show.showInt)(50 * v.col | 0))(Data_Show.show(Data_Show.showInt)(50 * v.row | 0))) ])([ Pha.ifN(pos > 0 && border(index)(-1 | 0))(function (v1) {
...
(function($PS) {
  ...
  var tricolorGame = new Game_Core.Game(function (v) {
      ...
      return Data_Traversable.sequence(Data_Traversable.traversableArray)(Run.applicativeRun)(Data_Array.replicate(Data_Lens_Getter.viewOn(state)(_size(Data_Lens_Internal_Forget.strongForget)))(Pha_Effects_Random.randomInt(Data_Lens_Getter.viewOn(state)(_nbColors(Data_Lens_Internal_Forget.strongForget)))));
  }, function (state) {
...
(function($PS) {
  ...
  var view = function (state) {
      ...
      var board = Pha_Elements.div([ Pha["class'"]("ui-board tricolor-board")(true) ])([ Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(100)(100) ])(Data_Array.concat([ Data_Array.mapWithIndex(function (i) {
          return function (color) {
              return Pha_Svg.circle([ Pha_Svg.r("7.5"), Pha["class'"]("tricolor-cell")(true), Pha["class'"]("finished")(levelFinished), Pha_Svg.stroke((function () {
              ...
              })()), Pha.style("transform")(translateCell(i)(size)), Pha_Attributes.onclick(Game_Core.playA(Game_Tricolor_Model.tricolorGame)(i)), Pha_Attributes.onpointerenter(Game_Tricolor_Model.setHoverCellA(new Data_Maybe.Just(i))), Pha_Attributes.onpointerleave(Game_Tricolor_Model.setHoverCellA(Data_Maybe.Nothing.value)) ]);
          };
...
(function($PS) {
  ...
  var valise = function (state) {
                      ...
                      return function (h$prime) {
                          return function (props) {
                              return function (children) {
                                  ...
                                  return Pha_Svg.g([ Pha.style("transform")((function () {
                                  ...
                                  })()) ])([ Pha_Svg.g(props)([ Pha_Svg.svg(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha["class'"]("valise-object")(true), Pha.style("touch-action")("none"), Pha["class'"]("draggable")(v.drag), Pha_Svg.width(Data_Show.show(Data_Show.showInt)(w$prime)), Pha_Svg.height(Data_Show.show(Data_Show.showInt)(h$prime)), Pha_Attributes.onpointerdown((function () {
                                      if (v.drag) {
                                      ...
                                      return [ Pha_Attributes.onpointerenter(Game_Valise_Model.showHelpA(v.help)), Pha_Attributes.onpointerleave(Game_Valise_Model.showHelpA("")) ];
                                  })()))([ Pha.h("use")([ Pha_Attributes.href("#" + v.symbol), Pha["class'"]("valise-symbol")(true) ])([  ]), Pha.maybeN(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(v.link)(function (l) {
                                      return Pha_Elements.a([ Pha_Attributes.href("#" + l) ])([ Pha_Svg.rect(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Pha_Svg.width("100%"), Pha_Svg.height("100%"), Pha["class'"]("valise-object-link")(true), Pha_Svg.fill("transparent"), Pha_Attributes.onpointerenter(Game_Valise_Model.showHelpA(v.help)), Pha_Attributes.onpointerleave(Game_Valise_Model.showHelpA("")) ])(children)) ]);
                                  })) ]) ]) ]);
                              };
                          };
                      };
      ...
      return Pha_Svg.svg([ Pha_Svg.viewBox(0)(0)(825)(690), Pha_Attributes["onpointermove'"](Game_Valise_Model.moveObjectA), Pha_Attributes.onpointerup(Game_Valise_Model.setDragA(Data_Maybe.Nothing.value)) ])([ Pha.h("use")([ Pha_Attributes.href("#valise"), Pha["class'"]("valise-close")(true), Pha_Svg.width("100%"), Pha_Svg.height("100%") ])([  ]), Pha_Svg.g([ Pha["class'"]("valise-open")(true) ])([ Pha.h("use")([ Pha_Attributes.href("#openvalise") ])([  ]), object({
          symbol: "switch",
          link: Data_Maybe.Nothing.value,
          help: "",
          drag: false
      })(300)(460)(42)(60)([ Pha_Attributes.onclick(Game_Valise_Model.toggleSwitchA), Pha.style("transform")((function () {
          if (state.isSwitchOn) {
  ...
  var view = function (state) {
      return Pha_Elements.div([ Pha["class'"]("ui-flex-center valise-main-container")(true), Pha["class'"]("open")(state.isOpen) ])([ Pha_Elements.div([  ])([ Pha_Elements.div([ Pha["class'"]("valise-logo")(true) ])([ Pha_Svg.svg([ Pha_Svg.width("100%"), Pha_Svg.height("100%") ])([ Pha_Svg.use("#logo")([  ]) ]) ]), Pha_Elements.div([ Pha["class'"]("valise-container")(true) ])([ valise(state), Pha_Elements.div([ Pha["class'"]("valise-help")(true), Pha["class'"]("visible")(state.helpVisible && state.help !== "") ])([ Pha.text(state.help) ]) ]) ]) ]);
  };
  exports["view"] = view;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  var onKeyDown = function (ev) {
      return Control_Bind.bind(Run.bindRun)(Pha_Action.getState)(function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 167, column 5 - line 169, column 70): " + [ v1.constructor.name ]);
      });
  };
